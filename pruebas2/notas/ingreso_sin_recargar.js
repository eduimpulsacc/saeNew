...
function cargaDatos(idDiv, idInput)
{
	...
	var reg=/(^[a-zA-Z0-9._áéíóúñ¡!¿? -]{1,70}$)/;
...
function creaInput(idDiv, idInput)
{
	...
	if(!mostrandoInput && divError.style.display!="block")
	{
		...
		// Creamos el input
		divContenedor.innerHTML="<input type='text' size='2' onBlur='cargaDatos(\""+idDiv+"\", \""+idInput+"\")' value='"+divContenedor.innerHTML+"' id='"+idInput+"' maxlength='40'>";
