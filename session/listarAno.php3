...
<body>
	<center>
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<!--tr>
				<td colspan=3 align=right>
					<?php if(($_PERFIL!=2)&&($_PERFIL!=4)){ //ACADEMICO Y LEGAL?>
						...
						<INPUT TYPE="button" value="AGREGAR" onClick=document.location="seteaAno.php3?caso=2">
											<?php }?>
			...
			<?php
				$qry="SELECT * FROM ANO_ESCOLAR WHERE ID_INSTITUCION=".$institucion." ORDER BY NRO_ANO ASC";
				$result =@pg_Exec($conn,$qry);
				if (!$result) {
			...
			?>
						...
						onClick=go('../admin/institucion/ano/fichas/listarAlumnosMatriculados.php3?ano=<?php echo $fila["id_ano"];?>&tipoFicha=1')>
							<td align="right" >
								<font face="arial, geneva, helvetica" size="1" color="#000000">
