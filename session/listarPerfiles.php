...
$qry="SELECT  DISTINCT usuario.id_usuario,perfil.id_perfil,perfil.nombre_perfil,accede.id_perfil, 
...
WHERE usuario.nombre_usuario = '".$_NOMBREUSUARIO."' AND accede.estado=1 ORDER BY 3,6 asc";
...
if($fila['id_perfil']!=3 && $fila['id_perfil']!=4 && $fila['id_perfil']!=5 && $fila['id_perfil']!=7 ){				
