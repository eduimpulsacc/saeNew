...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="600" align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
<tr height="20">
<td colspan="5" align="middle" class="tableindex Estilo4 Estilo5">PERFILES DE ACCESO ASOCIADOS</td>
</tr>
<tr>
...
accede.estado, accede.id_base,upper(institucion.nombre_instit) as nombre_instit,institucion.rdb, s.nombre
FROM usuario 
