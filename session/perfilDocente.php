			...
			<tr>
				<td align=center>
					<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
						...
						?>
									<tr bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent' onClick=go('seteaDocente.php?ano=<?php echo $fila['id_ano'];?>&institucion=<?php echo $fila['rdb'];?>&curso=<?php echo $fila['id_curso'];?>&caso=1&from=1&menu=5&categoria=19&nw=1')>
										<td align="center" >
											<font face="arial, geneva, helvetica" size="1" color="#000000">
					...
					<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
						...
						<?php
								for($i=0 ; $i < @pg_numrows($result) ; $i++){
									$fila = @pg_fetch_array($result,$i);
						?>
									<tr bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent' onClick=go('seteaDocente.php?ano=<?php echo $fila['id_ano']?>&institucion=<?php echo $fila['rdb']?>&curso=<?php echo $fila['id_curso']?>&ramo=<?php echo $fila['id_ramo']?>&caso=2&from=1&menu=5&categoria=19&nw=1')>
