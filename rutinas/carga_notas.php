...
$conn=@pg_connect("dbname=coi_final host=10.132.10.36 port=1550 user=postgres password=cole#newaccess") or die ("No pude conectar a la base de datos destino");
...
for ($k=0; $k < $num_0; $k++){
	 ...
	 $sql_curso = "select id_curso from curso where id_ano = '$id_ano' and ensenanza = '$ensenanza' and grado_curso = '$grado_curso' and letra_curso = '$letra_curso'";
...
echo "Fin carga de notas, $institucion, ano: $nro_ano <br>"; 	
?>
