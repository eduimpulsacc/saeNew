<? 
$conn=@pg_connect("dbname=coi_final host=200.2.201.19 port=5432 user=postgres password=cole#newaccess") or die (pg_last_error($conn));
...
<?
  ...
  <tr>
	...
	<script> setTimeout("window.location='rutina_tiene.php?desde=<?=$desde;?>&hasta=<?=$hasta;?>&flag=1&cuenta=<?=$cuenta;?>'");</script>
</body>
</html>
