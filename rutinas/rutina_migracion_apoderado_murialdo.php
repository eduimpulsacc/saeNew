...
echo "<br> conexion sae";
$conn2=pg_connect("dbname=murialdo host=190.101.89.162 port=1550 user=postgres password=post2005*") or die (pg_last_error($conn2));
echo "<br> conexion murialdo";
