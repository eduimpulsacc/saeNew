...
group by institucion.rdb, institucion.nombre_instit ";						
							...
							$result2 =@pg_Exec($conn,$qry2)or die("fallo ".$qry2);
    ...
    <table width="650" border="1" align="center" cellpadding="2" cellspacing="0" class="Estilo7">
									...
									$sql_curso2.="= ".$id_ano_[$i].") and ensenanza = '410' and grado_curso = '2')) and ";
									...
									$sql_curso3.=" ensenanza = '410' and grado_curso = '3'))   and id_periodo = ";
									...
									$sql_curso4.="'410' and grado_curso = '4')) and id_periodo = ".$id_periodo_[$i]." and promedio > '0'";
