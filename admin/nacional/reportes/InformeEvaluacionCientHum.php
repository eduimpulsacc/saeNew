...
function enviapag(form){
			...
			if (form.cmbNIVEL.value==0){
				...
				form.action = 'printPromediosCH.php';
				form.submit(true);
        ...
        <tr>
          <td align="center" valign="top"><table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td class="cuadro01">
			  <? 	$sql ="	SELECT id_nivel, nombre FROM niveles WHERE id_nivel > 6 ";
            ...
            <tr>
              <td  class="cuadro01">&nbsp;</td>
              <td colspan="2" class="cuadro01"><input type="submit" name="Submit" value="BUSCAR" class="botonXX" onClick="enviapag(this.form);">
