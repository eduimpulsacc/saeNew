...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<center>
	<form name="form" action="printAproReproSub.php" method="post">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" valign="top"><table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <!--  <select name="cmbANO" id="cmbANO" onChange='cargaContenido(this.id)'>
                ...
                <option value="2014" <? if($cmbANO==2012){?> selected="selected"<? }?>>2014</option>
                <option value="2013" <? if($cmbANO==2012){?> selected="selected"<? }?>>2013</option>
