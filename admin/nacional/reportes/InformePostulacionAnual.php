	...
	<center>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
		  ...
		  <form name="form" method="post" action="printPostulacionEstablecimientos.php">
		  <table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td colspan="2" class="cuadro01"><input type="submit" onClick="" name="Submit" value="BUSCAR" class="botonXX">
                &nbsp;
