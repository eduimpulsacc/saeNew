...
/*	$sql = "SELECT rdb,nombre_instit,id_ano FROM institucion INNER JOIN ano_escolar ON rdb=id_institucion WHERE rdb IN(SELECT rdb FROM corp_instit WHERE num_corp=".$corporacion.") AND nro_ano=".$cmbANO."";*/
	...
	$sql = "SELECT rdb,nombre_instit,id_ano FROM institucion 
	INNER JOIN ano_escolar ON rdb=id_institucion 
	WHERE rdb IN( 
	SELECT rdb FROM corp_instit 
    ...
    where nacional.id_nacional=".$corporacion." ) AND nro_ano=".$cmbANO."";
...
<table width="850" border="1" align="center" cellpadding="3" cellspacing="0">
  ...
  $sql = "select id_dignos,nombre from diagnostico where rdb 
  IN (  SELECT rdb FROM corp_instit 
	inner join nacional_corp on nacional_corp.num_corp = corp_instit.num_corp 
    inner join nacional on nacional.id_nacional = nacional_corp.id_nacional 
    where nacional.id_nacional=".$corporacion."; ) and tipo=1";
