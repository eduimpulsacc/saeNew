...
<div id="capa0">
  <table width="650" border="0" align="center">
    <tr>
      <td><input type="button" name="Submit" value="VOLVER" onClick="window.close()" class="botonXX"/></td>
      <td><div align="right">
...
<table width="750" height="843" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    <td height="113" valign="top">
      ...
      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" >
        <tr>
          <td class="titulo1">ALUMNOS  DE TODOS LOS ESTABLECIMIENTOS </td>
        </tr>
      </table>
    <br />
	  ...
	  $arr_mat_mes1= array();
	   ...
	   foreach ($instituciones as $institucion): 
		  ...
		  <tr>
			...
			$matricula_sep = alumnos_sep($id_ano,$conn);
			
			$matricula_total=matricula_total($id_ano,$conn);
			
			$porcentajetotal = ($matricula_sep * 100) / $matricula_total;
            ...
            <td align="right" class="text2"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<?=number_format($matricula_sep,'0',',','.');?></font></td>
			...
			$total = $total+$matricula_total;
			$total_sep = $total_sep+$matricula_sep;
			
			$total_por = ($total_sep*100) / $total;
	...
	<? endforeach ?>	  
        ...
        <td align="right" class="celdas2"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<?=number_format($total,'0,',',','.');?></font></td>
        <td align="right" class="celdas2"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<?=number_format($total_sep,'0,',',','.');?></font></td>
        <td align="right" class="celdas2"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<? echo round($total_por)."%";?></font></td>
		</tr>
