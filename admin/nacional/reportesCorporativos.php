...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<center>
	<font style="font-family:Arial, Helvetica, sans-serif; font-size:15px"><strong> REPORTES CORPORACION:</strong></font>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                          ...
                          <tr>
                           ...
                           <tr>
                            <td align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                            <td class="cuadro01"><a href="reportes/InformeCantidadAlumnoEnsenanza.php">8. Cantidad de Alumnos por Tipo de Enseñanza</a></td>
                          </tr>
                          
                           <tr>
                            <td align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                            <td class="cuadro01"><a href="reportes/asistencia_anual_sep.php">9. Cantidad de Alumnos SEP</a></td>
                          </tr>
  <tr>
                            <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                            <td class="cuadro01"><a href="reportes/reportePAEE/reportePAEE.php">10. Reporte PAEE </a></td>
                          </tr>
                          <? if($_PERFIL==0){ ?>
                    ...
                    <tr>
                      <td height="80" align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                          ...
                          <tr>
                            <td width="8%" align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                            <td width="92%" class="cuadro01"><a href="reportes/InformeAsistenciaMensualNivel.php?flag=0">10. Informe Mensual por niveles </a></td>
                          </tr>
                          <tr>
                            <td width="8%" align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                            <td width="92%" class="cuadro01"><a href="reportes/InformeAsistenciaAnual.php?flag=0">11. Informe Anual por Establecimientos </a></td>
                          </tr>
                          <tr>
                            <td width="8%" align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                          ...
                          <tr>
                            ...
                            <tr>
                              <!--<td align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                          <td class="cuadro01"><a href="reportes/InformePromedioEnsenanza.php">20. Promedios por Tipo de Enseñanza</a></td>-->
                          </tr>
                ...
                <td width="50%"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                          ...
                          <tr>
                           ...
                           <tr>
                            <td width="8%" align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                            <td width="92%" class="cuadro01"><a href="reportes/InformeDocentes.php">22. Cantidad de personal por cargo </a></td>
                          </tr>
                  ...
                  <?php   if($_NOMCORP!="Peñalolen"){?>
                    <tr>
                      <td align="center" valign="middle"><img src="../../cortes/arrow.png" width="9" height="9"></td>
                      <td class="cuadro01"><a href="reportes/CantAlumnosCorp.php">30. Cantidad Alumnos por establecimiento </a></td>
                    </tr>
                   <?php }?>
                  </table></td>
                  <!----------- COMENTADO HASTA NUEVO AVISO--------------------------------------------
