  ...
  <tr>
	...
	<form name="form" action="procesaEstablecimiento.php" method="post">
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			$qry_ins="select corp_instit.rdb, corp_instit.estado, institucion.nombre_instit 
  from corp_instit, institucion, nacional, nacional_corp
  where nacional_corp.id_nacional = '$_CORPORACION' and corp_instit.rdb = institucion.rdb 
  AND nacional.id_nacional=nacional_corp.id_nacional
  AND nacional_corp.num_corp=corp_instit.num_corp
