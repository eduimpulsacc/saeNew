	...
	<center>
		<form method="post" name="frm" action="procesaInstituciones.php?variable=<?=$variable?>">
			<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
				...
				<? 	$qry = "select corp_instit.rdb, corp_instit.estado, institucion.nombre_instit from corp_instit, institucion where corp_instit.num_corp = '$variable' and corp_instit.rdb = institucion.rdb order by nombre_instit asc";
				...
				?>			
					...
					{	
						...
						<tr bgcolor=#ffffff >
							...
							<td align="center"><img src="eliminar.png" onClick="MM_goToURL('parent','procesaInstituciones.php?del=1&num_corp=<?=$num_corp?>&rdb=<?=$rdb?>');return document.MM_returnValue" onmouseover=this.style.cursor='hand'></td>
						</tr>										
				<?	}	?>				
			</table>
		</form>
