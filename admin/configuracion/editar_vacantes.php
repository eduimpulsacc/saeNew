...
<link rel="stylesheet" type="text/css" media="screen" href="validacion/css/screen.css" />

<script src="validacion/lib/jquery.js" type="text/javascript"></script>
<script src="validacion/jquery.validate.js" type="text/javascript"></script>

<!-- for styling the form -->
<script src="validacion/js/cmxforms.js" type="text/javascript"></script>
...
";
                        ...
                        <tr>
                          <td><font face="Arial, Helvetica, sans-serif" size="2">Cantidad:</font></td>
						  <?
						  $qrycant="SELECT * FROM vacantes where id_vacante=".$id_vacante;
						  $resultcant=@pg_Exec($conn,$qrycant);
						  $fila4 = @pg_fetch_array($resultcant,0); 
						   ?>
                          <td><input name="cantidad" type="text" id="cantidad" size="4" value="<?= $fila4["vac_ini"]?>" class="required">
						  </td>
                        </tr>
                        <tr>
                          <td colspan="2">
