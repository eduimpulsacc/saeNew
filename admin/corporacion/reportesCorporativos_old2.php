					   ...
					   <tr>
					     <td>
						   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#000000">
						      <tr>
						        <td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('matricula','pesta1');"><span id="pesta1" class="span_normal" >Matricula</span></a></div></td>
						        <td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('asistencia','pesta2');"><span id="pesta2" class="span_normal" >Asistencia </span></a></div></td>
						        <td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('notas','pesta3');"><span id="pesta3" class="span_normal" >Calificaciones </span></a></div></td>
						        <td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('opcion4','pesta4');"><span id="pesta4" class="span_normal" >Dotacion Docente </span></a></div></td>
						        <td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('opcion5','pesta5');"><span id="pesta5" class="span_normal" >Postulacion </span></a></div></td>
								<td width="16%"><div align="center" class="Estilo4"><a href="javascript:;" onClick="muestra_tabla('opcion5','pesta5');"><span id="pesta5" class="span_normal" >Proyecto Int y Grupo Dif </span></a></div></td>
						      </tr>
						   </table>						 </td>
					   </tr>
					   <tr>
    ...
    <?php }
										    ...
										    <table width="600" border="0" align="center" cellpadding="5" cellspacing="0">
                                              <tr>
                                                ...
                                                <td width="50%"><img src="images/imprimir_reporte.gif" width="118" height="14" border="0" onClick="window.print()"></td>
                                              </tr>
                                            </table>
									      <? } ?>
											  ...
											  <tr>
												<td><table width="100%" border="0" cellspacing="0" cellpadding="3">
												  ...
												  for($i=0;$i<pg_numrows($result_ins);$i++){	
													...
													echo    $query_mat="select count(rut_alumno) as ret from matricula where id_ano in (select id_ano from ano_escolar where nro_ano = '$cmb_ano' and id_institucion = '$rdb') and bool_ar='1'";
                                                       $filsMatriculados=@pg_fetch_array(pg_exec($conn,$query_mat));
                                 ...
                                 <table width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                                   ...
                                   <tr>
                                     ...
                                     <td class="Estilo8">Informe Anual por Niveles </td>
                                       ...
                                       <td class="Estilo8"><input name="buscar" type="submit" id="buscar" value="BUSCAR"></td>
                                     </div>
                                   </tr>
                                   <tr>
									   ...
									   <form method="post" name="form" action="reportesCorporativos.php">
										...
										<? if($caso==""){ ?>
										  <table width="650" border="0" cellpadding="5" cellspacing="0">
											<tr>
											  <td align="center" colspan="2"><span class="Estilo1">Buscador Avanzado</span></td>
											</tr>
											<tr>
