...
if($xls==1){
	...
	header("Content-Disposition:inline; filename=Mat_masc_corp_$fecha_actual.xls"); 	 
	}	
?>
...
<title>Alumnos Sexo Masculino Corporaci&oacute;n <?php echo $nombre_corp ?></title>
...
function exportar(){
	window.location='print_mat_masc_corp.php?pesta=1&op=1&cmb_ano=<?=$cmb_ano ?>&xls=1';
	return false;
		  }		  
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
												  <tr>
													<td colspan="2"><div align="center" class="Estilo13">Matrícula de alumnos sexo Masculino de la Corporaci&oacute;n <?php echo $nombre_corp ?></div></td>
												  </tr>
												  <tr>
												  ...
												  for($i=0;$i<pg_numrows($result_ins);$i++){	
													   ...
													   <tr>
														...
														<td class="Estilo11"><div align="right" class="Estilo11"><b><?=$mascu ?></b></div></td>
													   </tr>
													   <?
												  ...
												  <tr>
													...
													<td class="Estilo4"><div align="right" class="Estilo9"><?=$total_mascu ?></div></td>
												  </tr>
												</table>
</body>
</html>
