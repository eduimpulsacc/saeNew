...
function cargarinicio(x){ 
 ...
 function valida(form){
	 ...
	 if(document.form.cmbSUBSECTOR.value==0){
		 alert("Seleccione Subsector");
		 return false;
		 }	 
		 
		 form.action = 'printAproReproSub.php';
				form.submit(true);
	 }	
</script>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad=    "MM_preloadImages('../../../cortes/b_ayuda_r.jpg','file:///C|/Documents and Settings/Eduardo/Mis documento/coi/cortes/b_info_r.jpg','file:///C|/Documents and Settings/Eduardo/Mis documento/coi/cortes/b_mapa_r.jpg','file:///C|/Documents and Settings/Eduardo/Mis documento/coi/cortes/b_home_r.jpg'),<? echo "cargarinicio('cmbANO');";?>">
          ...
          <td align="center" valign="top"><table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="33%" class="cuadro01">&nbsp;
                <select name="cmbANO" id="cmbANO" onChange='cargaContenido(this.id)'>
				<option value="0">selecione...</option>
               <?php  for($a=date("Y");$a>=2006;$a--){?>
                <option value="<?php echo $a ?>" <? if($cmbANO==$a){?> selected="selected"<? }?>><?php echo $a ?></option>
                <?php }?>
              </select>              </td>
            ...
            <tr>
              ...
              <td class="cuadro01">&nbsp;
			  <select disabled="disabled" name="cmbSUBSECTOR" id="cmbSUBSECTOR">									    
            ...
            <tr>
              <td  class="cuadro01">&nbsp;</td>
              <td colspan="2" class="cuadro01"><input type="button" name="Submit" value="BUSCAR" class="botonXX" onClick="valida(this.form)">
