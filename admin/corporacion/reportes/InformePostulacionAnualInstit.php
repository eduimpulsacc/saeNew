	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" valign="top"><table width="61%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td  class="cuadro01"><div align="right">INSTITUCI&Oacute;N ORIGEN </div></td>
              <td colspan="2" class="cuadro01">&nbsp;
			  <select name="cmbINSTIT">
			  	<option value="0" selected="selected">seleccione...</option>
				<? 	$sql = "SELECT institucion.rdb,nombre_instit  FROM institucion INNER JOIN  corp_instit ON  institucion.rdb=corp_instit.rdb WHERE num_corp=".$corporacion;
            ...
            <tr>
              ...
              <td colspan="2" class="cuadro01"><input type="submit" name="Submit" value="BUSCAR" class="botonXX">
                &nbsp;
                <input name="GRAFICCO" type="button" value="GRAFICO" class="botonXX">
&nbsp;                <input name="VOLVER" type="button" value="VOLVER" class="botonXX" onClick="window.location='../reportesCorporativos4.php'"></td>
              </tr>
          </table></td>
        </tr>
      </table>
