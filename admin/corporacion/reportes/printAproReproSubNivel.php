	  ...
	  $arr_mat_mes1= array();
	   ...
	   foreach ($instituciones as $institucion): 
		  ...
		  <tr>
			...
			from ramo where cod_subsector=".$cmbSUBSECTOR_1." and id_curso in (Select id_curso from curso where 
		    id_ano=".$id_ano." and id_nivel=".$cmbNIVEL.")) and promedio>='40'";
				...
				in(select id_ramo from ramo where cod_subsector=".$cmbSUBSECTOR_1." and id_curso in 
				(Select id_curso from curso where id_ano=".$id_ano." and id_nivel=".$cmbNIVEL.")) and promedio<'40'";
