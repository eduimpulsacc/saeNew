  ...
  <tr>
    ...
    <table width="650" border="1" align="center" cellpadding="2" cellspacing="0" class="Estilo7">
									...
									$sql_curso1 = "select  sum(CAST(promedio AS integer)) as suma, count(promedio) as
									 ...
									 = ".$id_ano_[$i].") and ensenanza = '310' and grado_curso = '1'))   and
									...
									$sql_curso2.="id_periodo = ".$id_periodo_[$i]." and promedio > '0'";
									...
									$sql_curso4.="'310' and grado_curso = '4')) and id_periodo = ".$id_periodo_[$i]." and promedio > '0'";
