...
<table width="900" height="843" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <?  $sql = "SELECT count(a.*) as total,b.nombre as diag,c.nombre_instit, c.rdb, e.nombre_emp || cast(' ' as varchar) || e.ape_pat || ";
		...
		$sql.= "FROM alumno a INNER JOIN diagnostico b ON  a.id_dignos=b.id_dignos ";
		...
		echo $sql.= "WHERE c.rdb in (SELECT rdb FROM corp_instit WHERE num_corp=".$corporacion.") AND d.tipo=1 AND g.nro_ano=".$cmbANO."";
