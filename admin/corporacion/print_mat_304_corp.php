...
if($xls==1){
	...
	header("Content-Disposition:inline; filename=Mat_304_corp_$fecha_actual.xls"); 	 
	}	
?>
...
<title>Matrícula al 30 de Abril Corporaci&oacute;n <?php echo $nombre_corp ?></title>
<link href="../../<?=$_ESTILO?>" rel="stylesheet" type="text/css">
<style type="text/css">
<!--
.Estilo16 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; }
.Estilo17 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; font-weight: bold; }
.Estilo19 {color: #000000}
.Estilo20 {font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; font-weight: bold; color: #000000; }
.Estilo21 {
...
function exportar(){
	window.location='print_mat_304_corp.php?pesta=1&op=1&cmb_ano=<?=$cmb_ano ?>&xls=1';
	return false;
		  }		  
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
												  <tr>
													<td colspan="2"><div align="center" class="Estilo21"  >Matrícula de alumnos después del 30 de abril Corporaci&oacute;n Total matrícula corporación <?php echo $nombre_corp ?>
</div></td>
												  </tr>
												  <tr>
													<td bgcolor="#CCCCCC"><strong class="Estilo17 Estilo19">Establecimiento</strong></td>
													<td width="20%" bgcolor="#CCCCCC" ><div align="right" class="Estilo20">Cantidad</div></td>
												  </tr>
												  <?php
												  ...
												  for($i=0;$i<pg_numrows($result_ins);$i++){	
													   ...
													   ?>
													   <tr>
														<td class="Estilo8"><span class="Estilo16">
													    <?=$establecimiento ?>
														</span></td>
														<td class="Estilo8"><div align="right" class="Estilo16"><b><?=$abril ?></b></div></td>
													   </tr>
													   <?
												  ...
												  ?>
												  <tr>
													<td bgcolor="#CCCCCC" class="Estilo4"><div align="right" class="Estilo20">Total</div></td>
													<td bgcolor="#CCCCCC" class="Estilo4"><div align="right" class="Estilo20"><?=$total_abril ?></div></td>
												  </tr>
												</table>
</body>
</html>
