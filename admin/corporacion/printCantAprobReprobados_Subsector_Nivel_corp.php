...
<tr>
 <td valign="top">
	 <table width="650" border="1" cellspacing="0" cellpadding="3">
	   <tr >
		 <td colspan="5" class="tableindex"><div align="center">CANTIDAD APROBADOS Y REPROBADOS DE TODOS LOS ESTABLECIMIENTOS SUBSECTOR Y NIVEL </div></td>
	   </tr>
	   <tr>
