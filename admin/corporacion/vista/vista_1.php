...
<table width="750" height="843" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <table width="98%" border="1" align="center" cellpadding="3" cellspacing="0" class="tabla2">
      <tr>
        <td rowspan="2" class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">ESTABLECIMIENTO</font></td>
        <td colspan="12" class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">2010</font></td>
		<td rowspan="2" class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">TOT.</font></td>
        <td rowspan="2" class="celdas1">&nbsp;</td>
      </tr>
      <tr>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">ENE</font></td>
		<td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">FEB</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">MAR</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">ABR</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">MAY</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">JUN</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">JUL</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">AGO</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">SEP</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">OCT</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">NOV</font></td>
        <td class="celdas1"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">DIC</font></td>
      </tr>
	  <?
	  $tot_instit=0;
	  $tot_1 = 0;
	  ...
	  $arr_mat_mes13= array();
	   ...
	   foreach ($instituciones as $institucion): 
		  ...
		  <tr>
			...
			<?
			$id_ano = ano_escolar_por_institucion($institucion['rdb'],$conn);
			
			
			?>
			<td class="text2" align="right"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<?=$matricula = matricula_institucion_mes($id_ano,1,$conn);?></font></td>
			<? 
			...
			?>
			<td class="text2" align="right"><font face="Verdana, Arial, Helvetica, sans-serif" style="font-size:10px">&nbsp;<?=$tot_instit?></font></td>
		    ...
		    <td class="text2" align="right"><a href="#"><img src="../images/grafico1.jpg" width="17" height="18" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr_meses?>&amp;arr_mat_mes=<?=$arr_cantidad?>&mes=1&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
		  </tr>
		  <?
		  $tot_instit=0;
		  ?>
	...
	<? endforeach ?>	  
	  ...
	  <tr>
        ...
        <td class="celdas2" align="right"><a href="#"><img src="../images/grafico1.jpg" width="17" height="18" border="0" /></a></td>
	  </tr>
	 
	  <tr>
	    <td class="celdas2">&nbsp;</td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr1?>&amp;arr_mat_mes=<?=$mat1?>&mes=1&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr2?>&amp;arr_mat_mes=<?=$mat2?>&mes=2&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr3?>&amp;arr_mat_mes=<?=$mat3?>&mes=3&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0"  onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr4?>&amp;arr_mat_mes=<?=$mat4?>&mes=4&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')"/></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr5?>&amp;arr_mat_mes=<?=$mat5?>&mes=5&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr6?>&amp;arr_mat_mes=<?=$mat6?>&mes=6&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr7?>&amp;arr_mat_mes=<?=$mat7?>&mes=7&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr8?>&amp;arr_mat_mes=<?=$mat8?>&mes=8&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr9?>&amp;arr_mat_mes=<?=$mat9?>&mes=9&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr10?>&amp;arr_mat_mes=<?=$mat10?>&mes=10&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr11?>&amp;arr_mat_mes=<?=$mat11?>&mes=11&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr12?>&amp;arr_mat_mes=<?=$mat12?>&mes=12&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right"><a href="#"><img src="../images/grafico2.jpg" width="22" height="27" border="0" onclick="MM_openBrWindow('../../admin/corporacion/reportes/esta0174.php?arr_rdb=<?=$arr13?>&amp;arr_mat_mes=<?=$mat13?>&mes=0&nro_ano=2010','','scrollbars=yes,resizable=yes,width=850,height=500')" /></a></td>
	    <td class="celdas2" align="right">&nbsp;</td>
	    </tr>
    </table>
    <br />
    <br />
