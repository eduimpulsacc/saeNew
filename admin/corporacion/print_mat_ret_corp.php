...
if($xls==1){
	...
	header("Content-Disposition:inline; filename=Mat_ret_corp_$fecha_actual.xls"); 	 
	}	
?>
...
<title>Alumnos Retirados Corporaci&oacute;n <?php echo $nombre_corp ?></title>
...
function exportar(){
	window.location='print_mat_ret_corp.php?pesta=1&op=1&cmb_ano=<?=$cmb_ano ?>&xls=1';
	return false;
		  }		  
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
												  <tr>
													<td colspan="2" class="Estilo2"><div align="center" class="Estilo5">Alumnos retirados corporaci&oacute;n <?php echo $nombre_corp ?></div></td>
												  </tr>
												  <tr>
													<td bgcolor="#CCCCCC" class="Estilo6">Establecimiento</td>
													<td width="20%" bgcolor="#CCCCCC" class="Estilo2"><div align="right"><strong>Cantidad</strong></div></td>
												  </tr>
												  <?php
												  ...
												  for($i=0;$i<pg_numrows($result_ins);$i++){	
													   ...
													   ?>
													   <tr>
														<td class="Estilo2"><?=$establecimiento ?></td>
														<td class="Estilo2"><div align="right"><b><?=$retirados ?></b></div></td>
													   </tr>
													   <?
												  ...
												  ?>
												  <tr>
													<td bgcolor="#CCCCCC" class="Estilo2"><div align="right"><strong>Total</strong></div></td>
													<td bgcolor="#CCCCCC" class="Estilo2"><div align="right"><strong>
												    <?=$total_retirados ?>
													</strong></div></td>
												  </tr>
</table>
