...
class Reporte { 
	...
	function CantidadSubsectores($conn){
		...
		$result = pg_exec($conn,$sql_sub) or die ("Select falló: ".$sql_sub);
		return $result;
	}
   function Subsectores($conn){
	...
	function Notas_2($conn){
		...
		$result = pg_exec($conn,$sql_notas) or die ("Select falló: ".$sql_notas);
		return $result;
	}
