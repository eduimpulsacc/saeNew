  ...
  <tr>
    <td><table width="100%" border="0">
      ...
      <table width="100%" border="0">
        <tr> 
          <td width="69%">&nbsp;</td>
          <td width="15%"><input class="botonXX"  type="button" name="Submit2" value="AGREGAR" onClick="window.location='plantilla.php'"></td>
          <td width="16%">&nbsp;</td>
        </tr>
      </table>
      <table width="100%" border="0">
		...
		<?php } ?>
                    ...
                    <tr align="center" valign="middle"> 
                      <td height="45" colspan="2" class="piepagina">SAE Sistema de Administraci&oacute;n Escolar - 2005 
					  </td>
                    </tr>
                  </table></td>
              </tr>
