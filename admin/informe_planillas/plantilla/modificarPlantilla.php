...
<!-- <form action="muestraPlantilla.php?creada=0" method="post">
 ...
 -->
            ...
            <td align="right"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp; 
              <input class="botonXX"  type="button" name="Submit3" value="MODIFICAR" onClick="enviar(this.form)">
              </font></td>
            <td align="right"><font size="2" face="Arial, Helvetica, sans-serif"> 
              ...
              <?php //if($creada==1){?>
              <?php //} ?>
              <input class="botonXX"  type="button" name="Submit2" value="LISTADO" onClick="window.location='listaPlantillas.php?botonera=1'">
              </font></td>
          </tr>
          <tr> 
            <td colspan="4">&nbsp;</td>
        ...
        <table width="100%" border="0">
          <tr> 
            ...
            <td width="83%"><font size="2" face="Arial, Helvetica, sans-serif">: 
				<input name="Titulo1" type="text" id="txtNombreTitulo1" size="50" maxlength="50" value="<? echo trim($filaPlantilla['titulo_informe1']);?>">
          </tr>
          <tr> 
            <td width="17%"><font size="2" face="Arial, Helvetica, sans-serif">Título Reporte 18</font></td>
            <td width="83%"><font size="2" face="Arial, Helvetica, sans-serif">: 
				<input name="Titulo2" type="text" id="txtNombreTitulo2" size="50" maxlength="50" value="<? echo trim($filaPlantilla['titulo_informe2']);?>">
          </tr>
        </table>

        <table width="100%" border="0">
          <tr> 
            <td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"><strong> 
              Puede modificar un texto escribiendo en el cuadro de texto<br>
			  Puede eliminar un elemento chequeando la casilla bajo la columna "Eliminar"
        ...
        <table width="100%" border="0"  cellspacing="0">
          <?php echo "<tr><td><font size=\"2\" face=\"Arial, Helvetica, sans-serif\">Eliminar</font></td></tr>";
		  if(($creada!=1) and ($periodo!="")) {
					...
					for($countArea=0 ; $countArea<@pg_numrows($resultTraeArea) ; $countArea++){
						...
						echo "<tr><td></td></tr>";
						echo "<tr><td><font color=\"#FFFFFF\" size=2 face=Arial, Helvetica, sans-serif><strong>".$filaTraeArea['nombre']."</strong></font></td>";
...
echo									$sqlTraeItem="SELECT * FROM informe_item WHERE id_subarea=".$filaTraeSubarea['id_subarea'];
									...
									$countI++;
										...
										echo "<tr bgcolor=".$color."><td><font size=2 face=Arial, Helvetica, sans-serif><input name=".$filaTraeItem['glosa']." type=\"text\" id=\"txtNombrePla\" size=\"50\" maxlength=\"200\"></font></td>";
			...
			//$countI=0;
				...
				$resultTraeConcepto=@pg_Exec($conn, $sqlTraeConcepto);
					...
					$nroA=$countArea+1;
						...
						echo "<tr bgcolor=\"#0099CC\"><td class=\"tablatit2-1\"><input type=\"checkbox\" name=\"delAREA[".$filaTraeArea['id_area']."]\" value=\"1\"></td><td class=\"tablatit2-1\"><font color=\"#FFFFFF\" size=2 face=Arial, Helvetica, sans-serif><strong>".$nroA.".- </font></strong><input name=\"AREA[".$area."]\" type=\"text\" id=\"txtNombrePla\" size=\"50\" maxlength=\"200\" value=\"".trim($filaTraeArea['nombre'])."\"></td>";
						echo "<td class=\"tablatit2-1\"><font face=Arial, Helvetica, sans-serif>&nbsp;</font></td></tr>";
							...
							$nroS=$countSubarea+1;
								...
								echo "<tr><td><input type=\"checkbox\" name=\"delSUBAREA[".$filaTraeSubarea['id_subarea']."]\" value=\"1\"></td><td><font size=1 face=Arial, Helvetica, sans-serif style=\"text-decoration:underline\">&nbsp;&nbsp;&nbsp; ".$nroA.".".$nroS.".- </font><input name=\"SUBAREA[".$subarea."]\" type=\"text\" id=\"txtNombrePla\" size=\"50\" maxlength=\"200\" value=\"".trim($filaTraeSubarea['nombre'])."\"></td>";
								echo "<td><font face=Arial, Helvetica, sans-serif>&nbsp;</font></td></tr>";
									...
									$countI++;
										...
										$nroI=$countItem+1;
										echo "<tr><td><input type=\"checkbox\" name=\"delITEM[".$filaTraeItem['id_item']."]\" value=\"1\"></td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$nroA.".".$nroS.".".$nroI.".-<input name=\"ITEM[".$item."]\" type=\"text\" id=\"txtNombrePla\" size=\"50\" maxlength=\"200\" value=\"".trim($filaTraeItem['glosa'])."\"></td>";
												if($filaTraeItem['tipo']==0){
