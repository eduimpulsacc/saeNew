...
<? if ($frmModo == "ingresar"){ ?>
  ...
  <tr>
    ...
    <td class="cuadro01">
      <input type="text" name=fecha_nacimiento size=15 maxlength=15 />
    </td>
    <td class="cuadro02"><b>FECHA DE INGRESO</b> </td>
    <td class="cuadro01">
      <input type="text" name=fecha_ingreso size=15 maxlength=15 />
    </td>
  </tr>
					     ...
					     <TR height="50" >
							<TD align=right colspan=2>
                               ...
                               <input name=btn_nivel type="button" class="botonXX" id="btn_nivel"  onClick="abre_pop_empleado();"  value="NIVEL">  -->
									<?php if(($_PERFIL!=2)&&($_PERFIL!=4)&&($_PERFIL!=6)&&($_PERFIL!=21)&&($_PERFIL!=22)&&($_PERFIL!=25)&&($_PERFIL!=26)){ //ACADEMICO Y LEGAL?>
									...
									<? if ($_PERFIL==0 || $_PERFIL==14){?><INPUT class="botonXX"  TYPE="button" value="ELIMINAR"  name=btnEliminar onClick=document.location="seteaEmpleado.php3?caso=9">&nbsp;<? } ?>
											<?php }?>
								 ...
								 case 0:
									imp('&nbsp;');
																     ...
																     case 31:
																		 ...
																		 break;	 
																	 case 32:
																		 imp('Capellan');																		 	 																	 break;																				 																	 case 33: 
																		 imp('Educador Diferencial');
																		 break;
      																 case 34:
																	 	imp('Educador de Parvulos');															 																  		break;														 																																			 
							      };
							};  ?>
