			...
			<TR height=15>
				<TD>
					<TABLE WIDTH="100%" BORDER=0 CELLSPACING=5 CELLPADDING=5 height="100%">
						...
						<TR height=20 >
							<TD align=middle colspan=1 class="tableindex">													</TD>
						</TR>
						<TR>
							<TD width=100%><div align="center"><span class="Estilo1">Estimado							  
							  (a) <?php
										...
										?>
							  , su clave ha sido modificada exitosamente.</span> </div></TD>
							<TD>&nbsp;</TD>
						</TR>
