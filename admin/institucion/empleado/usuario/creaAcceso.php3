		...
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<tr height="20" class="tableindex">
				<td align="middle" colspan="2">
					CREAR ACCESO COLEGIO INTERACTIVO
				</td>
			</tr>
							...
							<TR>
								...
								<TD>
									<Select name="cmbPERFIL">
										...
										<?php
                                            $qry="SELECT * FROM PERFIL order by nombre_perfil asc";
											$result =@pg_Exec($conn,$qry);
											if (!$result) 
			...
			if(($fila1["id_perfil"]!=0)&&($fila1["id_perfil"]!=9)&&($fila1["id_perfil"]!=15)&&($fila1["id_perfil"]!=16))
