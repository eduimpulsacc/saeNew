...
<?php
		...
		if (@pg_numrows($resultV)>0){
			...
			if (pg_numrows($resultVV)>0){?>
				...
				if(document.frm.m1 !=0 & document.frm.m2!=0 & document.frm.m3!=0){
	...
	if($frmModo!="ingresar"){
		...
		$qry="SELECT trabaja.fecha_ingreso, trabaja.fecha_retiro, trabaja.cargo,trabaja.resp_anotacion, empleado.*, empleado.rut_emp, empleado.foto,trabaja.autoriza_firma FROM (empleado INNER JOIN trabaja ON empleado.rut_emp = trabaja.rut_emp) INNER JOIN institucion ON trabaja.rdb = institucion.rdb WHERE (((trabaja.rdb)=".trim($institucion).") AND ((empleado.rut_emp)=".trim($empleado)."))";
		$result = pg_Exec($conn,$qry);
		...
		function valida(form){
			...
			if(form.file.value!=''){
				...
				var archivo=form.file.value
					...
					{
					alert('Elija un archivo del tipo jpg')
					return false;
					}			
				}
...
<? if ($frmModo == "ingresar"){ ?>
	...
	<FORM method="post" name="frm"  enctype="multipart/form-data" action="procesoEmpleado.php3">
  ...
  <tr>
    <td colspan="4"><div align="right">
		<? if($ingreso==1){?>
	   <INPUT class="botonXX"  TYPE="submit" value="GUARDAR"   name="btnGuardar" enctype="multipart/form-data" onClick="return valida(this.form);" >&nbsp;
	   <INPUT class="botonXX"  TYPE="button" value="CANCELAR" name="btnCancelar" onClick="location.href='listarEmpleado.php3'">
	   <? } ?>
       </div>	</td>
  </tr>		
  ...
  <tr>
    ...
    <td class="cuadro01">
      <input type="text" name=fecha_ingreso size=15 maxlength=15 value="01-01-2001" /> ej.(dd-mm-aaaa)
    </td>
  </tr>
  ...
  <tr>
	...
	?>	
	  ...
	  <? for($i=0;$i<pg_numrows($rs_cargos);$i++){
		  	$fila_cargo = pg_fetch_array($rs_cargos,$i);
		?>
      <option value=<?=$fila_cargo['id_cargo'];?> ><?=$fila_cargo['nombre_cargo'];?></option>
      <? } ?>
     <!-- <option value=2 >Jefe UTP</option>
      ...
      <option value=13 >Psic&oacute;logo(a)</option>
	  ...
	  <option value=30 >Coordinador(a) Acad&eacute;mico(a)</option>
	  ...
	  <option value=38 >Gestión Educativa</option>
	  <option value=40 >Inspector de Patio</option>
	  <option value=41 >PSICOPEDAGOGA</option>
	  <option value=42 >Auxiliar Biblioteca</option>
	  <option value=43 >Guardia</option>
      <option value=44 >Profesor SEP</option>
      <option value=45 >Chofer</option>
      <option value=46 >Especialista PIE</option>
      <option value=47 >Jefe UTP Básica</option>
      <option value=48 >Asistente de Aula</option>
      <option value=49 >Portero</option>
      <option value=50 >Secretaria Academica</option>
      <option value=51 >Secretaria de Dirección</option>
      <option value=52 >Ejecutiva Financiera</option>
      <option value=53 >Fonoaudiologa</option>
      <option value=54 >Asistente de la Educación</option>
      <option value=55 >Encargado de la Buena Convivenvia Escolar</option>
      <option value=56 >Kinesiologo</option>
      <option value=57 >Coordinador de Enlaces</option>
      <option value=58 >Director Interino</option>
      <option value=60 >asistente de biblioteca CRA</option>
      <option value=61 >ENCARGADO/A DE PME</option>
      <option value=62 >SECRETARIA CONTABLE</option>
      <option value=63 >TERAPEUTA OCUPACIONAL </option>
      <option value=64 >RECEPCIONISTA  </option>
      <option value=65 >Director(a) de ciclo</option>
      <option value=66 >Rector Interino</option>
      <option value=67 >Director Interino</option>
      <option value=102 >Profesor Jefe</option>-->
	  </select></td>
  </tr>
  <tr>
    ...
    <td class="cuadro02"><b>FIRMA DIGITAL</b></td>
    <td class="cuadro01"><input type="file" name="file" id="file"  title="Puede subir solo Imagenes .JPEG"/></td>
  </tr>
  <tr>
    ...
    <td width="30%" class="cuadro01"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td class="cuadro01"><label>
          <input type="checkbox" name="hab" id="hab" value="1" />
        </label></td>
        <td><font face="Geneva, Arial, Helvetica, sans-serif" size="1"><b>HABILIDADO</b></font></td>
        <td class="cuadro01"><input type="checkbox" name="te" id="te" value="1" checked /></td>
        <td><font face="Geneva, Arial, Helvetica, sans-serif" size="1"><b>TITULADO EN EDUCACION</b> </font> </td>
        <td class="cuadro01"><input type="checkbox" name="to" id="to" value="1" /></td>
					...
					<TABLE BORDER=0 CELLSPACING=5 CELLPADDING=5 width="100%">
						<TR height="50" >
							...
							if ($frmModo != "ingresar"){ 
							   ...
							   ?><? if(isset($nombrefoto)){ ?>
							   	<img src="../../../tmp/<?=$nombrefoto ?>" ALT= "FOTO"  width="90" height="100" border="1">
							  <? }else{ ?>
								<img src="images/icono_profesores.png" alt="FOTOGRAF&Iacute;A ALUMNO" name="ALUMNO" width="48" height="70" id="ALUMNO">		   <? 	}
								} ?>   
...
<?php
                  ...
                  <tr><td>
					...
					<tr>
    <td class="cuadro02"><b>CELULAR</b></td>
    <td class="cuadro01">
					<?php  if($frmModo=="mostrar"){ 
                        imp($fila['celular']);
                    };?>
       <?php if($frmModo=="ingresar"){ ?>
                          <input type="text" name="txtCELULAR" size="20" maxlength="30" />
                          <?php };?>
                            <?php if($frmModo=="modificar"){ ?>
                          <input type="text" name=txtCELULAR size=20 maxlength=30 value="<?php echo trim($fila['celular']); ?>" />
                          <?php }?>
    </td>
    <td class="cuadro02"><b></b></td>
    <td class="cuadro01"></td>
                          ...
                          <tr>
                            <td><table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#666666">
                              ...
                              <tr>
								...
								if($frmModo=="mostrar"){ 
									$qryCOM		="SELECT * FROM COMUNA WHERE COD_REG=".$regINS." AND COR_PRO=".$fila['ciudad']." AND COR_COM=".$fila['comuna'];
									$resultCOM	=@pg_Exec($conn,$qryCOM);
									$filaCOM	= @pg_fetch_array($resultCOM,0);
					      ...
					      <? if ($cmb_tipoensenanza!=0){ ?>
							...
							<? } ?>	
							 ...
							 <? /// muestro la tabla para Media de 1º a 4º								
								if (($cmb_tipoensenanza=="761") OR ($cmb_tipoensenanza=="410") OR ($cmb_tipoensenanza=="510") OR ($cmb_tipoensenanza=="610") OR ($cmb_tipoensenanza=="710") OR ($cmb_tipoensenanza=="360") OR ($cmb_tipoensenanza=="362") OR ($cmb_tipoensenanza=="361") OR ($cmb_tipoensenanza=="460") OR ($cmb_tipoensenanza=="461") OR ($cmb_tipoensenanza=="560") OR ($cmb_tipoensenanza=="561") OR ($cmb_tipoensenanza=="660") OR ($cmb_tipoensenanza=="661") OR ($cmb_tipoensenanza=="760") OR ($cmb_tipoensenanza=="860") OR ($cmb_tipoensenanza=="861") OR ($cmb_tipoensenanza=="810") OR ($cmb_tipoensenanza=="310")  OR ($cmb_tipoensenanza=="563")){ ?>	
							         <table width="100%" border="1" cellspacing="0" cellpadding="0">
									   <tr>
										 <td class="cuadro02"><div align="center">1&ordm; </div></td>
										 <td class="cuadro01"><label>
					     ...
					     <TR height="50" >
							<TD align=right colspan=4>
								...
								<?php if($frmModo=="mostrar"){ ?>
									...
									<!--	<INPUT class="botonXX"  TYPE="button" value="VOLVER"  name=btnEliminar onClick=document.location="listarEmpleado.php3?caso=9">&nbsp;  -->
					 ...
					 <table>
						 ...
						 <? for ($iii=0;$iii<$num_tipo_titulo;$iii++){
						       ...
						       <td>
								...
								?>
							    <input name="tipo_titulo[]" value="<?=$row_tipo_tit[codigo];?>" type="checkbox" onClick="<?=$var_click;?>" <? if ($frmModo=="mostrar"){echo "disabled";}?> <? chekear($row_tipo_tit[codigo]);?> /></td>
...
&nbsp;&nbsp;&nbsp;</td>
			   ...
			   <TD>
							  ...
							  <TD align=right colspan=0>							
                               ...
                               <input name=btn_nivel type="button" class="botonXX" id="btn_nivel"  onClick="abre_pop_empleado();"  value="NIVEL"> -->
                                    ...
                                    <INPUT class="botonXX"  TYPE="button" value="MODIFICAR" name=btnModificar  onClick=document.location="seteaEmpleado.php3?empleado=<?php echo $empleado?>&caso=3&pesta=3">&nbsp;
										<INPUT class="botonXX"  TYPE="button" value="VOLVER"  name=btnEliminar onClick=document.location="empleado.php3?caso=9">&nbsp;  
											<?php }?>
									<?php }//ACADEMICO Y LEGAL?>
								<!--	<INPUT class="botonXX"  TYPE="button" value="LISTADO" onClick=document.location="listarEmpleado.php3">&nbsp;   -->
								<?php };?>
				...
				<?php if($frmModo=="modificar"){ ?>
                              <select name="cmbCARGO0">
                               ...
                               <? for($i=0;$i<pg_numrows($rs_cargos);$i++){
								   	$fila_cargo = pg_fetch_array($rs_cargos,$i);
									if($fila_cargo['id_cargo']==$row_trabaja['cargo']){
								?>
                                <option value="<?=$fila_cargo['id_cargo'];?>" selected><?=$fila_cargo['nombre_cargo'];?></option>
                                <? }else{?>
                                 <option value="<?=$fila_cargo['id_cargo'];?>"><?=$fila_cargo['nombre_cargo'];?></option>
                                <? } ?>
                                <? } ?>
  ...
  <tr>
	...
	<td class="cuadro01">
      ...
      <? }
	  if($frmModo== "modificar"){?>
	  	<input name="anotacion"  type="checkbox" id="anotacion" value="1" <? if($fila['resp_anotacion']==1){?> checked="checked" <? } ?>/>
	  <? }
		if ($frmModo == "mostrar"){
			if($fila['resp_anotacion']==1) echo "SI"; else echo"NO";
		}
	  ?>
    </td>
   ...
   <td class="cuadro02">&nbsp;</td>
   <td class="cuadro01">&nbsp;</td>
   <td class="cuadro02">FIRMA DIGITAL</td>
	<td class="Estilo1">
	<?	if (($frmModo == "modificar") or ($frmModo == "ingresar")){ ?>
			<input name="file" type="file" id="file">
	<? }
	  		if ($frmModo == "mostrar"){?>
			<img src="../../../images/firma_digital.jpeg" border="0" height="20" width="20">Formato JPG
	<?	}  ?>
    		
	</td>
   </tr>
   <?php $sql_ret="select bool_er,fecha_retiro from trabaja where rut_emp=$_EMPLEADO and rdb=$institucion";
   $rs_ret = pg_exec($conn,$sql_ret);
   $fila_ret = pg_fetch_array($rs_ret,0);
   ?>
   <tr><td class="cuadro02">RETIRADO</td>
   <td class="cuadro01"><?php  if($frmModo == "mostrar") {
	   echo ($fila_ret['bool_er']==0)?"NO":"SI";
	   }?>
       <?	if (($frmModo == "modificar") or ($frmModo == "ingresar")){ ?>
       <input name="bool_er" id="bool_er" type="checkbox" value="1" <?php echo ($fila_ret['bool_er']==0)?"":"checked";?>>
       <?php  } ?>
       </td>
   <td class="cuadro02">FECHA RETIRO</td>
   <td class="cuadro01">&nbsp;<?php  if($frmModo == "mostrar") {
	   echo CambioFD($fila_ret['fecha_retiro']);
	   }?>
          <?	if (($frmModo == "modificar") or ($frmModo == "ingresar")){ ?>
       <input name="fecha_retiroe" id="fecha_retiroe" type="text" value="<?php echo @CambioFD($fila_ret['fecha_retiro']); ?>">
       <?php  } ?>
       </td></tr>
</table>
     <!-- nuevos campos -->
...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#666666">
  <tr>
    <td class="cuadro02" width="40%">AUTORIZA FIRMA PERMANENTE</td>
    <td  class="cuadro01"> <?
		   if ($frmModo=="mostrar"){
		      echo ($fila['autoriza_firma']==1)?"SI":"NO";
		   }
		   if ($frmModo=="modificar"){ ?>
		       <input name="autoriza_firma" type="radio" value="1" <?php echo ($fila['autoriza_firma']==1)?"checked":""?>>SI <input name="autoriza_firma" type="radio" value="0" <?php echo ($fila['autoriza_firma']==0)?"checked":""?>>NO
		<? } ?>	</td>
  </tr>
</table>
							...
							<TD align="center">
								<TABLE BORDER=1 CELLSPACING=0 CELLPADDING=3 width=100% bordercolor="#666666">
									<TR>
									    ...
									    <TD class="cuadro01"><?php 
											$qry="SELECT usuario.id_usuario, usuario.nombre_usuario, accede.estado, 
												accede.rdb, accede.id_sistema, perfil.id_perfil, perfil.nombre_perfil, institucion.saemovil,
												institucion.estado_colegio,institucion.evados,institucion.reca, institucion.cede
												FROM (accede INNER JOIN perfil ON accede.id_perfil = perfil.id_perfil) 
												INNER JOIN usuario ON accede.id_usuario = usuario.id_usuario
												join institucion on accede.rdb = institucion.rdb  WHERE (((usuario.id_usuario)=".$idUsuario.") AND ((accede.rdb)=".$_INSTIT.")) ORDER BY NOMBRE_PERFIL ASC;";
													$result =@pg_Exec($connection,$qry);
													if (!$result){ 
															...
															for($i=0 ; $i < @pg_numrows($result) ; $i++){
																...
																echo "- ".$fila1["nombre_perfil"];
																 if(($_PERFIL=="0")||($_PERFIL=="14")){
																	...
																	if($fila1["estado"]==1){?>
&nbsp;&nbsp;&nbsp;&nbsp;
<?php if($fila1["id_sistema"]==$fila1["estado_colegio"] || ($fila1["id_sistema"]==$fila1["saemovil"] || $fila1["id_sistema"]==$fila1["evados"] || $fila1["id_sistema"]==$fila1["reca"] || $fila1["id_sistema"]==$fila1["cede"])){?>
