  ...
  <tr>
    <td><table width="100%" border="0">
        <tr> 
          ...
          <td width="15%">
		  <? if($ingreso==1){ ?>
		  <input class="botonXX"  type="button" name="Submit2" value="AGREGAR" onClick="window.location='../../informe_planillas2/crea_informe_1.php'"></td>
		  <? } ?>
          <td width="16%">&nbsp;</td>
        </tr>
      </table>
      <table width="100%" border="0">
        ...
        <tr bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent' onClick=window.location='<? if ($filaP[nuevo_sis]!=1){ echo "modPlantilla.php";}else{echo "../../informe_planillas2/ver_informe.php";}?>?plantilla=<?php echo $filaP["id_plantilla"];?>&creada=1'> 
          ...
          <td align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?php echo ($filaP['tipo']==0)?"Informe de Personalidad":"Informe Diagn&oacute;stico"; ?></font></td>
