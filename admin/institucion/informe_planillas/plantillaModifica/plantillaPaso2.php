...
<form action="muestraPlantilla.php" method="post">
  <table width="76%" border="0" align="center">
    ...
    <tr> 
	  ...
	  <?php if($itemCreado==1){?>
		<input type="submit" class="botonXX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' name="sgte" value="SIGUIENTE >>">
		<?php } ?>
	  </td>
    </tr>
    <tr> 
