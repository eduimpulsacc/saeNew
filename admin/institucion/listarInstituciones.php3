...
function sistemas(col){

var funcion=1;
var parametros = "funcion="+funcion+"&col="+col;
$.ajax({
	    url:'sistemas/cont_activa.php',
	  data:parametros,
	  type:'POST',
	  success:function(data){
...
function actAsoc(col){
$('#asociado *').attr('selected','selected');
$('#disponible *').attr('selected','selected');
var funcion=2;
var frm = $("#frm").serialize();
var parametros = "funcion="+funcion+"&col="+col+"&frm="+frm;
$.ajax({
		url:'sistemas/cont_activa.php',
		data:parametros,
		type:'POST',
...
<div id="dialogx" title="Asociar sistemas a instituci&oacute;n"></div>
...
<?php
	...
	<table border="0" cellpadding="1" cellspacing="1" bgcolor="white" WIDTH=650 align=center>
		...
		<tr height="20">
			<td align="middle" colspan="11" class="tableindex">
					Total de Instituciones			</td>
		</tr>
		<tr bgcolor="#48d1cc">
		  <td colspan="7" ALIGN=left bgcolor="#FFFFFF"><font face="arial, geneva, helvetica" size="1" color="#000000">
						   <strong>(Si desea activar/desactivar una aplicaci&oacute;n, haga click sobre la imagen)</strong></font></td>
		  </tr>
		<tr bgcolor="#48d1cc">
			<td ALIGN=CENTER WIDTH=108 class="tablatit2-1">
				RBD			</td>
			<td ALIGN=CENTER WIDTH=392 class="tablatit2-1">
				NOMBRE			</td>
			
			
			
			<td width="140" ALIGN=center class="tablatit2-1">ACTIVAR SISTEMAS</td>
		</tr>
		<?php
		 ...
		 ?>
		    <tr VALIGN=TOP bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent'>
				...
				<td align="center"><img src="../clases/img_jquery/iconos/Web-Application-Icons-Set/PNG-24/Add.png" border="0" onClick="sistemas(<?php echo $fila["rdb"];?>)"></td>				
			</tr>
		<?php }?>
		<tr>
			<td colspan="11">
