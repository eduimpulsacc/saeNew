<?	require('../../../util/header.inc');
	...
	$sql = "SELECT cod_decreto,cod_tipo FROM plan_tipo WHERE cod_decreto IN (SELECT cod_decreto FROM ";
	...
	if($num < $total_filas){
		...
		$sql = "INSERT INTO plan_tipo (cod_decreto,cod_tipo) VALUES (".$fila['cod_decreto'].",".$fila['cod_tipo'].")";
...
<table width="700" border="0" class="celdas3" align="center" >
  ...
  <tr>
	...
	<script> setTimeout("window.location='Traspaso_PlanTipo.php?num=<? echo $num; ?>'");</script>
</body>
</html>