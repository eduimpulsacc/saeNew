                        ...
                        <tr>
                          <td><!-- COPIO LOS BOTONES PARA QUE NO ESTÉN SEPARADOS -->
                            ...
                            <br>
                              ...
                              <form method "post" action="../ano/reportes/printInformeEntrevistas_C.php" name="form" target="_blank">
                                  ...
                                  <table width="90%" border="1" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td><table width="100%" height="43" border="1" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td class="tableindex">Traspaso de Instituciones </td>
                                          </tr>
                                          <tr>
                                            <td height="27"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="269" class="cuadro01">INSTITUCION: <? ?></td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">
												  <? 	$sql ="select rdb,nombre_instit from institucion ORDER BY nombre_instit ASC";
												  		$rs_instit = @pg_exec($conn,$sql);?>
														<select name="cmb_colegio">
                                                ...
                                                <tr>
                                                  <td class="cuadro01">ORIGEN: 
                                                    <input name="rb_ORIGEN" type="radio" value="1">
                                                  Local    
                                                  <input name="rb_ORIGEN" type="radio" value="2" checked>
                                                  Servidor web </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td class="cuadro01">ELIMINA INSTITUCION DE:
                                                    <input name="rb_ELIMINA" type="radio" value="1" checked>
                                                    SI
                                                    <input name="rb_ELIMINA" type="radio" value="2">
                                                    NO</td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">&nbsp;</td>
                                                ...
                                                <tr>
                                                  <td class="cuadro01"><input name="cb_ok" type="submit" class="botonXX"  id="cb_ok"  value="Buscar"></td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                      </table></td>
