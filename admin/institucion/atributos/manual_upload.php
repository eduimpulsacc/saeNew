...
<link href="../../../<?=$_ESTILO?>" rel="stylesheet" type="text/css">
	<body bgcolor="#ffffff">
	<title>Agregar Manual de Convivencia</title>
			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="1" width="350" bgcolor="white">
						<tr>
							<td class="tableindex">INGRESAR&nbsp;MANUAL DE CONVIVENCIA</td>
						</tr>
						<tr>
							<td align="center" class="cuadro01">
								<form action="insertaManual.php?rdb_=<?php echo $institucion ?>" method="post" enctype="multipart/form-data">
