...
<BODY>
	<?php echo tope("../../../util/");?>
	<FORM method=post name="frm" action="procesoActividadesEspeciales.php3">
							...
							<TD align=right colspan=2>
								...
								<?php if($frmModo=="mostrar"){ ?>
									<?php if(($_PERFIL!=2)&&($_PERFIL!=4)){ //ACADEMICO Y LEGAL?>
										...
										<INPUT TYPE="button" value="MODIFICAR" name=btnModificar  onClick=document.location="seteaActividadesEspeciales.php3?caso=3">&nbsp;
											<?php }?>
								...
								<?php if($frmModo=="modificar"){ ?>
									<INPUT TYPE="submit" value="GUARDAR"   name=btnGuardar onclick="return valida(this.form);">&nbsp;
									<INPUT TYPE="button" value="CANCELAR" name=btnCancelar onClick=document.location="seteaActividadesEspeciales.php3?caso=1">&nbsp;
								<?php };?>
							</TD>
						</TR>
