...
//  ['justifyfull','custom2','custom3','separator'],
    [/*'popupeditor','about'*/]];
...
this.btnList = {
    ...
    "italic":         ['Italic',               'Cursiva',             'editor_action(this.id)',  'ed_format_italic.gif'],
    ...
    "justifyleft":    ['JustifyLeft',          'Alinear a la izquierda',       'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Centrar',     'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         'Alinear a la derecha',      'editor_action(this.id)',  'ed_align_right.gif'],
	"justifyfull": 	  ['justifyfull',		   'Justificar',				'editor_action(this.id)', 'justifyfull.gif'],
    "orderedlist":    ['InsertOrderedList',    'Numeración',       'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Viñetas',      'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Reducir sangría',    'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Aumentar sangría',    'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Color de fuente',         'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            'Color de fondo',   'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', 'Regla horizontal',    'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           'Insertar link Web',    'editor_action(this.id)',  'ed_link.gif'],
