						...
						<TR height="50" >
							<TD align=right colspan=2>
								...
								<?php if($frmModo=="mostrar"){ ?>
									...
									if ($situacion !=0){ 
									if($modifica==1){?>
										<INPUT class="botonXX"  TYPE="button" value="MODIFICAR" name=btnModificar  onClick=document.location="seteaProcesoAdmision.php3?caso=3">&nbsp;
									<?php } 
								...
								<?php if($frmModo=="modificar"){
										if($modifica==1){ ?>
									<INPUT class="botonXX"  TYPE="submit" value="GUARDAR"   name=btnGuardar onClick="return valida(this.form);">&nbsp;
									<INPUT class="botonXX"  TYPE="button" value="CANCELAR" name=btnCancelar onClick=document.location="seteaProcesoAdmision.php3?caso=1">&nbsp;
								<?php 	}
									  };?>
							</TD>
						</TR>
						<TR height=20>
							<TD align=middle colspan=2 class="tableindex">											PROCESO ADMISION															</TD>
						</TR>
						<TR>
							<TD width=30></TD>
							<TD WIDTH=570>
								<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0>
									<TR>
										<TD class="datosB">
											...
											<textarea name="textarea" rows="20" cols="60" onKeyUp="return maximaLongitud(this,4096)" onpaste="return anulas ()"></textarea>
											<br>
											...
											<?php 
												if($frmModo=="mostrar"){ 
													echo trim($fila['proceso_admision']);
												}
											?>
											</font>
											<?php if($frmModo=="modificar"){ ?>
											<script language="JavaScript1.2" defer>
												...
												<TEXTAREA NAME="txtCONT" ROWS="20" COLS="60" onKeyUp="return maximaLongitud(this,4096)" Onpaste="return anulas ()"><?php echo trim($fila['proceso_admision']);?></TEXTAREA>
											 <br>
											 <font face="Arial, Helvetica, sans-serif" size="2">
											  Max. cantidad de caracteres = 4096											  </font>
