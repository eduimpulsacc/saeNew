			...
			<tr>
				<td>
					<table border="0" cellpadding="0" cellspacing="1" width="350" bgcolor="white">
						<tr>
							<td bgcolor="#003366"><font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="1" color="white"><b>INGRESAR&nbsp;IMAGEN</b></font></td>
						</tr>
						<tr>
							<td>
								<form action="insertafotouni.php" method="post" enctype="multipart/form-data">
