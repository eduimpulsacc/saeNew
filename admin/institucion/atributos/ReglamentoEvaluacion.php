...
<table border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> 
	  ...
	  <?php } ?>
	<FORM method=post name="frm" action="procesoReglamentoEvaluacion.php">	
				...
				<TD>
					<TABLE WIDTH="100%" BORDER=0 CELLSPACING=5 CELLPADDING=5 height="100%">
						<TR  >
							...
							<input name="button"  type="button" class="botonXX" onClick=window.open('reglamentoev_upload.php?rdb=<?php echo $institucion ?>','REGLAMENTO','height=200,width=380,scrollbar=no,location=no,resizable=no,target=_blank') value="SUBIR REGLAMENTO DE EVALUACI&Oacute;N">
							<? } 
							}?>
							...
							if($frmModo=="mostrar"){
									if($modifica==1){?>
							<INPUT class="botonXX"  TYPE="button" value="MODIFICAR" name=btnModificar  onClick=document.location="seteaReglamentoEvaluacion.php?caso=3">&nbsp;
									<?php }
									}
						...
						<TR height=20>
							<TD align=middle colspan=2 class="tableindex"><p>REGLAMENTO DE EVALUACI&Oacute;N</p>
							  <p>&nbsp;</p></TD>
						</TR>
						<? if($fila['reglamento_evaluacion']!=""){?>
						<TR height=20>
						  <TD align=middle colspan=2 class="tableindex"><input type="button" class="botonXX" onClick="location.href='<? echo "archivos/".$fila['reglamento_evaluacion'];?>'" value="Descargar Archivo"><!--<a href="<? echo "archivos/".$fila['reglamento_evaluacion'];?>">Descargar Archivo </a>--></TD>
						  </TR>
						 <? } ?>
						<TR>
							<TD width=23></TD>
										...
										<TD class="datosB">
											<p>
											  ...
											  <font face="Arial, Helvetica, sans-serif" size="2">
											    <?php 
												if($frmModo=="mostrar"){ 
													echo trim($fila['reglamento_evaluacion']);
												}
											?>
											    </font>
											  <?php if($frmModo=="modificar"){ ?>
											  ...
											  <TEXTAREA NAME="txtCONT" ROWS="20" Onpaste="return anulas ()" COLS="60" onKeyUp="return maximaLongitud(this,4096)"><?php echo trim($fila['reglamento_evaluacion']); ?></TEXTAREA>												
											  <br>
											  <font face="Arial, Helvetica, sans-serif" size="2">
											    Max. cantidad de caracteres = 4096												</font>
											      <?php };?>										
