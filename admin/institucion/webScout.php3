...
<BODY>
	<?php echo tope("../../util/");?>
	<FORM method=post name="frm" action="procesoWS.php3">
			...
			<TR height=15>
				<TD>
					<TABLE WIDTH="100%" BORDER=0 CELLSPACING=5 CELLPADDING=5 height="100%">
						...
						<?php if(($_PERFIL==1)||($_PERFIL==14)||($_PERFIL==0)||($_PERFIL==12)){ //DIRECTOR GENERAL , ADM WEB COLEGIO, ADM TOTAL WEB?>
										<?php if($_FRMMODO=="mostrar"){ ?>
											<INPUT TYPE="button" value="MODIFICAR" onClick=document.location="seteaWS.php3?caso=3">
										<?php }?>
										<?php if($_FRMMODO=="modificar"){ ?>
											<INPUT TYPE="submit" value="GUARDAR" onclick="return valida(this.form);">&nbsp;
											<INPUT TYPE="button" value="CANCELAR" onClick=document.location="seteaWS.php3?caso=1">
										<?php }?>
									<?php }?>
								<?php }?>
								<?php if($_PERFIL!=12){?>
									...
									<TR>
										<TD>
											...
											<?php if($frmModo=="modificar"){ ?>
												<INPUT type="text" name=txtREP size=83 maxlength=50 value="<?php echo $fila1['repws']?>">
											<?php };?>
										</TD>
									</TR>
								</TABLE>
								...
								<TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0>
									...
									<TR>
										<TD>
											...
											?>
											<?php if($frmModo=="modificar"){ ?>
												<INPUT type="text" name=txtEMAIL size=83 maxlength=50 value="<?php echo $fila1['emailws']?>">
											<?php };?>
										</TD>
									</TR>
								</TABLE>
						...
						<TR>
							<TD width=30></TD>
							<TD> 
							<INPUT TYPE="button" value="DIARIO ELECTRONICO"   name=btnCancelar onClick=document.location="noticia/listarNoticia.php3?agrupacion=4">
							<INPUT TYPE="button" value="AGENDA WEB" name=btnCancelar name=btnCancelar onClick=document.location="agenda/listarAgenda.php3?agrupacion=4">
							</TD>
						</TR>
					</TABLE>
				</TD>
