...
<?php
	...
	if ($frmModo=="ingresar") {
		 for($i=0;$i < 20 ;$i++){	 
			...
			echo "<script>window.location = 'SubPlanPropio.php?plan=".$txtNRESOL."&ensenanza=".$cmbENS."'</script>";
		}
...
if ($frmModo=="modificar"){
                   echo "<script>window.location = '../atributos/seteaTipoEnse.php?caso=1&ensenanza=".$_ENSENANZA." &institucion1=".$_INSTIT."'</script>";         
                 }
