                      ...
                      <tr>
						...
						<TR height=15>
							<TD width="100%" colspan=2>
								<?php if($frmModo=="mostrar"){?>
									<INPUT TYPE="button" value="ALUMNOS" onClick=document.location="alumno/listarAlumnos.php?_url=0">
									<?php if($fila['ensenanza']>100){// PREBASICA NO TIENE SUBSECTORES?>
										<INPUT TYPE="button" value="SUBSECTORES" onClick=document.location="ramo/listarRamos.php">
