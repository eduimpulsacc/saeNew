...
<BODY>
	<?php echo tope("../../../util/");?>
	<FORM method=post name="frm" action="procesoSubPropio.php">
	<?php 
		...
		<TABLE WIDTH=600 BORDER=0 CELLSPACING=0 CELLPADDING=0 >
          ...
          <TR> 
            ...
            <TD align=right colspan=2> 
              ...
              &nbsp; 
              <INPUT TYPE="button" value="CANCELAR" name=btnCancelar onClick=document.location="listarPlanesEstudio.php">&nbsp;
								<?php };?>
								<?php if($frmModo=="mostrar"){ ?>
									...
									<?php if($_PERFIL!=17){?>
										<?php if(($_PERFIL!=2)&&($_PERFIL!=4)){ //ACADEMICO Y LEGAL?>
											...
											<INPUT TYPE="button" value="ELIMINAR"  name=btnEliminar onClick=document.location="seteaCurso.php?caso=9">&nbsp;
											<?php }?>
										<?php }?>
										<INPUT TYPE="button" value="LISTADO" onClick=document.location="listarCursos.php">
              &nbsp; 
              <?php }?>
              <?php };?>
              ...
              &nbsp; 
              <INPUT TYPE="button" value="CANCELAR" name=btnCancelar onclick=document.location="seteaPlanEstudio.php?caso=1">&nbsp;
								<?php };?>
							</TD>
						</TR>
															...
															if (pg_numrows($result)!=0){
																...
																for($i=0 ; $i < @pg_numrows($result) ; $i++){
																	...
																	//	if($fila["cod_tipo"]>100) PARA QUE MUESTRE TODO
																	       $qry="SELECT * FROM TIPO_ENSENANZA WHERE COD_TIPO=".$fila["cod_tipo"];
																			$result =@pg_Exec($conn,$qry);
																			 $fila9 = @pg_fetch_array($result,0);
	...
	<?php }//COLEGIO?>
                    ...
                    GRADOS PARA EL PLAN DE ESTUDIO</FONT></strong> </TD>
									...
									<TR>
										...
										<?php $qry="SELECT * FROM cursos_plan WHERE cod_decreto=".$plan;
														...
														?>
														<? if ($fila8['pa']=="1"){ ?>
																<input name="PA" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>PRIMER AÑO</font></strong><?php } ?>
														<? if ($fila8['sa']==1){ ?>
																<input name="SA" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>SEGUNDO AÑO</font></strong><?php } ?>
														<? if ($fila8['ta']==1){ ?>
																<input name="TA" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>TERCER AÑO</font></strong>&nbsp;<?php } ?> 
														<? if ($fila8['cu']==1){ ?>
					    						                <input name="CU" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>CUARTO AÑO</font></strong><?php } ?> 
														<br><br>
														<? if ($fila8['qu']==1){ ?>
																<input name="QU" type="checkbox" value="1" checked disabled ><strong><font face="arial, genova, helvetica" size=1>QUINTO AÑO</font></strong><?php } ?>
														<? if ($fila8['sx']==1){ ?>
																<input name="SX" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>SEXTO AÑO</font></strong>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
														<? if ($fila8['sp']==1){ ?>
																<input name="SP" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>SEPTIMO AÑO</font></strong><?php } ?> 
														<? if ($fila8['oc']==1){ ?>
					                    						<input name="OC" type="checkbox" value="1" checked disabled><strong><font face="arial, genova, helvetica" size=1>OCTAVO AÑO</font></strong><?php } ?> 
                  ...
                  <TD bgcolor=#0099cc><strong> <FONT face="arial, geneva, helvetica" size=2 color=WHITE>&nbsp; 
                    SUBSECTORES PARA PLAN PROPIO</FONT></strong> </TD>
					</TR>
					<TR>
