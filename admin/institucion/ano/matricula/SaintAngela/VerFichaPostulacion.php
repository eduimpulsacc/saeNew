...
<table width="630" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="258"><font face="Arial, Helvetica, sans-serif" size="-1">
      <?  imp($curso_post)?>
    </font></td>
    <td width="126"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>A&Ntilde;O AL QUE POSTULA </strong></font></td>
    <td width="113"><font face="Arial, Helvetica, sans-serif" size="-1">
      <?  imp($fila_postula['id_ano'])?>
    </font></td>
  </tr>
  <tr>
	...
	if($fila_postula['estado']==3 ) echo "Seleccionado(a)";?>
    </font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
