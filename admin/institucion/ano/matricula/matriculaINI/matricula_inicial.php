<? require('../../../../../util/header.inc');
	...
	echo $sql_ano_actual = "select nro_ano from ano_escolar where id_institucion=".$institucion." AND id_ano = '".$_ANO."'";
	...
	echo $sql = "DELETE FROM tmp_matricula WHERE rdb=".$institucion;
              ...
              <tr align="left" valign="top"> 
                <td height="83"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      ...
                      <td width="73%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
							...
							<form name="form" action="valida_matricula.php" enctype="multipart/form-data" method="post">
					...
					<hr width=100% size="1" color="" align="center">
									...
									<input name="submit" type="submit" value="CARGAR MATRICULA" class="botonXX"></a>
									<p></p>
									<hr width=100% size="1" color="" align="center">
						</fieldset>
						<br />
