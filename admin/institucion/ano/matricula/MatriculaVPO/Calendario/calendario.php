...
for ($cont=1920;$cont<$ano+23;$cont++){
...
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario){
	...
	<a href="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')"><img src=Calendario/calendario.gif width=20 height=20 border=0></a>
	';
	
}

function escribe_formulario_fecha_vacio2($nombrecampo,$nombreformulario){
	global $raiz;
	
	echo '
	
	<a href="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">Fecha Entrega</a>
	';
	
}

function escribe_formulario_fecha_vacio3($nombrecampo,$nombreformulario){
	global $raiz;
	
	echo '
	
	<a href="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">Fecha LLegada</a>
	';
	
}

function escribe_formulario_fecha_vacio4($nombrecampo,$nombreformulario){
	global $raiz;

	echo '
	
	<a href="#" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">Fecha Zarpe</a>
	';
