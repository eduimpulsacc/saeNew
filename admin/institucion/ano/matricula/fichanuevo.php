...
<table width="650" border="0" align="center">
 ...
 $rs_madre=$ob_reporte->Madre($conn);
    ...
    $fil_3 = @pg_fetch_array($rs_madre,0);
	
		$ob_reporte->CambiaDatoApo($fila_madre);
		
		
		$nombre_madre    = $fil_3['nombre_apo'];
		$paterno_madre   = $fil_3['ape_pat'];
		$materno_madre   = $fil_3['ape_mat'];
		$rut_madre       = $fil_3['rut_apo'];
		$dig_rut_madre   = $fil_3['dig_rut'];

		$ultimo_ano_madre    = $fil_3['ultimo_ano_aprobado'];
		
		$ocupacion_madre     = $fil_3['ocupacion'];
		$primer_parto_madre     = $fil_3['edad_primer_parto'];
