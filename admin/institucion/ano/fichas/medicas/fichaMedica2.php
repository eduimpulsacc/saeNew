			...
			<TR height=15>
				<TD><br />
				  <table width="100%" border="0" cellpadding="3" cellspacing="0">
                    <tr>
                      <td colspan="2" class="tableindex">Registro de Salud Socia(o) </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="2"><div align="center">
					   ...
					   if ($frmModo != "mostrar"){
					       ?>
                           <label>
                           <input type="submit" name="Submit" value="EVALUACIONES" class="BotonXX" onClick="return valida(this.form);" />
                           </label>
						   <?
					   }	   
                    ...
                    <tr>
                      ...
                      <tr>
                        <td width="39%" class="cuadro02">&nbsp;FECHA DE NACIMIENTO</td>
                        <td width="61%"><FONT face="arial, geneva, helvetica" size=1 color=#000000>&nbsp;  <input name="" type="text">dd-mm-aaaa</FONT></td>
                      </tr>
                      <tr>
                        <td class="cuadro02">&nbsp;SEXO</td>
                        <td><FONT face="arial, geneva, helvetica" size=1 color=#000000><input type="radio" name="radio" id="radio" value="radio">
                          Masculino 
                            <input type="radio" name="radio" id="radio2" value="radio"> 
                            Femenino</FONT></td>
                      </tr>
                      <tr>
                        <td class="cuadro02">&nbsp;FRECUENCIA DE PR¡CTICA DE ACTIVIDAD FÕSICA</td>
                        <td><FONT face="arial, geneva, helvetica" size=1 color=#000000><p>1 a 2 veces  por semana&nbsp; ___&nbsp;&nbsp; Horas diarias __<br>
                          3 a 5 veces  por semana&nbsp;&nbsp; ___&nbsp;&nbsp; Horas diarias __<br>
                          Todos los d&iacute;as&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ___&nbsp;&nbsp; Horas diarias __</p></FONT></td>
                      </tr>
                    </table>
                    </td>
                    </tr>
				   ...
				   <textarea name="txtMEDICAMENTO" cols="60" rows="3"> <?php echo ($fila['medicamentos'])?></textarea>
				        ...
				        <tr>
				          <td><font face="Arial, Helvetica, sans-serif" size="-2"><strong>PROBLEMAS ESPECÔFICOS DE SALUD</strong></font></td>
					    </tr>
				        <tr>
				          <td>
				            ...
				            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
				              ...
				              <tr>
								...
								<TABLE width=100% bgcolor=#cccccc Border=0 cellpadding=1 cellspacing=0>
				        <tr>
				          <td><font face="Arial, Helvetica, sans-serif" size="-2"><strong>TRATAMIENTO PARA PROBLEMA ESPECIFICO DE SALUD</strong></font></td>
					    </tr>
				        <tr>
				          <td>
				            <table width="100%" border="0" cellspacing="0" cellpadding="0">
				              <tr>
								...
								<!-- fin modificacion ficha -->	
									<table width="100%" border="0" cellspacing="1" cellpadding="0">
				                      <tr>
				                        <td class="tableindex">REGISTRO DE EVALUACIONES</td>
                                      </tr>
				                      <tr>
				                        <td align="center"><table width="100%" border="0">
				                          <tr>
				                            <td width="39%" class="cuadro02">&nbsp;FECHA</td>
				                            <td width="61%"><FONT face="arial, geneva, helvetica" size=1 color=#000000>
				                          ...
				                          <tr>
				                            ...
				                            <td><FONT face="arial, geneva, helvetica" size=1 color=#000000>
				                              <input type="text" size="5"> hh:mm</FONT></td>
				                            </tr>
				                          <tr>
				                            <td class="cuadro02">&nbsp;OBSERVACIONES</td>
				                            <td>
				                              <textarea name="te_se_cli" cols="60" rows="3" id="te_se_cli"></textarea>
				                              </td>
				                            </tr>
				                          </table>
                                      ...
                                      <tr>
                                      	 <td class="tableindex">EVALUACIONES <input name="" type="button" value="AGREGAR" class="botonXX"></td>
                                      </tr>
                                       <tr>
				                        <td align="center"><table width="100%" border="0">
				                          <tr>
				                            <td width="30%" class="cuadro02">&nbsp;PESO</td>
				                            <td width="70%"><FONT face="arial, geneva, helvetica" size=1 color=#000000>
				                              <input name="input" type="text" size="10">
				                            </FONT></td>
				                            </tr>
				                          <tr>
				                            <td class="cuadro02">&nbsp;ESTATURA</td>
				                            <td><FONT face="arial, geneva, helvetica" size=1 color=#000000>
				                              <input type="text" size="10">
				                            </FONT></td>
				                            </tr>
				                          <tr>
				                            <td class="cuadro02">&nbsp;IMC</td>
				                            <td><input name="textfield" type="text" id="textfield" size="10"></td>
				                            </tr>
                                            <tr>
				                            <td class="cuadro02">&nbsp;PORCENTAJE DE GRASA CORPORAL</td>
				                            <td><input name="te_se_cli" type="text" id="te_se_cli" value="" size="10">
				                              </td>
				                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td class="cuadro02">ENTRENAMIENTO SUGERIDO</td>
                                              <td class="textosimple"><input type="checkbox" name="checkbox" id="checkbox">
                                                Trabajo Cardiovascular<br>
                                                <input type="checkbox" name="checkbox2" id="checkbox2">
                                                Trabajo de Tonificaci&oacute;n<br>
                                                <input type="checkbox" name="checkbox3" id="checkbox3">
                                                Trabajo de GAP<br>
                                                <input type="checkbox" name="checkbox4" id="checkbox4">
                                                Acondicionamiento F&iacute;sico<br>
                                                <input type="checkbox" name="checkbox5" id="checkbox5">
                                                Otro (Observaciones):<br>
...
<br>
  ...
  <!-- aki --> 
				                      <tr>
				                        <!--                                <td height="55" colspan="2" align="center"> -->
				                        <td>
				                          <table width="41%" border="1" cellspacing="1" cellpadding="0"  style="border-collapse:collapse" align="center">
				                            <tr bgcolor="#CCCCCC">
				                              <td width="28%" height="41"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>MES</strong></font></td>
				                              <td width="16%"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>&nbsp;IMC</strong></td>
				                              <td width="43%"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>&nbsp;% GRASA CORPORAL</strong></td>
				                              <td width="13%"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>Grafico</strong></font></td>
                                            </tr>
				                            <tr>
				                              <td class="textosimple">Enero</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Febrero</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Marzo</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Abril</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Mayo</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Junio</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Julio</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Agosto</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Septiembre</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Octubre</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Noviembre</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
				                            <tr>
				                              <td class="textosimple">Diciembre</td>
				                              <td>&nbsp;</td>
				                              <td>&nbsp;</td>
				                              <td><img src="grafico.png" width="30" height="30"></td>
				                              </tr>
