				  ...
				  <table width="100%" border="0" cellpadding="3" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td valign="bottom" class="cuadro01"><label>
                        <input name="fechacontrol" type="text" id="fechacontrol" size="10" maxlength="10" value="<?=$fecha ?>" onChange="fechas(this.value); this.value=borrar">
                      dd-mm-aaaa</label></td>
                    </tr>
					<tr>
						...
						<td valign="bottom" class="cuadro01">
						  <label>
							<input name="horacontrol" type="text" id="horacontrol" size="5" maxlength="5" value="<?=$f1['hora']; ?>">
						  hh:mm</label>
					  	</td>
					</tr>
                    <tr>
