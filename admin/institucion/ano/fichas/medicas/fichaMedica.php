  ...
  <tr>
	...
	<? }?>
		<TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0 >
			...
			<TR height=15>
				<TD><br /><input type="hidden" name="id_curso" id="id_curso" value="<?php echo $c_curso ?>">
                    ...
                    <tr>
                      <td colspan="2"><div align="center">
					   ...
					   if ($frmModo != "mostrar"){
						...
						?>
						<label>
                        <input name="Submit2" type="button" class="BotonXX" onClick="window.location='listarFichasAlumno.php3?alumno=<?php echo $alumno ?>&id_curso=<?php echo $c_curso ?>'" value="Volver"/>
                        </label>
                        <br />
                        <br />
                        <br /><br>
