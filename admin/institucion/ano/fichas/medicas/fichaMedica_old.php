...
//-->
		...
		<SCRIPT language="JavaScript">
			...
			var nro=0;			
				...
				if(!chkFecha(form.txtFECHAATE,'FECHA ATENCION inválida.')){
					return false;
				};
				...
				if(!chkFecha(form.txtFECHAPROXATE,'FECHA PROXIMA ATENCION inválida.')){
					return false;
				};
				if(nro==2){//PRIVADA
					if(!chkVacio(form.clinica,'Ingrese nombre de clínica .')){
						return false;
					};
					if(!chkVacio(form.fono_clinica,'Ingrese fono de la clínica')){
						return false;
					};
				};
				return true;
...
<? } ?>
	<?php //echo tope("../../../../../util/");?>
	<FORM method=post name="frm" action="../../../../../procesoFichamedica.php3">
						...
						<TR height="50" >
							<TD align=right colspan=2>
								<?php if($frmModo=="ingresar"){ ?>
									...
									<INPUT TYPE="button" value="CANCELAR" class="botonXX"  name=btnCancelar onClick=document.location="listarFichasAlumno.php3?alumno=<?php echo $alumno;?>">&nbsp;
								<?php };?>
								<?php if($frmModo=="mostrar"){ ?>
									<?php if(($_PERFIL!=2)&&($_PERFIL!=4)){ //ACADEMICO Y LEGAL?>
										<INPUT TYPE="button" value="MODIFICAR" name=btnModificar class="botonXX"  onClick=document.location="seteaFicha.php3?caso=3">&nbsp;
									<?php }?>
										<INPUT TYPE="button" value="VOLVER" class="botonXX"  onClick=document.location="listarFichasAlumno.php3?alumno=<?php echo $alumno;?>">&nbsp;
								<?php };?>

								<?php if($frmModo=="modificar"){ ?>
									<INPUT TYPE="submit" value="GUARDAR" class="botonXX"  name=btnGuardar onClick="return valida(this.form);" >&nbsp;
									<INPUT TYPE="button" value="CANCELAR" class="botonXX"  name=btnCancelar onclick=document.location="seteaFicha.php3?alumno=<?php echo $alumno?>&caso=1&idFicha=<?php echo $_FICHAM?>">&nbsp;
								<?php };?>
							</TD>
						</TR>
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="of_otros_desc" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="of_otros_desc_indic" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="ot_otros_desc" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="ot_otros_desc_indic" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="or_otros_desc" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
																		...
																		<TR>
																			...
																			<TD COLSPAN=5 align=left>
																				<?php 
																					if($frmModo=="ingresar"){ 
																				?>
																					<input type=text NAME="or_otros_desc_indic" size=50>
																				<?php };?>
																				<?php 
																					if($frmModo=="mostrar"){ 
						  ...
						  <TD colspan=3 align=center>
							...
							<br>
						        ...
						        <table width="600" bgcolor="#FFFFFF">
                                  <tr>
                                    <td width="30" bgcolor="#FFFFFF" height="30" align="center"><? if($fila['grupo_sanguineo']==1){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
                                    <td width="230" bgcolor="#FFFFFF"><font face="Arial, Helvetica, sans-serif" size="-2">RH(-)</font></td>
                                    <td width="30" bgcolor="#FFFFFF" align="center"><? if($fila['grupo_sanguineo']==2){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
                                    <td width="230" bgcolor="#FFFFFF"><font face="Arial, Helvetica, sans-serif" size="-2">RH(+)</font></td>
								  </tr>
                                  <tr>
                                    <td bgcolor="#FFFFFF" height="30" align="center"><? if($fila['grupo_sanguineo']==3){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
                                    <td bgcolor="#FFFFFF"><font face="Arial, Helvetica, sans-serif" size="-2">AB(I)</font></td>
                                    <td bgcolor="#FFFFFF" align="center"><? if($fila['grupo_sanguineo']==4){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
                                    <td bgcolor="#FFFFFF"><font face="Arial, Helvetica, sans-serif" size="-2">A(II)</font></td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#FFFFFF" height="30" align="center"><? if($fila['grupo_sanguineo']==5){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
                                    <td bgcolor="#FFFFFF"><font face="Arial, Helvetica, sans-serif" size="-2">B(III)</font></td>
                                    <td bgcolor="#FFFFFF" align="center"><? if($fila['grupo_sanguineo']==6){?><img src="../../../../../tic.gif"><? } else {?>_ <? }?></td>
							...
							<table width="600" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
							  ...
							  <tr>
								...
								<table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
								  <tr>
									<td width="30" height="30"  align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico1']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico1" <? if($fila['problema_especifico1']==1){?> checked <? }?>><? }?></td>
									<td width="290"><font face="Arial, Helvetica, sans-serif" size="-2">DIABETES</font></td>
									<td width="30" align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico2']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico2" <? if($fila['problema_especifico2']==1){?> checked <? }?>><? }?></td>
									<td width="290"><font face="Arial, Helvetica, sans-serif" size="-2">PROBLEMAS DE COAGULACÍON</font></td>
								  </tr>
								  <tr>
									<td height="30" align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico3']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico3" <? if($fila['problema_especifico3']==1){?> checked <? }?>><? }?></td>
									<td><font face="Arial, Helvetica, sans-serif" size="-2">EPILEPSIA</font></td>
									<td align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico4']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico4" <? if($fila['problema_especifico4']==1){?> checked <? }?>><? }?></td>
									<td><font face="Arial, Helvetica, sans-serif" size="-2">CRISIS ASMÁTICAS</font></td>
								  </tr>
								  <tr>
									<td height="30" align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico5']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico5" <? if($fila['problema_especifico5']==1){?> checked <? }?>><? }?></td>
									<td><font face="Arial, Helvetica, sans-serif" size="-2">CRISIS CONVULSIVAS</font></td>
									<td align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico6']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico6" <? if($fila['problema_especifico6']==1){?> checked <? }?>><? }?></td>
									<td><font face="Arial, Helvetica, sans-serif" size="-2">ASMA</font></td>
								  </tr>
								  <tr>
									<td height="30" align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico7']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_especifico7" <? if($fila['problema_especifico7']==1){?> checked <? }?>><? }?></td>
									<td><font face="Arial, Helvetica, sans-serif" size="-2">SANGRAMIENTO NASAL FRECUENTE</font></td>
									<td align="center"><? if($frmModo=="mostrar"){if($fila['problema_especifico8']==1){?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type="checkbox" name="problema_espeficico8" <? if($fila['problema_especifico8']==1){?> checked <? }?>><? }?></td>
								  ...
								  <tr>
								    <td height="48" colspan="4" align="center" valign="middle"><table width="600" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="330" align="left"><font face="Arial, Helvetica, sans-serif" size="-2"><? if($frmModo<>"mostrar"){?>
                                          <input type=text NAME="problema_especifico_otros" size=50 value = "<?echo strtoupper($fila['problema_especifico_otros'])?>">
                                          <? } else echo strtoupper($fila['problema_especifico_otros'])?></font></td>
                                      </tr>
                                      <tr>
                                            ...
                                            <td align="center">
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                                <tr>
												  ...
												  <? if($frmModo=="mostrar"){if($fila['tipo_seguro']==1) {?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type=radio value=1 name=tipo_seguro onClick="layerCLINICA.style.visibility='hidden';nro=1" <? if($fila['tipo_seguro']==1){?> checked <? }?>><? }?>
                                                  </font></td>
                                                ...
                                                <tr>
												  ...
												  <? if($frmModo=="mostrar"){if($fila['tipo_seguro']==2) {?> <img src="../../../../../tic.gif"> <? } else { ?>_ <? }} else {?> <input type=radio value=2 name=tipo_seguro onClick="layerCLINICA.style.visibility='visible';nro=1" <? if($fila['tipo_seguro']==2){?> checked <? }?>><? }?>
                                                  </font></td>
...
-->												  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                                    <tr>
                                                      ...
                                                      <td><? if($frmModo=="mostrar"){ ?>
	                                                               <font face="Arial, Helvetica, sans-serif" size="2"><strong><? echo strtoupper($fila['isapre'])?></strong></font>
													      <? } else { ?>
