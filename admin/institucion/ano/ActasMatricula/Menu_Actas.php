	  ...
	  <TABLE WIDTH="589" BORDER=0 CELLSPACING=5 CELLPADDING=5 align="center" >
						...
						<TR>
							<TD width="100%" align=middle class="tableindex">
								<div align="center">
								  <p>ACTAS SIGE MINEDUC DE PROMOCION</p>
								  </div></TD>
						</TR>
					</TABLE>
					<TABLE WIDTH="589" align="center" BORDER=0 CELLSPACING=5 CELLPADDING=5 >
					 
            <td width="589"> <font face="Arial, Helvetica, sans-serif"><img src="../../../../cortes/arrow.png" width="9" height="9"> <? if($_PERFIL==0){?>
              <a href="Archivo01.php">Archivo 
              1. Nomina de Estudiantes</a><hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="Archivo02.php">Archivo 
              2. Información del Curso</a><hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="Archivo03.php">Archivo 
              3. Estudiantes del Curso</a><hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              <? } ?>
              <a href="IniciaArchivo04.php">Archivo 
              4. Antecedentes Académicos de los Estudiantes</a>
              <img src="../../../../images/descarga_SIGE.png" width="39" height="38">
              <hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="IniciaArchivo05.php">Archivo 
              5. Situación de Promoción de los Estudiantes  <img src="../../../../images/descarga_SIGE.png" width="39" height="38" border="0"></a>
              <hr size="1">
			  <? if($_PERFIL==0){?>
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              
              <a href="Archivo06.php">Archivo 
              6. Docentes de los Subsectores, Asignaturas o Módulos</a><hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="procesoArchivo07.php?pagina=0">Archivo 
              7. Acta del Curso</a><hr size="1">
              <img src="../../../../cortes/arrow.png" width="9" height="9">   
              <a href="Archivo08.php">Archivo 
              8. Subsectores, Asignaturas o Módulos</a><hr size="1">
			  <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="Archivo09.php">Archivo 
              9. Nómina de Alumnos  Licenciados</a><hr size="1">
			  <img src="../../../../cortes/arrow.png" width="9" height="9">
              <a href="Archivo10.php">Archivo 
