...
<div id="paso" style="display:<? echo $ps3?>" >
  ...
  <tr>
	...
	Total Errores: <?php echo $contador_rut+$tot_err_vn  ?>
	<br>
<br>
  ...
  <tr>
    <td>&nbsp;</td>
	  ...
	  <table width="589" border="0" align="center">
        ...
        <tr> 
      <td width="589" class="textolink"><p><img src="../../../../cortes/arrow.png" width="9" height="9">   <a href="Archivo21_txt.php">Archivo 
        21. Datos del Establecimiento</a>
        <hr size="1" noshade>
        <img src="../../../../cortes/arrow.png" width="9" height="9">   <a href="Archivo22_txt.php">Archivo 22. Datos 
