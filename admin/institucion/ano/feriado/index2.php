    ...
    <tr>
      <td><table width="61%" border="0">
        ...
        <table width="100%" border="0">
          <tr> 
            <td>
			<?php $sql2="select distinct feriado.id_feriado, feriado.fecha_inicio,feriado.fecha_fin,feriado.descripcion from feriado where id_ano=244 union select feriados_nac.idferiado_nac,feriados_nac.feriado_nac,feriados_nac.fecha_fin,feriados_nac.descripcion from feriados_nac where id_ano=".$ano;
