    ...
    <tr>
      <td><table width="61%" border="0">
        ...
        <table width="100%" border="0">
          ...
          <td align="right"> 
            <input class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' type="button" name="Button" value="AGREGAR" onClick=document.location="seteaFeriado.php?caso=2"> 
              <input class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' type="button" name="Submit3" value="VOLVER" onClick=document.location="../ano_escolar.php"></td>
          </tr>
        </table>
      ...
      <table width="100%" border="0" align="center">
		...
		<?php
			...
			$anoActual=$fecSis["year"];
					...
					?>
					<tr align="center" bgcolor=#ffffff onClick=go('seteaFeriado.php?caso=3&id_feriado=<?php echo $filaFerNac["id_feriado"];?>&bool_fer=<?php echo $filaFerNac["bool_fer"];?>') onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent'> 
      ...
      <table width="100%" border="0" align="center">
		...
		for($j=0 ; $j<pg_numrows($result2) ; $j++){
		  ...
		  $desc = $filaFeriado["descripcion"];
		   ...
		   ?>
        <tr align="center" bgcolor=#ffffff onClick=go('seteaFeriado.php?caso=3&id_feriado=<?php echo $filaFeriado["id_feriado"];?>&bool_fer=<?php echo $filaFeriado["bool_fer"];?>') onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent'> 
