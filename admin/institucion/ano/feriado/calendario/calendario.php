...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario,$fecha){
	global $raiz;
	// calculamos el valor de fecha
	$ano2 = date(Y);
	$ano2--;
	
	if ($fecha == "-$ano2" or $fecha == "--"){
	   $fecha = "";
	}      
	
	 echo '
	    <INPUT value="'.$fecha.'" name="'.$nombrecampo.'" size="10" onChange="fechas(this.value); this.value=borrar">&nbsp;&nbsp;
	    <input class="botonXX"  type=button value="Calendario" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">
	';	
