                    ...
                    <tr> 
					  ...
					  <table>
                          <tr class="textosimple">
                            <td align="center">&nbsp;</td>
                            <td align="center">
							<input name="button3" TYPE="button" class="botonXX" onClick="MM_openBrWindow('pacti_extra.php?curso=<?= $_GET["curso"]?>&alumno=<?= $alumno?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
							<INPUT TYPE="button" value="VOLVER" class="botonXX" name="volver" onClick="window.location.href='hoja_de_vida.php?cmb_curso=<?= $_GET["curso"]?>'"></td>
                            <td align="center"></td>
                          </tr>
					  </table>
					  </div>
