	  ...
	  if($institucion!=""){
		   ...
		   echo "<img src='".$d."menu/imag/logo.gif' >";
								...
								<FONT face="arial, geneva, helvetica" size=3>
									<strong>CITACI&Oacute;N DE APODERADOS </strong></font></td>
         					
	  </tr>
	  <tr>
		                        <td width="229" align=left><font face="arial, geneva, helvetica" size=2> <strong>ALUMNO</strong> </font> </td>
                                <td width="16"><font face="arial, geneva, helvetica" size=2> <strong>:</strong> </font> </td>
                                <td width="443"><font face="arial, geneva, helvetica" size=2> <strong>
                                  <?php
