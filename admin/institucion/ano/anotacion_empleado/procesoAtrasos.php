...
//Nombres del personal
	...
	$qry_fecha = "delete from anotacion_empleado where rut_emp = '$rut_alumno' and tipo = 1 and fecha <= '$fechaMax' and fecha >= '$fechaMin'"; //Selecciono todos los dias del mes actual
...
//					echo $fecha;
					...
					if($periodo!=""){
						...
						$qry_add = "insert into anotacion_empleado(id_anotacion,tipo,fecha,rut_emp,id_periodo,rdb) values ('$id_max',1,'$fecha','$rut_alumno','$periodo','$institucion')";						
