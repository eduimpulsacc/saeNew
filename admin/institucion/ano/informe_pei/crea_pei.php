...
function guardaPla(){
	...
	var nombre=$("#txtNombre").val();
	 if(area==0 || (nombre.length==0 && nombre=="")){
	alert("Debe completar todos los campos");	 
	}
	else{
	var parametros="funcion=1&area="+area+"&nombre="+nombre;
	$.ajax({
	  url:'cont_pei.php',
	  data:parametros,
	  type:'POST',
...
{	
	...
	y.innerHTML=label+" <input name=\"items[]\" size=70 class=\"item\"> <input name=\"id_sub1[]\"  type=hidden  value=\""+id_sub_local+"\"><input name=\"id_cat1[]\" value=\""+pos_cat+"\"  type=hidden ><input type=\"checkbox\" name=\"aplicaconc[]\" value=1 class=\"chitm\" >(Con Concepto)";
//";
}
