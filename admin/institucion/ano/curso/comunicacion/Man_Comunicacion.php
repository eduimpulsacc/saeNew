...
<tr>
	...
	<? if($admcomun==1){?>
			<tr>
				<td><INPUT class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' TYPE="button" value="AUTORIZAR" name=btnGuardar onclick=document.location="AutorizarComunicacion.php3?comunicacion=<? echo $fila_Comun['id_comun']; ?>"></td>
			</tr>
