<?php 
	...
	$pag="detalles_vitacora_alumno.php";
	if($caso==1){//MOSTRAR ALUMNO
		...
		/*if ($pesta == 3){
		   $pag = "detalles_vitacora_alumno.php?pesta=3";
		}
		if ($pesta == 5){
		   $pag = "detalles_vitacora_alumno.php?pesta=5";
		} 
		if ($pesta == 2){
		   $pag = "detalles_vitacora_alumno.php?pesta=2";
		}  
		if ($pesta == 4){
		   $pag = "detalles_vitacora_alumno.php?pesta=4";
		}
