...
"Datos-->".$separaDatos[$i];
 ...
 $separa1=explode("|",$separaDatos[$i]);
	...
	echo "<br>". $sql_insert = "INSERT INTO lectura_veloz(id_ano,id_ramo,id_curso,rut_alumno,fecha,palabra,concepto) 
	                 VALUES
                     (".$ano.",".$id_ramo.",".$id_curso.",".$rut_alumno.",'".$fecha."',".$puntaje.",".$concepto.");";
