...
function carga_curso(id_ano){
	...
	var rdb="<?=$institucion;?>"
	var funcion =1;
	var parametros='funcion='+funcion+'&id_ano='+id_ano+"&rdb="+rdb;
	//alert(parametros);
		$.ajax({
...
function guarda_Alumnos(){
	...
	var parametros = "funcion="+funcion+'|'+"cantidad="+contador+'|'+$("#rut_alumno"+i+"").val()+'|'+$("#TXT_nota"+i+"").val()+'|'+$("#select_cursos").val()+'|'+ramo+'|'+$("#txtFECHA").val()+'|'+ano+'|'+$("#CMB_Conc"+i+"").val()+'*';
