			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0">
			  ...
			  <tr>
				...
				<select name="modo_eval">
				  ...
				  <option value="1" <? if ($modo_eval==1){ ?> selected="selected" <? } ?>>Numérico</option>
				  <option value="2" <? if ($modo_eval==2){ ?> selected="selected" <? } ?>>Conceptual</option>
				  <option value="3" <? if ($modo_eval==3){ ?> selected="selected" <? } ?>>Numérico - Conceptual (I,S,B,MB)</option>
				  <option value="4" <? if ($modo_eval==4){ ?> selected="selected" <? } ?>>Conceptual (I,S,B,MB) - Numérico</option>
