<?php require('../../../../../../util/header.inc');
	...
	$actualizar = "update detalle_planificacion set activo = '$estado' where id = '$id_detalle'";
	$res_actualizar = pg_Exec($conn,$actualizar);
	
	
	// vuelvo a la página de planificacion
	echo  "<script>window.location='planificacion.php?id_ramo=$id_ramo&cmbPERIODO=$periodo'</script>";
