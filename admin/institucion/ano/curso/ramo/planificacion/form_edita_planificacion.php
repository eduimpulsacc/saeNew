...
<?php 
	...
	$Rs_Notas = @pg_exec($conn,$qry);
	 ...
	 $select_deta = "select * from detalle_planificacion where id = '$id_detalle'";
	 $res_deta = @pg_Exec($conn,$select_deta);
	 $num_deta = @pg_numrows($res_deta);
	  
	 $fil_deta    = @pg_fetch_array($res_deta,0);
...
<FORM method="post" name="frm" action="actualiza_planificacion.php">
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF"><label>
              <input name="fecha_ini" type="text" id="fecha_ini" value="<?=$fecha_ini ?>">
            </label></td>
            <td class="tablatit2-1">Fecha T&eacute;rmino </td>
            <td bgcolor="#FFFFFF"><input name="fecha_fin" type="text" id="fecha_fin" onFocus="validafechaini()" value="<?=$fecha_fin ?>"></td>
          </tr>
          <tr>
            <td class="tablatit2-1">T&iacute;tulo</td>
            <td colspan="3" bgcolor="#FFFFFF"><label>
              <input name="titulo" type="text" id="titulo" size="60" onFocus="validafechafin()" value="<?=$titulo ?>">
            </label></td>
            </tr>
		  <tr>
            <td class="tablatit2-1">Realizado</td>
            <td colspan="3" bgcolor="#FFFFFF"><label>
            <select name="realizado" id="realizado">
			   <option value="0">No</option>
			   <option value="1">Si</option>
            </select>
            <input name="id_detalle" type="hidden" id="id_detalle" value="<?=$id_detalle ?>">
            </label></td>
            </tr>	
          <tr>
            <td class="tablatit2-1">Descripci&oacute;n</td>
            <td colspan="3" bgcolor="#FFFFFF"><label>
              <textarea name="descripcion" cols="57" rows="9" id="descripcion"><?=$descripcion ?></textarea>
            </label></td>
            </tr>
          <tr>
            <td colspan="4" bgcolor="#FFFFFF"><div align="center">
              <label>
              <input type="button" name="Submit" value="Guardar Planificaci&oacute;n" onClick="validaformulario()">
              </label>
              <label>
              <input name="Submit2" type="button" onClick="MM_goToURL('parent','planificacion.php?id_ramo=<?=$ramo ?>');return document.MM_returnValue" value="Volver">
              </label>
            </div></td>
            </tr>
        </table>
