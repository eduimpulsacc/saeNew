...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<FORM method="post" name="frm" id="frm" action="new_procesoIngreso.php3">
...
<INPUT class="botonXX"  TYPE="submit" value="GUARDAR5" name="btnGuardar" 
onClick="return <?php if ($aprox_entero == 1){ echo "valida1"; }else{echo "valida";} ?>(<? echo $institucion;?>, <? echo $grado;?>, <? echo $ensenanza;?>);">

									<? }else{ ?>

<INPUT class="botonXX"  TYPE="submit" value="GUARDAR6" name=btnGuardar 
onClick="return <?php if ($aprox_entero == 1){ echo "valida1"; }else{echo "valida";} ?>(<? echo $institucion;?>, <? echo $grado;?>, <? echo $ensenanza;?>);">
									<? } ?>
									&nbsp;
<?	}	
...
<!--<INPUT class="botonXX" TYPE="button" value="NUEVOGUARDAR" name="btnNUEVOGUARDAR" onClick="enviardatos('procesador_notas.php','frm','respuesta')" >
-->
<? } ?>
...
// CICLO X //
											...
											for($i=0 ; $i < @pg_numrows($result) ; $i++){   // el mismo resul lo recorro en ciclo 
												...
												if ($fila1["nro_lista"] != ""){
												   ...
												   //echo  "<input type='hidden' name='nro_lista' value=".$fila1['nro_lista']." >";
												}else {
												   echo $X; }
...
function enviardatos(url,formid,divrespuesta){
        ...
        for (var i=0; i <= Formulario.elements.length-1;i++) {
			...
			if ( Formulario.elements[i].type != 'button' && Formulario.elements[i].type != 'submit' /*&&  Formulario.elements[i].type != 'hidden'*/ ) {
