...
$ont++;
		...
		$table = $table."<th align='left' class='formatoth' >&nbsp;".$curso[ $i ][ "ape_pat" ]." ".$curso[ $i ][ "ape_mat" ]." ".$curso[ $i ][ "nombres" ]."&nbsp;</th>";
			...
			for ( $e = 0 ; $e < 20 ; $e++ ){ 
				...
				if( $curso[ $i ][ "notas" ][ $e ]!=0 or $curso[ $i ][ "notas" ][ $e ]=='B' or $curso[ $i ][ "notas" ][ $e ]=='S' or $curso[ $i ][ "notas" ][ $e ]=='I' or $curso[ $i ][ "notas" ][ $e ]=='MB' or $curso[ $i ][ "notas" ][ $e ]=='AL' or $curso[ $i ][ "notas" ][ $e ]=='L' or $curso[ $i ][ "notas" ][ $e ]=='NL' ){
