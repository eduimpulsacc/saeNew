...
//	$alumno			=$_ALUMNO;
	...
	$ramo			=$_RAMO;
	$plan			=$_PLAN;
	$cod_subsector  =$_SUBSECTOR;
	$docente		=5; //Codigo Docente
	$_POSP          =5;
	$_bot           = 5;
	$_MDINAMICO     = 1;
	
	echo "frmModo es: $frmModo <br>";
	echo "cod_subsector es: $cod_subsector <br>";
	echo "Ramo tiene: $ramo <br>";
...
//-------
    ...
    // tomo el nombre del subsector
	$qryn="SELECT * FROM subsector WHERE cod_subsector = '$cod_subsector'";
	$rqryn = pg_Exec($conn,$qryn);
	$fsubs = pg_fetch_array($rqryn,0);
	$nombresubs = $fsubs['nombre'];
      ...
      function enviapag(form){
			...
			frmModo = form.frmModo.value;
 			...
 			if (form.cmb_curso.value!=0){
				...
				pag="../seteaCurso.php3?caso=11&p=4&curso="+curso2+"&frmModo="+frmModo
				form.action = pag;
				form.submit(true);	
			}		
		 }
       ...
       function enviapag2(form){
			...
			frmModo = form.frmModo.value;
 			...
 			if (form.cmb_ano.value!=0){
				...
				pag="../../seteaAno.php3?caso=10&pa=10&ano="+ano2+"&frmModo="+frmModo
				form.action = pag;
				form.submit(true);	
			}		
		 }		 
			...
			<TR height=15>
					...
					<TABLE WIDTH="100%" BORDER=0 CELLSPACING=5 CELLPADDING=5 height="100%">
						<TR height="50" >
							<TD align=left colspan=2>
								...
								<?php if($frmModo=="mostrar"){ ?>
								<?php if($_PERFIL==17){ ?>
									<INPUT class="botonXX"  TYPE="button" value="INICIO" onClick=parent.location.href="../../../../../session/perfilDocente.php3">
								<?php }?>
									<?php if($_PERFIL!=17){?> 
				...
				<?php  } ?>
					...
					<TR>
                       ...
                       <TD width="100%"> <table width="100%" border=0 cellpadding=2 cellspacing=2 class="datosB">
                  		<tr> 
						 <?php if($frmModo=="ingresar"){ ?>  

                  			<td width="22"> <font face="arial, geneva, helvetica" size=1 color=#000000>&nbsp; 
                   			 </font> </td>
                 		 	<td width="201" class="nombre_campo">    <span class="nombre_campo">                		  COD. SUBSECTOR </span> </td>
							  	<?php //if ((($fila3['grado_curso']==3) or ($fila3['grado_curso']==4)) and ($fila3['cod_tipo']==310) and ($frmModo=="ingresar")and ($filaVrfy['rdb']==0)) { ?>

                  <td width="142" class="nombre_campo"> <strong>RESOLUCION</strong></td>
							  
                  <td width="173" class="nombre_campo"> FECHA 
                  </td>
							</tr>
							<tr class="datosB"> 
...
//						   if((($fila3["cod_tipo"]==110) or ((($fila3["cod_tipo"]==310) and (($frmModo=="mostrar") || ($frmModo=="modificar"))) and (($fila5['grado_curso']==1) or ($fila5['grado_curso']==2))) OR ((($fila3["cod_tipo"]>=410) and (($frmModo=="mostrar") || ($frmModo=="modificar"))) and (($fila5['grado_curso']==1) or ($fila5['grado_curso']==2) or ($fila5['grado_curso']==3) or ($fila5['grado_curso']==4)))) || $filaVrfy['rdb']!=0){ 
							if((($fila3["cod_tipo"]==110) or (($fila3["cod_tipo"]==310) and (($fila5['grado_curso']==1) or ($fila5['grado_curso']==2))) OR (($fila3["cod_tipo"]>=410)  and (($fila5['grado_curso']==1) or ($fila5['grado_curso']==2) or ($fila5['grado_curso']==3) or ($fila5['grado_curso']==4))))or ($filaVrfy['rdb']!=0)) {?>
							   ...
							   <td width="27"> <font face="arial, geneva, helvetica" size=1 color=#000000>&nbsp; 
								   ...
								   <?php } ?>
							  <td width="131" class="nombre_campo"> 								SUBSECTOR  </td>
                  ...
                  <td></td>
                  			<td width="226" class="nombre_campo"> SECTOR</td>
							  <td width="182" class="nombre_campo"> SUBSECTOR								 </td>
								<?php } ?>
							</tr>
							<tr class="datosB"> 
							   <?php if(($frmModo=="ingresar") and($filaVrfy['rdb']==0)){ ?>
            ...
            <TD width="100%"> <table width="100%" border=0 cellpadding=2 cellspacing=2 class="datosB">
                ...
                <tr>
				   ...
				   <td width="310" align="top">				                       <span class="nombre_campo">SUBSECTOR OBLIGATORIO
                        </span>				     <?php 
						//exit;
						if($frmModo=="ingresar"){ ?>
                  ...
                  <td width="206" align="top">				                      <span class="nombre_campo">SUBSECTOR ELECTIVO</span>                    <?php if($frmModo=="ingresar"){ ?>
            ...
            <TD width="100%"> <table width="100%" border=0 cellpadding=2 cellspacing=2 class="datosB">
                <tr> 
                  <td nowrap ><span class="nombre_campo">                     INCIDE EN PROMOCION (SE IMPRIME EN EL ACTA)</span> <br>
                    <?php if($frmModo=="ingresar"){ ?>
                    ...
                    <INPUT type="checkbox" name=ip size=83 maxlength=50 value=1 
											...
											?>>
                    <?php };?></td>
                  <td width="254" ><span class="nombre_campo"> &nbsp; SUBSECTOR ASOCIADO A RELIGION 
                 </span> <br>  <?php if($frmModo=="ingresar"){ ?>
              ...
              <table width="100%" border="0" class="datosB">
                <tr>
                  <td><span class="nombre_campo">APROXIMAR 
                    NOTAS</span> 
                    <?php if ($frmModo=="ingresar"){
					//echo $qry7;
					//exit;?>
...
<TR>
            ...
            <TD width="100%"> <table width="100%" border=0 cellpadding=2 cellspacing=0 class="datosB">
                <tr class="datosB"> 
                  <?php  if( ($frmModo=="mostrar") and ($fila1['conex']==1) ) { ?>
                  <td align="left" valign="top" class="datosB"><span class="nombre_campo">EXAMEN 
                    </span>
                    <?php } elseif ($frmModo=="ingresar" or $frmModo=="modificar") { ?>
a                  
                  <td colspan="2" align="left" valign="top" class="datosB"> 
                    <span class="nombre_campo">EXAMEN</span>   
                    <?php } ?>
                    <?php if ($frmModo=="ingresar"){ ?>
                    ...
                    <?php
							if ($fila1['conex']==1)
								imp(($fila1['conex']==1)?"SI":"NO");?>
             
                    <?php };?>
                    <?php if($frmModo=="modificar"){ ?>
                    <input name="conEX" type="radio" value=1 onClick="muestraText(this.form);"
						<?php 
						  echo ($fila1['conex']==1)?"checked":"";
						?>> 
                    <?php } ?>
                  </td>
                  <td width="1" height="42" class="datosB">&nbsp;</td>	
                  <?php  if( ($frmModo=="mostrar") and ($fila1['conex']==2) ) { ?>
                  <td align="left" valign="top" class="datosB"> 
                    <span class="nombre_campo">SIN EXAMEN</span> 
                    <?php }elseif ($frmModo=="ingresar" or $frmModo=="modificar") { ?>
                  <td align="left" valign="top" class="datosB">  
                    <span class="nombre_campo">SIN EXAMEN</span>                    <?php }?>
                    <?php if ($frmModo=="ingresar"){ ?>
                    <input type="radio" name="conEX" value="2" onClick="ocultaText(this.form);"  checked> 
                    <?php }?>
                    <!--br-->
                    <?php 
					if($frmModo=="mostrar"){ ?>
                    ...
                    <?php
						if ($fila1['conex']==2)
							imp(($fila1['conex']==2)?"SI":"NO");?>
            
                    <?php };?>
                    <?php if($frmModo=="modificar"){?>
                    <input name="conEX" type="radio" value=2 onClick="ocultaText(this.form);"
						<?php 
						  echo ($fila1['conex']==2)?"checked":"";
						?>> 
                    <?php } ?>
                  </td>
                  <td align="left" valign="top" class="datosB">&nbsp; </td>
                </tr>
                <tr> 
                  <?php if ((($frmModo=="mostrar") and ($fila1['conex']==1)) or ($frmModo=="ingresar") or ($frmModo=="modificar")) {?>
                  <td height="15" align="left" valign="top" class="nombre_campo">PORCENTAJE 
                    EXAMEN</td>
                  <td align="left" valign="top" class="nombre_campo">NOTA 
                    EXIMICI&Oacute;N</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>					
                ...
                <tr> 
                  <td height="40" align="left" valign="top" class="datosB"> 
                    <?php if($frmModo=="ingresar"){ ?>
                    <p> 
				...
				<tr>
					<td class="nombre_campo">PORCENTAJE EXAMÉN ESCRITO</td>
					<td class="nombre_campo">PORCENTAJE EXAMÉN ORAL</td>
				</tr>
				<? if($frmModo=="ingresar"){?>
					<tr>
				...
				<? } 
					if($frmModo=="mostrar"){ ?>
					<tr>
						<td><? echo $fila1["pct_ex_escrito"]; ?></td>
						<td><? echo $fila1["pct_ex_oral"]; ?></td>
					</tr>
				<? } ?>
				<? } ?>
<?	//	if($institucion==25452 || $institucion==24977 || $institucion==25478 || $_PERFIL==0 ){	//restringir la prueba de nivel		?>
          ...
          <?php  if( ($frmModo=="mostrar") and ($fila1['prueba_nivel']==1) ) { ?>
                  <td align="left" valign="top" class="datosB"><span class="nombre_campo">PRUEBA DE NIVEL</span> 
           <?php } elseif ($frmModo=="ingresar" or $frmModo=="modificar") { ?>
				  <td class="datosB"><span class="nombre_campo">PRUEBA DE NIVEL 
                  </span>
				    <?php } ?>
                    <?php if ($frmModo=="ingresar"){	?>
          ...
          <?php  if( ($frmModo=="mostrar") and ($fila1['prueba_nivel']==2) ) { ?>
                  <td align="left" valign="top" class="datosB"><span class="nombre_campo">SIN PRUEBA DE NIVEL</span> 
           <?php } elseif ($frmModo=="ingresar" or $frmModo=="modificar") { ?>
                  <td align="left" valign="top" class="datosB"><span class="nombre_campo">SIN PRUEBA DE NIVEL</span> 
           <?php } ?>
                    <?php if ($frmModo=="ingresar"){	?>
                ...
                <tr> 
                  ...
                  <td height="15" align="left" valign="top" class="nombre_campo">PORCENTAJE 
                    PRUEBA DE NIVEL</td>
                  <TD colspan="2" class="nombre_campo"> MODO DE EVALUACION PRUEBA DE NIVEL&nbsp;&nbsp;&nbsp; </TD>
                  <?php // } ?>
                </tr>
                <tr> 
...
<tr class="datosB"><td colspan="10">&nbsp;</td></tr>
				...
				<?php }?>
						<TR>
							<TD width=6></TD>
							<TD>
								<TABLE width=100% BORDER=0 CELLPADDING=2 CELLSPACING=2 class="datosB">
									<TR>
										
                  <TD colspan="2" class="nombre_campo">                     MODO DE EVALUACION
                  </TD>
									...
									<TR>
										<TD width="39%">
											...
											<?php 
												if($frmModo=="mostrar"){ 
												   $modoeval = trim($fila1['modo_eval']);
												   
												   echo "modoeval es: $modoeval <br>";
												    ...
												    if ($modoeval == 3){
												       echo "Numérico-Conceptual";
												    }
												    if ($modoeval == 4){
												       echo "Conceptual-Numérico";
												    }
											     }									
						...
						<TR>
							...
							<TD>
								<TABLE width=100% BORDER=0 CELLPADDING=2 CELLSPACING=2 class="datosB">
									<TR>
										<TD class="nombre_campo">  												DOCENTE
										</TD>
										<TD class="nombre_campo">  												AYUDANTE
										</TD>
									</TR>
									<TR>
										<TD>
							...
							<TD colspan=2 align="center">
								<?php if($frmModo=="mostrar"){?>
										<?php
											...
											$result =@pg_Exec($conn,$qry);
											if (pg_numrows($result)!=0){?>
												<INPUT class="botonXX"  TYPE="button" value="EVALUACION" onClick=document.location="notas/mostrarNotas.php3?truncado=<?php echo $fila1['truncado']; ?>">
             								    <!-- <INPUT class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' TYPE="button" value="ALUMNOS" onClick=document.location="../alumno/InscribirAlumnos.php3"> -->
												<?
						...
						if (!$fila1106){
						  ...
						  $fila1106 = @pg_fetch_array($result1106,0);
									...
									if($fila1106['situacion']==0){//CERRADO NO MOSTRAR ESTE BOTON CON LINK	
										  ...
										  ?>		
             							  <INPUT class="botonXX"  TYPE="button" value="INSCRIBIR ALUMNOS">
										  <?
									}else{
										  ?>		
             							  <INPUT class="botonXX"  TYPE="button" value="INSCRIBIR ALUMNOS" onClick=document.location="InscribirAlumnos.php">
										  <?
									 }
									 ?>	  
												...
												<?php if ($fila['conex']==1) { ?> 
												<input class="botonXX"  type="button" value="SITUACION FINAL ALUMNOS" onClick=document.location="situacionFinal.php3?frmModo=mostrar">
												<?php } ?>										
     										<?php
												}else{
											?>
											...
											?>
										<INPUT class="botonXX"  TYPE="button" value="ARCHIVOS" onClick=document.location="contenido/listarContenidos.php3">
								...
								<?php }else{?>
									...
									<?php }?>
								<?php }?>
								<?	if($institucion==25452 || $institucion==24977 || $institucion==25478 || $_PERFIL==0 ){	?>
										<INPUT class="botonXX"  TYPE="button" value="NOTAS NIVEL" onClick=document.location="notas/mostrarNotasNivel.php3">
								<?	}?>
							</TD>
						</TR>
      ...
      <td height="23">
	  <a href="
	  <?php if($frmModo=="modificar"){ ?>seteaRamo.php3?ramo=<?php echo $ramo?>&caso=1&plan=<?php echo $plan ?><?php };?>
	  <?php if($frmModo=="mostrar"){ ?>listarCursos.php3<? }?>
	  <?php if($frmModo=="ingresar"){ ?>listarRamos.php3?plan=<?php echo $plan ?> <? }?>
	  "
	  class="boton02" >
