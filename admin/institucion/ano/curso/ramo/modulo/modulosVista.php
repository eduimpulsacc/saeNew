...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
  <tr>
    <td height="51" colspan="3" align="right"><input type="button" name="ingrel" id="ingrel" value="Modificar" onclick="mod_data(<?php echo $ramo ?>)" class="botonXX"/>&nbsp;&nbsp;<input type="button" name="ingrel2" id="ingrel2" value="Cerrar Pesta&ntilde;a" onclick="cierra(<?php echo $ramo ?>)" class="botonXX"/>&nbsp;&nbsp;</td>
  </tr>
  <tr class="tableindex">
   ...
   <?php for($a=0;$a<$contador;$a++){
	 ...
	 ?>
  <tr>
    <td align="center"><?php echo ($fila['id_ramo']==$ramo)?"<img src='../../../../../clases/img_jquery/iconos/Web-Application-Icons-Set/PNG-24/OK.png' width='12' height='12'>":"" ?></td>
    <td align="center"><?php echo ($hijo)?"<img src='../../../../../clases/img_jquery/iconos/Web-Application-Icons-Set/PNG-24/OK.png' width='12' height='12'>":"" ?></td>
