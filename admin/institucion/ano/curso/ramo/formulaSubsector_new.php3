	...
	function InicialesSubsector($Subsector)
{
	...
	$qry1="";
	$qry1 = "SELECT ramo.id_ramo, subsector.nombre, formula_hijo.id_formula, porcentaje, truncado FROM subsector INNER JOIN ramo ON subsector.cod_subsector = ramo.cod_subsector INNER JOIN formula_hijo ON formula_hijo.id_hijo=ramo.id_ramo WHERE (((formula_hijo.id_formula)=".trim($formula).")) ";
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  ?>
	...
	<? } ?>
	<? if($fila_ramo['truncado']==1) $PromedioF=round($Promedio); else $PromedioF=$Promedio; ?>
