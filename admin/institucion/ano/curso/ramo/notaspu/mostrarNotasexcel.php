				                         ...
				                         <?
											...
											for($i=0 ; $i < @pg_numrows($result) ; $i++){
												...
												//NOTAS ALUMNO POR RAMO Y PERIODO
  											    $qry2="SELECT * FROM pu_notas notas$nro_ano WHERE (((notas$nro_ano.rut_alumno)=".$fila1['rut_alumno'].") AND ((notas$nro_ano.id_periodo)=".$periodo.") AND ((notas$nro_ano.id_ramo)=".$ramo."))"; 
