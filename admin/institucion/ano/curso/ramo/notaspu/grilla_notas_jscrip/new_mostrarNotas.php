...
/***************************************************/
  ...
  function procesarNotas(ramo,periodo){
	  
	  var parametros="ramo="+ramo+"&periodo="+periodo;
	  	 $.ajax({
			url: '../procesoPU.php',
			type: 'post',
			dataType: "html",
...
<? if($_PERFIL==0){?>
	...
	<INPUT class="botonXX"  TYPE="button" value="PROCESAR NOTAS" onClick="procesarNotas(<?php echo $ramo ?>,<?php echo $periodo ?>)">
