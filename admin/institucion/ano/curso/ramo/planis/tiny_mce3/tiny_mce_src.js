...
(function() {
	...
	tinymce.create('tinymce.Editor', {
		...
		setupIframe : function() {
			...
			// Setup body
			d.open();
			d.write(s.doctype + '<html><head xmlns="http://www.w3.org/1999/xhtml"><base href="' + t.documentBaseURI.getURI() + '" /><meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" /></head><body id="tinymce" class="mceContentBody"></body></html>');
			d.close();
