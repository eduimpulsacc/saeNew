...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../../../../../cortes/b_ayudaza_r.jpg','../../../../../cortes/b_info_r.jpg','../../../../../cortes/b_mapa_r.jpg','../../../../../cortes/b_home_r.jpg');MM_callJS('ocultar()')">
<script>
   function ocultar(){
       document.getElementById("m0").style.display='none';
       document.getElementById("m1").style.display='none';
...
<?php } ?>
	<?php //echo tope("../../../../../util/");?>
	<FORM method=post name="frm" action="procesoRamo_new.php3">
	<?php 
		...
		<TABLE WIDTH=600 BORDER=0 CELLSPACING=0 CELLPADDING=0 align=center>
			...
			<TR height=15>
				...
				$qry="SELECT curso.id_curso, tipo_ensenanza.cod_tipo FROM tipo_ensenanza INNER JOIN curso ON tipo_ensenanza.cod_tipo = curso.ensenanza WHERE (((curso.id_curso)=".$curso."))";
					...
					/// para ingresar los subsectores por selección multiple
					?>
					<TR>
   					   <TD colspan="2">
					       <table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr>
								<td align="center"><label>
								  <input type="button" name="Submit" value="SELECCI&Oacute;N M&Uacute;LTIPLE" onClick="multiple();" class="botonXX">
								</label></td>
								<td align="center"><label>
								  <input type="button" name="Submit2" value="INGRESO INDIVIDUAL" onClick="individual();" class="botonXX">
								</label></td>
							  </tr>
							</table>
                      </TD>					
					   ...
					   <table border=0 cellspacing=2 cellpadding=2>
                  		<tr> 
							<?php if($frmModo=="ingresar"){ ?>  
                  			...
                  			<td width="22"><input type="hidden" name="seleccionmultiple" value="1"> <font face="arial, geneva, helvetica" size=1 color=#000000>&nbsp; 
                   			 </font> </td>
                 		 	<td width="201"> <font face="arial, geneva, helvetica" size=1 color=#000000> 
                    		 <strong> SUBSECTORES</strong> </font> </td>
						  ...
						  <td width="173"><?php if($frmModo=="ingresar"){ ?>
                            <input name="codRes" type="text" id="codRes"></td>
									<td width="173"><font face="arial, geneva, helvetica" size=1 color=#000000>FECHA</font></td>
									<td width="173"><input name="txtFecha" type="text" id="txtFecha" size="10">
                                      <?php };?></td>
                  		</tr>
						    ...
						    for($i=0 ; $i < @pg_numrows($result7) ; $i++){
								...
								if (!$result2){ 
									...
									if (pg_numrows($result2)==0){
									    $cant_sub++;	
									    $nombre_subsector = $fila1['nombre'];
										$cod_subsector    = $fila1['cod_subsector'];
										
									    ?>
										<tr> 
						                <td><label><input type="checkbox" name="codsub<?=$cant_sub ?>" value="<?=$cod_subsector ?>" ></label></td>
						                <td colspan="5"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><? echo "$nombre_subsector"; ?></font></td>
						                </tr>
										<?
																
									}
								}
						    }  ?><input type="hidden" name="cant_sub" value="<?=$cant_sub ?>"><?	
					   } 
					...
					<?
					   /// fin ingreso de subsectores en forma multiple
					?>					
					<TR>
   					<TD width=6></TD>					
                       <TD width="571">
				  ...
				  <? } 	
				     ...
				     if ($frmModo=="ingresar"){ ?>
				           <input type="radio" name="conEX" value="1" onClick="muestraText(this.form);">
					    	<font face="arial, geneva, helvetica" size=1 color=#000000><strong>SI</strong></font>
						    &nbsp;
						   <input type="radio" name="conEX" value="2" onClick="ocultaText(this.form);">
						   <font face="arial, geneva, helvetica" size=1 color=#000000><strong>NO</strong></font>
				   <? }				  
