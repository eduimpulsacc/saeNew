                      ...
                      <td width="73%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td align="left" valign="top"><form name="form1" method="post"><table width="100%" border="0">
                              <tr>
                                <td width="11%"><font size="2" face="Arial, Helvetica, sans-serif">&nbsp; <font size="1">PERIODO</font></font></td>
			 ...
			 ?>
				...
				?>
								...
								<input name="creada" type="hidden" value="<? echo $creada;?>">
                                  ...
                                  <?php } ?>
                                  <?php if (($creada==1)&&(!$modificar)&&($periodo!=0)){
                              ...
                              <tr>
                                <td colspan="4"><table width="100%" border="0">
                                  <tr>
                                    ...
                                    <td width="91%"><font size="2" face="Arial, Helvetica, sans-serif">: <?php echo $filaCurso['grado_curso']. "-".$filaCurso['letra_curso']."     ".$filaEns['nombre_tipo'] ?></font></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
