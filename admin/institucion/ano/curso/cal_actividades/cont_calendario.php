...
for($c=0;$c<pg_numrows($rs_cur);$c++){
	...
	?>
     <option value="<?php echo $fila_cur['id_curso'] ?>" <?php echo ($fila_cur['id_curso']==$_SESSION['ccc'])?"selected":""; ?>><?php echo $fila_cur['curso'] ?></option>
    <?
}
?>
 </select>
<?
    ...
    <script type="text/javascript" src="../../../../clases/jquery-ui-1.9.2.custom/development-bundle/ui/jquery.ui.widget.js"></script>
...
&nbsp;&nbsp;&nbsp; --> </div>
		...
		<div id="add-event-form" title="Nueva Actividad">
			...
			<fieldset>
				...
				<table style="width:100%; padding:5px;">
					...
					<tr>
						...
						<td>&nbsp;</td>
						<td><label>Hora t&eacute;rmino</label>
						...
						<td>
						<td><label>Minuto t&eacute;rmino</label>
		...
		<div id="display-event-form" title="Datos Actividad"></div>
...
<?	
	...
	$fter = $te[2]."-".$mt."-".$dt;*/
	 ...
	 $rs_guarda = $ob_calendario->guardaAct($conn,$curso,$nombre,CambioFE($fecha_inicio),CambioFE($fecha_termino),$hora_inicio,$hora_termino,$descripcion);
}
if($funcion==4){
//var_dump($_POST);
...
if($funcion==7){
$rs = $ob_calendario->traeAct($conn,$ia);
$fila_act = pg_fetch_array($rs,0);
?>
<script>
$( document ).ready(function() {
...
<?
/*$txt = $f['id_actividad']."__".$f['fecha_inicio']."__".$f['fecha_termino']."__".$f['hora_inicio']."__".$f['hora_inicio']."__".$f['nombre']."__".$f['descripcion'];
echo $txt;*/
}
?>