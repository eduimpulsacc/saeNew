...
require('../../../../util/header.inc');
	...
	// CURSO
	//--------------------------------
	$sql_curso = "SELECT curso.id_curso, curso.grado_curso, curso.letra_curso, tipo_ensenanza.nombre_tipo, plan_estudio.nombre_decreto, evaluacion.nombre_decreto_eval, institucion.rdb, institucion.dig_rdb, institucion.nu_resolucion, curso.ensenanza, curso.cod_es ";
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="650" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td width="198" rowspan="5" align="left">			<!--img src=../../../../../../tmp/<? //echo $institucion ?> ALT="NO DISPONIBLE"  height="80" -->
			<div align="center">
 ...
 <td width="161" rowspan="5"><? //} ?>
   <?
	...
	<table width="650" border="1" cellspacing="0" cellpadding="0">
	  ...
	  // SUBSECTORES - RAMOS
	  //---------------------------------
	  $sql_ramo = "SELECT ramo.id_ramo, subsector.nombre, ramo.conex, ramo.modo_eval, ramo.sub_obli ";
	  ...
	  <tr>
		...
		if ($examen == 2){ // Ramo sin examen (consulta en tabla notas)
			$sql_notas = "select promedio from notas, tiene$nro_ano ";
			$sql_notas = $sql_notas . "where notas.rut_alumno = '".$alumno."' and notas.id_ramo = ".$ramo." and tiene$nro_ano.id_ramo = $ramo and tiene$nro_ano.rut_alumno = $alumno";
			...
			if ($sub_obli == "2" and $promedio_ramo =="&nbsp;" )
				$sql_eximidos = "select * from tiene$nro_ano where tiene$nro_ano where id_ramo = $ramo and rut_alumno = $alumno";
	  ...
	  <tr >
		<td height="41" colspan="3"><font face="Verdana, Arial, Helvetica, sans-seri" size="-2"><strong>EN CONSECUENCIA: </strong>
		<?
	...
	<table width="650" height="119" border="0" cellpadding="0" cellspacing="0">
	  <tr>
		<td height="27"><div align="left"><font size="2"><strong><font face="Verdana, Arial, Helvetica, sans-seri">Observaciones:___________________________________________________________</font></strong></font></div></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		<td><div align="left"><font size="2"><strong><font face="Verdana, Arial, Helvetica, sans-seri">________________________________________________________________________</font></strong></font></div></td>
		</tr>
	</table>
