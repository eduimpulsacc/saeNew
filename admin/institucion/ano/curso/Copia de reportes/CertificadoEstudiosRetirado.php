...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="650" border="1" cellspacing="0" cellpadding="0">
	  ...
	  $sql_ramo = $sql_ramo . "FROM ramo INNER JOIN subsector ON ramo.cod_subsector = subsector.cod_subsector, tiene3 ";
	  $sql_ramo = $sql_ramo . "WHERE (((ramo.id_curso)=".$curso.") and tiene3.rut_alumno = ".$alumno." and tiene3.id_ramo = ramo.id_ramo) ";
	  ...
	  <tr>
	    ...
	    <td align="center">
		<?
			$sql_notas = "select promedio from notas ";
