...
if($grado==16) $gr="diezseis";
	 ...
	 $sqlTraePlantilla="SELECT * FROM pei_plantilla WHERE  activa=1 AND rdb=".$institucion;
...
<?								
			  ...
			  <? if($tipo_hoja!=1){?>
              <input class="botonXX"  type="button" name="Submit2" value="VOLVER" onClick="window.location='listar_alumnos.php'"><? }else{?>
        ...
        <table width="100%" border="0"  cellspacing="0">
          <?php if(($creada!=1) and ($periodo!="")) {}//fin if($creada!=1)
			
			if($creada==1){}//fin if($creada==1)
