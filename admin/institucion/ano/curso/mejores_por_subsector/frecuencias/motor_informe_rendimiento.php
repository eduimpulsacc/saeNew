...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<table width="701" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    <td width="98" class="textosmediano"> <div align="left"> <font size="1" face="arial, geneva, helvetica"> 
		  ...
		  if ($fila["id_curso"]==$cmb_curso){
				...
				echo "<option value=".$fila['id_curso'].">".$Curso_pal."</option>";
                      ...
                      Periodo</td>
                    <td width="523"><select name="cmb_periodos" class="ddlb_9_x">
		  ...
		  ?>
                    ...
                    <td width="80"><div align="right"> 
                        <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'mainFrame\']','InformeRendimiento.php?c_curso='+cmb_curso.value+'&c_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value);return document.MM_returnValue" value="Buscar">
                      </div></td>
                  </tr>
                </table>
