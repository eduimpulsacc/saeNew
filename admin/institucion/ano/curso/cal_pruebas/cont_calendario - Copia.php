...
$( document ).ready(function() {
    ...
    <option value="0">Seleccione...</option>
		...
		<div id="display-event-form" title="Detalle Actividad">
...
?>
<!---->
    <select name="cmb_ramo" id="cmb_ramo" onchange="traeEvento(this.value)">
    <option value="0">Seleccione ramo</option>
    <?
for($r=0;$r<pg_numrows($rs_ramo);$r++){
	$fila_ram = pg_fetch_array($rs_ramo,$r);
	?>
     <option value="<?php echo $fila_ram['id_ramo'] ?>"><?php echo $fila_ram['nombre'] ?></option>
    <?
}
?>
 </select>
