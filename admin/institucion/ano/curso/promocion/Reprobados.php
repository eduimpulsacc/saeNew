...
<?php 
	...
	$sql_alu = $sql_alu . "WHERE (((matricula.id_curso)=".$curso.") and promocion.rut_alumno = matricula.rut_alumno and  matricula.bool_ar=0 AND promocion.id_curso = matricula.id_curso and promocion.situacion_final = 2) ";
...
<center>
<FORM method=post name="frm" action="procesoPromocion_pro_rep.php">
...
<table width="750" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td align="right">
      ...
      <INPUT name="button2" TYPE="button" class="botonXX" onClick=document.location="FechaObserva.php"  value="CANCELAR"></td>
  </tr>
  <tr align="center">
    <td class="tableindex">ALUMNOS REPROBADOS DEL CURSO</td>
  </tr>
</table>
<table width="750" border="0" cellspacing="1" cellpadding="1">
  <tr bgcolor="#48d1cc">
    ...
    <td align="center" class="tablatit2-1">MOTIVO REPROBACION </td>
...
for($cont_paginas=0 ; $cont_paginas < $cont_alumnos  ; $cont_paginas++)
{
	...
	$tipo_reprova = $fila_promo['tipo_reprova'];
?>  
  <tr>
    ...
    <td align="center"><FONT face="arial, geneva, helvetica" size=1>
	  <select name="tipo_reproba_obj[<?php echo $cont_paginas; ?>]">
	  <option value="0" selected></option>
	  <option value="1"<? if($tipo_reprova == 1){?>selected<? }?>>Reprobado por Notas</option>
	  <option value="2"<? if($tipo_reprova == 2){?>selected<? }?>>Reprobado por Asistencia</option>	  	  
	  </select>
	</FONT></td>
    <td align="center"><input name="observacion_obj[<?php echo $cont_paginas; ?>]" type="text" value="<? echo trim($observacion) ?>" size="20" maxlength="100" >      </tr>
 <? }?>
</table>
