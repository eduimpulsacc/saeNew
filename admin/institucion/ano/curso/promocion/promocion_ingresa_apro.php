 ...
 <? 
	...
	for($cont_sub=0 ; $cont_sub < $cont_ramos ; $cont_sub++)
	{
		...
		if ($examen == 2){
			...
			echo " promedio --> ".$promedio_general_par;
			echo "... promedio2 -->".Promediar($promedio_general_par, $contador_general_par,$truncado_per);
			echo "aproxima final ".$truncado_per;
			    ...
			    if($nro_ano < 2008){
					...
					if ($_INSTIT==769 or $_INSTIT==24988){
						...
						if($promedio_bonificado > 70){
						 ...
						 echo "<br>".$promedio_general = $promedio_general + $promedio_bonificado;
    ...
    for($cont_sub=0 ; $cont_sub < $cont_ramos ; $cont_sub++){
		...
		for($b=0; $b<$cuenta_periodo; $b++){
			...
			if($modo_eval!=1){
				...
				//echo "total suma -->".$prom_gral."   contador--> ".$cont_subsector;
				if($truncado_per==1){
					$prom_parcial = round($prom_gral / $cont_subsector);
				}else{
		...
		/* $promedio_general_sum = $promedio_general_sum + $prom_final;
		 if($subsector!=13){
			 $contador_general_sum++;
		 }*/
