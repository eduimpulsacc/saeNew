...
if($funcion==lista_alumnos){
		  ...
		  $regis_2=pg_Exec($conn,$sql);
			  ...
			  ?>
             <div align="left"> <input name="Enviar" type="submit" class="botonxx" value="Imprimir"  />&nbsp;&nbsp;&nbsp;  <input name="Enviar" type="button" class="botonxx" value="Volver" onclick="location.href='../reportes/Menu_Reportes_new2.php'"  />
             </div><br />
...
$fecha_del=$fecha_ano.'-'.$fecha_mes.'-'.$fecha_dia;
	...
	<td width="250" align="left"><?=$fila['ape_pat'].' '.$fila['ape_mat'].' '.$nombre_alumno?>&nbsp;
