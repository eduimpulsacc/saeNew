...
<table width="100%">
	...
	if($funcion==21){
		...
		$result = $obj_familia->guarda_entrevista($rdb,$id_ano,$rut_alumno,$rut_apo,$fecha_ent,$asunto_ent,$contenido_ent,$tipo_entrevista,$id_asistencia,$acuerdo_ent,$observaciones);
		if($result){
		 echo 1;
		 }else{
		 echo 0;		 
...
<STYLE>
 ...
 font-size:11px;
  ...
  <tr>
    ...
    <td><?php echo $nombre_completo_apo ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php echo ($tipo_entrevista==1)?"Rendimiento":"Conducta"; ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="2">MOTIVO ENTREVISTA</td>
    <td><?php echo pg_result($rs_asunto,1); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
