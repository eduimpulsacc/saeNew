...
function modifica_familiar()
  {
	...
	var comuna_apo = $('#select_comunas_apo').val();
 ...
 $('#eva_destino :selected').map(function(){
	...
	var parametros='funcion='+funcion+'&rut_apo='+rut_apo+'&nombre_apo='+nombre_apo+'&ape_pat_apo='+ape_pat_apo+'&ape_mat_apo='+ape_mat_apo+'&fecha_nac_apo='+fecha_nac_apo+'&sexo_apo='+sexo_apo+'&nacionalidad_apo='+nacionalidad_apo+'&txt_calle_apo='+txt_calle_apo+'&txt_nro_apo='+txt_nro_apo+'&txt_block_apo='+txt_block_apo+'&txt_depto_apo='+txt_depto_apo+'&txt_villa_apo='+txt_villa_apo+'&txt_fono_apo='+txt_fono_apo+'&txt_celular_apo='+txt_celular_apo+'&txt_email_apo='+txt_email_apo+'&comuna_apo='+comuna_apo+'&txt_niv_edu_apo='+txt_niv_edu_apo+'&txt_ocupacion_apo='+txt_ocupacion_apo+'&txt_religion_apo='+txt_religion_apo+'&select_sistema_salud_apo='+select_sistema_salud_apo+'&relacion_apo='+relacion_apo+"&chk_apoderado="+chk_apoderado+"&chk_sostenedor="+chk_sostenedor+"&rut_alumno="+rut_alumno+"&txt_profesion_apo="+txt_profesion_apo+"&edad_primer_parto="+edad_primer_parto+"&ultimo_ano_aprobado="+ultimo_ano_aprobado+"&grup="+grup+"&estado_civil="+estado_civil+"&tipo_trabajo="+tipo_trabajo;
...
-->      </ul>
    ...
    <tr>
    <td class="cuadro02">Pa&iacute;s origen </td>
...
<input type="hidden" id="tipo_alum_emb" value="<?=$fila_matricula['bool_ae']?>" /></td>
    ...
    <tr>
      ...
      <td class="cuadro01"><input type="text" name="txt_eleccion" id="txt_eleccion" value="<?=$fila_matricula['txt_eleccion']?>" /></td>
      <td class="cuadro01"><input type="text" name="pasaporte" id="pasaporte" value="<? echo trim($fila['pasaporte'])?>" /></td>
    </tr>
    </table>
    <br />
    <table width="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 style="border-collapse:collapse"  >
...
<input type="hidden" id="hidden_retirosolo" value="<? echo $fila_matricula['bool_retirosolo'];?>" /></td>
   ...
   <br>
    <table width="100%" BORDER="1" CELLPADDING=0 CELLSPACING=0 style="border-collapse:collapse"  >
    <TR>
    <TD colspan="3"><div id="titulo" class="tableindex">AUTORIZACIONES</div>
    </TD>
    </TR>
    <TR  class="cuadro02">
      <TD>Cambiar de ropa en caso de ser necesario</TD>
      <TD >Tomar fotograf&iacute;as/videos en actividades escolares</TD>
      <TD>Compartir fotograf&iacute;as en Facebook Escuela</TD>
    </TR>
    <TR  class="cuadro01">
