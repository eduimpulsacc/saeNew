...
function insRow()
{
	...
	y.className="td2";
	y.id="td"+j;
	y.innerHTML="Codigo: <input name='codigo"+j+"' type='text' size='10' id='codigo"+j+"'> Descripción: <input name='descripcion"+j+"' size='65' type='text' id='descripcion"+j+"'><input type='hidden' name='total' value='"+j+"'> &nbsp; <a href=\"javascript:;\" onclick=\"delRow('"+j+"');\">elimina</a>"
								      ...
								      // no hacer nada
									   ...
									   ?> 
										<script>
											...
											y.className="td2";
											y.id="td"+j;
											y.innerHTML="Codigo: <input name='codigo"+j+"' type='text' size='10' id='codigo"+j+"' value='<?=$codigo ?>'> Descripción: <input name='descripcion"+j+"' size='65' type='text' id='descripcion"+j+"' value='<?=$detalle ?>'><input type='hidden' name='total' value='"+j+"'> &nbsp; <a href=\"javascript:;\" onclick=\"delRow('"+j+"');\">elimina</a>"
										</script>
										<?
									}	
									$i++;
