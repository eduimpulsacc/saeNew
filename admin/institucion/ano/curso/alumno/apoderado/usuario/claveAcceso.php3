...
require('../../../../../../../util/funciones_new.php'); 
	...
	$_POSP           =7;
	$dinamico = $_GET['cram'];//recibo variable que identificara menu docente
	$_MDINAMICO      = $dinamico;
	
	// REGISTRO DE HISTORIAL DE NAVEGACION
	registrarnavegacion($_USUARIO,'CLAVE ACCESO',1,0,$_SERVER[REMOTE_ADDR], 
	pg_dbname($conn),ObtenerNavegador($_SERVER['HTTP_USER_AGENT']),$_INSTIT,$_NOMBREUSUARIO,$_CURSO,$conn);
	//******************************************************//
                ...
                <td height="83" colspan="3"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="27%" height="363" align="left" valign="top"> 
                        <? $menu_lateral=1; include("../../../../../../../menus/menu_lateral.php"); ?></td>
