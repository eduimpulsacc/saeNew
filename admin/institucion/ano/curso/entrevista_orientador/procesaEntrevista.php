...
if($accion==1){//insertar
  ...
  $sql_ins = "insert into entrevista_orientador (id_ano, id_curso,rut_emp,rut_entrevistado,fecha,tipo,observaciones, acuerdos)
...
elseif($accion==2){//modificar
	 ...
	 $sql_up="update entrevista_orientador set fecha = '".CambioFecha($fecha_entrevista)."' , observaciones='$observaciones', acuerdos='$acuerdos'
...
elseif($accion==3){//eliminar
 $sql_del = "delete from entrevista_orientador where id_entrevista = ".$id_entrevista;
