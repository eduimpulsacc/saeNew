	...
	// return true;
		...
		$.ajax({
				...
				data:"accion=1"
					 ...
					 +"&empleado="+<?php echo ($empleado!='admin')?$empleado:0; ?>,
				type:'POST',
				success:function(data){
					//console.log(data);
					//$('#lista').html(date);
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2" align="center" class="tableindex">&nbsp;Listado de Entrevistas Oientador</td>
    </tr>
  <tr>
  ...
  <tr class="cuadro01">
    ...
    <td width="88%"><form id="combo"><select name="c_curso"  class="ddlb_9_x" id="c_curso">
  ...
  <tr class="cuadro01">
    ...
    <td><label for="fecha_en1"></label>
      <input name="fecha_en1" type="text" id="fecha_en1" readonly></td>
  </tr>
    ...
    <?php if($perfil==0 || $perfil==14 || $perfil == 21 ||  $perfil == 25 || $perfil == 20){  ?>
    <tr class="cuadro01">
