	    ...
	    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
           ...
           <td align="center" width="97" class="item" bgcolor="#666666"><div align="center">%</div></td>
			...
			for($i=0 ; $i < @pg_numrows($result) ; $i++){
			   ...
			   <td align="left" class="subitem" ><font  color="#000000"><?php echo $ob_reporte->tilde(ucfirst(strtolower($fila["ape_pat"]))." ".ucfirst(strtolower($fila["ape_mat"])).", ".ucfirst(strtolower($fila["nombre_alu"])));?></font></td>
			   <? if($cb_ok== "Buscar"){?>
