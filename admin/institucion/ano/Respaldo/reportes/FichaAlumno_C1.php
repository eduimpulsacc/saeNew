...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'FichaAlumno_C.php?institucion=$institucion';
		form.submit(true);
	}	
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="589" align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="833" height="722" align="left" valign="top" background="../../../../<?=$_IMAGEN_IZQUIERDA?>">&nbsp;</td>
                              ...
                              <table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                                <tr> 
                                  <td>
								     ...
								     <!-- COPIO LOS BOTONES PARA QUE NO ESTÉN SEPARADOS --><!-- FIN DE COPIA DE BOTONES -->
<!-- AQUÍ EL CONTENIDO CENTRAL DE LA PÁGINA --><br>

	   
<form method "post" action="printFichaAlumno_C.php" name="form" target="_blank">
  <div align="left">
  ...
  ?>
    ...
    <?      }
		...
		?>
                    ...
                    <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" onClick="MM_goToURL('parent','FichaAlumno.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">                    </td>
        </tr>
                </table>	</td>
      </tr>
          </table>	</td>
