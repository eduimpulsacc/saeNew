...
if ($alumno==0)
    ...
    for($cont_paginas=0 ; $cont_paginas < $cont_alumnos ; $cont_paginas++){
       ...
       if (($fila['ensenanza']>109 and $fila['ensenanza']<310) or ($fila['ensenanza']>300 and $fila['grado_curso']<5)){  ?>
			 <table width="650" border="0" cellpadding="0" cellspacing="0">
			   <tr>
				<td>
...
/// AQUI INFORME PARA LA ENSEÁNZA MEDIA Y GRADO = 2  SE SACA MOMENTANEAMENTE

//// CODIGO ELIMINADO PARA LA ENSEÁNZA MEDIA  //////


   /// para los que no llevan colilla
	if ($cont_alumnos > 1){
