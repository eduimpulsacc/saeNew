...
<SCRIPT language="JavaScript">
	function enviapag2(form){
				...
				document.form.action='printInformeGraficoTipoEnsenanza_C.php?cmb_periodos='+periodo;
				document.form.submit(true);
	}
	function enviapag(form){
		form.action = 'InformeGraficoTipoEnsenanza.php?institucion=$institucion';
		form.submit(true);
    }
...
<form method "post" action="printInformeGraficoTipoEnsenanza_C3.php" target="_blank" name="form">
<!--<form method "post" action="printInformeGraficoTipoEnsenanza_C.php" target="_blank" name="form">-->
...
<table width="80%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
		...
		<? if($_PERFIL==0){?>
        <td width="55"><input type="button" name="cb_exp" value="Exportar" onClick="enviapag2(this.form)"  class="botonXX"></td>
