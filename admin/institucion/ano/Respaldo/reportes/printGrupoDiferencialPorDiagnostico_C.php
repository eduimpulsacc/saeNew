...
function enviapag2(form){
	form.target="_blank";
	document.form.action='printGrupoDiferencialPorDiagnostico_C.php?cmbGRUPO=<?=$cmbGRUPO?>&cmbDIGNOSTICO=<?=$cmbDIGNOSTICO;?>&c_reporte=<?=$reporte?>&exportar=1';
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" class="tableindex">FICHA GRUPO DIFERENCIAL POR DIAGN&Oacute;STICO </td>
  </tr>
  <tr>
