...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'motor_ficha_alumno.php?institucion=$institucion';
				form.submit(true);
...
?>
 ...
 <? if  (($cantidad_alumnos - $i)<>1) 
   ...
   <!-- AQUÍ COPIO EL CONTENIDO DEL FRAME DE BUSQUEDA -->
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'mainFrame\']','FichaAlumno.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
   ...
   <!-- FIN DE COPIA DE CONTENIDO DE FRAME DE BUSQUEDA -->
   
   
     <!-- FIN DE NUEVO CODIGO INSERTADO -->
