		...
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<tr>
				<td colspan=2 align=right>
					<INPUT TYPE="button" value="VOLVER" onClick=document.location="observacionesPorAlumno1.php3">
				</td>
			</tr>
			...
			?>
						<tr bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent' onClick=go('observacionesAlumno.php3?alumno=<?php echo $fila["rut_alumno"];?>&curso=<?php echo $curso;?>')>
							<td align="right" >
								<font face="arial, geneva, helvetica" size="1" color="#000000">
