...
<SCRIPT language="JavaScript">
			...
			if (document.form.cmb_curso.value!=0){		
				...
				document.form.action = "FichaMatriculaPostulacion.php";
...
<form name="form" method "post" action="printFichaMatriculaPostulacion_C.php" target="_blank">
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="80" class="cuadro01"><div align="center">
