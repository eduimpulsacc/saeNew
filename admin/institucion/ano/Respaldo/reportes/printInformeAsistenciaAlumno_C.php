    ...
    <td><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <?php
		...
		for($i=0 ; $i < @pg_numrows($result) ; $i++){
			...
			$DiasAsistencia = $DiasHabiles - $cuenta_inasis;
			if($DiasAsistencia!=0){
...
<table width="650" border="0" align="center">
	...
	$ob_reporte->Firmas($conn);?>
		<td width="25%" class="item" height="100"><div align="center">________________________________<br>       <?=$ob_reporte->nombre_emp;?><br><?=$ob_reporte->nombre_cargo;?></div>
		</td>
	<? } ?>
	...
	$ob_reporte->rdb=$institucion;
	$ob_reporte->Firmas($conn);?>
		<td width="25%" class="item"> <div align="center">________________________________<br><?=$ob_reporte->nombre_emp;?><br><?=$ob_reporte->nombre_cargo;?></div>
		</td>
	<? } ?>
