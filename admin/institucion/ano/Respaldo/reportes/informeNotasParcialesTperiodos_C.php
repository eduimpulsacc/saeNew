...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'informeNotasParcialesTperiodos_C.php';
		form.submit(true);
	}	
}
...
function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'printInformeNotasParcialesNewTperiodos_C.php?xls=1';
...
<? //if($_PERFIL==0 && $institucion==25114){?>
	<form method "post" action="printInformeNotasParcialesNewTperiodos_C.php" name="form" target="_blank">
<? //}else{ ?>
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<table width="" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="98" class="textosimple">&nbsp;</td> <!--ANTIGUO SELECC PENDIENTES-->
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
