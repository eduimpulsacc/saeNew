...
<table width="650" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="right">
	  <div id="capa0">
	    <input name="button3" TYPE="button" class="botonXX" onClick="MM_openBrWindow('printNotasParciales_3y4_extre.php?c_curso=<?=$c_curso ?>&c_alumno=<?=$c_alumno ?>&c_periodos=<?=$c_periodos ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
	  </div>
    </div></td>
  </tr>
</table>
<?
	...
	///////////////// para rescatar al profesor jefe /////////////////
    ...
    ///// finc codigo para profesor jefe /////////////
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" class="tableindex"><div align="center"><strong>INFORME  DE NOTAS </strong></div></td>
      </tr>
      <tr>
...
//		  $sql2 = $sql2 . "WHERE (((ramo.id_curso)=".$curso.")); ";
		  ...
		  <?
	        ...
	        for($per=0 ; $per < @pg_numrows($resultPer) ; $per++)
			{
				...
				$sql_peri22 = "select promedio from notas$nro_ano where rut_alumno = '".$alumno."' and id_periodo = '".$periodos."' AND id_ramo=".$id_ramo."";
				...
				*/
				...
				$result_peri22 =@pg_Exec($conn,$sql_peri22);
				if (pg_numrows($result_peri22)>0){
					$fila_peri = @pg_fetch_array($result_peri22,0);
...
<!--  taller -->
<?
		  $sql2 = "SELECT t.* FROM taller as t INNER JOIN tiene_taller as tt ON t.id_taller=tt.id_taller WHERE rut_alumno=".$alumno." and id_ano=".$ano." ";
          $result =@pg_Exec($conn,$sql2);
		  if (!$result) 
		  {
			  error('<B> ERROR :</b>Error al acceder a la BD. (SUBSECTOR)</B>');
...
<!-- fin taller -->
		...
		<table width="650" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<? if($institucion!=25218) { ?><td width="172"><font size="1" face="Arial, Helvetica, sans-serif"><? if ($_INSTIT==770){ ?> &nbsp; <? }else{ ?><strong>TOTAL DIAS INASISTENTES</strong><? } ?></font></td>
		    ...
		    <td><div align="left"><font size="1"><strong><font size="2"><strong><font face="Verdana, Arial, Helvetica, sans-seri">________________________________________________________________________</font></strong></font><font face="Arial, Helvetica, sans-serif"></font></strong></font></div></td>
		        ...
		        <table width="650" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="1"><?=$cargo_dir2 ?> Establecimiento
                  </tr>
                  <tr>
...
<table width="53%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr class="cuadro01">
    <td width="39" class="cuadro01">Curso</td>
    <td width="123">
	  <div align="left"> 
    ...
    <td width="51" class="cuadro01">Periodo</td>
	...
	<? if ($institucion!=25218) {?>
      <input name="cb_ok" type="button" class="botonXX"  onClick="MM_goToURL('parent','NotasParciales_3y4_extre.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&c_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&cmb_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&cmb_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value);return document.MM_returnValue" value="Buscar">
     <? }else { ?>
      <input name="cb_ok" type="button" class="botonXX"  onClick="MM_goToURL('parent','NotasParciales_3y4_extre.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&c_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&cmb_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&cmb_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value);return document.MM_returnValue" value="Buscar">
	<? }?>	</div>
<!--    <td width="199"><div align="right">
