...
function enviapag2(form){
	form.target="_blank";
	document.form.action='printProyectoIntegracionPorColegio_C.php?cmbPROYECTO=<?=$cmbPROYECTO?>&c_reporte=<?=$reporte?>&exportar=1';
...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" class="tableindex" >FICHA PROYECTO DE INTEGRACI&Oacute;N POR ESTABLECIMIENTOS </td>
  </tr>
  <tr>
