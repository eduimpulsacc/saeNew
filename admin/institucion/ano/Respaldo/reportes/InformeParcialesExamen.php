...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" class="tableindex"><div align="center">INFORME  DE NOTAS (uno) </div></td>
      </tr>
...
<?
      ...
      <tr>
        <td height="20"  class="tableindex"><div align="center">INFORME  DE NOTAS (dos) </div></td>
      </tr>
	   <?
	  if ($institucion==770){
	      ?>
...
<input name="" type="button" value="Nueva B&uacute;squeda"  class="botonXX" onClick="window.location='NotasParciales_Examen.php?flag=0'">
