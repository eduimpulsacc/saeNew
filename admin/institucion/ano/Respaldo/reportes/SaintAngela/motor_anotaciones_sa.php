...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'motor_anotaciones_sa.php?institucion=$institucion';
				form.submit(true);
