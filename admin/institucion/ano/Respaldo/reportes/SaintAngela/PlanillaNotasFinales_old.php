...
<table width="650" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="#003b85">
    	<td ><div align="center"><strong><font color="White" size="3" face="arial, geneva, helvetica">PLANILLA DE NOTAS FINALES </font></strong></div></td>
	</tr>
	<tr>
...
<br>
  ...
  <tr  bgcolor="#003b85">
    <td rowspan="2" width="20"><font size="2" face="arial, geneva, helvetica" color="#FFFFFF"><strong>Nº</strong></font></td>
	<td width="170" rowspan="2" ><font size="2" face="arial, geneva, helvetica" color="#FFFFFF"><strong>NOMBRE DEL ALUMNO </strong></font></td>
    <td colspan="<? echo $num_subsectores+1 ?>"><div align="center"><font size="2" face="arial, geneva, helvetica" color="#FFFFFF"><strong>SUBSECTORES</strong></font></div></td>
    </tr>
  <tr>
    <?
	$siglas="";
