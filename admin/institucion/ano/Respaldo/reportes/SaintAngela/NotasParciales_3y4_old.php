...
for($cont_paginas=0 ; $cont_paginas < $cont_alumnos ; $cont_paginas++)
{
	...
	if ($fila['ensenanza']==110 and $fila['grado_curso']>4 and $fila['grado_curso']<7)	
		$coordinador = "Marcela Cardemil Bañados";
		
	if ($fila['ensenanza']==110 and $fila['grado_curso']>6 and $fila['grado_curso']<9)	
		$coordinador = "Marcelo Meza Gotor";
		        ...
		        <table width="650" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="2">Profesor(a) 
                        Jefe </font></div></td>
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="2">Director de Ciclo </font></div></td>
                  </tr>
                  <tr> 
...
<!--            <td width="67"><div align="center"><font size="1"><strong><font face="Arial, Helvetica, sans-serif">-->
			<? 
/*			if ($promedio > 0) 
			{
				echo $promedio = round($promedio / $cont_prom,0);
