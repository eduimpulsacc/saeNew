...
function enviapag2(form){
	...
	if (form.cmb_ano.value!="0"){		
		pag="../../seteaAno.php3?caso=10&pa=29&ano="+ano2
		form.action = pag; 
		form.target="_self";
		form.submit(true);		
	}		
...
with (form){
	...
	if (form.cmbCURSO.value=="0"){		
	  ...
	  form.target="_blank";
	  form.action = 'printCantidadAprobadosyReprobadosCursoporSubsector.php';
	  form.submit(true);
	}		
 }
...
<form name="form"   action="printCantidadAprobadosyReprobadosCursoporSubsector.php" method="post">
    ...
    <td height="27"><table width="100%" border="1">
      ...
      <tr>
        ...
        <td>
		  ...
		  <select name="cmbCURSO" class="ddlb_x" >
