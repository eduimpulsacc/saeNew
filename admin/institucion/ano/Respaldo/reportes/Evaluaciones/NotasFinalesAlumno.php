...
<form name="form"   action="printNotasFinalesAlumno.php" method="post">
  ...
  <tr>
    <td height="27"><table width="100%" border="1">
      ...
      <tr>
		...
		<select name="cmbCURSO" class="ddlb_x" onChange="window.location='NotasFinalesAlumno.php?cmbCURSO='+this.value;" >
