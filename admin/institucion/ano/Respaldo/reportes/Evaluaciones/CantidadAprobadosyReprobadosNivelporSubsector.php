...
function enviapag2(form){
	...
	if (form.cmb_ano.value!="0"){		
		pag="../../seteaAno.php3?caso=10&pa=28&ano="+ano2
		form.action = pag; 
		form.target="_self";
		form.submit(true);
	}		
...
with (form){
	...
	if (form.cmbNIVEL.value=="0"){		
	  ...
	  form.target="_blank";
	  form.action = 'printCantidadAprobadosyReprobadosNivelporSubsector.php';
	  form.submit(true);
	}		
 }
...
<form name="form"   action="printCantidadAprobadosyReprobadosNivelporSubsector.php" method="post">
