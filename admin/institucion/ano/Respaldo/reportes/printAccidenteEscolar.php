  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="16%"><div align="right"><img src="../../../../logo_gob.png" width="179" height="76" border="0"/></div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="35%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr class="Estilo1">
            <td height="18">Particular Subencionado </td>
            <td>= 3 </td>
            <td>&nbsp;</td>
          </tr>
      ...
      <tr>
        <td colspan="3"><span class="Estilo2">A. INDIVIDUALIZACI&Oacute;N DEL ESTABLECIMIENTO </span></td>
        </tr>
      <tr>
        <td colspan="3">&nbsp;</td>
        </tr>
      <tr>
        <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><span class="Estilo1"><?=$ob_institucion->ins_pal;?><br />__________________________________________<br />
...
___________________<br />
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          <tr>
          ...
          <tr>
            ...
            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="0">
              ...
              <tr>
                ...
                <td height="50" class="Estilo1"><div align="center">__________________________<br />
                  NOMBRE-APELLIDO</div></td>
                <td class="Estilo1"><div align="center">___________________<br />
                  C.NAC.ID.</div></td>
              </tr>
              <tr>
      ...
      <tr>
        <td colspan="3"><table width="100%" border="0" cellspacing="3" cellpadding="0">
          <tr>
            ...
            <td width="27%" class="Estilo1">&nbsp;</td>
          </tr>
          <tr>
            <td class="Estilo1">________________________________________________________________________</td>
            <td class="Estilo1">_________________</td>
          </tr>
          <tr>
            <td class="Estilo1">________________________________________________________________________</td>
            <td class="Estilo1">FIRMA Y TIMBRE </td>
          </tr>
          <tr>
            <td class="Estilo1">________________________________________________________________________</td>
            <td class="Estilo1">RECTOR O REPRESENTANTE </td>
          </tr>
        </table></td>
        </tr>
      <tr>
  ...
  <tr>
    <td><table width="100%" border="1" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td rowspan="2" class="Estilo1" valign="top"><img src="../../../../img_reporte.jpg"  width="30" height="250"/></td>
