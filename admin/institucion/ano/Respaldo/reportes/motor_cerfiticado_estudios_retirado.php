...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'motor_cerfiticado_estudios_retirado.php?institucion=$institucion';
				form.submit(true);
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="219"><select name="cmb_alumno" class="ddlb_9_x">
      ...
      <?
		$sql="select matricula.rut_alumno, alumno.ape_pat, alumno.ape_mat,  alumno.nombre_alu from matricula, alumno where id_curso = ".$cmb_curso. " and matricula.rut_alumno = alumno.rut_alumno and matricula.bool_ar = 1 order by ape_pat, ape_mat, nombre_alu";
    ...
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'mainFrame\']','CertificadoEstudiosRetirado.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
