                         ...
                         <table width="100%" height="43" border="1" cellpadding="0" cellspacing="0">
						  ...
						  <table width="100%" border="0" cellspacing="5" cellpadding="0">
							<tr>
							  ...
							  <td colspan="3"><input name="rdOPCION"  id="rdOPCION" type="radio" value="1" checked onClick="busqueda(this.form);">
							    Periodo
							...
							<tr>
							  ...
							  <td width="73"><input type="submit" name="cb_ok" id="cb_ok" value="Buscar" class="botonXX"></td>
							  <? if($_PERFIL == 0){?>
