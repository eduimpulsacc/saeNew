					   ...
					   <td>
						   <table align="center">
							   <tr><td class="subitem"><?=$ob_membrete->ins_pal;?></td></tr>
								...
								<tr><td class="subitem">Fono: <?=$ob_membrete->telefono;?> - Fax: <?=$ob_membrete->fax;?></td></tr>
						   </table>
						</td>
					</tr>
				</table>
		...
		<td>
			<table width="440" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td class="subitem">Periodo</td>	
					<td class="subitem">RBD</td>										
				</tr>
				<tr>
					<td class="subitem">&nbsp;<?=$ob_membrete->nro_ano;?></td>
					<td class="subitem"><?=$ob_membrete->nombre_periodo;?></td>
					<td class="subitem"><?php echo $institucion."-".$ob_membrete->dig_rdb;?></td>										
				</tr>
				<tr><td colspan="3">&nbsp;</td></tr>
				<tr>
					<td colspan="2" class="subitem">&nbsp;Nombre Alumno(a)</td>
					<td class="subitem">Curso</td>
				</tr>												
				<tr>
					<td colspan="2" class="subitem">&nbsp;<?php echo $ob_reporte->nombres;?></td>
					<td class="subitem"><?php echo $ob_membrete->grado_curso." - ".$ob_membrete->letra_curso." ".$ob_membrete->ensenanza;?></td>										
				</tr>																
			</table>
		</td>		
	</tr>
...
<?					if ($nuevo_sis==1){  ?>
					<table width="630" align="center"><tr><td>
						<table width="630" align="center" border="1" cellpadding="<?=$txtFILAS;?>" cellspacing="0">
						<?
						$contador=0;
						...
						for ($i=0;$i<$num_cat;$i++){
							...
							<tr>
							  <td colspan="2"  class="item"><? echo $row_cat['glosa'];?></td>
							</tr>
                        <? 	$ob_informe->id_padre=$row_cat[id];
							...
							for ($j=0;$j<$num_sub;$j++){
								...
								<tr class="tabla04">
									<td><span class="subitem"><img src="../../../../../cortes/p.gif" width="10" height="1" border="0">
									...
									<?	for ($z=0;$z<$num_item;$z++){
											...
											<tr>
												<td class="subitem"><img src="../../../../../cortes/p.gif" width="20" height="8" border="0"><? echo $row_item['glosa'];?></td>
												<td width="1%" nowrap class="subitem">
												<?	$ob_informe->ano=$ano;
													$ob_informe->nuevo=1;
													$ob_informe->periodo=$periodo;
