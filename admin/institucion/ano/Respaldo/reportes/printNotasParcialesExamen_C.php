		...
		<?
		 ...
		 // echo @pg_numrows($result1);
		  ...
		  <tr>
			...
			$tot_periodo = 1;
			?>
            <td align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong>1º<? echo $tipo_per."<br>70%"; ?></strong></font></td>
			<?	}		}
			$tri = 2;
...
<? } ?>
  ...
  <tr>
    <td class="subitem"><font size="1"><strong><font face="Arial, Helvetica, sans-serif"><? echo "**La nota promedio del semestre corresponde a la suma del 70% del promedio de 
notas parciales y el 30% de notas de la prueba solemne ";?></font></strong></font></td>
  </tr>
</table>
      ...
      <tr>
		...
		<?
		  ...
		  <tr>
            <td width="231" align="left">
			  <div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong>Subsector del Aprendizaje (Formaci&oacute;n General ) </strong></font></div></td>
            <td colspan="20" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif">NOTAS 2   </font></strong></td>
			<?
			...
			if($p1==$periodo){
			if((trim($fila1['nombre_periodo'])=="PRIMER TRIMESTRE") OR (trim($fila1['nombre_periodo'])=="SEGUNDO TRIMESTRE") OR (trim($fila1['nombre_periodo'])=="TERCER TRIMESTRE") OR (trim($fila1['nombre_periodo'])=="PRIMER SEMESTRE") OR (trim($fila1['nombre_periodo'])=="SEGUNDO SEMESTRE") OR ($chk_periodo==1)){			
			$tot_periodo = 1;
			?>
            <td align="center"><font size="1" face="Arial, Helvetica, sans-serif"><strong>1º<? echo $tipo_per."<br>70%"; ?></strong></font></td>
			<?	}	}	
