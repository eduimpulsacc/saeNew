    ...
    <tr>
      <td><table width="61%" border="0">
        ...
        <table width="100%" border="0">
          ...
          <td align="right">
		  	<input type="button" name="Button" value="IMPRIMIR" onClick=document.location="asistenciaCursoIMP.php3?curso=<?php echo $curso ?>"> 
            <input type="button" name="Submit3" value="VOLVER" onClick=document.location="asistenciaPorCurso1.php3"></td>
          </tr>
        </table>
