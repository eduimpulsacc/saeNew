...
<SCRIPT language="JavaScript">
		function enviapag2(form){
						...
						document.form.action='printInformeRendimiento_C.php?cmb_periodos='+periodo+'&cmb_curso='+curso;
...
<form method "post" action="printInformeRendimiento.php" target="_blank" name="form">
