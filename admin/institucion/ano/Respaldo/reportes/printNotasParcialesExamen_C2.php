...
<?
	if (empty($alumno))
		$sql_alu = "select * from matricula$nro_ano, alumno where id_curso =".$curso." and matricula$nro_ano.rut_alumno = alumno.rut_alumno order by alumno.ape_pat, alumno.ape_mat";
	else
		$sql_alu = "select * from matricula$nro_ano where rut_alumno ='".$alumno."' and id_ano = ".$ano;
		  ...
		  <?
			...
			$result2 =@pg_Exec($conn,$sql3);
		  	if (!$result2) 
		  	{
				...
				if(!$tipo_eval==0){
				/////////////////////////PORCENTAJES//////////////
					$sql_pocentaje = "SELECT pos21 FROM nota_porcentaje2009 WHERE id_periodo=".$periodo." AND id_ramo=".$id_ramo;
			...
			?>
            <td height="25"><div align="left"><font size="1" face="Arial, Helvetica, sans-serif"><? echo $fila['nombre']."(".$pos21.")"; ?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos1=porcentaje($periodo,$id_ramo,'pos1',$nota1,$conn); }else{ if($nota1<40 && $nota1>0){ ?><strong><font color="#FF0000"><? echo $nota1 ?></font><? } else { echo $nota1; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos2=porcentaje($periodo,$id_ramo,'pos2',$nota2,$conn); }else{ if($nota2<40 && $nota2>0){ ?><strong><font color="#FF0000"><? echo $nota2 ?></font><? } else { echo $nota2; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos3=porcentaje($periodo,$id_ramo,'pos3',$nota3,$conn); }else{ if($nota3<40 && $nota3>0){ ?><strong><font color="#FF0000"><? echo $nota3 ?></font><? } else { echo $nota3; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos4=porcentaje($periodo,$id_ramo,'pos4',$nota4,$conn); }else{ if($nota4<40 && $nota4>0){ ?><strong><font color="#FF0000"><? echo $nota4 ?></font><? } else { echo $nota4; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos5=porcentaje($periodo,$id_ramo,'pos5',$nota5,$conn); }else{ if($nota5<40 && $nota5>0){ ?><strong><font color="#FF0000"><? echo $nota5 ?></font><? } else { echo $nota5; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos6=porcentaje($periodo,$id_ramo,'pos6',$nota6,$conn); }else{ if($nota6<40 && $nota6>0){ ?><strong><font color="#FF0000"><? echo $nota6 ?></font><? } else { echo $nota6; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos7=porcentaje($periodo,$id_ramo,'pos7',$nota7,$conn); }else{ if($nota7<40 && $nota7>0){ ?><strong><font color="#FF0000"><? echo $nota7 ?></font><? } else { echo $nota7; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos8=porcentaje($periodo,$id_ramo,'pos8',$nota8,$conn); }else{ if($nota8<40 && $nota8>0){ ?><strong><font color="#FF0000"><? echo $nota8 ?></font><? } else { echo $nota8; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos9=porcentaje($periodo,$id_ramo,'pos9',$nota9,$conn); }else{ if($nota9<40 && $nota9>0){ ?><strong><font color="#FF0000"><? echo $nota9 ?></font><? } else { echo $nota9; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos10=porcentaje($periodo,$id_ramo,'pos10',$nota10,$conn); }else{ if($nota10<40 && $nota10>0){ ?><strong><font color="#FF0000"><? echo $nota10 ?></font><? } else { echo $nota10; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos11=porcentaje($periodo,$id_ramo,'pos11',$nota11,$conn); }else{ if($nota11<40 && $nota11>0){ ?><strong><font color="#FF0000"><? echo $nota11 ?></font><? } else { echo $nota11; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos12=porcentaje($periodo,$id_ramo,'pos12',$nota12,$conn); }else{ if($nota12<40 && $nota12>0){ ?><strong><font color="#FF0000"><? echo $nota12 ?></font><? } else { echo $nota12; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos13=porcentaje($periodo,$id_ramo,'pos13',$nota13,$conn); }else{ if($nota13<40 && $nota13>0){ ?><strong><font color="#FF0000"><? echo $nota13 ?></font><? } else { echo $nota13; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos14=porcentaje($periodo,$id_ramo,'pos14',$nota14,$conn); }else{ if($nota14<40 && $nota14>0){ ?><strong><font color="#FF0000"><? echo $nota14 ?></font><? } else { echo $nota14; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos15=porcentaje($periodo,$id_ramo,'pos15',$nota15,$conn); }else{ if($nota15<40 && $nota15>0){ ?><strong><font color="#FF0000"><? echo $nota15 ?></font><? } else { echo $nota15; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos16=porcentaje($periodo,$id_ramo,'pos16',$nota16,$conn); }else{ if($nota16<40 && $nota16>0){ ?><strong><font color="#FF0000"><? echo $nota16 ?></font><? } else { echo $nota16; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos17=porcentaje($periodo,$id_ramo,'pos17',$nota17,$conn); }else{ if($nota17<40 && $nota17>0){ ?><strong><font color="#FF0000"><? echo $nota17 ?></font><? } else { echo $nota17; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos18=porcentaje($periodo,$id_ramo,'pos18',$nota18,$conn); }else{ if($nota18<40 && $nota18>0){ ?><strong><font color="#FF0000"><? echo $nota18 ?></font><? } else { echo $nota18; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos19=porcentaje($periodo,$id_ramo,'pos19',$nota19,$conn); }else{ if($nota19<40 && $nota19>0){ ?><strong><font color="#FF0000"><? echo $nota19 ?></font><? } else { echo $nota19; } }?></font></div></td>
			<td width="17"><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if($pos21=="100"){	echo $pos20=porcentaje($periodo,$id_ramo,'pos20',$nota20,$conn); }else{ if($nota20<40 && $nota20>0){ ?><strong><font color="#FF0000"><? echo $nota20 ?></font><? } else { echo $nota20; } }?></font></div></td>
			<? 			
			if($pos21=="100"){
				$prome = $pos1+$pos2+$pos3+$pos4+$pos5+$pos6+$pos7+$pos8+$pos9+$pos10+$pos11+$pos12+$pos13+$pos14+$pos15+$pos16+$pos17+$pos18+$pos19+$pos20;
			}else{
...
$promedio_periodo_aux = 0;				
				...
				/*	if($prome_abajo<40 && $prome_abajo>0){ ?><strong><font color="#FF0000"><? 
					...
					$prome_periodo = ($prom_per / $cuenta_semestral);
					echo round($prome_periodo);
					//echo $prom_per;
					//echo "(".$cuenta_semestral.")"?></font></td>								
				<?
			}
...
<? } ?>	
 ...
 <? if ($_INSTIT==9239){
	...
	if ($_INSTIT==9239) { 
		...
		echo  "Paz Alejandra González Vargas ";
		
		
		} 
		
		if ($gradino==310){
		echo  " María Irene Araus Vilches";
...
<? if(($institucion!="770") and ($institucion!="11209" ) and ($institucion!="14629") and ($institucion!="25269")){	?>  	
