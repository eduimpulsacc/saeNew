...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'FichaAlumnoajax.php?institucion=$institucion';
				form.submit(true);
...
function generacursos()
{

	echo $consulta="SELECT rut_alumno, nombre_alumno  FROM alumno ";
	

	// Voy imprimiendo el primer select compuesto por los paises
	echo "<select name='paises' rut_alumno='paises' onChange='cargaContenido(this.id)'>";
...
<body>
			...
			<div id="demo" style="width:600px;">
				...
				<div id="demoIzq"><?php generacursos(); ?></div>
			</div>
...
if ($curso != 0){
  ...
  <tr>
    <td><div id="capa0">
		<div align="right">
		  <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printFichaAlumnoajax.php?c_curso=<?=$c_curso?>&c_alumno=<?=$c_alumno ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
		</div>
      </div></td>
  </tr>
</table><br>
  ...
  <tr>
    ...
    Alumno<br>
      <select name="cmb_alumno" class="ddlb_9_x">
        ...
        <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" onClick="MM_goToURL('parent','FichaAlumnoajax.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">
	</td>
    </tr>
</table>
