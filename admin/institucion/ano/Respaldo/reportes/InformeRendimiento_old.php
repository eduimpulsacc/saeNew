...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr bgcolor="#003b85">
    <td bgcolor="#003b85" colspan=3><div align="center" class="Estilo1"><font face="Arial, Helvetica, sans-serif" color="#FFFFFF"><strong>INFORME RENDIMIENTO ESCOLAR POR CURSO</strong></font></div></td>
    </tr>
  <tr>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? if ($con_gen>0)echo round($cont_por1/$e,0)."%"; else echo "0%"?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $cont_gen2?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? if ($con_gen>0)echo round($cont_por2/$e,0)."%"; else echo "0%"?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $cont_gen3?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? if ($con_gen>0)echo round($cont_por3/$e,0)."%"; else echo "0%"?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $cont_gen4?></font></div></td>
    <td width="29"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? if ($con_gen>0)echo round($cont_por4/$e,0)."%"; else echo "0%"?></font></div></td>
  </tr>
</table>
