<?	require('../../../../util/header.inc');
	...
	$ob_reporte ->ano =$ano;
	$ob_reporte ->cargo=5;
	$rs_empleado = $ob_reporte->DotacionDocente($conn);
...
<table width="100%" border="1" cellpadding="5" cellspacing="0">
  <tr>
    <td colspan="11" class="item">DOCENTES</td>
  </tr>
  <tr>
    ...
    <td class="item">HORAS<br />
      AMPLIACI&Oacute;N<br />
      JEC</td>
    <td class="item">TOTAL<br />
      HORAS<br />
      AULA</td>
    <td class="item">HORAS<br />
    EXCEDENTES</td>
    <td class="item">CARGO /<br />
    ASIGNATURA / <br />
    ESPECIALIDAD </td>
    <td class="item">OBSERVACI&Oacute;N</td>
  </tr>
  ...
  <tr>
    ...
    <td class="subitem"><div align="left"><?=$ob_reporte->tilde($fila_emp['nombre']);?></div></td>
    <td class="subitem"><?=$fila_emp['hrs_contrato'];?></td>
    <td class="subitem"><?=$fila_emp['art_69'];?></td>
    <td class="subitem"><?=$fila_emp['amp_simple'];?></td>
    <td class="subitem"><?=$fila_emp['amp_jec'];?></td>
    <td class="subitem"><?=$fila_emp['total_aula'];?></td>
    <td class="subitem"><?=$fila_emp['hrs_excedente'];?></td>
    <td class="subitem"><?=$fila_emp['cargo_asig'];?></td>
    <td class="subitem"><?=$fila_emp['obs'];?></td>
  </tr>
  <? 
  	$total_contrato = $total_contrato + $fila_emp['hrs_contrato'];
	$total69 = $total69 + $fila_emp['art_69'];
	$totalsimple = $totalsimple  + $fila_emp['amp_simple'];
	$totaljec = $totaljec  + $fila_emp['amp_jec'];
	$total_aula =$total_aula  + $fila_emp['total_aula'];
	$total_exdec = $total_exdec  + $fila_emp['hrs_excedente'];
  ...
  <tr>
    ...
    <td class="item"><?=$total69;?></td>
    <td class="item"><?=$totalsimple;?></td>
    <td class="item"><?=$totaljec;?>;</td>
    <td class="item"><?=$total_aula;?></td>
    <td class="item"><?=$total_exdec;?></td>
