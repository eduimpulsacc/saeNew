<SCRIPT language="JavaScript">
	...
	if (form.cmb_curso.value!=0){
		...
		form.action = 'InformeEntrevistas.php?institucion=$institucion';
		form.submit(true);
                            ...
                            <br>
                              <table width="650" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><div id="capa0">
                                      <div align="right">
                                        <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printInformeEntrevistas.php?c_curso=<?=$c_curso?>&c_alumno=<?=$c_alumno ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
                                      </div>
                                  </div></td>
                                </tr>
                              </table>
...
?>
	...
	if 	(!empty($fila_foto['foto'])){
		...
		$retrieve_result = @pg_exec($conn,$output);?>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                <tr>
                                  <td class="tableindex"><div align="center">REGISTRO DE ENTREVISTAS -
                                    <?=$Nro_Ano;?>
                                  </div></td>
                                </tr>
                              </table>
			...
			?>
                            ...
                            <br>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1">
                                    <? $Curso_pal = CursoPalabra($curso,1,$conn); echo "$Curso_pal"; ?>
                                  </font></td>
                            ...
                            <br>
                              ...
                              <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                  <td colspan="3"><div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="3"><b>ENTREVISTAS -
                                    <?=$Nro_Ano?>
                                  </b></font></div></td>
                                </tr>
                                <tr>
  ...
  for ($x=0; $x < $num; $x++){
	  ...
	  ?>
                                <tr>
                                  <td width="15%" valign="top" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1">
                                    <?=$fecha ?>
                                  </font></td>
                                  <td width="25%" valign="top" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1">
                                    <?=$asunto ?>
                                  </font></td>
                                  <td width="60%" valign="top" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1">
                                    <?=$observaciones ?>
                                  </font></td>
                                </tr>
                                <tr>
  ...
  ?>
    ...
    ?>
                                      <font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1">
                                        <div align="center">
                                          <?=$nombre_utp ?>
                                        </div>
                                    </font> <font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1"><strong>
                                          <div align="center"> <? if($institucion==14629) echo "Sub-Director Academico"; else echo "Jefe de UTP"; ?> </div>
                                        </strong></font></td>
                                </tr>
                              </table>
                            <? 
...
?>
		...
		?>
                                                    ...
                                                    <br>
                                                    <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" onClick="MM_goToURL('parent','InformeEntrevistas.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&amp;cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">                                                  </td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                      </table></td>
