					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="5">
						  ...
						  <tr> 
                            <td align="left" valign="top"> <table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                                <tr> 
                                  <td width="8%" align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                                  <td width="92%" class="cuadro01"><a href="FichaAlumno.php">Ficha Personal del Alumno</a></td>
                                </tr>
                                <tr> 
                                  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                                  <td class="cuadro01"><a href="InformeAnotaciones.php">Anotaciones</a></td>
								...
								<tr> 
                                  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                                  <td class="cuadro01"><a href="InformeAlumnosSexo.php">Cantidad de alumnos por tipo de enseñanza</a></td>
                                </tr>
								<tr>
                                  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
								  <td class="cuadro01"><a href="InformeEntrevistas.php">Informe de Entrevistas</a></td>
								  </tr>
                                  	<tr>
                                  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
								  <td class="cuadro01"><a href="carta_apoderado_alumno.php">Carta Apoderado Basada en Alumno</a></td>
								  </tr>
                              </table></td>
                          </tr>					  
                            ...
                            <td class="cuadro02"><strong>Notas Parciales</strong></td>
							  ...
							  <tr> 
								...
								<td height="80" align="left" valign="top"> <table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
									...
									<tr> 
									  <td width="8%" align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
									  <td width="92%" class="cuadro01"><a href="InformeGraficoNotasGeneralesPeriodo.php?flag=0">Informe Gráfico Notas Generales Período</a></td>
									</tr>
									<tr> 
									  <td width="8%" align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
									...
									<tr> 
									  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
									  <td class="cuadro01"><a href="Notassubsectorcursos.php?flag=0">Cantidad de notas en Cursos por Subsector </a></td>
									</tr>
								  </table></td>
							  </tr>
                                <!--tr> 
						 ...
						 <tr> 
                            <td height="80"> <table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
								...
								<tr> 
								  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
								  <td class="cuadro01"><a href="../../../../admin/institucion/ano/reportes/InformeAsistenciaporhoras.php">Informe de Asistencia por horas de clase mensual </a></td>
								</tr>
								
								<tr> 
								  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
								  <td class="cuadro01"><a href="../../../../admin/institucion/ano/reportes/InformeAsistenciaGraficoAlumnos.php">Informe de Asistencia Gráfico por Alumnos </a></td>
								</tr>
                              </table></td>
                          </tr>
						 ...
						 <?  if ($_INSTIT!=9074) {?>
                          ...
                          <tr> 
                            <td align="left" valign="top"> <table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
                                <tr> 
                                  <td width="8%" align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                                  <td width="92%" class="cuadro01"><a href="InformePersonalidadPeriodo_C.php?ai_institucion=<?=($institucion)?>&c_reporte=22">Informe de Desarrollo 
                          ...
                          <tr> 
                            <td><table width="100%" border="0" cellpadding="5" cellspacing="0" class="datosC">
							 <tr> 
							    ...
							    <tr> 
                                  <td align="center" valign="middle"><img src="../../../../cortes/arrow.png" width="9" height="9"></td>
                                  <td class="cuadro01"><a href="ficha_matricula.php3">Ficha de Matrícula</a></td>
                                </tr>
                              </table></td>
                          </tr>	
