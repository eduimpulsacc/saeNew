  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#999999">
        ...
        <tr>
          <td width="5%" height="25" bgcolor="#CCCCCC" class="item">N&ordm;</td>
          <td width="23%" bgcolor="#CCCCCC" class="item">Apellido Paterno </td>
          <td width="23%" bgcolor="#CCCCCC" class="item">Apellido Materno </td>
          <td width="33%" bgcolor="#CCCCCC" class="item">Nombres </td>
          <td width="15%" bgcolor="#CCCCCC" class="item">R.U.N.</td>
		  <? if($cod_tipo > 110){?>
          <td width="15%" bgcolor="#CCCCCC" class="item">Especialidad</td>
		  <? } ?>
        </tr>
		<?
			if ($cod_tipo==110){
