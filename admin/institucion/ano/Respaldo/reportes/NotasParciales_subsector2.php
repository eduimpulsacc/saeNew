...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'NotasParciales_subsector2.php?institucion=$institucion';
				form.submit(true);
      ...
      <tr align="left" valign="top">
        <td height="83"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
			  ...
			  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
				  ...
				  <div id="capa0">
					<div align="right">
					  <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printNotasParciales_subsector2.php?c_curso=<?=$curso ?>&c_periodos=<?=$periodo ?>&c_alumno=<?=$alumno ?>','','scrollbars=yes,resizable=yes,width=790,height=1000')" value="IMPRIMIR">
					</div>
				  </div>
			...
			for($cont_paginas=0 ; $cont_paginas < $cont_alumnos ; $cont_paginas++){
				...
				//---------------------------
				$sql = "SELECT ano_escolar.nro_ano, curso.grado_curso, curso.truncado_per, curso.letra_curso, tipo_ensenanza.nombre_tipo, curso.cod_decreto, alumno.ape_pat, alumno.ape_mat, alumno.nombre_alu,institucion.nombre_instit, curso.ensenanza, truncado_final  ";
			...
			<? } ?>
				...
				<table width="100%" border="1">
				  ...
				  echo "<br>".$sql2 = $sql2 . "WHERE (((ramo.id_curso)=".$curso.") AND ((tiene$nro_ano.rut_alumno)='".$alumno."')) order by ramo.id_orden; ";
...
<table border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="498" colspan="4"><div align="right">
       <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" onClick="MM_goToURL('parent','NotasParciales_subsector2.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&amp;c_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value+'&amp;cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;cmb_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&amp;cmb_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value);return document.MM_returnValue" value="Buscar"></div></td>
    </tr>
</table>
</center>
</form>
