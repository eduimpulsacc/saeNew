...
<table width="650" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20"><font face="Verdana, Arial, Helvetica, sans-serif" size="4"><div align="center"><b>INFORME  DE NOTAS</b> </div></font></td>
      </tr>
      <tr>
...
<? } ?>			
		        ...
		        <table width="650" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><div align="center"><strong><font face="Arial, Helvetica, sans-serif" size="1"><? if ($_INSTIT==14912){ ?><img src="<? echo($imagen)?>" width="176" height="54"><? } else if ($_INSTIT!=14912) {?>________________________________</font></strong></div><? } ?></td>
                  </tr>
		  ...
		  <tr>
		    <td height="22"><div align="left"><font size="1"><strong><font size="2"><strong><font face="Verdana, Arial, Helvetica, sans-seri">________________________________________________________________________</font></strong></font><font face="Arial, Helvetica, sans-serif"></font></strong></font></div></td>
		        ...
		        <table width="650" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="1">Profesor(a) Jefe</font>1</div></td>
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="1"><?=$cargo_dir2 ?> Establecimiento </font></div></td>
                  </tr>
                  <tr>
                    <td><div align="center"><strong><font face="Arial, Helvetica, sans-serif" size="1"><? if(($institucion==8930)OR($institucion==770)){  echo $nombre_profesor; }else{ echo $nombre_profe;} ?></font></strong></div></td>
...
?>
  ...
  if($fila_anota["codigo_anotacion"]!=""){?>
      ...
      <?	}	?>
	     ...
	     <?
	     if ($e==5 or $e==10 or $e==15 or $e==20){
	          echo "<H1 class=SaltoDePagina>&nbsp;</H1>";
	     } ?>
...
?>
  ...
  if  (($cantidad_alumnos - $i)<>1) {
      if ($institucion!=26080 and $institucion != 14912 and $institucion != 2163){
	      echo "<H1 class=SaltoDePagina>&nbsp;</H1>";
	  }	  
  }
 //alumno ?>
 ...
 <? if(($institucion!="770") and ($institucion!="12086") and ($institucion!="11209") and ($institucion!="516")){	?>
    
		<p><font face="Arial, Helvetica, sans-serif"><strong><img src="tijera.gif" width="32" height="16">- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -- - - - - - - - - - - - - - - - - - - </strong></font></p>
		<table width="650" border="0" cellspacing="0" cellpadding="0">
		  <tr>
       ...
       <?	
	    /// salto de página despues de la firma
...
<?		 
	 /// AQUI FIN DE MOSTRAR LAS ANOTACIONES PARA ESTE ALUMNO 
