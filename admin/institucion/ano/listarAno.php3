  ...
  <tr>
	...
	<center>
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			<tr>
				<td colspan=6 align=right><? if($_PERFIL==0){?><!--<img src="images/botton_Agreg1.png" onmouseover="this.src='images/botton_Agreg2.png';" onmouseout="this.src='images/botton_Agreg1.png';" />--> <? } ?>
					<?php if($_PERFIL==0){ ?>
			...
			<tr height="20">
				<td colspan="<? echo ($institucion==9827)?"6":"5";?>" align="middle" class="tableindex">A&ntilde;os Acad&eacute;micos </td>
			</tr>
			<tr>
				...
				<td align="center" width="150" class="tablatit2-1">
                    ...
                    <? if($institucion==9827){?>
                <td align="center" width="150" class="tablatit2-1">
					<div align="center">HORA DE ENTRADA</div></td>
                    <? } ?>
