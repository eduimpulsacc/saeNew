  ...
  <tr>
	...
	<center>
		                              <table BORDER="0" CELLSPACING="1" CELLPADDING="3" width="650">
                                        ...
                                        <tr height="20"> 
                                          <td align="middle" colspan="7" class="tableindex"> 
                                            Per&iacute;odos <input type="button" value="Agregar Periodos" onClick=go('seteaPeriodo.php3?caso=2')> </td>
                                        </tr>
                                        <tr > 
                                          ...
                                          <td align="center" class="tablatit2-1"> 
                                            FECHA TERMINO </td>
                                          <td align="center" class="tablatit2-1">POSICION NOTA</td>
                                        
                                          
                                          <td align="center" class="tablatit2-1">ESTADO</td>
                                        </tr>
                                        <?php
				$qry="SELECT periodo.id_periodo, periodo.cerrado, periodo.nombre_periodo, periodo.fecha_inicio, periodo.fecha_termino, periodo.posicion_nota, ano_escolar.nro_ano FROM ano_escolar INNER JOIN quiz_periodos periodo ON ano_escolar.id_ano = periodo.id_ano WHERE (((ano_escolar.id_ano)=".$ano.")) ORDER BY periodo.fecha_inicio";
				$result =@pg_Exec($conn,$qry);
				if (!$result) {
					...
					for($i=0;$i<@pg_numrows($result);$i++){
						$fila = @pg_fetch_array($result,$i);
                                        ...
                                        <?php if($modifica==1){ //ACADEMICO Y LEGAL?>
                                          ...
                                          <td align="center"><font face="arial, geneva, helvetica" size="1" color="#000000"> 
                                            <strong> 
                                         <?php echo  $fila["posicion_nota"];  ?></strong></font>
                                          </td>
                                          <?
