...
<SCRIPT language="JavaScript">
	...
	function enviapag(form){
		if (form.cmb_curso.value!=0){
			...
			window.location= 'informePromediosFinalesCurso.php?cmb_curso=' + document.form.cmb_curso.value +'&c_reporte=<?=$c_reporte;?>&numero=<?php echo $numero ?>';
		}	
	}			
...
<form method "post" action="printInformepromediosFinalesCurso.php" target="_blank" name="form">
<input name="c_reporte" type="hidden" value="<?=$c_reporte;?>">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="textosimple"><input type="radio" name="finalp" id="finalp" value="1" onClick="activa(this.value)" checked>
      SI 
        <input type="radio" name="finalp" id="finalp" value="2"  onClick="activa(this.value)">
        NO</td>
