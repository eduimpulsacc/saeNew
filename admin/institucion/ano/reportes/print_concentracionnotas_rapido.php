...
<? for ($i=0;$i<count($cod_subsector);$i++){?>
			...
			//if ($promedio==0){
			  //   $promedio="&nbsp;";
			//}
			echo $total[trim($rut_alumno)][1]['ramo_nota'][$i];
			...
			//if ($promedio==0){
			  //   $promedio="&nbsp;";
			//}*/
			echo $total[trim($rut_alumno)][2]['ramo_nota'][$i];
			...
			//if ($promedio==0){
			  //   $promedio="&nbsp;";
			//}*/
			echo $total[trim($rut_alumno)][3]['ramo_nota'][$i];
			//$promedio=NULL;
			//$row_saca_ramo[modo_eval]=NULL;
			?></td>
				<td width="1%" align="center" nowrap="nowrap"><? 
	...
	if($num_saca_num!=""){			
			...
			*/
			...
			//if ($promedio==0){
			  //   $promedio="&nbsp;";
			//}*/
			echo $total[trim($rut_alumno)][4]['ramo_nota'][$i];
						  ...
						  */
						      ...
						      ?>&nbsp;AÑO</b></td>
						              ...
						              <td class="textosimple"><b><? 
						               		 ...
						               		 echo $total[trim($rut_alumno)][$j]['ano']; 
							  ...
							  <?
										  ...
										  if ($total[trim($rut_alumno)][$j]['establecimiento'] == "xxx"){
										      ?>
										      <tr class="textosimple">
										         <td colspan="2">Sin información. <br><br><br><br><br><br></td>
										      </tr>    
										      <?
								 	          ...
								 	          <tr class="textosimple">
										        <td colspan="2">Establecimiento:<b><? echo $total[trim($rut_alumno)][$j]['establecimiento'];?></b></td>
										      </tr>
									          <tr class="textosimple">
										        <td colspan="2">Ciudad:<b>
											   <? 
											   if ($_INSTIT!=770){
											      echo $total[trim($rut_alumno)][$j]['ciudad'];
											   }else{
											       echo "Ovalle";
										       }
											   ?></b>&nbsp;&nbsp;Comuna: <b>
											   ...
											   if($institucion==770)
											       ...
											       echo $total[trim($rut_alumno)][$j]['comuna'];
											   ?> 
											  </b></td>
										      </tr>
											  ...
											  <tr class="textosimple">
													...
													<td colspan="2">Exenta de Educacion Nº <b><? echo $total[trim($rut_alumno)][$j]['plan'];?></b></td>
											  ...
											  <tr class="textosimple">
											   ...
											   <tr class="textosimple">
													   <td colspan="2">Exenta de Educacion N&ordm;&nbsp;<b>
													   <? echo $total[trim($rut_alumno)][$j]['decreto'];?></b>
				...
				if ($origen[1]==2){
					...
					if ($num_general>0){
						...
						$promedio=$row_general[promedio];
							...
							echo $total[trim($rut_alumno)][1]['promedio_general'] ;
				...
				if ($origen[2]==2){
					...
					if ($num_general>0){
						...
						$promedio=$row_general[promedio];
							...
							echo $total[trim($rut_alumno)][2]['promedio_general'] ;
							$promedio=NULL;
						?></td>
				<td width="1%" align="center" nowrap="nowrap"><? 
			//	imprime_array($grado_curso);
				...
				if ($origen[3]==2){
					...
					if ($num_general>0){
						...
						$promedio=$row_general[promedio];
							...
							echo $total[trim($rut_alumno)][3]['promedio_general'];
							//$promedio=NULL;
						?></td>
				<td width="1%" align="center" nowrap="nowrap"><? 
			//	imprime_array($grado_curso);
				...
				if ($origen[4]==2){
					...
					if ($num_general>0){
						...
						$promedio=$row_general[promedio];
							...
							echo $total[trim($rut_alumno)][4]['promedio_general'];
				...
				if ($origen[1]==2){
					...
					if ($num_general>0){
						...
						$promedio=trim($row_general[asistencia]);
							...
							echo $total[trim($rut_alumno)][1]['promedio_asistencia'];
							//$promedio=NULL;
						?>    </td>
				<td width="1%" align="center" nowrap="nowrap"><? 
			//	imprime_array($grado_curso);
				...
				if ($origen[2]==2){
					...
					if ($num_general>0){
						...
						$promedio=trim($row_general[asistencia]);
							...
							echo $total[trim($rut_alumno)][2]['promedio_asistencia'];
							//$promedio=NULL;
						?>    </td>
				<td width="1%" align="center" nowrap="nowrap"><? 
			//	imprime_array($grado_curso);
				...
				if ($origen[3]==2){
					...
					if ($num_general>0){
						...
						$promedio=trim($row_general[asistencia]);
							...
							echo $total[trim($rut_alumno)][3]['promedio_asistencia'];;
							//$promedio=NULL;
						?>    </td>
				<td width="1%" align="center" nowrap="nowrap"><? 
			//	imprime_array($grado_curso);
				...
				if ($origen[4]==2){
					...
					if ($num_general>0){
						...
						$promedio=trim($row_general[asistencia]);
							...
							echo $total[trim($rut_alumno)][4]['promedio_asistencia'];;
							//$promedio=NULL;
						?></td>
			  </tr>
			</table>
			...
			<? $fecha = date("d-m-Y")?>
			<tr><td align="center" class="textosimple"><? if($_INSTIT!=770 and $_INSTIT!=14703){ 
				echo $ciudad; 
			}elseif ($_INSTIT==770) { 
				echo Ovalle; 
			}else 
			...
			//	$ponderacion_rende = $acumulo_promedio/$contador_acumulado;
				//$ponderacion_rende = substr($acumulo_promedio/$contador_acumulado,0,2);
				$temp1 = $total[trim($rut_alumno)]['contador_acumulado'];
				$temp2 = $total[trim($rut_alumno)]['acumulo_promedio'];
				$temp3 = $total[trim($rut_alumno)]['ponderacion_rende'];
				
			   ?>	
			  <table width="100%" border="100" cellspacing="0" cellpadding="2" align="left">
				<tr>
				  <td class="textosimple" width="170">Total notas promediadas</td>
				  <td width="20"><?=$temp1 ?></td>
				
				  <td class="textosimple" width="170">Suma Ponderación</td>
				  <td width="20"><?=$temp2 ?></td>
				
				  <td class="textosimple" width="170">Ponderación Demre</td>
				  <td width="20"><?=$temp3 ?></td>
				</tr>
			  </table>
			  <?
