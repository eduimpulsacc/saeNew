...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="cuadro01"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
      ...
      <tr>
        <td class="cuadro01" width="53%"> A&ntilde;o Escolar<br>
            ...
            <select name="cmb_ano" class="ddlb_x" id="cmb_ano"  onChange="window.location='informePei.php?cmb_ano='+this.value;">
...
NO</td>
          ...
          <table width="100%" border="0" cellspacing="3" cellpadding="0">
            ...
            <tr>
              <td width="50%"  class="cuadro01">Oservaciones                </td>
...
NO</td>
            ...
            <tr>
              <td  class="cuadro01">Sugerencia</td>
...
Sigla</td>
      ...
      <tr>
        <td  class="cuadro01"><br>
          ...
          <? if($_PERFIL == 17){ ?>
          <select name="cmb_curso"  class="textosimple" id="cmb_curso" onChange="window.location='informePei.php?c_reporte=<?=$reporte;?>&cmb_curso='+this.value;">
      ...
      <tr>
        <td  class="cuadro01"><br>
         ...
         <tr>
              <td  class="cuadro01">&Aacute;rea de Evaluaci&oacute;n<br>

              <select name="area" id="area"  class="textosimple">
                <option value="0">Seleccione &Aacute;rea de evaluaci&oacute;n</option>
                <?php 
				$rs_area=$ob_motor->areaPei($conn);
