    ...
    <td width=""><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td class="cuadro01" width="53%"> A&ntilde;o Escolar<br>
            ...
            <select name="cmb_ano" class="ddlb_x" id="cmb_ano"  onChange="window.location='PlanPaiAnio.php?cmb_ano='+this.value;">
      ...
      <tr>
        <td  class="cuadro01"><br>
          ...
          <? if($_PERFIL == 17){ ?>
          <select name="cmb_curso"  class="textosimple" id="cmb_curso" onChange="window.location='PlanPaiAnio.php?c_reporte=<?=$reporte;?>&cmb_curso='+this.value;">
