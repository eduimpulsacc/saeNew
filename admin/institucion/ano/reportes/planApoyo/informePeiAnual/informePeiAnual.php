...
if (form.cmb_curso.value!=0){
	form.target="_parent";
	form.action = 'informePeiAnual.php';
	form.submit(true);
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="105" align="left" class="textosimple"><input name="retirado" type="radio" value="0">
SI
...
NO</td>
  ...
  <tr>
    <td class="textosimple">&nbsp;&Aacute;rea de Evaluaci&oacute;n</td>
    <td colspan="2" class="textosimple"><select name="area" id="area"  class="textosimple">
