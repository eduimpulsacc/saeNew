    ...
    <tr>
      <td><table width="61%" border="0">
        ...
        <table width="100%" border="0">
          ...
          <td align="right"> 
								<INPUT TYPE="button" value="IMPRIMIR" onClick=document.location="asistenciaAlumnoIMP.php3?alumno=<?php echo $alumno;?>&curso=<?php echo $curso;?>">
             <input type="button" name="Submit3" value="VOLVER" onClick=document.location="asistenciaPorAlumno2.php3?curso=<?php echo $curso; ?>"></td>
          </tr>
        </table>
	  ...
	  <tr align="center" bgcolor="#48d1cc"> 
		...
		//for($i=0 ; $i<pg_numrows($result7) ; $i++){
		  ...
		  $porc	   = ($total * 100) / $dias_habiles;
		   ...
		   ?>
        <tr align="center" bgcolor=#ffffff onMouseOver=this.style.background='yellow';this.style.cursor='hand' onMouseOut=this.style.background='transparent'> 
          <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif"><?php  echo trim($filaC['grado_curso']);?>
            º&nbsp;<?php echo $filaC['letra_curso'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></div></td>
          ...
          <td align="center"> <table WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0" bgcolor=white>
              <tr> 
                <td align="left"> <font face="arial, geneva, helvetica" size="1" color=black> 
                  <ul>
                    <li>Para volver al listado de Reportes presione &quot;GUARDAR&quot;.</li>
