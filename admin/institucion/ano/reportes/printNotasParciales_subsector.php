	      ...
	      $prom_cont_asis =0;
		   for($i=0 ; $i < @pg_numrows($result1) ; $i++)
			...
			$fila1 = @pg_fetch_array($result1,$i);
				...
				?>			
				<br>
		  <table width="750" border="1" align="center" cellpadding="0" cellspacing="0" class="Tabla" height="15">
                    <tr>
                      <td width="30%" class="Tabla">Subsector del Aprendizaje (Formacion General) </td>
                      <td width="50%" class="Tabla"><div align="center">NOTAS</div></td>
                      <td width="5%" class="Tabla"><div align="center">Prom Sem.</div></td>
                      <!--<td width="5%" class="Tabla"><div align="center">2&ordm; SE </div></td>-->
					  <?
					  if ($ensenanza==110 and $grado_curso < 5){
					        ...
					        /// muestro columna
						    ?>
                            <td width="5%" class="Tabla"><div align="center">N.E.</div></td>
					<? } ?> 		
                      <td width="5%" class="Tabla"><div align="center">Gral.</div></td>
                    </tr>
...
<? /**************************************************************************************************************************/?>                  
						...
						<tr>
						  ...
						  <td>
						   ...
						   ?>
						   <table width="100%" border="0" cellpadding="0" cellspacing="1" height="15">
							<tr>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color1 ?>"><? echo $nota1 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color2 ?>"><? echo $nota2 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color3 ?>"><? echo $nota3 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color4 ?>"><? echo $nota4 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color5 ?>"><? echo $nota5 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color6 ?>"><? echo $nota6 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color7 ?>"><? echo $nota7 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color8 ?>"><? echo $nota8 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color9 ?>"><? echo $nota9 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color10 ?>"><? echo $nota10 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color11 ?>"><? echo $nota11 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color12 ?>"><? echo $nota12 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color13 ?>"><? echo $nota13 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color14 ?>"><? echo $nota14 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color15 ?>"><? echo $nota15 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color16 ?>"><? echo $nota16 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color17 ?>"><? echo $nota17 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color18 ?>"><? echo $nota18 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color19 ?>"><? echo $nota19 ?></font></td>
							  <td class="Tabla" width="22">&nbsp;<font color="<?=$color20 ?>"><? echo $nota20 ?></font></td>
							</tr>
						  </table>
						  
					    </td>
						  <td class="Tabla"><div align="center">&nbsp;<font color="<?=$color21 ?>"><? if (trim($promedio_semestre)>0){ ?><?=$promedio_semestre ?> <? }else{ echo "$promedio_semestre"; } ?></font></div></td>
						  <td class="Tabla"><div align="center">&nbsp;</div></td>
						  ...
						  <? } ?>
						  -->		   
						  <td class="Tabla"><div align="center">&nbsp;
...
<? /************************************************************************************************************************/?>                        
				   ...
				   ?>		
                    ...
                    <tr>
                      ...
                      <td class="Tabla" align="center">&nbsp;<? echo @round(($suma_prom/$cuenta_prom)); ?></td>
...
<? if ($_INSTIT!=14629){ ?>
  ...
  <? } ?>		
		...
		<table width="650" height="35" border="0" cellpadding="0" cellspacing="0">
		  <tr>
			<td height="16"><div align="left"><font size="1"><strong><font face="Arial, Helvetica, sans-serif" size="1">Las notas en cursiva serán promediadas al final del semestre y corresponderán a una nota parcial.</font></strong></font></div></td>
		  </tr>	
		  <tr>
