...
<center>
<div id="capa0">
  <input name="button4" type="button" class="botonXX" onClick="cerrar()"  value="CLOSE">
		 ...
		 include("firmas/firmas.php");?>1		  
		        <table width="650" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td><div align="center"><font face="Arial, Helvetica, sans-serif" size="1"><? if ($institucion==9566){?>Vice-Rector del Establecimiento<? } else {?><?=$cargo_dir2 ?><? }?> </font></div></td>
                  </tr>
                  <tr>
