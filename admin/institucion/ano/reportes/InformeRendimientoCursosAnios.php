...
function enviapag(form){
	if (form.cmbramo.value!=0){
		form.cmbramo.target="self";
		form.target="_blank";
		form.action = 'printInformeRendimientoCursosAnios.php';
		form.submit(true);
	}	
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td height="395" align="left" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
					  ...
					  $ob_reporte->institucion = $institucion;
						echo	$resultENS= $ob_reporte->EnsenanzaNotas($conn);
 ...
 <select name="ramo" id="ramo"></select>                                                 </div></td>
		  ...
		  ?>
                                                ...
                                                <tr>
                                                  <td align="right" class="cuadro01"><div align="right">Tipo:</div></td>
                                                  <td class="cuadro01"><input type="checkbox" name="psintesis" id="psintesis" value="1">
                                                    <label for="checkbox">P.Sintesis</label></td>
                                                </tr>
                                                <tr>
