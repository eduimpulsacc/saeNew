...
<script language="javascript">
			 ...
			 window.location="../../../../index.php";
			  //window.location="Menu_Reportes_newApo.php";
		 </script>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="5">
              <tr>
				...
				if($_PERFIL==0 || $_PERFIL==14 or $_PERFIL==27 ){ ?>
                    <input name="CONFIG" type="button" class="botonXX" id="CONFIG" onClick="window.location='listaConfiguracionReporte.php'" value="CONFIGURACI&Oacute;N REPORTES">
                    <? } 
					
					if($_PERFIL!=15 && $_PERFIL!=16){
					?>&nbsp;&nbsp;
                     <input name="CONFIG" type="button" class="botonXX" id="CONFIG" onClick="window.location='MenuConfiguracionFirmaReporte.php'" value="AUTORIZAR FIRMA">
                    <?	
					}
				}?>
                      ...
                      <table width="100%" border="0">
                        ...
                        <? 	$ob_reporte->reporte=$fila['id_reporte'];
							...
							if($_PERFIL==0 ){
								...
								elseif($_PERFIL==14){
									$rs_item=$ob_reporte->ItemMenuAdm($conn);
                        ...
                        <tr>
						  ...
						  <td class="cuadro01"  <?php if(strlen($fils_item['descripcion'])>0){echo 'title="'.$fils_item['descripcion'].'"';} ?>>&nbsp;<a href="<?=$fils_item['ruta'];?>?c_reporte=<?=$fils_item['id_item'];?>&numero=<?=$contador;?>&nombre=<?=$fils_item['nombre'];?>"><? echo $contador.".- ".$fils_item['nombre'];?></a></td>
					    </tr>
                        <? $contador++;
