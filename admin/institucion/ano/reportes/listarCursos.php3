		...
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<tr>
				<td colspan=4 align=right>
					<INPUT TYPE="button" value="IMPRIMIR" onClick=document.location="listarCursosIMP.php3">
