...
<SCRIPT language="JavaScript">
	...
	//alert(parametros);	 
	$.ajax({
	  url:'../curso/Ensayos_PSU/Cont_CartaFelicitacionAlumno.php',
	  data:parametros,
	  type:'POST',
...
function carga_curso(id_ano){
	...
	//alert(parametros);
		$.ajax({
	  url:'../curso/Ensayos_PSU/Cont_Ensayo_PSU.php',
	  data:parametros,
	  type:'POST',
	  success:function(data){
		 //alert(data);
...
function carga_ramos(id_curso){
	...
	//alert(parametros);
		...
		$.ajax({
	  url:'../curso/Ensayos_PSU/Cont_Ensayo_PSUreport.php',
	  data:parametros,
	  type:'POST',
	  success:function(data){
		// alert(data);
                            ...
                            <td height="395" align="left" valign="top"> 
                              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                                <tr> 
								  ...
								  <div id="layer2"></div>
<br>
<form name="form" id="form" method="post" action="printInformeEnsayoPSU.php" target="_blank">

  <center>
    <table width="90%" border="0" cellspacing="0" cellpadding="3">
    <tr>
      <td colspan="2" class="tableindex">Buscador Avanzado   <input name="c_reporte" type="hidden" value="<?=$reporte;?>">
