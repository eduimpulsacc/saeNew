...
<body>
	...
	<center>
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			?>
						<tr bgcolor=#ffffff onmouseover=this.style.background='yellow';this.style.cursor='hand' onmouseout=this.style.background='transparent' onClick=go('observacionesPorAlumno2.php3?curso=<?php echo $fila["id_curso"];?>&caso=1')>
							<td align="right" >
								<font face="arial, geneva, helvetica" size="1" color="#000000">
