...
&nbsp;									  </td>
									...
									<tr>
									  ...
									  <td width="50" align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>NB1</b></font></td>
									  <td width="50" align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>NB2</b></font></td>
									  <td width="50" align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>NB3</b></font></td>
									  <td width="50" align="center"><font face="Arial, Helvetica, sans-serif" size="2"><b>NB4</b></font></td>
									...
									?>
									 ...
									 <? 	$sqlprefe1="select count(*) as cuenta from formulario_postulacion where prefe_1= ".$fila['rdb']." and preferencia=1 and id_estado=0 and grado=1";
									 		$prefe1= @pg_Exec($conn,$sqlprefe1);
											$filaprefe1_1 = @pg_fetch_array($prefe1,0);
											
											$sqlprefe2="select count(*) as cuenta from formulario_postulacion where prefe_1= ".$fila['rdb']." and preferencia=1 and id_estado=0 and grado=2";
									 		$prefe2= @pg_Exec($conn,$sqlprefe2);
											$filaprefe1_2 = @pg_fetch_array($prefe2,0);
											
											$sqlprefe3="select count(*) as cuenta from formulario_postulacion where prefe_1= ".$fila['rdb']." and preferencia=1 and id_estado=0 and grado=3";
									 		$prefe3= @pg_Exec($conn,$sqlprefe3);
											$filaprefe1_3 = @pg_fetch_array($prefe3,0);
											
											$sqlprefe4="select count(*) as cuenta from formulario_postulacion where prefe_1= ".$fila['rdb']." and preferencia=1 and id_estado=0 and grado=4";
											...
											/**********************************************************************************************************************/
											$sqlprefe1="select count(*) as cuenta from formulario_postulacion where prefe_3= ".$fila['rdb']." and preferencia=3 and id_estado=0 and grado=1";
									 		$prefe3_3= @pg_Exec($conn,$sqlprefe1);
											$filaprefe3_1 = @pg_fetch_array($prefe3_3,0);
											
											$sqlprefe2="select count(*) as cuenta from formulario_postulacion where prefe_3= ".$fila['rdb']." and preferencia=3 and id_estado=0 and grado=2";
									 		$prefe3_3= @pg_Exec($conn,$sqlprefe2);
											$filaprefe3_2 = @pg_fetch_array($prefe3_3,0);
											
											$sqlprefe3="select count(*) as cuenta from formulario_postulacion where prefe_3= ".$fila['rdb']." and preferencia=3 and id_estado=0 and grado=3";
									 		$prefe3_3= @pg_Exec($conn,$sqlprefe3);
											$filaprefe3_3 = @pg_fetch_array($prefe3_3,0);
											
											$sqlprefe4="select count(*) as cuenta from formulario_postulacion where prefe_3= ".$fila['rdb']." and preferencia=3 and id_estado=0 and grado=4";
									 		$prefe3_4= @pg_Exec($conn,$sqlprefe4);
											$filaprefe3_4 = @pg_fetch_array($prefe3_4,0);
											/****************************************************************************************************************/
											$sqlprefe1="select count(*) as cuenta from formulario_postulacion where prefe_4= ".$fila['rdb']." and preferencia=4 and id_estado=0 and grado=1";
									 		$prefe4_1= @pg_Exec($conn,$sqlprefe1);
											$filaprefe4_1 = @pg_fetch_array($prefe4_1,0);
											
											$sqlprefe2="select count(*) as cuenta from formulario_postulacion where prefe_4= ".$fila['rdb']." and preferencia=4 and id_estado=0 and grado=2";
									 		$prefe4_2= @pg_Exec($conn,$sqlprefe2);
											$filaprefe4_2 = @pg_fetch_array($prefe4_2,0);
											
											$sqlprefe3="select count(*) as cuenta from formulario_postulacion where prefe_4= ".$fila['rdb']." and preferencia=4 and id_estado=0 and grado=3";
									 		$prefe4_3= @pg_Exec($conn,$sqlprefe3);
											$filaprefe4_3 = @pg_fetch_array($prefe4_3,0);
											
											$sqlprefe4="select count(*) as cuenta from formulario_postulacion where prefe_4= ".$fila['rdb']." and preferencia=4 and id_estado=0 and grado=4";
									 		$prefe4_4= @pg_Exec($conn,$sqlprefe4);
											$filaprefe4_4 = @pg_fetch_array($prefe4_4,0);
											/**********************************************************************************************************************/
											$sqlprefe1="select count(*) as cuenta from formulario_postulacion where prefe_5= ".$fila['rdb']." and preferencia=5 and id_estado=0 and grado=1";
									 		$prefe5_1= @pg_Exec($conn,$sqlprefe1);
											$filaprefe5_1 = @pg_fetch_array($prefe5_1,0);
											
											$sqlprefe2="select count(*) as cuenta from formulario_postulacion where prefe_5= ".$fila['rdb']." and preferencia=5 and id_estado=0 and grado=2";
									 		$prefe5_2= @pg_Exec($conn,$sqlprefe2);
											$filaprefe5_2 = @pg_fetch_array($prefe5_2,0);
											
											$sqlprefe3="select count(*) as cuenta from formulario_postulacion where prefe_5= ".$fila['rdb']." and preferencia=4 and id_estado=0 and grado=3";
									 		$prefe5_3= @pg_Exec($conn,$sqlprefe3);
											$filaprefe5_3 = @pg_fetch_array($prefe5_3,0);
											
											$sqlprefe4="select count(*) as cuenta from formulario_postulacion where prefe_5= ".$fila['rdb']." and preferencia=5 and id_estado=0 and grado=4";
