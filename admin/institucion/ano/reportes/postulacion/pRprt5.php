...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('../../../../../cortes/b_ayuda_r.jpg','../../../../../cortes/b_info_r.jpg','../../../../../cortes/b_mapa_r.jpg','../../../../../cortes/b_home_r.jpg')">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
   ...
   <table>
                                  ...
                                  <tr><td align="left"><? echo "<img src='".$d."tmp/".$institucion."insignia". "' >";	?>&nbsp;</td>
   ...
   <tr>
      <td width="70" align="left" ><font face="Arial, Helvetica, sans-serif" size="2">Institucion:</font></td>
							  <td width="153" align="left"><? 
								  ...
								  ?>
                              &nbsp; </td>
                        <td width="149" align="left"><input name="button3" type="button" class="botonXX" onClick="imprimir()" value="IMPRIMIR"></td>
                </tr>
                                  <tr><td align="left">&nbsp;</td>
	...
	$resultado_query_cue = pg_exec($conn,$sql_curso);
                 ...
                 ?>                                    </td>
                                  ...
                                  <tr>
									...
									<td colspan="2"><center>
									  TOTAL DE POSTULACIONES A UN ESTABLECIMIENTO POR CURSO 
									</center></td>
									</tr>
									<tr>
									...
									<tr>
									 ...
									 <? 
									 $sql3="select grado_curso,letra_curso,id_nivel from  curso where id_curso =".$_GET["cmb_grado"];
								...
								<? $sql4="select nro_ano from  ano_escolar where id_ano =".$ano;
									...
									<tr>
									  ...
									  <td>
									<?   $sql6="select * from  vacantes where grado =".$grado;
									...
									?>
									 ...
									 <? $sql8="select ensenanza from curso where id_curso=".$_GET["cmb_grado"];
									...
									<table width="723" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td width="168" align="center" class="tableindex">Curso</td>
                                        <td width="168" align="center" class="tableindex">Cantidad</td>
                                        <td width="168" align="center" class="tableindex">Vacantes</td>
									...
									<? echo $filag['grado_curso'];?>&nbsp;</td>
                                        <td align="center">
									<? $sql7="select count(*) as total  from matricula".$fila2["nro_ano"]." where id_curso=".$_GET["cmb_grado"]; 
										$result6= pg_exec($conn,$sql7);
		        						$fila5 = @pg_fetch_array($result6,0); 
										echo $fila5["total"];
									?>
										&nbsp;</td>
                                        <td align="center"><? echo $fila4["vac_ini"];?>&nbsp;</td>
                                        <td align="center"><? echo $fila5["total"]+$fila4["vac_ini"]; ?>&nbsp;</td>
                                      </tr>
                                    </table>
									 </td>
									  </tr>
