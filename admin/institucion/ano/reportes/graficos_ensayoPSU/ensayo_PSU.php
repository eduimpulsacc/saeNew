...
function validaform(){
	...
	document.form.action="graficos/GraficosEnsayosPsu.php";
...
//-->
function tip(vala){
	if(document.getElementById("graf1").checked == true){
	document.getElementById("tipo").value =1;
	}
	if(document.getElementById("graf2").checked == true){
...
<input name="tipo" type="hidden" id="tipo" value="">
  ...
  <center>
    ...
    <tr>
     ...
     <tr>
      <td>Alumno:</td>
      <td><div id="lista_alumnos"><select name="select_alumno" >
      <option>Seleccionar</option>
      </select></div></td>
    </tr>
     <tr>
       <td>Tipo de Gr&aacute;fico</td>
       <td><input type="radio" name="radio" id="graf1" value="graf1" onChange="tip(1)">
         L&iacute;neas 
           <input type="radio" name="radio" id="graf2" value="graf2" onChange="tip(2)">
           Barras</td>
     </tr>
    <br>
