...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" class="tableindex"><div align="center">INFORME GENERAL DE ASISTENCIA POR CURSO </div></td>
  </tr>
  <tr>
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td bgcolor="#CCCCCC" class="titulo">CURSOS</td>
    <td width="8%" bgcolor="#CCCCCC" class="titulo">MATR&Iacute;C.</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">1</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">2</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">3</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">4</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">5</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">6</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">7</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">8</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">9</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">10</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">11</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">12</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">13</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">14</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">15</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">16</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">17</td>
    <td width="4" align="" bgcolor="#CCCCCC" class="titulo">18</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">19</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">20</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">21</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">22</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">23</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">24</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">25</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">26</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">27</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">28</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">29</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">30</td>
    <td width="4" bgcolor="#CCCCCC" class="titulo">31</td>
