...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="capa0">
		<div align="right">
          <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printInformeGraficoTipoEnsenanza.php?&periodo=<?=$periodo ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
        </div>
      </div></td>
  </tr>
</table>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan=3 class="tableindex"><div align="center">RENDIMIENTO GRÁFICO TIPOS DE ENSEÑANZA</div></td>
    </tr>
  <tr>
