...
<SCRIPT language="JavaScript">
	...
	//alert(parametros);	 
	$.ajax({
	  url:'Cont_ReportePromediosInsuficientes_curso.php',
	  data:parametros,
	  type:'POST',
...
function validaform(){
	...
	document.form.action='print_promedios_insuficientes_curso.php';
  ...
  <center>
    ...
    <tr>
      <td colspan="2" class="tableindex">Buscador Avanzado </td>
       ...
       <tr>
      <td>Periodo</td>
      <td><div id="select_periodo"><select name="select_periodo" >
