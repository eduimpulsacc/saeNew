...
$institucion	= $_INSTIT;
$ano			= $_ANO;
$curso			= $_REQUEST['cmbCURSO'];
$reporte		= $_REQUEST['c_reporte'];
/// funcion
...
//if($_PERFIL==0) print_r($fila_config);	
...
<title>Notas Alumnos Subsector</title>
...
<table width="650" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr>
	...
	<table width="100%" border="1" cellspacing="0" cellpadding="3">
      ...
      <tr>
        <td colspan="7"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><strong><?
			  if($institucion!=""){
...
if($ob_config->firma1!=0){
	...
	<!--<td width="25%" class="item" height="100"><div align="center">
	-->
	  <? if($institucion==25114){?>
	  <br />
	  <br />
	  <br />
	  <br /><? } elseif($institucion==12962){?>
<td width="25%" valign="baseline" class="item"><div align="center">
  <img src="FIRMA_utp.jpg" width="167" height="88">________________________________
	<? }else{?>
<td width="25%" class="item"> <div align="center">
   <br />
...
if($ob_config->firma2!=0){
	...
	if($institucion==25114){
	?>
<td width="25%" class="item"> <div align="center"><img src="firmaIbero.jpg" width="118" height="85" /><img src="timbreIbero.jpg" width="93" height="86" />________________________________
	<? }elseif($institucion==12962){?>
<td width="25%" valign="baseline" class="item"><div align="center">
  <img src="firma_directora.jpg" width="167" height="88">________________________________
	<? }else{?>
<td width="25%" class="item"> <div align="center">
   <br />
    ________________________________
