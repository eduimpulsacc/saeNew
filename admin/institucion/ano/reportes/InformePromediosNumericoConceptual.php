...
<SCRIPT language="JavaScript">
	function enviapag2(form){
			...
			document.form.action='printInformePromediosNumericoConceptual.php?cmb_periodos='+periodo+'&cmb_curso='+curso+'&cmb_subsector='+subsector;
			document.form.submit(true);
	}
	function enviapag(form){
		if (form.cmb_curso.value!=0){
			form.cmb_curso.target="self";
			window.location= 'InformePromediosNumericoConceptual.php?cmb_periodos='+ '&cmb_curso=' + document.form.cmb_curso.value +'&c_reporte=<?=$reporte;?>';
		}	
	}			
...
<form method "post" action="printInformePromediosNumericoConceptual.php" target="_blank" name="form">
...
if($cmb_curso!=0){
	...
	$resultado_sub = $ob_motor ->Subsector_conceptual($conn);
}
//------------------
?>
<center>
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <tr>
		<td class="textosimple">&nbsp;</td>
		<td width="89" class="textosimple"> &nbsp;</td>
		<td width="150">&nbsp;</td>
	</tr>
</table>
