...
/*	$ob_membrete->ramo= $ramo;
	...
	$sql ="SELECT id_nivel FROM niveles WHERE id_nivel=".$nivel;
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><div align="left"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>NIVEL</strong></font></div></td>
    <td><div align="left"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>:</strong></font></div></td>
    <td><div align="left"><font face="Arial, Helvetica, sans-serif" size="-2"><? echo strtoupper($ob_membrete->nombre_nivel)?></font></div></td>
  </tr>
</table>
<br />
...
inner join curso
on curso.id_curso = ramo.id_curso
where id_nivel=$nivel order by su.cod_subsector asc 
";
...
for($x=0;$x<pg_numrows($rs_ramos);$x++){
	...
	$ob_reporte->periodo=$periodo;
	$ob_reporte->id_nivel = $nivel;
	$ob_reporte->cod_subsector =$fila_arr['cod_subsector'];
	$rs_promedios = $ob_reporte->promedioNiveles($conn); 
