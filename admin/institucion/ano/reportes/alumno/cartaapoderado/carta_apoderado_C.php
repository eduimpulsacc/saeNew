...
<SCRIPT language="JavaScript">
			...
			if (document.form.cmb_curso.value!=0){
				form.target="_self";				
				document.form.action = "carta_apoderado_C.php";
...
<center>
  <table width="90%" border="0" cellspacing="0" cellpadding="3">
    ...
    <tr>
      <td>C/Colilla</td>
      <td><p>
        <input type="checkbox" name="colilla" value="1">
      </p></td>
    </tr>
    <tr>
      <td>Fecha</td>
      <td>&nbsp;<input type="text" name="txtFECHA" id="txtFECHA" value="<?php echo date("d-m-Y"); ?>"></td>
    </tr>
    <tr>
      <td colspan="2"><div align="center">
        <label>
        <input name="cb_ok" type="submit" class="botonXX" id="Buscar" value="Buscar">
		<? if($_PERFIL==0){?>		  
			<input name="cb_exp" type="submit" class="botonXX"  id="cb_exp" value="Exportar">
		<? }?>	
        </label>
        <input name="cb_ok2" type="button" class="botonXX" id="cb_ok" value="Volver"onClick="window.location='../../Menu_Reportes_new2.php'">
