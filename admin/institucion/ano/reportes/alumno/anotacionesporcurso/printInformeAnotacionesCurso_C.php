				 ...
				 while ($i < $n1){				
			        ...
			        $detalle = $f2['detalle'];	
						 ...
						 <?
						  ...
						  $sql_curso_alumnos = "select * from anotacion where rut_alumno in (select rut_alumno from matricula where id_curso = '$curso' and bool_ar = '0') and codigo_tipo_anotacion > '0' and codigo_anotacion = '$codigo' and id_periodo 
