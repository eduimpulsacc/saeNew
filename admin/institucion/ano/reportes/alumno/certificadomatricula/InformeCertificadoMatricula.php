...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeCertificadoMatricula.php?institucion=$institucion';
		form.submit(true);
	}	
}
                    ...
                    <td height="395" align="left" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                        <tr>
                          <td><!-- FIN DEL CONTENIDO CENTRAL DE LA PÁGINA -->
                            ...
                            <br>
                              <br>
                              <form method "post" action="printInformeCertificadoMatricula.php" name="form" target="_blank">
  ...
  ?>
		...
		?>
                                                ...
                                                <tr>
                                                  ...
                                                  <td width="21" class="cuadro01">&nbsp;</td>
                                                  <td width="495" class="cuadro01"><input name="cb_ok" type="submit" class="botonXX"  id="cb_ok" value="Buscar">                                                    <input name="cb_ok2" type="button" class="botonXX"  id="cb_ok2" value="Volver" onClick="window.location='../../Menu_Reportes_new2.php'"></td>
                                                </tr>
                                            </table></td>
                                          </tr>
                                      </table></td>
