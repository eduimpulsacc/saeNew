...
<table width="650" border="0" cellspacing="2" cellpadding="2">
  <tr>
   ...
   <tr>
    <td colspan="3"><div align="center" class="titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="3"><b>ENTREVISTAS HECHAS POR DOCENTES </b></font></div></td>
  </tr>
  <?
  	$ob_reporte->ano = $ano;
  ...
  <tr>
    <td colspan="3" ><div align="center">
     <?php echo ($num>0)?'<hr size="1">':"<font class='subitem'>Sin entrevistas</font><br><hr size='1'>" ?> 
    </div></td>
  </tr>
  <?
  ...
  ?> 
   <tr>
    <td colspan="3"><div align="center" class="titulo"><font face="Verdana, Arial, Helvetica, sans-serif" size="3"><b>ENTREVISTAS HECHAS POR ORIENTADOR </b></font></div></td>
  </tr> 
  <?
  	$ob_reporte->ano = $ano;
	$ob_reporte->rut_entrevistado = $alumno;
	$res2 = $ob_reporte ->traeEntrevistaOrientador($conn);
	$num2 = @pg_numrows($res2);
  
  for ($x=0; $x < $num2; $x++){
      $fil2 = @pg_fetch_array($res2,$x);
	  
	  $fecha = $fil2['fecha'];
	  $acuerdos = $fil2['acuerdos'];
	  $observaciones = $fil2['observaciones'];
	  
	  ?>	
	  <tr>
		<td width="15%" valign="top" class="subitem" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1"> <? impF($fecha); ?></font></td>
		<td width="25%" valign="top" class="subitem" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1"><?=nl2br($observaciones) ?></font></td>
		<td width="60%" valign="top" class="subitem" ><font face="Verdana, Verdana, Arial, Helvetica, sans-seri" size="1"><?=nl2br($acuerdos) ?></font></td>
	  </tr>
	  <tr>
	    <td colspan="3" valign="top" ><hr size="1"></td>
  </tr>
