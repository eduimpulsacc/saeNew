...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeCertificadoTraslado_C.php?institucion=$institucion';
		form.submit(true);
	}	
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <td height="395" align="left" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                        <tr>
                          <td><!-- FIN DEL CONTENIDO CENTRAL DE LA PÁGINA -->
                            ...
                            <br>
                              <br>
                              <form method "post" action="printCertificadoTraslado_C.php" name="form" target="_blank">
  ...
  ?>
		...
		?>
                                                ...
                                                <tr>
                                                  <td class="cuadro01">Fecha Retiro  </td>
                                                  <td width="21" class="cuadro01">:</td>
                                                  <td width="495" class="cuadro01"><input type="text" name="txtFECHA" maxlength="10"></td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">Leyenda Retiro</td>
                                                  <td class="cuadro01">&nbsp;</td>
                                                  <td class="cuadro01"><input name="opcion" type="radio" id="radio" value="1" checked="CHECKED">
                                                    <label for="opcion"><em>se retira del establecimiento el d&iacute;a</em></label></td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">&nbsp;</td>
                                                  <td class="cuadro01">&nbsp;</td>
                                                  <td class="cuadro01"><input type="radio" name="opcion" id="radio2" value="0">
                                                    estuvo matriculado hasta</td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">&nbsp;</td>
                                                  <td width="21" class="cuadro01">&nbsp;</td>
