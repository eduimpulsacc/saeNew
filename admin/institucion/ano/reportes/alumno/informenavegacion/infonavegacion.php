...
$(function() {
  ...
  $(function() {
	...
	function buscapag(form){
			if (form.fechaIni.value!="" && form.fechaFin.value!="" || form.fechaIni.value){
				form.submit(true);
			}else{
				alert("Seleccione el rango de fechas a buscar");
				return false;
			}	
	}
...
if(opt==1){
	var ruta = "../informenavegacion/printInfoNavegacion.php";
}
else{
	var ruta = "../informenavegacion/printGraficoInfoNavegacion.php";
}
  ...
  <center>
    ...
    <tr>
      ...
      <tr>
        ...
        <td width="85%">
          <input type="text" name="fechaIni" id="fechaIni" value="" readonly placeholder="Seleccione una fecha"></td>
      </tr>
      <tr>
        <td width="15%">Fecha Fin</td>
        <td width="85%">
          <input type="text" name="fechaFin" id="fechaFin" value="" readonly placeholder="Seleccione una fecha"></td>
      </tr>
      <tr>
        <td>Formato</td>
        <td><input type="radio" name="formato" id="formato" value="1" onChange="act(this.value)">
          Listado <input type="radio" name="formato" id="formato" value="2" onChange="act(this.value)">
          Gráfico</td>
      </tr>
