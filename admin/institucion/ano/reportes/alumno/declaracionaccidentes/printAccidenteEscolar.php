...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
		...
		<? 
			if($institucion!=""){
			    echo "<img src='../../../../../../tmp/".$institucion."insignia". "' width='100' height=100 >";
		    }else{
  ...
  <tr>
    <td>
     <?php if(intval($fila_accidente['folio'])>0){ ?>
    <table align="right">
   
          <tr class="Estilo6">
            <td height="18"> Declaraci&oacute;n N&deg;</td>
            <td colspan="2"><?php echo $fila_accidente['folio'] ?></td>
            </tr>
