<SCRIPT language="JavaScript">
	...
	if (form.cmb_curso.value!=0){
		form.target="_self";
		form.action = 'entrevistaAlumno.php?institucion=$institucion';
		form.submit(true);
...
function tipoRep(){
var crc = document.getElementsByName("cmb_curso")[0].value;
if(crc==0){
	var ruta = "printConteoEntrevistaAlumno.php";
}
else{
	var ruta = "printentrevistaAlumno.php";
}
form.target="_blank";
		form.action = ruta;
		//form.submit(true);
                                                ...
                                                <tr>
                                                  <td width="269" class="cuadro01">Curso<br>
                                                       <select name="cmb_curso"  class="ddlb_9_x" onChange="enviapag(this.form);">
														<option value="0" selected>(RESUMEN CURSOS)</option>
														<?
                                                    ...
                                                    <br>
                                                    <br>
                <input name="cb_ok" type="submit" class="botonXX"  id="cb_ok"  value="Buscar" onClick="tipoRep()">
					<? if($_PERFIL==0){?>		  
