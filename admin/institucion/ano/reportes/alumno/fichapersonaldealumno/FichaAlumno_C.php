...
<?
  ...
  ?>
		...
		?>
                                                ...
                                                <tr>
                                                  <td class="cuadro01">Alumno Retirado </td>
                                                  <td width="21" class="cuadro01">:</td>
                                                  <td width="495" class="cuadro01"><input name="retirado" type="checkbox" id="retirado" value="1"></td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">Firma Apoderado </td>
                                                  <td width="21" class="cuadro01">:</td>
                                                  <td width="495" class="cuadro01"><label><input name="chk_apo" type="checkbox" id="chk_apo" value="1"></label></td>
                                                </tr>
                                                <tr>
    ...
    <td width="53" align="right" valign="top" background="../../../../../../<?=$_IMAGEN_DERECHA?>">&nbsp;</td>
  </tr>
      </table>
</td>
  </tr>
