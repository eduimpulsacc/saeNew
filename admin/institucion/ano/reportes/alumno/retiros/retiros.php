...
<SCRIPT language="JavaScript">
	...
	if (form.cmb_curso.value!=0){
		form.target="_self";
		form.action = 'retiros.php?institucion=$institucion';
		form.submit(true);
...
$(document).ready(function(){
  ...
  function validar(form){
	   if(document.getElementById('cmb_curso').value==0){
		 ...
		 else if(document.getElementById('fecha_hasta').value < document.getElementById('fecha_desde').value){
                        ...
                        <tr>
                          <td><!-- COPIO LOS BOTONES PARA QUE NO ESTÉN SEPARADOS -->
                            ...
                            <br>
                              ...
                              <form method="post" action="printInformeRetiros_C.php" name="form" target="_blank" onSubmit="return validar(this)">
                                            ...
                                            <td height="27"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="269" class="cuadro01">Curso<br>
                                                      ...
                                                      Fecha Desde
                                                      <input name="fecha_desde" type="text" id="fecha_desde" readonly>
                                                    <br>
                                                    Fecha Hasta
<input name="fecha_hasta" type="text" id="fecha_hasta" readonly>
<br>
                                                    <br>
