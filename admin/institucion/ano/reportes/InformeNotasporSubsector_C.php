...
<SCRIPT language="JavaScript">
	function enviapag(form){
		if (form.cmb_curso.value!=0){
			...
			window.location= 'InformeNotasporAsignatura_C.php?cmb_periodos=' + document.form.cmb_periodos.value + '&cmb_curso=' + document.form.cmb_curso.value;
		}	
	}			
...
<form method "POST" action="printNotassubsectorcursos_C.php" target="_blank" name="form">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="69" class="textosimple">Periodo</td>
    <td width="272">
	  <div align="left">
	    <select name="cmb_periodos" class="ddlb_9_x">
          ...
          $sqlcurso="SELECT id_curso from curso where id_ano=$ano LIMIT 1";
