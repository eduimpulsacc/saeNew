...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				form.target="_parent";
				form.action = 'InformeNotasFinales_C.php';
				form.submit(true);
 ...
 <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="589" align="left" valign="top"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
     ...
     <form method "post" action="printInformeNotasFinales_C.php" name="form" target="_blank">
     ...
     <input name="numero" type="hidden" value="<?=$numero;?>">
                                ...
                                <center>
                                  <table width="" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width=""><table width="" height="43" border="0" cellpadding="0" cellspacing="0">
                                          <tr>
                                            <td width="" class="tableindex"><? echo $numero.".- Buscador ".$nombre;?></td>
                                          </tr>
                                          <tr>
                                            <td height="27"><table width="" border="0" cellspacing="5" cellpadding="0">
                                                <tr>
                                                  <td width="53" class="textosimple">Curso</td>
                                                  <td width="207"><div align="left"> <font size="1" face="arial, geneva, helvetica">
                                                  ...
                                                  <td width="105" class="textosimple">Alumno</td>
                                                  <td width="191"><select name="cmb_alumno" class="ddlb_9_x">
...
<tr>
<td class="textosimple">Promoci&oacute;n realizada</td>
<td><input name="final" type="checkbox" id="final" value="1" checked></td>
<td class="textosimple">Tipo evaluaci&oacute;n </td>
<td><span class="textosimple">
<input name="tipo_eval" type="radio" value="0" checked="checked">
Promedio&nbsp;
<input name="tipo_eval" type="radio" value="1">
Ponderación
...
<td class="textosimple"><input name="ck_orden" type="radio" value="1" checked>
Alfabetico 
<input name="ck_orden" type="radio" value="0">
Nro Lista </td>
<td class="textosimple">&nbsp;</td>
<td class="textosimple">
<input name="tipo_eval" type="radio" value="3">
Ex. Semestral 
<input name="tipo_eval" type="radio" value="2">
Bonificaci&oacute;n
<input name="tipo_eval" type="radio" value="4">
Apreciaci&oacute;n<br><br>
<input type="checkbox" name="conexamen" id="conexamen" value="1">
Promedio Con Examen 
...
<tr>
  ...
  <td class="textosimple"><input type="radio" name="chkASISTENCIA" id="chkASISTENCIA" value="1" checked>
    SI
    <input name="chkASISTENCIA" type="radio" id="chkASISTENCIA" value="0">
    NO</td>
  <td class="textosimple">Mejor y promedio del curso</td>
  <td class="textosimple"><input name="rdMEJOR" type="radio" id="radio" value="1" checked>
    SI
      <input name="rdMEJOR" type="radio" id="radio2" value="0">
      NO</td>
</tr>

                                                <tr>
                                                  <td colspan="4" class="textosimple"><table width="320" border="0" cellspacing="2" cellpadding="0" align="left">
                                                      <tr>
                                                ...
                                                <tr>
                                                  <td colspan="4" class="textosimple"><div align="right">
