                    ...
                    <tr> 
                      <td width="27%" height="363" align="left" valign="top"> 
                       ...
                       <td width="73%" align="left" valign="top"><!-- cuerpo de la página --><br>
						 ...
						 ?>
						<form name="form" method="post" action="printInformeAtrasoPeriodo_C.php" target="_blank">
                        ...
                        <input name="numero" type="hidden" value="<?=$numero;?>">
                         ...
                         <table width="100%" height="43" border="1" cellpadding="0" cellspacing="0">
						  ...
						  <table width="100%" border="0" cellspacing="5" cellpadding="0">
							<tr>
							  <td width="100" class="textosimple">Modo Busqueda </td>
							  <td colspan="3" class="textosimple"><input name="rdOPCION"  id="rdOPCION" type="radio" value="1" checked onClick="busqueda(this.form);">
							    Periodo
							    <input name="rdOPCION" type="radio" id="rdOPCION" value="2" onClick="busqueda(this.form);">
						        Fecha</td>
						    </tr>
							<tr>
							  <td colspan="4" class="textosimple" align="left">
							  <div id="capa1" style="display:'block'">
							  <table width="100%">
                                <tr>
                                  <td width="130" class="textosimple">Periodo</td>
                                  <td ><select name="cmb_periodos" class="ddlb_9_x" onChange="enviapag(this.form);">
							...
							<table width="600" border="0" align="right" cellpadding="1" cellspacing="0">
                              <tr>
                                ...
                                <th width="64" scope="col"><div align="right">
                                  <input type="button" onClick="enviapag2(this.form)" name="cb_ex" id="cb_ex" value="Exportar" class="botonXX">
                                </div></th>
