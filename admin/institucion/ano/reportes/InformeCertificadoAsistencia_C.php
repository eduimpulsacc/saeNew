...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeCertificadoAsistencia_C.php?institucion=$institucion';
		form.submit(true);
	}	
}
                    ...
                    <td height="395" align="left" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                        <tr>
                          <td><!-- FIN DEL CONTENIDO CENTRAL DE LA PÁGINA -->
                            ...
                            <br>
                              <br>
                              <form method "post" action="printAsistenciaPorAlumno_C.php" name="form" target="_blank">
				...
				echo "<option value=".$fila['id_curso'].">".$Curso_pal."</option>";
												...
												?>
                                                    <select name="cmbPERIODO">
                                                      ...
                                                      <? for($x=0;$x<pg_numrows($result_periodo);$x++){
												  	$fila = pg_fetch_array($result_periodo,$x);
												?>
                                                      <option value="<?=$fila['id_periodo'].",".$fila['nombre_periodo'];?>">
                                                        <?=$fila['nombre_periodo'];?>
                                                        </option>
                                                      <? } ?>
                                                    </select>
