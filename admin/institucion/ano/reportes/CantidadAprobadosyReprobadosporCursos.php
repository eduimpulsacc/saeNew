...
//include('../../../clases/class_creadorselects.php');
...
function enviodatos() {  // INICIO 
		...
		var cmb_curso = document.getElementById('cmb_curso').value;
 ...
 window.open('printCantidadAprobadosyReprobadosporCurso.php?idcurso='+cmb_curso+'&idano='+cmb_ano+'&c_reporte='+c_reporte +'','Popup',caracteristicas); 
   
	}  // FIN FUNCION 
  
  
function crearselect(x) {  // INICIO
		...
		var ano = x;
		if (ano != "") var idano  = document.getElementById('cmb_ano').value; // parametro
		
		var crearselect  = 'curso'; // indicador del combo que se creara
					
		ajax.open("POST","../../../clases/class_creadorselects.php",true);
						
		  divimg.innerHTML=""
		  divimg.innerHTML='<img src="../../../clases/img_jquery/loading.gif">';
		  ...
		  ajax.onreadystatechange=function() {
			 ...
			 //}else  { divimg.innerHTML='<img src="../../../clases/img_jquery/loading.gif">'; }
														  
		  } 
		
		  ajax.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
          ajax.send("select="+crearselect+"&idano="+idano)
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"   onLoad="crearselect(<?=$ano?>)" >
      ...
      <tr>
        ...
        <td width="50%">
           ...
           <? 
			 ...
			 echo   '<select name="cmb_ano" id="cmb_ano" class="ddlb_x" onChange="crearselect()">';
		...
		<td width="50%" align="center">
          <input type="button" name="buscar" value="Buscar" class="BotonXX" onClick="enviodatos()" >
