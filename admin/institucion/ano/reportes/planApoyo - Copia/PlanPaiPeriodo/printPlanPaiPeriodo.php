...
?>
  ...
  <tr>
    ...
    <td class="item">&nbsp;</td>
	  ...
	  echo $ob_reporte->tildeM($nombre_alumno);  ?></td>
        ...
        <table width="650" border="0" align="center">
  <tr >
    <td colspan="5" class="textonegrita" >II. ESTRATEGIAS ESPECÍFICAS PARA FAVORECER EL ACCESO, LA PARTICIPACIÓN Y EL APRENDIZAJE</td>
  </tr>
  <tr >
    <td colspan="5" >&nbsp;</td>
  </tr>
  ...
  <tr >
    ...
    <td class="textosimple"><?php echo $f_responsable['ape_pat']." ".$f_responsable['ape_mat']." ".$f_responsable['nombre_emp'] ?></td>
...
(Se&ntilde;ala asignaturas y periodos)</td>
    ...
    <td class="textosimple"><?php echo $f_cresponsable['ape_pat']." ".$f_cresponsable['ape_mat']." ".$f_cresponsable['nombre_emp'] ?></td>
    <td class="textosimple"><?php echo $fila_plan['curricular_contexto'] ?></td>
    <td align="center"><?php echo ($fila_cont['curricular']==1)?"SI":""; ?></td>
  </tr>
  <tr>
    ...
    <td><span class="textosimple"><?php echo $f_vmresponsable['ape_pat']." ".$f_vmresponsable['ape_mat']." ".$f_vmresponsable['nombre_emp'] ?></span></td>
...
(Tiempo, espacio, forma de agrupar en la sala,tutor, etc.)</td>
    ...
    <td class="textosimple"><?php echo $f_orgresponsable['ape_pat']." ".$f_orgresponsable['ape_mat']." ".$f_orgresponsable['nombre_emp'] ?></td>
    <td class="textosimple"><?php echo $fila_plan['org_contexto'] ?></td>
    <td align="center"><?php echo ($fila_cont['organizacion']==1)?"SI":""; ?></td>
  </tr>
  <tr>
    <td class="tableindex">FAMILIAR</td>
    <td class="textosimple"><?php echo $fila_plan['familar_descripcion'] ?></td>
    <td class="textosimple"><?php echo $f_famresponsable['ape_pat']." ".$f_famresponsable['ape_mat']." ".$f_famresponsable['nombre_emp'] ?></td>
    <td class="textosimple"><?php echo $fila_plan['familar_contexto'] ?></td>
    <td align="center"><?php echo ($fila_cont['familiar']==1)?"SI":""; ?></td>
  </tr>
  <tr>
    <td class="tableindex">OTROS</td>
    <td class="textosimple"><?php echo $fila_plan['otros_descripcion'] ?></td>
    <td class="textosimple"><?php echo $f_otrresponsable['ape_pat']." ".$f_otrresponsable['ape_mat']." ".$f_otrresponsable['nombre_emp'] ?></td>
