...
<SCRIPT language="JavaScript">
	...
	function validaform(){
		...
		if($('#select_curso').val()==0){
		alert("Seleccione Curso");
		return false;
		}else if($('#select_mes').val()==0){
...
<!-- INICIO FORMULARIO DE BUSQUEDA -->
	...
	<form method="post" action="printJustificaAsistencia.php" name="form" target="_blank">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><label for="select_curso">
    	<select id="select_curso" name="select_curso">
    		<option value="0">Seleccione curso</option>
    		<?php 
    			for ($i=0; $i < @pg_numrows($result_curso) ; $i++) { 
    				$cursoSelect = @pg_fetch_array($result_curso,$i); 
		  
					echo "<option value=".$cursoSelect['id_curso'].">".$cursoSelect['grado_curso']."-".$cursoSelect['letra_curso']." ".$cursoSelect['nombre_tipo']."</option>";
    			}
    		 ?>
    	</select></td>
  </tr>
