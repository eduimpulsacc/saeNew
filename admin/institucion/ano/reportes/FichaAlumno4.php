...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'FichaAlumno4.php?institucion=$institucion';
				form.submit(true);
                    ...
                    <tr> 
                      <td width="27%" height="363" align="left" valign="top"> 
                        <table width="84%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <td height="181" align="left" valign="middle"><img src="../../../../cortes/banner_01.jpg" width="162" height="166"></td>
                          </tr>
                        </table></td>
    ...
    <td width="731" height="30" align="center" valign="top"> 
      <table width="729" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr> 
		  ...
		  <td width="81" height="30"><a href="Menu_Reportes.php" ><img src="../../botones/reportes_roll.gif" name="Image8" width="81" height="30" border="0" id="Image8"></a></td>
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent','FichaAlumno4.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
