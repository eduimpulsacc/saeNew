...
<SCRIPT language="JavaScript">
	...
	function enviapag(form){
		if (form.cmb_curso.value!=0){
			...
			window.location= 'InformeNotasporAsignatura_C.php?cmb_periodos=' + document.form.cmb_periodos.value + '&cmb_curso=' + document.form.cmb_curso.value +'&c_reporte=<?=$reporte;?>';
		}	
	}			
...
<form method="post" action="printInformeNotasporAsignatura_C.php" target="_blank" name="form">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    	...
    	<tr>
	  <td class="textosimple">Examen periodo</td>
	  <td class="textosimple"><input type="radio" name="ck_exm" value="1">
	    SI &nbsp;
	    <input name="ck_exm" type="radio" value="0" checked="CHECKED">
	    NO</td>
	  </tr>
	<tr>
		<td class="textosimple">Orden</td>
		<td class="textosimple"><input type="radio" name="ck_orden" value="1" checked="checked">Alfabetico &nbsp;<input type="radio" name="ck_orden" value="0">Nro Lista</td>
		</tr>
	<tr>
	  <td class="textosimple">Promedio</td>
	  <td class="textosimple"><input type="radio" name="ck_prom" value="1" checked="checked">
	    Mayor 
	      <input type="radio" name="ck_prom" value="2">
	      Menor 
	      <input name="txtPROM" type="text" id="txtPROM" size="5"></td>
	  </tr>
	<tr>
	  <td class="textosimple">Leccionario</td>
	  <td class="textosimple"><input type="radio" name="ck_lecc" value="1">
	    SI &nbsp;
	    <input name="ck_lecc" type="radio" value="0" checked="CHECKED">
	    NO</td>
	  </tr>
    </table>
	...
	<table width="600" border="0" align="right" cellpadding="1" cellspacing="0">
      <tr>
        ...
        <th width="64" scope="col"><div align="right">
          <input name="cb_ex" type="button" class="botonXX" onClick="enviapag2(this.form)" id="cb_ex" value="Exportar">
        </div></th>
