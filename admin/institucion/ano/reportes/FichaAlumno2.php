...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="119" rowspan="6"><div align="center"><img src=../../../../../../../tmp/<? echo $institucion ?> ALT="INISGNIA"  width=80 ></div></td>
	<? }?>
    <td width="404"><font face="Arial, Helvetica, sans-serif" size="-1"><strong><? echo $nombre_institu;?></strong></font></td>
		<?
		...
		if 	(!empty($fila_foto['foto']))
		{
			...
			$retrieve_result = @pg_exec($conn,$output);?>  		
    <td width="119" rowspan="6"><div align="center"><img src=../../../../../../../tmp/<? echo $alumno ?> ALT="FOTO"  width=70 ></div></td>
	<? }?>
  </tr>
  <tr>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td bgcolor="#003b85"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-1"><strong><font color="#FFFFFF">FICHA DEL ALUMNO</font></strong></font><font color="#FFFFFF" size="-2" face="Arial, Helvetica, sans-serif">&nbsp;</font></div></td>
  </tr>
</table>
<br>
<table width="650" border="0" cellspacing="0" cellpadding="0">
 ...
 <table width="650" border="0" cellspacing="0" cellpadding="0">
   <tr>
     <td width="102"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>BECA ALIMENTACION JUNAEB</strong></font></div></td>
     <td width="94"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>BENEFICIO CHILE SOLIDARIO </strong></font></div></td>
     <td width="103"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>ALUMNO ORIGEN INDIGENA</strong></font></div></td>
     <td width="76"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>REPITENDE DEL GRADO </strong></font></td>
     <td width="93"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>ALUMNA EMBARAZADA </strong></font></td>
     <td width="89"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>GRUPO DIFERENCIAL </strong></font></td>
     <td width="77"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>INTEGRADO</strong></font></div></td>
   </tr>
   <tr>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_baj?></font></div></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_bchs?></font></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_aoi?></font></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_rg?></font></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_ae?></font></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_gd?></font></td>
     <td><font face="Arial, Helvetica, sans-serif" size="-2"><? echo $bool_i?></font></td>
   </tr>
   <tr>
