...
<?php 
	...
	if ($sw == 1){
	   ...
	   echo $sql = "select  * from periodo where id_ano = ".$ano." and id_periodo = ".$periodo." order by fecha_inicio" ;
	   $result10 =@pg_Exec($conn,$sql);
	   if (!$result10) 
	   {
	   ...
	   else
	   {
	     ...
	     {
		     $fila1 = @pg_fetch_array($result10,0);	
		     if (!$fila1)
		     {
			     error('<B> ERROR :</b>Error al acceder a la BD. (PERIODOS)</B>');
			     exit();
		...
		<?
		  ...
		  echo "aqui3";
		   ...
		   for($i=0 ; $i < @pg_numrows($result10) ; $i++)
			...
			$fila1 = @pg_fetch_array($result10,$i);
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">Firma Apoderado AA</font></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="center"><font size="1" face="Arial, Helvetica, sans-serif">Firma Apoderado 2 </font></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
