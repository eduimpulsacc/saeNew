...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				form.target="_parent";
				form.action = 'InformeNotasSemestrales_C.php';
				form.submit(true);
                    ...
                    <td height="395" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                        <tr>
                          <td><br>
                              ...
                              <form method "post" action="printInformeNotasSemestrales_C.php" name="form" target="_blank">
                                          ...
                                          <tr>
											...
											<table width="" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  ...
                                                  <td width="263"><div align="left"> <font size="1" face="arial, geneva, helvetica">
                                                ...
                                                <tr>
                                                  <td colspan="3"><table width="320" border="0" cellspacing="2" cellpadding="0" align="center">
                                                      <tr>
                                                      ...
                                                      <tr>
                                                        <td class="textosimple">Tipo de evaluaci&oacute;n </td>
                                                        <td colspan="3"><input name="tipo_eval" type="radio" value="0" checked="checked"> Promedios</td>
                                                      </tr>
                                                      <tr>
                                                        <td class="textosimple">&nbsp;</td>
                                                        <td colspan="3"><input name="tipo_eval" type="radio" value="1">Ponderación</td>
                                                      </tr>
                                                      <tr>
                                                        <td class="textosimple">Subsector no valido </td>
                                                        <td colspan="3"><input name="ck_subsector" type="checkbox" id="ck_subsector" value="1"></td>
                                                      </tr>
                                                      <tr>
                                                        <td class="textosimple">Promoci&oacute;n realizada</td>
                                                        <td colspan="3"><input name="chk_final" type="checkbox" id="chk_final" value="1"></td>
                                                      </tr>
                                                      <tr>
                                                        <td class="textosimple">Cuadro Asistencia</td>
                                                        <td colspan="3"><input name="chkASISTENCIA" type="checkbox" id="chkASISTENCIA" value="1" checked></td>
                                                      </tr>
                                                  </table>
												  </td> 
												  <td>&nbsp;</td>
