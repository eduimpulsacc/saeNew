...
<table width="650" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <table width="650" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
                                  <tr>
                                ...
                                <br>
                                <table width="650" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333" class="Estilo2">
                                  <tr>
...
(SELECT id_curso FROM curso WHERE id_ano=".trim($ano)."  AND grado_curso=1))";
                                ...
                                <table width="650" border="0" cellpadding="0" cellspacing="0" class="Estilo2">
                                  ...
                                  <tr>
                                    <td valign="top"><table width="650" border="1" cellpadding="0" cellspacing="0" bordercolor="#333333">
                                      <tr>
