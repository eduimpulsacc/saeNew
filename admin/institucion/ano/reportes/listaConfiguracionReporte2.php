<?php 	require('../../../../util/header.inc');
	...
	$rs_reporte=$ob_reporte->BuscaReporte2($conn);
                                ...
                                <table width="100%" border="0">
                                  <tr>
                                    <td width="100%"><div align="right">
										...
										<input name="volver" type="button"  class="botonXX" id="volver" value="VOLVER" onClick="window.location='Menu_Reportes_new.php'">
                                    </div></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td class="cuadro01"><table width="100%" border="1" align="center">
                                        <tr class="cuadro01">
                                          ...
                                          <td colspan="12"><div align="center">GRADOS EN QUE APLICA </div></td>
                                        </tr>
                                        <tr class="cuadro01">
                                          <td>1</td>
                                          <td>2</td>
