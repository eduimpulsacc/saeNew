...
if (form.cmb_curso.value!=0){
	form.target="_parent";
	form.action = 'InformePersonalidadFinal.php';
	form.submit(true);
...
<form method "post" action="printInformePersonalidadFinal.php" name="form" target="_blank">
...
NO</td>
  ...
  if($_PERFIL==0){?>
    ...
    <td class="textosimple">Agregar Portada (s&oacute;lo Ens. P&aacute;rvulos)</td>
     <td  class="textosimple"><input name="chk_portada" type="checkbox" id="chk_portada" value="1"></td>
