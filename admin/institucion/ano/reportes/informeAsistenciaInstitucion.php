...
$result_peri = $ob_motor ->periodo($conn);
	...
	$rs_anio = $ob_reporte->AnoInstitucion($conn);
...
function enviapag(form){
	if (form.anodesde.value!=0){
		form.anodesde.target="self";
		form.target="_blank";
		form.action = 'printinformeAsistenciaInstitucion.php';
		form.submit(true);
	}	
}
                                      ...
                                      <td><table width="100%" height="43" border="1" cellpadding="0" cellspacing="0">
                                          ...
                                          <tr>
                                            <td height="27"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="35%" align="right" class="cuadro01"><div align="right">A&ntilde;os acad&eacute;micos</div></td>
                                                  <td class="cuadro01"><label for="anodesde"></label>
                                                    <select name="anodesde" id="anodesde" >
