...
if ($curso != 0){
   ...
   <tr>
    <td><div id="capa0">
		<div align="right">
          <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printInformeAsistenciaporhoras.php?c_curso=<?=$curso ?>&mes=<?=$mes ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
        </div>
      </div></td>
   </tr>
  </table>
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<select name="mes" class="ddlb_9_x">
        ...
        <option value="01" <? if ($mes=="01"){ ?> selected="selected" <? } ?>>Enero</option>
		<option value="02" <? if ($mes=="02"){ ?> selected="selected" <? } ?>>Febrero</option>
		<option value="03" <? if ($mes=="03"){ ?> selected="selected" <? } ?>>Marzo</option>
		<option value="04" <? if ($mes=="04"){ ?> selected="selected" <? } ?>>Abril</option>
		<option value="05" <? if ($mes=="05"){ ?> selected="selected" <? } ?>>Mayo</option>
		<option value="06" <? if ($mes=="06"){ ?> selected="selected" <? } ?>>Junio</option>
		<option value="07" <? if ($mes=="07"){ ?> selected="selected" <? } ?>>Julio</option>
		<option value="08" <? if ($mes=="08"){ ?> selected="selected" <? } ?>>Agosto</option>
		<option value="09" <? if ($mes=="09"){ ?> selected="selected" <? } ?>>Septiembre</option>
		<option value="10" <? if ($mes=="10"){ ?> selected="selected" <? } ?>>Octubre</option>
		<option value="11" <? if ($mes=="11"){ ?> selected="selected" <? } ?>>Noviembre</option>
		<option value="12" <? if ($mes=="12"){ ?> selected="selected" <? } ?>>Diciembre</option>
    </select></td>
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" onClick="MM_goToURL('parent','InformeAsistenciaporhoras.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_mes='+mes.options[mes.selectedIndex].value+'&cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&mes='+mes.options[mes.selectedIndex].value);return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
