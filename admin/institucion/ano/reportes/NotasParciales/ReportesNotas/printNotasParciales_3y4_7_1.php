...
/*function envia_mes2($mes){
   ...
   if ($periodo==0) $sw = 1;
	...
	$sql="SELECT nom_com FROM institucion i INNER JOIN comuna c ON i.region=c.cod_reg AND i.ciudad=c.cor_pro AND i.comuna=c.cor_com WHERE rdb=".$institucion;
				  ...
				  <table width="750" border="1" align="center" cellpadding="2" cellspacing="1">
					...
					for($e=0 ; $e < @pg_numrows($result) ; $e++){
					   ...
					   for ($iii=0; $iii < $num_peri; $iii++){
							...
							$sql3 = "SELECT promedio FROM notas$nro_ano WHERE rut_alumno='".$alumno."' AND id_ramo='$id_ramo' AND id_periodo='$id_periodo2'";
			...
			?>
				...
				<table width="650" border="0" align="center">
				  <tr><td align="right"><?	
							...
							echo "<font face='verdana' size='1'>".$comuna.", ".fecha_espanol($fecha)."</font>";
							?>
