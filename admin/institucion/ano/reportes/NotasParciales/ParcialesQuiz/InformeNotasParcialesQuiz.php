...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeNotasParcialesQuiz.php';
		form.submit(true);
	}	
}
...
function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'printInformeNotasParcialesQuiz.php?xls=1';
...
<? //if($_PERFIL==0 && $institucion==25114){?>
	<form method "post" action="printInformeNotasParcialesQuiz.php" name="form" target="_blank">
<? //}else{ ?>
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="textosimple"><input name="opc_Colilla" type="checkbox" value="1" checked>C/Colilla	</td>
    <td>&nbsp;</td>
  </tr>
