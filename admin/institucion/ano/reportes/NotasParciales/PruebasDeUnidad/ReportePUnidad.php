...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'ReportePUnidad.php';
		form.submit(true);
	}	
}
...
/*function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'printReportePUnidad.php?xls=1';
...
if( form.c_curso.value!=0 || form.cmb_periodos.value!=0)	
{
	...
	if(document.getElementById('puni0').checked){
		var ruta = "printReportePUnidad.php";
	}
	else if(document.getElementById('puni1').checked){
		var ruta = "printReportePSintesis.php";
	}
...
<table width="" border="0" cellspacing="0" cellpadding="0">
 ...
 <!-- <tr>
  ...
  <tr>
    ...
    <td class="textosimple"><input type="radio" name="tipop" id="puni0" value="0">
Prueba de Unidad
  <input type="radio" name="tipop" id="puni1" value="1">
Prueba de S&iacute;ntesis</td>
    <td>&nbsp;</td>
  </tr>
  <!--<tr>
	...
	<table width="650" border="0" cellpadding="1" cellspacing="0">
      <tr>
        <th width="512" scope="col"><div align="right">
          <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" value="Buscar" onClick="elige()">
        </div></th>
