  ...
  <?
                if($tipo_rep==5){
					if($fila['coef2']==0){
						...
						?>
				      <td  align="center" class="subitem" rowspan="2" ><font color="<?php echo ($prom_anual>0 && $prom_anual<40)?'#FF0000':"#000000" ?>"><b>
				        <? 
  ...
  <?
                if($tipo_rep==5){
					if($fila['coef2']==0){
						...
						?>
				      <td  align="center" class="subitem" rowspan="2" ><font color="<?php echo ($prom_anual>0 && $prom_anual<40)?'#FF0000':"#000000" ?>" style="font-weight:bold"><b>
				        <? 
...
<tr>
	<td align="center" width="200"><div style="width:95%;background-color:#ccc; border:1px #000000 solid; text-align:center" class="item" align="center"><strong>I: Insuficiente</strong><br />1.0 a 3.9</div></td>
      <td align="center" width="200"><div style="width:95%;background-color:#ccc; border:1px #000000 solid; text-align:center" class="item" align="center"><strong>S: Suficiente</strong><br />4.0 a 4.9</div></td>
        <td align="center" width="200"><div style="width:95%;background-color:#ccc; border:1px #000000 solid; text-align:center" class="item" align="center"><strong>B: Bueno</strong><br />5.0 a 5.9</div></td>
          <td align="center" width="200"><div style="width:95%;background-color:#ccc; border:1px #000000 solid; text-align:center" class="item" align="center"><strong>MB: Muy bueno</strong><br />6.0 a 7.0</div></td>
</tr>
</table>
<br />
<table align="center" border="0" cellpadding="0" cellspacing="0" width="800">
<tr><td class="textosimple">*<i>Las calificaciones obtenidas de las evaluaciones incluidas en este informe, enmarcadas por decreto 67, se traducen en nivel de desempe&ntilde;o (Insuficiente, Suficiente, Bueno y Muy Bueno), seg&uacute;n corresponda.</i></td></tr>
</table>
<br />
