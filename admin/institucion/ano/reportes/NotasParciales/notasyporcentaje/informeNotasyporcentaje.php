...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'informeNotasyporcentaje.php';
		form.submit(true);
	}	
}
...
function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'informeNotasyporcentaje.php?xls=1';
...
<form method "post" action="printinformeNotasyporcentaje.php" name="form" target="_blank">
