...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeNotasParcialesPorcentaje.php';
		form.submit(true);
	}	
}
...
function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'InformeNotasParcialesPorcentaje.php?xls=1';
...
<form method "post" action="print_NotasParcialesPorcentaje.php" name="form" target="_blank">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="27">
	<table width="" border="0" cellspacing="0" cellpadding="3" class="cuadro01">
  ...
  <tr class="cuadro01">
    ...
    <td><div align="left"><span class="cuadro01">
  ...
  <tr>
    ...
    <td class="textosimple">
	   ...
	   <!-- <input name="tipo_rep" type="radio" value="1">C/Subsector Hijo--><br>
  ...
  <tr>
    ...
    <td class="textosimple"><input name="opc_mprom" type="checkbox" id="opc_mprom" value="1" checked>
      Mostrar promedios <?php //if($_PERFIL==0){?>
