		 ...
		 $sqlperiodosd = "Select * from periodo where id_ano = $ano  and id_periodo=$perio order by fecha_inicio";
	        ...
	        for($perx=0 ; $perx < @pg_numrows($resultPerx) ; $perx++)
			{
		        ...
		        for($pmx=0 ; $pmx < @pg_numrows($result_perix) ; $pmx++)
				{
				 ...
				 $sql ="SELECT avg(cast(promedio as integer)) FROM notas$nro_ano WHERE rut_alumno=".$alumno." AND id_periodo=".$periodosx." and promedio > '0'";
...
if($progP==1){
	...
	<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="361" class="item"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><? echo strtoupper(trim($ob_membrete->ins_pal)) ?></font></div></td>
        <td width="161" rowspan="7" align="center" valign="top" ><?
					$result = @pg_Exec($conn,"select insignia,rdb from institucion where rdb=".$institucion);
					$arr=@pg_fetch_array($result,0);
					$fila_foto  = @pg_fetch_array($result,0);
      ...
      <tr>
        ...
        <td class="item"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><? echo trim($nro_ano) ?></font></div></td>
      </tr>
      <tr>
        <td><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><strong>CURSO</strong></font></div></td>
        <td class="item"><strong>:</strong></td>
        <td class="item"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><? echo $Curso_pal; ?></font></div></td>
      </tr>
      <tr>
        <td><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><strong>ALUMNO</strong></font></div></td>
        <td class="item"><strong>:</strong></td>
        <td class="item"><div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
...
<?php }?>
                      ...
                      <strong><font color="<?php echo ($prome_1<40 && $prome_1>0 )?"#FF0000":"#000000" ?>" face="Arial, Helvetica, sans-serif" size="1">
                      <? 
echo $prome_1 ?>
                      <?php 
...
echo $prome_1 ?><? } else { echo $prome_1; } ?> 
<?php }?>
					</font><font color="<?php echo ($prome_1<40 && $prome_1>0 )?"#FF0000":"#000000" ?>" face="Arial, Helvetica, sans-serif" size="1">
                    <? 
echo $prome_1 ?>
					<?php 
	$ob_reporte->pminimo = $prome_1;
