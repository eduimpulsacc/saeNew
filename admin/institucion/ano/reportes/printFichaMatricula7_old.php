...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="textonegrita"><div align="center">FICHA DE MATRICULA --- hh</div></td>
...
<table width="650" border="1" align="center" style="border-collapse:collapse">
  ...
  <tr>
    <td width="123" valign="top" class="textosimple">NOMBREssssss</td>
  ...
  <tr>
    ...
    <td  valign="top" class="textosimple"><?php echo $fila['bool_estudio_anoant'] ?></td>
...
<br />
<table width="650" border="0" align="center" style="border-collapse:collapse">
  <tr>
...
<table width="650" border="0" align="center" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td width="84" class="textosimple"><input type="checkbox" name="checkbox5" id="checkbox7" />
      SI
  ...
  <tr>
    ...
    <td class="textosimple"><input type="checkbox" name="checkbox6" id="checkbox9" />
      SI
  ...
  <tr>
    ...
    <td class="textosimple"><input type="checkbox" name="checkbox7" id="checkbox11" />
      SI
  ...
  <tr>
    ...
    <td class="textosimple"><input type="checkbox" name="checkbox8" id="checkbox13" />
      SI
...
<table width="650" border="1" align="center" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td align="center" class="textosimple"><input type="checkbox" name="checkbox24" id="checkbox37" /></td>
    <td class="textosimple">CERTIFICADO DE NOTAS</td>
    <td align="center" class="textosimple"><input type="checkbox" name="checkbox28" id="checkbox41" /></td>
  </tr>
  <tr>
    ...
    <td align="center" class="textosimple"><input type="checkbox" name="checkbox29" id="checkbox42" /></td>
  </tr>
  <tr>
    <td class="textosimple">PLAZO FECHA</td>
    <td align="center" class="textosimple"><input type="checkbox" name="checkbox26" id="checkbox39" /></td>
  ...
  <tr>
    ...
    <td align="center" class="textosimple"><input type="checkbox" name="checkbox27" id="checkbox40" /></td>
...
<table width="650" border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td valign="top" class="textosimple">ESTADO CIVIL</td>
    <td valign="top" class="textosimple">&nbsp;<?=$fila['estado_civil'];?></td>
  </tr>
  <tr>
    <td width="123" valign="top" class="textosimple">DOMICILIO</td>
    <td valign="top" class="textosimple" colspan="3">&nbsp;<?=$fila['calle']." ".$fila['nro'];?></td>
  ...
  <tr>
    ...
    <td width="140" valign="top" class="textosimple">TELEFONO FIJO:</td>
    <td valign="top" class="textosimple">&nbsp;<?=$fila['telefono'];?></td>
  </tr>
  <tr>
    <td valign="top" class="textosimple">CELULAR</td>
    <td valign="top" class="textosimple">&nbsp;<?=$fila['celular'];?></td>
    <td valign="top" class="textosimple">E-MAIL</td>
    <td valign="top" class="textosimple">&nbsp;<?=$fila['email'];?></td>
  </tr>
  <tr>
    <td valign="top" class="textosimple">TRABAJA</td>
    <td  valign="top" class="textosimple">&nbsp;<?=($fila['bool_trabaja']==1)?"SI":"NO";?></td>
  ...
  <tr>
    ...
    <td valign="top" class="textosimple">ESTUDIOS DE LA MADRE</td>
    <td valign="top" class="textosimple">&nbsp;<?=$fila['nivel_edu_madre'];?></td>
  </tr>
</table>
<br />
<table width="650" border="1" align="center" style="border-collapse:collapse">
...
<table width="650" border="1" align="center" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td class="textosimple"><? if($fila['bool_integracion']==1) echo "SI"; else echo "NO";?></td>
    <td class="textosimple">FICHA PROTECCION SOCIAL</td>
    <td class="textosimple"><input type="checkbox" name="checkbox17" id="checkbox25" />
      SI
