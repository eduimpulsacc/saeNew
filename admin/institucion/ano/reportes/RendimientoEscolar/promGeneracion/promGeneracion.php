                    ...
                    <td height="395" align="left" valign="top"><table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                        <tr>
                          <td><!-- FIN DEL CONTENIDO CENTRAL DE LA PÁGINA -->
                            ...
                            <br>
                              <br>
                              <form method="post" action="printpromGeneracion.php" name="form" target="_blank">
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td ><table width="100%" height="43" border="1" cellpadding="0" cellspacing="0">
                                          ...
                                          <tr>
                                            <td height="27" class="cuadro01"><table width="650" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                  <td width="35%" class="cuadro01"><div align="left">Curso</div></td>
					  ...
					  $ob_motor->institucion = $institucion;
						...
						?>
                                                ...
                                                <tr>
                                                  <td class="cuadro01">Porcentaje Logro</td>
                                                  <td class="cuadro01">                                                    <input name="prc_logro" type="text" id="prc_logro" size="5"> 
                                                    (Solo valores enteros)</td>
                                                </tr>
                                                <tr>
                                                  <td class="cuadro01">Ver promedio</td>
                                                  <td class="cuadro01"><input name="rango" type="radio" id="radio" value="1" checked="CHECKED">
                                                    A&ntilde;o actual
                                                    <br>
<input name="rango" type="radio" id="rango" value="2">
Hist&oacute;rico
<label for="rango"></label></td>
                                                </tr>
                                                <tr>
