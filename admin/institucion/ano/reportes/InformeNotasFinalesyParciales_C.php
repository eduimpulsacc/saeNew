...
<form method "post" action="printInformeNotasFinalesyParciales.php" name="form" target="_blank">
  ...
  <tr>
    ...
    <td width="263">
	  <div align="left"> 
	    ...
	    <select name="c_curso"  class="ddlb_9_x">
    ...
    <td width="80"><div align="right"><? if($_PERFIL==0){?><? }?>
    </div></td>
  </tr>
  <tr>
    <td class="textosimple">Promedios</td>
    <td  class="textosimple"><input name="ckPROMEDIO" type="radio" value="0" checked>
      Aritmetico 
        <input name="ckPROMEDIO" type="radio" value="1">
        Apreciacion</td>
    <td class="textosimple">Orden</td>
    <td class="textosimple"><input name="ck_orden" type="radio" value="1" checked="checked">
      Alfabetico 
