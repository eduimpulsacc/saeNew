...
order by a.tipo desc, fecha";
	...
	if($institucion==11209){ echo $sql_anota2;}
...
<?
	...
	for($e=0 ; $e < @pg_numrows($result_anota) ; $e++)
	{
		...
		if ($fila_anota['tipo']==4 and $fila_anota['tipo_conducta']==2){
			$tipo_conducta = "NEGATIVA";
			$contadoralumno_negativas++;
		}	
		
		if ($fila_anota['tipo']==1 and $fila_anota['tipo_conducta']==2){
			$tipo_conducta = "NEGATIVA";
			$contadoralumno_negativas++;
		}	
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td class="item"><strong>:</strong></td>
    <td colspan="4" class="subitem"><? echo utf8_decode($observacion)?></td>
    </tr>
  <?	if($fila_anota["sigla"]!=""){	?>
  <tr>
...
//  if ($_INSTIT==12086){ 
  ...
  <tr>
    ...
    <td width="50%" align="center" height="30" class="item"><strong>Curso</strong></td>
  </tr>
  <tr>
    <td class="item"><strong>Total anotaciones Positivas&nbsp;&nbsp;&nbsp;: <?=$contadoralumno_positivas; ?></strong></td>
    <td class="item"><strong>Total anotaciones Positivas&nbsp;&nbsp;&nbsp;: <?=$contadorcurso_positivas; ?></strong></td>
  </tr>
  <tr>
    <td class="item"><strong>Total anotaciones Negativas&nbsp;&nbsp;: <?=$contadoralumno_negativas; ?> </strong></td>
    <td class="item"><strong>Total anotaciones Negativas&nbsp;&nbsp;: <?=$contadorcurso_negativas; ?></strong></td>
  </tr>
  </table><br>
