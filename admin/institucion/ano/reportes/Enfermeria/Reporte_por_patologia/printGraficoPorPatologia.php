...
$rs_atenciones=$ob_reporte->EstadisticaenfermeriaPatologia($conn);
...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'INFORME ESTADISTICO DE ATENCIONES POR PATOLOGIA'
        },
        tooltip: {
		...
		echo "['".CursoPalabra($fila_atencion['id_curso'],1,$conn) ."',   ".($fila_atencion['cuenta']*100)/$fila_atencion['total']."],";
		?>
		<?php }?>
...
<table width="650" border="0" align="center">
 ...
 <tr>
    ...
    <?php for($a=0;$a<pg_numrows($rs_atenciones);$a++){
		...
		?>
  <tr class="textosimple">
      <td ><span class="textosimple"><?php echo CursoPalabra($fila_atencion['id_curso'],1,$conn) ?></span></td>
