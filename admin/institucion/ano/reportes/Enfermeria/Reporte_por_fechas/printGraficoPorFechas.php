...
$rs_atenciones=$ob_reporte->ConteoEnfermeriaFecha($conn);
...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'INFORME ESTADISTICO DE ATENCIONES POR FECHA'
        },
        tooltip: {
        ...
        series: [{
            type: 'pie',
            name: 'Grafico por fechas',
            data: [
			<?php for($a=0;$a<pg_numrows($rs_atenciones);$a++){
		$fila_atencion = pg_fetch_array($rs_atenciones,$a);
		echo "['".CambioFD($fila_atencion['fecha']) ."',   ".($fila_atencion['cuenta']*100)/$fila_atencion['total']."],";
		?>
		<?php }?>
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td class="textosimple">DESDE <?php echo $f_incio ?> HASTA <?php echo $f_fin ?></td>
  </tr>
  <tr>
</table><br />
...
<table width="650" border="0" align="center">
 ...
 <tr>
    ...
    <?php for($a=0;$a<pg_numrows($rs_atenciones);$a++){
		...
		?>
  <tr class="textosimple">
      <td ><span class="textosimple"><?php echo CambioFD($fila_atencion['fecha']) ?></span></td>
