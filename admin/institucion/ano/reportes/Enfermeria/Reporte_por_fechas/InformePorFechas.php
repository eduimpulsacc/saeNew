...
$rs_patologia = $ob_motor->Patologia($conn);
...
if(opt==1){
	var ruta = "printInformePorFechas.php";
}
else if (opt==2){
	var ruta = "printGraficoPorFechas.php";
}
else{
	var ruta = "printConsolidadoPorFechas.php";
}
  ...
  <tr>
    <td colspan="2" class="cuadro01">Fecha Inicio
	  ...
	  <div align="left">
	    ...
	    <input type="text" name="f_incio" id="f_incio">
	    <br>
	  </div></td>
    </tr>
	<tr>
	...
	<tr>
	  <td colspan="2" class="cuadro01"><input type="radio" name="tipo" id="tipo1" value="1" onChange="act(this.value)">
	  
	    Detalle</td>
	  </tr>
	<tr>
	  <td colspan="2" class="cuadro01"><input type="radio" name="tipo" id="tipo1" value="2" onChange="act(this.value)">
	    Gr&aacute;fico</td>
	  </tr>
	<tr>
	  <td colspan="2" class="cuadro01"><input type="radio" name="tipo" id="tipo2" value="3" onChange="act(this.value)"> 
	    Consolidado
</td>
	  </tr>
	<tr>
