...
$rs_atenciones=$ob_reporte->EnfermeriaFecha($conn);
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tableindex"><div align="center">INFORME DE ATENCIONES POR RANGO DE FECHAS</div></td>
    </tr>
  <tr>
    <td c>&nbsp;</td>
  </tr>
...
EGRESO</td>
   ...
   <?php  for($a=0;$a<$cont_atencion;$a++){
	   ...
	   ?>
  <tr>
    <td class="textosimple"><?php echo $fila_atencion['nombre_patologia'] ?></td>
