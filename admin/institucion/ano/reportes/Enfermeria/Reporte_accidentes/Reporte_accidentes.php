  ...
  <tr>
	...
	<tr>
	  <td colspan="2" class="cuadro01"><br>
	    Curso
	    <br>
		   <select name="cmb_curso" id="cmb_curso" class="ddlb_9_x"  >
	...
	<tr>
	  <td colspan="2" class="cuadro01">Tipo de Reporte</td>
	  </tr>
	<tr>
	  <td colspan="2" class="cuadro01">&nbsp;</td>
	  </tr>
	<tr>
	  <td colspan="2" class="cuadro01"><input name="tipo" type="radio" id="tipograf" value="1" onChange="act(this.value)">
	    Listado 
