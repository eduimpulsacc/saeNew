...
$cont_atencion = $ob_reporte->TraeAccidentecuenta($conn);
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tableindex"><div align="center">GR&Aacute;FICO DECLARACI&Oacute;N ACCIDENTES</div></td>
    </tr>
  <tr>
    <td c>&nbsp;</td>
  </tr>
...
$(function () {
    ...
    $('#container').highcharts({
        ...
        title: {
            text: 'Listado accidentes escolares'
        },
        subtitle: {
            text: 'Periodo <?php echo $f_incio ?> a <?php echo $f_fin ?>.'
        },
        xAxis: {
            type: 'category'
        },
	   ...
	   ?>
			{
                name: '<?php echo ($fila_atencion['tipo']==1)?"Trayecto":"En establecimiento" ?>',
                y: <?php echo $fila_atencion['cuenta'] ?>
