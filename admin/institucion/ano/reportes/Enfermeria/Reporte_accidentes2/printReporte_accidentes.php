...
<table width="650" border="0" align="center" cellspacing="0">
  <tr class="tableindex">
    ...
    <td width="63" align="center">Folio</td>
    <td width="88" align="center">Fecha</td>
    <td width="79" align="center">Hora</td>
    <td width="312" align="center">Alumno</td>
    <td width="79" align="center">Tipo</td>
  </tr>
  ...
  <tr class="textosimple">
    ...
    <td align="center"><?php echo  ($fila_atencion['tipo']==1)?"DE TRAYECTO":"EN EL ESTABLECIMIENTO" ?></td>
  </tr>
  <?php }?>
</table>
