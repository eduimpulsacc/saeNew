...
if(opt==1){
	var ruta = "printInformePorAlumno.php";
}
else{
	var ruta = "printGraficoPorAlumno.php";
}
  ...
  <tr>
	...
	<tr>
	  <td colspan="2" class="cuadro01"><br>
	    Curso
	    <br>
		   <select name="cmb_curso" id="cmb_curso" class="ddlb_9_x" onChange="enviapag()" >
	  ...
	  <td colspan="2" class="cuadro01"><br>
	    ...
	    <br>
        <div id="alumno">
		   <select name="cmbALUMNO"  class="ddlb_9_x" >
