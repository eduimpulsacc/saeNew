...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="tableindex"><div align="center">INFORME DE ATENCIONES POR ALUMNO</div></td>
    </tr>
  <tr>
    <td c>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td class="textosimple"><strong>ALUMNO:</strong> <?=$alumno[1];?></td>
  </tr>
  <tr>
</table><br />
<table width="650" border="1" align="center" cellpadding="1" cellspacing="1" style="border-collapse:collapse">
  <tr>
    <td width="93" align="center" class="tableindex">PATOLOGIA</td>
...
EGRESO</td>
   ...
   <?php  for($a=0;$a<$cont_atencion;$a++){
	   ...
	   ?>
  <tr>
    <td height="25" class="textosimple"><?php echo $fila_atencion['nombre_patologia'] ?></td>
    ...
    <td class="textosimple"><?php echo utf8_decode($fila_atencion['destino']); ?></td>
  </tr>
  <?php }?>
</table><br />
<br />
