...
if (form.cmb_curso.value!=0){
	form.target="_parent";
	form.action = 'InformePersonalidadAnual_C.php';
	form.submit(true);
...
<!-- INICIO FORMULARIO DE BUSQUEDA -->
 <?php //$acc = ($_PERFIL==0)?"printInformePersonalidadAnual_CS.php":"printInformePersonalidadAnual_C.php"; 
  $acc = "printInformePersonalidadAnual_CS.php";   ?> 
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td colspan="2"><select name="cmb_alumno" class="ddlb_9_x">
  ...
  <tr>
    ...
    <td width="142" class="textosimple"><input name="retirado" type="radio" value="1">
SI
  <input name="retirado" type="radio" value="0" checked>
NO</td>
    <td class="textosimple">Evaluaci&oacute;n</td>
    <td colspan="2"><input name="evaluacion" type="radio" value="2">
      Concepto 
  ...
  <tr>
    ...
    <td colspan="2" class="textosimple"><input name="destaca" type="radio" value="0" checked>
      SI 
  ...
  <tr>
    ...
    <td class="textosimple">Agregar Edad</td>
    <td colspan="2" class="textosimple">
      <input name="chk_edad" type="checkbox" id="chk_edad" value="1">
    </td>
    <td><span class="textosimple">Incluir<br>
      Auntoevaluaci&oacute;n</span></td><td colspan="2"><span class="textosimple">
      <input name="ckAUTO" type="radio" value="1">
SI
<input name="ckAUTO" type="radio" value="0" checked="CHECKED">
NO</span></td><td>&nbsp;</td>
    </tr>
  <tr>
    ...
    <td width="103" class="textosimple"><input name="escala" type="radio" value="1" checked>
      SI 
        <input name="escala" type="radio" value="2">
        NO</td>
    <td width="116" class="textosimple"><input name="posicion_escala" type="radio" value="1">
      Arriba 
        <input name="posicion_escala" type="radio" value="2" checked="CHECKED">
        Abajo</td>
  ...
  <tr>
    ...
    <td colspan="2" class="textosimple"><input type="checkbox" name="chk_apo" value="1"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="textosimple">Fecha</td>
    <td colspan="2" class="textosimple" id="textfield"><label for="txtFECHA"></label>
      <input name="txtFECHA" type="text" id="txtFECHA" value="<?=date("d-m-Y");?>" maxlength="10"></td>
    <td class="textosimple">Asistencia(%)</td>
    <td colspan="2" class="textosimple"><input name="chk_asis" type="checkbox" id="chk_asis" value="1" checked></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td class="textosimple">Hoja anexa</td>
    <td colspan="2" class="textosimple" id="textfield2"><input name="hoja_anexa" type="checkbox" id="hoja_anexa" value="1">
      <label for="hoja_anexa"></label></td>
     <td class="textosimple">Agregar Portada (s&oacute;lo Ens. P&aacute;rvulos)</td>
     <td colspan="2"  class="textosimple"><input name="chk_portada" type="checkbox" id="chk_portada" value="1"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
   ...
   <td width="95"  class="textosimple">Incluir<br>
              ...
              <td class="textosimple">Tipo de Informe</td>
                      <td colspan="2" class="textosimple"><input name="tipo_planilla" type="radio" id="tipo_planilla0" value="0" checked="CHECKED"> Informe de Personalidad<br> <input name="tipo_planilla" type="radio" id="tipo_planilla1" value="1" >Informe Diagn&oacute;stico</td>
    <td>&nbsp;</td>
  </tr>
   <tr>
     <td colspan="4">	 </td>   
