...
function enviapag2(form){
	...
	if (form.cmb_ano.value!="0"){		
		pag="../../seteaAno.php3?caso=10&pa=22&ano="+ano2
		form.action = pag;
		form.submit(true);	
	}		
 }
...
<form name="form"   action="printNotasAlumnoporSubsector.php" method="post" target="_blank">
...
<table align="center" width="90%" height="43" border="1" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="27"><table width="100%" border="0" cellpadding="0" cellspacing="5">
      <tr>
      ...
      <tr>
		...
		<select name="cmbCURSO" class="ddlb_x" onChange="window.location='NotasAlumnoporSubsector.php?cmbPERIODO='+cmbPERIODO.value+'&cmbCURSO='+this.value+'&c_reporte='+c_reporte.value;" >
	  ...
	  <tr>
		...
		<select name="cmbALUMNO" class="textosimple" id="cmbALUMNO">
			<option value=0 selected>(Todos los alumnos)</option>
			   <?
			   $sql="select matricula.rut_alumno, alumno.ape_pat, alumno.ape_mat,  alumno.nombre_alu from matricula, alumno where id_curso = ".$cmbCURSO. " and matricula.rut_alumno = alumno.rut_alumno order by ape_pat, ape_mat, nombre_alu";
	  ...
	  <tr>
	    <td colspan="3" align="left"><table width="320" border="0" cellspacing="2" cellpadding="0" align="left">
          <tr>
