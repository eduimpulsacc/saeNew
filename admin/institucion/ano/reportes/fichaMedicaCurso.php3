			...
			<TR height=15>
				<TD>
					<TABLE WIDTH="100%" BORDER=0 CELLSPACING=5 CELLPADDING=5 height="100%">
						<TR height="50">
							<TD align=right>
<INPUT TYPE="button" value="IMPRIMIR" onClick=document.location="fichaMedicaCursoIMP.php3?alumno=<?php echo $alumno;?>&curso=<?php echo $curso;?>">
<INPUT TYPE="button" value="VOLVER" onClick=document.location=".php3?curso=<?php echo $curso?>">
							</TD>
						</TR>
												...
												<TR>
													<TD >
														<TABLE WIDTH="100%" BORDER=0 CELLSPACING=0 CELLPADDING=0>
															<TR valign=top>
																<TD width=50>FECHA</TD><TD>:</TD><TD><?php impF($fila["fecha"])?></TD>
															</TR>
															<TR>
