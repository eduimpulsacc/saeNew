...
function enviapag(form){
	if (form.c_curso.value!=0){
		...
		form.target="_parent";
		form.action = 'InformeNotasParcialesExamen_C.php';
		form.submit(true);
	}	
}
...
function enviapag2(form){
        if( form.c_curso.value!=0 || form.cmb_periodos.value!=0){
                form.target="_blank";
                document.form.action = 'printInformeNotasParcialesExamen_C.php?xls=1';
...
<? //} ?>
<form method="post" action="printInformeNotasParcialesExamen_C.php" name="form" target="_blank">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="506"><font size="1" face="arial, geneva, helvetica">
...
(dia-mes-a&ntilde;o) </td>
  ...
  <tr>
    <td class="textosimple">Incluir observaciones</td>
    <td class="textosimple"><input name="opc_obs" type="checkbox" id="opc_obs" value="1" checked="CHECKED"></td>
  </tr>
  <tr>
