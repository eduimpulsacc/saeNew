...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="textosimple">Modelo</td>
    <td colspan="2"  class="textosimple"><input type="radio" name="chkMODELO" id="chkMODELO" value="0" checked>
      Estandar 
        <input type="radio" name="chkMODELO" id="chkMODELO" value="1">
        Catolico</td>
    </tr>
    <tr>
      <td class="textosimple">Firma solo con cargo </td>
      <td ><input name="chcargo" id="chcargo" value="1" type="checkbox"></td>
    </tr>
    <tr>
