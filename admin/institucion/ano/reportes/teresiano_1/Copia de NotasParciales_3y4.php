...
//		$query_notas="select rut_alumno,id_periodo,promedio from notas2005 as notas where id_ramo='$row_ramo[id_ramo]' order by rut_alumno,id_periodo";
		...
		for ($j=0;$j<$num_prom;$j++){
			...
			$arreglo_prom[$j]=number_format($arreglo_prom[$j]+$row_prom[promedio],2);
...
//		echo $query_prom."<br>";
		...
		$arreglo_prom[$x]=number_format($arreglo_prom[$x]/$num_ramo,2);
...
//	echo "---$num_ramo.----";
//	-echo "<table><tr><td>";imprime_array($arreglo_prom); echo "</td><td>";imprime_array($arreglo_rut);echo "</tr></table>";-->
...
<?
	if (empty($alumno))
	echo 	$sql_alu = "select * from matricula, alumno where id_curso =" . $curso . " and matricula.rut_alumno = alumno.rut_alumno order by alumno.ape_pat, alumno.ape_mat";
	else
