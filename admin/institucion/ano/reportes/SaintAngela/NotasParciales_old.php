  ...
  <tr>
	...
	<table width="649" border="0" cellpadding="0" cellspacing="0">
      <tr>
			...
			?>
              <tr>
                <td width="114"><div align="left"><font face="arial, geneva, helvetica" size="2"><strong>INSTITUCI&Oacute;N</strong></font></div></td>
                <td width="9"><font face="arial, geneva, helvetica" size="2"><strong>:</strong></font></td>
                <td width="361"><div align="left"><font face="arial, geneva, helvetica" size="2"><? echo strtoupper(trim($fila['nombre_instit'])) ?></font></div></td>
      ...
      <tr>
		...
		<?
		  ...
		  <tr>
			...
			<font size="2" face="Arial, Helvetica, sans-serif"><strong>Subsector de Aprendizaje</strong></font></td>
...
//		  $sql2 = $sql2 . "WHERE (((ramo.id_curso)=".$curso.")); ";
		  ...
		  <?
			...
			?>
            <td height="25"><div align="justify"><font size="0" face="Arial, Helvetica, sans-serif"><? echo $fila['nombre']; ?></font></div></td>
