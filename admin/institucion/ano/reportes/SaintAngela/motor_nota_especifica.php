...
<table width="709" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><select name="cmb_nota" class="ddlb_9_x">
      <option value=1 selected>Nº 1</option>
      <option value=2 >Nº 2</option>
      <option value=3 >Nº 3</option>
      <option value=4 >Nº 4</option>
      <option value=5 >Nº 5</option>
      <option value=6 >Nº 6</option>
      <option value=7 >Nº 7</option>
      <option value=8 >Nº 8</option>
      <option value=9 >Nº 9</option>
      <option value=10 >Nº 10</option>
      <option value=11 >Nº 11</option>
      <option value=12 >Nº 12</option>
      <option value=13 >Nº 13</option>
      <option value=14 >Nº 14</option>
      <option value=15 >Nº 15</option>
      <option value=16 >Nº 16</option>
      <option value=17 >Nº 17</option>
      <option value=18 >Nº 18</option>
      <option value=19 >Nº 19</option>
      <option value=20 >Nº 20</option>	  	  	  	  	  	  	  	  	  
    </select></td>
