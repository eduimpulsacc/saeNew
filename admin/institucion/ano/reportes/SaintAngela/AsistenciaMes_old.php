...
<?php require('../../../../../util/header.inc');
	...
	if (empty($curso) or empty($mes)) exit;
...
.Estilo11 {font-family: Verdana, Arial, Helvetica, sans-serif; font-weight: bold; font-size: 12px; }
-->
</style>
</head>
...
<table width="819" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="697"><font face="Verdana, Arial, Helvetica, sans-serif" size="-1"><? echo ucwords(strtolower($direccion));?></font><font face="Verdana, Arial, Helvetica, sans-serif" size="+1">&nbsp;</font></td>
    <td width="10">&nbsp;</td>
  ...
  <tr>
    <td><span class="Estilo11">ASISTENCIA <span class="Estilo2"><strong><? echo CursoPalabra($curso, 1, $conn)?></strong></span></span></td>
    <td>&nbsp;</td>
    </tr>
  <tr>
    <td height="41" valign="top"><span class="Estilo11"></span></td>
    <td>&nbsp;</td>
    </tr>  
</table>
<br>	
<table width="826" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#003b85">
    <td align="center"><font face="Arial, Helvetica, sans-serif" size="2" color="white"><strong>INFORME GENERAL DE ASISTENCIA MENSUAL </strong></font></td>
  </tr>
  <tr>
...
<? 
  ...
  for($YYYY=0 ; $YYYY < 31 ; $YYYY++)
  {
	...
	//if (checkdate($mes, $dia_1, $nro_ano) and ($dia_pal <> "sáb" and $dia_pal <> "dom" )) 
	if (FechaValida($mes,$dia_num,$nro_ano, $ano))
  ...
  <? 
	...
	for($Y=0 ; $Y < 31 ; $Y++)
  	{
		...
		if (FechaValida($mes,$dia,$nro_ano, $ano))
		{
			...
			$asistentes_a[$Y+1] = $asistentes;
			$inasistentes_a[$Y+1] = $fila_comsulta['cantidad']; 
			$total_asis = $total_asis + $asistentes; 
			$total_ause = $total_ause + $fila_comsulta['cantidad']; 
	...
	?>
    <td height="30"><div align="left"><span class="Estilo4">Asistencia</span></div></td>
...
<table width="819" height="119" border="0" cellpadding="0" cellspacing="0">
  <tr>
	<td height="27"><div align="left"><font size="2"><strong><font face="Arial, Helvetica, sans-serif">Observaciones: _____________________________________________________________________________<font size="2"><strong>__________<font size="2"><strong>______________</strong></font></strong></font></font></strong></font></div></td>
  </tr>
  <tr>
	<td height="22"><div align="left"><font size="2"><strong><font face="Arial, Helvetica, sans-serif">_____________________________________________________________________________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">__________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">____________________________</font></strong></font></strong></font></strong></font></div></td>
	</tr>
  <tr>
	<td height="23"><div align="left"><font size="2"><strong><font face="Arial, Helvetica, sans-serif">_____________________________________________________________________________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">__________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">____________________________</font></strong></font></strong></font></strong></font></div></td>
	</tr>
			  <tr>
	<td height="23"><div align="left"><font size="2"><strong><font face="Arial, Helvetica, sans-serif">_____________________________________________________________________________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">__________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">____________________________</font></strong></font></strong></font></strong></font></div></td>
	</tr>
  <tr>
	<td><div align="left"><font size="2"><strong><font face="Arial, Helvetica, sans-serif">_____________________________________________________________________________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">__________</font><font size="2"><strong><font face="Arial, Helvetica, sans-serif">____________________________</font></strong></font></strong></font></strong></font></div></td>
	</tr>
</table>
</center>
</body>
...
function FechaValida($mes_f, $dia_f, $ano_f, $ano_esc)
{
	...
	if (checkdate($mes_f, $dia_f, $ano_f) and ($dia_pal_f <> "sáb" and $dia_pal_f <> "dom" )) 
	{
		...
		if ($feriado==0)
		{
			$sql_ano = "select count(*) as cantidad from ano_escolar where id_ano = " . $ano_esc . " and fecha_inicio <= '".$mes_f."-".$dia_f."-".$ano_f."' and fecha_termino >= '".$mes_f."-".$dia_f."-".$ano_f."'";
			$result_ano =pg_Exec($conn,$sql_ano );
			$fila_ano = pg_fetch_array($result_ano,0);	
			$fuera_ano = $fila_ano['cantidad'];		
			if ($fuera_ano==0)
				$sw = 1;
			else
				$sw = 0;
