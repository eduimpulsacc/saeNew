...
function enviapag(form){
	...
	if (form.cmb_alumno.value!=0){
		form.target="_blank";
		form.action = 'printInformeCertificadoEstudios_PDF.php';
		form.submit(true);
...
<? 
	...
	$resultado_query_cue = $ob_motor ->curso22($conn);
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="cuadro01"><select name="cmb_alumno" class="ddlb_9_x"  <?php if($_PERFIL==0)echo "onchange='activaPDF();'"  ?>>
      ...
      <?
		...
		?>
          ...
          <tr>
            ...
            <td class="cuadro01"><input name="firma" type="radio" value="0" checked="checked">
Nombre/Apellido
  <input name="firma" type="radio" value="1">
Apellido/ Nombre </td>
          ...
          <tr>
            <td class="cuadro01">NO OPTA religi&oacute;n</td>
            <td class="cuadro01"><input name="optarel" type="checkbox" id="optarel" value="1">
              <label for="optarel"></label></td>
