...
$html="<center><table width='550' border='0' cellspacing='0' cellpadding='0'>
 ...
 <td width='50' rowspan='5'>
		...
		<td width='60'><font face='Verdana, Arial, Helvetica, sans-seri' size='-2'>REGIÓN</font></td>
	...
	$html.="<table width='550' border='0' cellspacing='0' cellpadding='0'>
	  <tr>
		<td align='center'><font face='Verdana, Arial, Helvetica, sans-seri' size='-1'><strong>";
		 ...
		 if($institucion==770){ $html.= " AÑO ESCOLAR $nro_ano"; }else{ $html.= strtoupper($nombre_institu);}
	  ...
	  if($rd_tipo==2){
		$html.="<td align='justify'>
		      <font face='Verdana, Arial, Helvetica, sans-seri' size='-1'> Reconocido oficialmente por el Ministerio de Educación de la República de Chile según ";
			    if($institucion==12086){ $html.= "RESOLUCIÓN EXENTA Nº 1379 DE FECHA 16 DE JUNIO DE 1987, MODIFICADA Y AMPLIADA SEGÚN RESOLUCIÓN EXENTA "; }else{ $html.= " DECRETO&nbsp;";}
				
				$html.=" <br> 
		      <strong>&nbsp;N&ordm;&nbsp; 
		      ".$nu_resolucion ." de  ".$ano_solo ."</strong> Rol Base de Datos&nbsp; <strong>Nº". $rolbasededatos."</strong> otorga el presente Certificado de Calificaciones  Anuales y Situación Final a DON(A) <u><strong>".$ob_reporte->tildeM($nombre_alu)."</strong></u>&nbsp;&nbsp;Run <strong>".$rut_alumno ."</strong> del&nbsp;  <strong>".$Curso_pal . $especialidad ."</strong> de acuerdo al plan de estudios aprobados por el Decreto&nbsp;<strong> Nº ";  
			   if($institucion==253){
				   	$html.= " 5715 de 2001 ";
			   }else{				   
				   $html.= $nombre_decreto;
			   ...
			   $html.="</strong> Reglamento de Evaluación y Promoción Escolar Decreto exento de Evaluación <strong>Nº ". $nombre_decreto_eval ."</strong>
		  </font></td>";	  
        	  }else{ //Imprime el nombre y el rut en una linea aparte
	
		$html.="<td align='justify'>
		      <font face='Verdana, Arial, Helvetica, sans-seri' size='-1'> Reconocido oficialmente por el Ministerio de Educación de la República de Chile según "; if($institucion==1590){ $html.= "Ley Nº12446 DE 1957 y exento Nº 0540 de 1997,"; }elseif($institucion==9940 and $ensenanza==310) { $html.= "DECRETO&nbsp; <b>Nº 03016 DE 1977 </b>";}else{ $html.= "DECRETO&nbsp; <strong>N&ordm; 
		       ".$nu_resolucion ." de  ".$ano_solo;} 
			  
			  $html.="</strong> Rol Base de Datos&nbsp;<strong>Nº ".$rolbasededatos."</strong> otorga el presente Certificado de Calificaciones  Anuales y Situación Final a DON(A) <strong>".$ob_reporte->tildeM($nombre_alu) ."</strong>, Run&nbsp;<strong>".$rut_alumno ."</strong> del&nbsp; <strong>"; 
			   	if($institucion==5661){
					$html.= $especialidad = str_replace('CIENTÍFICO','CIENTÍFICA',$Curso_pal);				
				}else{
			   ...
			   if ($institucion==25182){
			   		$html.= "150 de 2007, modifica por Nº 4142 de 2009";
					...
					if ($situacion_final==2){
						if($_INSTIT==10232){
						 ...
						 if ($grado==8){
							...
							$html.= "REPITE EL ".$paso_a." AÑO DE ".strtoupper($ensenanza_pal);
						 ...
						 if ($grado==8){
							...
							$html.= "EL ALUMNO(A) HA REPROBADO EL ".$paso_a." AÑO DE ".strtoupper($ensenanza_pal);
						}else{
