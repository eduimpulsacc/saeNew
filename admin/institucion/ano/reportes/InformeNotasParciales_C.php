...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td class="textosimple">&nbsp;</td>
    <td class="textosimple"><input name="rdASIGNATURA" type="radio" id="rdASIGNATURA" value="1" checked>
      Todas 
        <input type="radio" name="rdASIGNATURA" id="rdASIGNATURA" value="2">
