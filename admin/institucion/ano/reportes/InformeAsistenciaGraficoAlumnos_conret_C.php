...
<form method "post" action="printInformeAsistenciaGraficoAlumnos_conret_C.php" name="form" target="_blank">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td class="textosimple">&nbsp;</td>
    <td colspan="2" align="right"><input name="cb_ok" type="submit" class="botonXX"  id="cb_ok" value="Buscar">
      <input name="cb_ex" type="submit" class="botonXX"  id="cb_ex" value="Exportar">
      <input name="cb_ex2" type="button" class="botonXX"  id="cb_ex2" value="Volver"onClick="window.location='Menu_Reportes_new2.php'"></td>
	<? if($_PERFIL == 0){?>
    <? }?>
  </tr>
</table>
