	 ...
	 if(!$("#formato1").is(':checked') && !$("#formato2").is(':checked'))
	{
		...
		return false;
		 ...
		 if($("#formato1").is(':checked')){
			var ruta = "printinformeAtrasosCurso.php";
		}
		if($("#formato2").is(':checked')){
			var ruta = "printGraficoAtrasosCurso.php";
		}
  ...
  <center>
    ...
    <tr>
     ...
     <tr>
       ...
       <td width="71%"><div id="select_curso"><select name="select_curso" >
         <option>Seleccionar</option>
         </select></div></td>
     </tr>
     <tr>
       <td>Alumnos Retirados</td>
       <td><input name="ck_retirado" type="checkbox" id="ck_retirado" value="1"></td>
     </tr>
     <tr>
       <td>Formato</td>
