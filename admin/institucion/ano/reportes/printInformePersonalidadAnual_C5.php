      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr> 
          <td width="20%" class="item">Alumno(a)</td>
			    <td width="52%" class="subitem">: <b> <?php echo $ob_reporte->Tilde($ob_reporte->nombres);?> </b></td>
...
?>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="15%" class="tabla04" ><font face="Verdana, Arial, Helvetica, sans-serif" size="1">Se destaca en:</font><font face="Verdana, Arial, Helvetica, sans-serif" size="1">&nbsp;</font></td>
