...
var opt2 =  $("input[name='tipo']:checked").val();


if(opt2==1){
	var ruta = "printAsistenciaEmpleaado.php";
}
else{
	var ruta = "graphAsistenciaEmpleado.php";
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td class="cuadro01"><input name="tipo" type="radio" class="tipoo"  value="1" checked="CHECKED">
    Listado&nbsp;
    <input type="radio" name="tipo" class="tipoo" value="2" >G&aacute;fico</td>
    </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="right" class="cuadro01">
      <input name="cb_ok" type="button" class="botonXX"  id="cb_ok" value="Buscar" onClick="act()">
