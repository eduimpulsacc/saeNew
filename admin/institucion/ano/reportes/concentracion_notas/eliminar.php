...
function redireccion(form){
	 ...
	 window.location="eliminar.php?rut_alumno=<?=$rut_alumno ?>&curso="+curso
}
</script>
</head>
<body>
...
<? if (($curso!=0) AND ($curso!=NULL)){  ?>
	...
	<td class="td2"><input name="institucion" class="editbox " value="<?=$institucion_conc ?>" disabled="disabled" />	</tr>
	<tr>
	<td class="td2 Estilo3 Estilo4">CIUDAD</td>
	<td class="td2"><input name="ciudad" class="editbox " value="<?=$ciudad ?>" disabled="disabled"/></td>
	</tr>
	<tr>
		<td class="td2 Estilo3 Estilo4">A&Ntilde;O DEL CURSO </td>
	<td class="td2"><input name="ano" class="editbox " maxlength="4" value="<?=$ano_nro ?>" disabled="disabled" /></td>	
	</tr>
	<tr>
		<td class="td2 Estilo3 Estilo4">PLAN DE ESTUDIO</td>
	    <td class="td2"><input name="plan" class="editbox " maxlength="30" value="<?=$plan ?>" disabled="disabled" /></td>
	</tr>
	<tr>
		<td class="td2 Estilo3 Estilo4">DECRETO DE EVALUACION</td>
	<td class="td2"><input name="decreto" class="editbox " maxlength="30" value="<?=$decreto ?>" disabled="disabled" /></td>	
	</tr>
...
<tr><td colspan="2" class="td2 Estilo3 Estilo4"><table width="100%" class="td2" id="mytable" >
  ...
  while ($i < $num_conc_detalle){ 
      ...
      <td nowrap="nowrap" class="td2"><?=$nombre_subsector ?> 
	    <input name="cod_subsector" type="hidden"  value="<?=$subsector ?>"/>
	 </td>
      <td nowrap="nowrap" class="td2"><input name="nota_sub" class="editbox" size="5" maxlength="2"  value="<? if ($promedio_sub!=''){ echo $promedio_sub; }else{ echo $religion; } ?>" disabled="disabled"/></td>
      </tr>
      <?
	  $i++;
  ...
  <tr>
    ...
    <td nowrap="nowrap" class="td2"><input name="promedio" type="text" class="editbox" value="<?=$promedio ?>" size="5" maxlength="2" disabled="disabled"/></td>
  </tr>
  <tr>
    <td class="td2">ASISTENCIA</td>
    <td nowrap="nowrap" class="td2"><input name="asistencia" type="text" class="editbox" value="<?=$asistencia ?>" size="5" maxlength="3" disabled="disabled" />
      %</td>
  </tr>
</table></td>
</tr>
<tr>
	<td colspan="2" align="center">
		...
		<input name="guardar" type="submit" class="botonXX" id="cb_ok" value="ELIMINAR INFORMACION"/></td>
</tr>
