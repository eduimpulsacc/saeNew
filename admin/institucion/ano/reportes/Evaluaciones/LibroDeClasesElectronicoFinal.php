...
with (form){
	...
	if (form.cmbSUBSECTOR.value=="0"){		
		...
		return false;
	  	  ...
	  	  form.target="_blank";
	  form.action = 'printLibroDeClasesElectronicoFinal.php';
	  form.submit(true);
	}		
 }
...
function enviapag2(form){
	...
	if (form.cmb_ano.value!="0"){		
		pag="../../seteaAno.php3?caso=10&pa=24&ano="+ano2
		form.action = pag;
		form.target="_self";
		form.submit(true);	
	}		
...
<form name="form"   action="printLibroDeClasesElectronicoFinal.php" method="post">
  ...
  <tr>
    <td height="27"><table width="100%" border="1">
      ...
      <tr>
		...
		<select name="cmbCURSO" class="ddlb_x" onChange="window.location='LibroDeClasesElectronicoFinal.php?cmbCURSO='+this.value;" >
