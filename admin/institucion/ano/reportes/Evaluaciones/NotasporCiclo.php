...
function enviapag2(form){
	...
	if (form.cmb_ano.value!=0){
		...
		pag="../../seteaAno.php3?caso=10&pa=17&ano="+ano2
		form.action = pag;
		form.target="_parent";
		form.submit(true);
		}	
 ...
 function enviapag(form){
	...
	if (document.form.cmb_ano.value!="0"){
		...
		pag="../printInformeNotasCiclo_C.php";
		form.action = pag;
		form.target="_blank";
		form.submit(true);	
		}else{
...
<form name="form"   action="../printInformeNotasCiclo_C.php" method="post" target="_blank">
...
<table align="center" width="90%" height="43" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    <td height="27"><table width="100%" border="0">
      ...
      <tr>
        <td class="textosimple">Per&iacute;odo</td>
        <td>
