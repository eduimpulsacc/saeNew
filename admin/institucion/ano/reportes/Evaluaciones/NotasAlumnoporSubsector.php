...
<form name="form"   action="printNotasAlumnoporSubsector.php" method="post">
  ...
  <tr>
    <td height="27"><table width="100%" border="0" cellpadding="0" cellspacing="5">
      ...
      <tr>
		...
		<select name="cmbCURSO" class="ddlb_x" onChange="window.location='NotasAlumnoporSubsector.php?cmbPERIODO='+cmbPERIODO.value+'&cmbCURSO='+this.value;" >
