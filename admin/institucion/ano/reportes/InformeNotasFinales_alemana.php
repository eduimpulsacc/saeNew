...
<?
	...
	// DATOS PERIODO
	//----------------------------------------------------------------------------
	if ($_INSTIT==14629  or $_INSTIT==14596){
...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'InformeNotasFinales_alemana.php?institucion=$institucion';
				form.submit(true);
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><div id="capa0">
		<div align="right">
          <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printInformeNotasFinales_alemana.php?c_curso=<?=$c_curso ?>&c_alumno=<?=$c_alumno ?>&dia=<?=$dia ?>&mes=<?=$mes ?>&ano2=<?=$ano2 ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
        </div>
      </div>
    </td>
  </tr>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
    <tr>
    	<td class="tableindex"><div align="center">INFORME DE NOTAS FINALES2</div></td>
	</tr>
  <?
  if ($_INSTIT==1260){ ?>
	  <tr>
...
<?			if($modo_eval==3){ ?>
 ...
 <table width="650" border="1" cellspacing="0" cellpadding="0">
			   ...
			   <?
				...
				<?
					...
					$promedio = $fila_notas['promedio'];		
						...
						$final_total = ($final_total +$prom_gene_periodos);						
  ...
  <tr>
	...
	$observacion = $fila_promedio['observacion'];
	?>
    <td width="73"><div align="center"><font face="Arial, Helvetica, sans-serif" size="-2"><? echo round($PromedioFinal/$cuenta); ?></font></div></td>			
  </tr>
  <tr>
    <!--<td><div align="left"><font face="Arial, Helvetica, sans-serif" size="-2"><strong>MEJOR PROMEDIO DEL CURSO</strong></font></div></td>
    <td colspan="4">&nbsp;</td>
