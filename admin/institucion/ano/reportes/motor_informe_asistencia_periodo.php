...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'motor_informe_asistencia_periodo.php?institucion=$institucion';
				form.submit(true);
...
<table width="709" border="1" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'mainFrame\']','InformeAsistenciaPeriodo.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_periodos='+cmb_periodos.options[cmb_periodos.selectedIndex].value);return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
