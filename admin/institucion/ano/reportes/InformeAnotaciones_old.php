...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#003b85">
    <td bgcolor="#003b85"><div align="center"><strong><strong><font color="White" size="1" face="verdana, arial, geneva, helvetica">INFORME DE ATRASOS, ANOTACIONES E INASISTENCIAS </font></strong></strong></div></td>
    </tr>
  <tr>
</table>
<br>
...
<?
	...
	$sql_anota = $sql_anota . "where rut_alumno = ".$alumno." and (fecha>='".$fecha_inicio."' and fecha<='".$fecha_termino."') and anotacion.rut_emp = empleado.rut_emp ";
	$sql_anota = $sql_anota . "and (tipo = 1 or tipo = 2 or tipo is null) order by tipo, fecha ";
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="524"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><? echo ucwords(Cfecha3($fecha));?></font></td>
  </tr>
</table>
<table width="650" border="0" cellspacing="0" cellpadding="0">
   <tr>
