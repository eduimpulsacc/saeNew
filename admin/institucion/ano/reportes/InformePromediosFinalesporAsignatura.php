...
<SCRIPT language="JavaScript">
	...
	function enviapag(form){
		if (form.cmb_curso.value!=0){
			...
			window.location= 'InformePromediosFinalesporAsignatura.php?cmb_periodos='+ '&cmb_curso=' + document.form.cmb_curso.value +'&c_reporte=<?=$reporte;?>';
		}	
	}			
...
<form method "post" action="print_InformePromediosFinalesporAsignatura.php" target="_blank" name="form">
...
<table width="" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr>
		...
		<td width="89" class="textosimple"><input type="checkbox" name="conexamen" value="1"> &nbsp;</td>
		<td width="150">&nbsp;</td>
	</tr>
    <tr>
		<td class="textosimple">Con&nbsp;Examen&nbsp;Periodo</td>
		<td width="89" class="textosimple"><input type="checkbox" name="conexamenperiodo" value="1"> &nbsp;</td>
		<td width="150">&nbsp;</td>
	</tr>
    <tr>
		<td class="textosimple">Con&nbsp;Apreciaci&oacute;n</td>
		<td width="89" class="textosimple"><input type="checkbox" name="conapreciacion" value="1"> &nbsp;</td>
		<td width="150">&nbsp;</td>
	</tr>
</table>
