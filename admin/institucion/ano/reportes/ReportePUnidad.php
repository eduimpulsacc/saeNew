...
<? //if($_PERFIL==0 && $institucion==25114){?>
	<form method "post" action="printReportePUnidad.php" name="form" target="_blank">
<? //}else{ ?>
...
<table width="" border="0" cellspacing="0" cellpadding="0">
 ...
 <!-- <tr>
  ...
  <tr>
    ...
    <td class="textosimple"><input type="radio" name="radio" id="puni0" value="puni0">
      Prueba de Unidad 
      <input type="radio" name="radio" id="puni1" value="puni1">
