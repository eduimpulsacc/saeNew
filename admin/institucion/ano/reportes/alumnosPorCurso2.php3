		...
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<tr>
				<td colspan=2 align=right>
					<INPUT TYPE="button" value="IMPRIMIR" onClick=document.location="alumnosPorCursoIMP.php3?curso=<?php echo $curso;?>">
					<INPUT TYPE="button" value="VOLVER" onClick=document.location="alumnosPorCurso1.php3">
				</td>
			</tr>
