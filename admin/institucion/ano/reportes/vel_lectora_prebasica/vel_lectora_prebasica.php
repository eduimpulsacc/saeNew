...
function validaform(){
	...
	if ($('#tipo0').is(':checked')) {
		ruta='printVelLectoraPB.php';
		
	}
	if ($('#tipo1').is(':checked')) {
		
		ruta='printGraficoVelLectoraPB.php';
    ...
    <tr>
      ...
      <tr>
                                       <td align=left>MOSTRAR:</td>
                                        ...
                                        <td  valign="bottom"><input name="concepto" type="radio" id="concepto" value="1" checked="CHECKED">Concepto <input type="radio" name="concepto" id="concepto" value="2">Sigla </td>
                                      </tr>
      <tr>
        <td align=left>TIPO:</td>
        <td  valign="bottom">  <input name="tipo" type="radio" id="tipo0" value="0" checked="CHECKED">
      Reporte &nbsp;  <input name="tipo" id="tipo1" type="radio" value="1">
      Gráfico &nbsp;&nbsp;&nbsp;</td>
      </tr>
    <br>
