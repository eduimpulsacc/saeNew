   ...
   ?>						  
					  ...
					  <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
						 <tr>
						  <td><div id="capa0">
							<div align="right">
							  <input name="button3" type="button" class="botonXX" onClick="MM_openBrWindow('printInformeRendimientoEscolar.php?tipo_ensenanza=<?=$tipo_ensenanza ?>','','scrollbars=yes,resizable=yes,width=770,height=500')" value="IMPRIMIR">
							</div>
						  </div></td>
						 </tr>
					   </table>
...
<!-- INICIO FORMULARIO DE BUSQUEDA -->
 ...
 <form action="InformeRendimientoEscolar.php" method="post">
<? 
