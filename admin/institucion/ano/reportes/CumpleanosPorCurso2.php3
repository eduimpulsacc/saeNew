		...
		<table WIDTH="600" BORDER="0" CELLSPACING="1" CELLPADDING="3">
			...
			<tr>
				<td colspan=2 align=right>
					<INPUT TYPE="button" value="IMPRIMIR" onClick=document.location="CumpleanosPorCursoIMP.php3?curso=<?php echo $curso;?>">
					<INPUT TYPE="button" value="VOLVER" onClick=document.location="CumpleanosPorCurso1.php3">
				</td>
			</tr>
			<tr height="20" bgcolor="#0099cc">
				<td align="middle" colspan="3">
					<font face="arial, geneva, helvetica" size="2" color="#ffffff">
						<strong>CUMPLEAÑOS POR CURSO</strong>
					</font>
				</td>
			</tr>
			<tr bgcolor="#48d1cc">
			...
			<?php
				$qry="SELECT alumno.rut_alumno, alumno.dig_rut, alumno.nombre_alu, alumno.ape_pat, alumno.ape_mat, alumno.fecha_nac,curso.id_curso FROM ((alumno INNER JOIN matricula ON alumno.rut_alumno = matricula.rut_alumno) INNER JOIN curso ON matricula.id_curso = curso.id_curso) WHERE (((curso.id_curso)=".$curso.") AND ((matricula.id_ano)=".$ano.")) order by  alumno.ape_pat, alumno.ape_mat,alumno.nombre_alu ASC";
			...
			?>
						<tr>
							...
							<td align="center" >
								<font face="arial, geneva, helvetica" size="1" color="#000000">
									<strong><?php impF($fila["fecha_nac"]) ;?></strong>
								</font>
							</td>
						</tr>
			<?php
