...
/* *********** comparaciones de subsectores  ****************** */
			...
			else if( strpos($fila['nombre'],'ARTE')!=0 || strpos($fila['nombre'],'ARTISTICA')!=0 ){
				$fila['nombre'] ='ART';
			}
			...
			else if( strpos($fila['nombre'],'MUSICA')!=0 ){
				$fila['nombre'] ='MUSIC';
			}
			...
			if($fila['cod_subsector']==100001 || $fila['cod_subsector']==100002 || $fila['cod_subsector']==100003 || $fila['cod_subsector']==100004 || $fila['cod_subsector']==100005 || $fila['cod_subsector']==100006 || $fila['cod_subsector']==100007 || $fila['cod_subsector']==100008 ){	?>
...
<?			}	?>
	        ...
	        for($per=0 ; $per < @pg_numrows($resultPer) ; $per++)
			{
	            ...
	            <td align="center"><font size="1" face="Arial, Helvetica, sans-serif" color="#000099"><? 
					if($prome_1<40 && $nota1>0){ ?><font color="#FF0000"><? 
						echo $prome_1;?></font><? 
					} else { 
						echo $prome_1; 
					} ?></font></td>								
