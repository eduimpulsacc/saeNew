...
$query_concep="select * FROM informe_concepto_eval where id_plantilla=$plantilla order by id_concepto  $modoorden";
...
?>
                                <tr>
                                  <td class="cuadro01"><? echo $row_cat['glosa'];?></td>
                                  <td colspan="<? echo $num_concep;?>">&nbsp;</td>
                                </tr>
                                <?
			...
			?>
                                <tr>
                                  <td class="cuadro01"><img src="../../../cortes/p.gif" width="10" height="1" border="0"><? echo $row_sub['glosa'];?></td>
                                  <td class="cuadro01">
					...
					?>
                                 <option ><? echo $row_concep[nombre];?></option>
                                  <? }?>
								  </select>
					...
					?>
                                <tr>
                                  <td class="cuadro01"><img src="../../../cortes/p.gif" width="20" height="1" border="0"><? echo $row_item['glosa'];?></td>
								  <td>
							...
							?>
                                ...
                                <? }?>
                                <tr>
                                  <td colspan="50"  align="center"><input name="submit" type="button" value="Aceptar" class="botonXX" onClick="MM_goToURL('parent','ver_informe.php?plantilla=<?=$plantilla;?>&creada=1');return document.MM_returnValue" ></td>
                                </tr>
                              </table>
                              </form></td></tr></table>                         </td>
                          </tr>
