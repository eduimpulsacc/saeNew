...
<form action="../../planilla_planillas2/plantilla/muestraPlantilla.php" method="post">
  <table width="76%" border="0" align="center">
    ...
    <tr> 
      <td> 
	   <?php 
		if($subareaCreada==1){
			$srcSA="../area/subarea/creaSubarea.php?creada=1&plantilla=$plantilla";
		}else{
			$srcSA="../area/subarea/subarea.php?plantilla=$plantilla";
		}
		?>
	  <fieldset style="border-color:#003b85">
    ...
    <tr> 
      ...
      <td colspan="3" bordercolor="#003b85"> 
        <?php 
		if($itemCreado==1){
			$srcI="../area/subarea/item/creaItem.php?creada=1&subarea=$subarea";
		}else{
			$srcI="../area/subarea/item/blanco.htm";
		}
		?>
        <fieldset style="border-color:#003b85">
    ...
    <tr> 
	  ...
	  <?php if ($_CONCEPTO!=""){//if($itemCreado==1){?>
