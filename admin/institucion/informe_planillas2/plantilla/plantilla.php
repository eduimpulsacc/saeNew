...
<form action="../../planilla_planillas2/plantilla/plantillaPaso2.php" method="post">
  <table width="520" border="0" align="center">
    ...
    <tr> 
      <td colspan="3"> 
        <?php 
		if($plantilla!=""){
			$srcP="creaPlantilla.php?creada=1&plantilla=$plantilla";
		}else{
...
<!--		<iframe id="iframe0" name="iframe0" src="<?php //echo $srcP; ?>" frameborder="0" style="width:100%; height:260%;"></iframe> -->
		<iframe id="iframe0" name="iframe0" src="<?php echo $srcP; ?>" frameborder="0" style="width:100%; height:320%;"></iframe>
        </fieldset>
        &nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td colspan="3" bordercolor="#003b85"><font size="2" face="Arial, Helvetica, sans-serif"> 
        2do.- Crear Conceptos evaluativos </font> </td>
    </tr>
    <tr> 
      <td> 
        <?php 
        ...
        <iframe id="iframe0" name="iframe0" src="conceptos.php" frameborder="0" style="width:100%; height:100%;"></iframe>
        &nbsp; 
        </fieldset></td>
    </tr>
    <tr> 
...
<input class="botonXX"  type="submit" name="sgte" value="SIGUIENTE >>" ></td>
    </tr>
    <tr> 
