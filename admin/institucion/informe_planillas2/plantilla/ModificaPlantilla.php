...
<?php } ?>
<form action="../../planilla_planillas2/plantilla/procesoPlantilla.php" method="post" name="form">
...
<BR>
      <table  width="500" border="0" align="center" cellpadding="0" cellspacing="1">
        ...
        <tr> 
          <td colspan="4" class="tablatit2-1"><div align="center">Detalle de Item</div></td>
        </tr>
