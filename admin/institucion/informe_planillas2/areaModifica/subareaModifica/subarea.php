...
<body>
<form action="../../../planilla_planillas2/areaModifica/subareaModifica/creaSubarea.php" method="post">
  <font size="2" face="Arial, Helvetica, sans-serif">Cantidad de Subareas a crear:</font> 
