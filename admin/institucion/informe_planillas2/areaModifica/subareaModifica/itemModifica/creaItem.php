...
<body>
<form action="../../../../planilla_planillas2/areaModifica/subareaModifica/itemModifica/procesoItem.php" method="post">
...
if(($creada!=1) and ($con_concepto==1)){//ITEM es con concepto evaluativo
	for ($cant=0 ; $cant<$txtCant ; $cant++){
			...
			$obj = $obj."<input name=\"txtNombreItem[".$cant."]\" type=text size=30 maxlength=200>";
			$obj = $obj."</font></td>";
	...
	for ($cant=0 ; $cant<$txtCant ; $cant++){
			$obj = "<td width=47%>";
			$obj = $obj."<font size=2 face=Arial, Helvetica, sans-serif>Nombre: ";
			$obj = $obj."<input name=\"txtNombreItem[".$cant."]\" type=text size=50 maxlength=200>";
			$obj = $obj."</font></td>&nbsp;&nbsp;";
