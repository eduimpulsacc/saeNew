...
<body>
<form action="../../planilla_planillas2/concepto/creaConcepto.php" method="post">
  <font size="2" face="Arial, Helvetica, sans-serif">Cantidad de Conceptos Evaluativos 
  a crear:</font> 
  <input name="txtCant" type="text" size="2" maxlength="5">
