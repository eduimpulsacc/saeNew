...
if ($modificar){
	 ...
	 for ($i=0;$i<$largo;$i++){
	 	$id_temp=$id[$i];
		//echo "salto-->".${"salto".$id_temp};
		
		if(${"salto".$id_temp}==1)$salto=1;else $salto=0;
		//echo "s".$salto; 
		  
			$query_update="update informe_area_item set glosa='$campo[$i]', salto_pagina=$salto where id='$id_temp'";
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
                    ...
                    <tr> 
                      ...
                      <td width="73%" align="left" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
							...
							<tr>
							  <td class="fondo">Modificaci&oacute;n del Informe de Personalidad</td>
							</tr>
	...
	?>
                                <tr>
                                  <td  valign="bottom" class="cuadro01">Nombre</td>
                                  <td  valign="bottom" class="cuadro01">Salto de Pagina</td>
                                  <? if($_PERFIL==0){?>
                                  <td  valign="bottom" class="cuadro01">ID</td>
                                  <? } ?>
...
?>
                                <tr>
                                  <td>
								  	<input name="campo[]" value="<? echo $row_cat['glosa'];?>" size="60">
								  	<input name="id[]" type="hidden" value="<? echo $row_cat['id'];?>">
								  </td>
                                  <td><input type="checkbox" name="salto<? echo $row_cat['id'];?>" id="salto<? echo $row_item['id'];?>" value="1" <? echo ($row_cat['salto_pagina']==1)?"checked":"";?>>
                                    <label for="checkbox"></label></td>
                                   <? if($_PERFIL==0){?>
                                  <td><? echo $row_cat['id'];?></td>
                               <? } ?>
                                </tr>
			...
			?>
                                <tr>
                                  <td><img src="../../../cortes/p.gif" width="10" height="1" border="0">
								    ...
								    <input name="campo[]" value="<? echo $row_sub['glosa'];?>" size="60">
								    <input name="id[]" type="hidden" value="<? echo $row_sub['id'];?>"></td>
                                  <td><input type="checkbox" name="salto<? echo $row_sub['id'];?>" id="salto<? echo $row_sub['id'];?>" value="1" <? echo ($row_sub['salto_pagina']==1)?"checked":"";?>></td>
                                  <td><? echo $row_sub['id'];?></td>
					...
					?>
                                <tr>
                                  <td><img src="../../../cortes/p.gif" width="20" height="1" border="0">
								  <input name="campo[]" value="<? echo $row_item['glosa'];?>" size="60">
								  <input name="id[]" type="hidden" value="<? echo $row_item['id'];?>"></td>
                                  <td><input type="checkbox" name="salto<? echo $row_item['id'];?>" id="salto<? echo $row_item['id'];?>" value="1" <? echo ($row_item['salto_pagina']==1)?"checked":"";?>></td>
                                  <td><? echo $row_item['id'];?></td>
                                ...
                                <? }?>
								     <? }?>
                                <tr>
                                  <td colspan="52"  align="center"><input name="modificar" type="submit" value="Modificar" class="botonXX"></td>
                                </tr>
                              </table>
                              </form></td></tr></table>                         </td>
                          </tr>
