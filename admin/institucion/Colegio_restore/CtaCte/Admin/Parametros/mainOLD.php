...
<?
...

	{
		...
		$sql_insert = "INSERT INTO con_parametro VALUES($li_id_colegio, $ldt_dia_emision, $ldt_dia_vencimi, $ldt_dia_cierre) ;";
		...
		$sql_update = "Update con_parametro set dia_emision = $ldt_dia_emision, dia_vencimiento = $ldt_dia_vencimi, dia_cierre = $ldt_dia_cierre Where rdb = $li_id_colegio ;";
  ...
  <table width="60%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td colspan="2" class="linea_datos_02"> 
        ...
        <div align="center">PARAMETRO DE DATOS.</div>
    ...
    <tr> 
      ...
      <td class="linea_datos_02" width="37%"> 
        ...
        <div align="center">Instituci&oacute;n :</div>
      ...
      <td class="membrete_datos" width="63%">&nbsp; 
        ...
        <input type="hidden" name="hf_id" value="<?=($li_id_colegio)?>">

        <input type="hidden" name="hf_opcion" value="<?=($li_opcion)?>">
    ...
    <tr> 
      ...
      <td class="linea_datos_02" width="37%"> 
        ...
        <div align="center">Dia Emisi&oacute;n :</div>
    ...
    <tr> 
      ...
      <td class="linea_datos_02" width="37%"> 
        ...
        <div align="center">Dia Vencimiento :</div>
    ...
    <tr> 
      ...
      <td class="linea_datos_02" width="37%"> 
        ...
        <div align="center">Dia Cierre :</div>
