...
<?
...

	{
		...
		$li_id_cuenta      = $_POST["hf_id_cuenta"];
		...
		$sql_update = "Update con_cuenta set nombre = '$ls_nombre' Where rdb = $li_id_colegio and id_cuenta = $li_id_cuenta;";
	...
	window.location.href="update.php?ai_id=<?=($li_id_colegio)?>&ai_id_cuenta=<?=($li_id_cuenta)?>"
...
<?
	...
	$li_id_cuenta = $_GET["ai_id_cuenta"];

	//echo "Valor ::: $li_id  <br>";



	$sql= "Select * From con_cuenta Where rdb = $li_id and id_cuenta = $li_id_cuenta;";
  ...
  <table width="50%" border="1" align="center" cellpadding="2" cellspacing="0">
    ...
    <tr> 
      ...
      <td class="membrete_datos">&nbsp; 
        ...
        <input type="hidden" name="hf_id_cuenta" value="<?=pg_result($resultado_query, $j, 1);?>">
    ...
    <tr> 
      ...
      <td class="membrete_datos"> 
        ...
        <input type="text" name="tf_nombre" value="<?=Trim(pg_result($resultado_query, $j, 2));?>" class="text_9_x_300">
