...
<div align="center"><font color="#FFFFFF" size="2"><strong>LISTADO DE CUENTAS.</strong></font></div></td>
  ...
  <table width="85%" border="1" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td class="linea_datos_02" width="47%"> 
        <div align="center">NOMBRE COLEGIO</div>
      </td>
      <td class="linea_datos_02" width="8%"> 
        <div align="center">ID</div>
      </td>
      <td class="linea_datos_02" width="33%"> 
    ...
    <tr> 
      ...
      <td class="membrete_datos" width="12%"> 
        <div align="center"> 
          ...
          <input type="button" name="cb_update" value="M" class="cb_submit_9_20x17" onClick="MM_goToURL('parent.frames[\'main\']','update.php?ai_id='+hf_id_colegio_<?=($j)?>.value+'&ai_id_cuenta='+hf_id_cuenta_<?=($j)?>.value);return document.MM_returnValue" >
          <input type="button" name="cb_delete" value="E" class="cb_submit_9_20x17" onClick="if (confirm('¿Esta seguro que desea eliminar esta Cuenta?')){MM_delete.value = hf_id_colegio_<?=($j)?>.value;MM_delete_02.value = hf_id_cuenta_<?=($j)?>.value;this.form.submit()}">
        </div>
      </td>
    </tr>
    <?
