...
<?
	...
	if($_POST["cb_new"] != ''){
		...
		$sql= "Select id_cuenta From con_cuenta Order by id_cuenta Desc;";
		...
		$sql_new = "INSERT INTO con_cuenta VALUES ($li_colegio, $li_ultimo, '$ls_nombre', $asignacion);";
...
<form name="form1" method="post" action="">
  <table width="500" border="1" align="center" cellpadding="2" cellspacing="0">
    <tr> 
      <td width="22%" class="linea_datos_02"> <div align="center">NOMBRE :</div></td>
      <td colspan="3" class="membrete_datos"> <input type="text" name="tf_nombre" class="text_9_x_300"> 
        <input type="hidden" name="ddlb_colegio" value="<?=($li_id_colegio)?>"> 
      </td>
    </tr>
    <tr> 
      <td class="linea_datos_02" width="22%">asociado a:</td>
      <td width="20%" class="membrete_datos"><input type="radio" name="asignacion" value="1">
        MATRICULA</td>
      <td width="28%" class="membrete_datos"><input type="radio" name="asignacion" value="2">
        COLEGIATURA</td>
      <td width="30%" class="membrete_datos"><input type="radio" name="asignacion" value="3" checked>
        OTROS</td>
    </tr>
  </table>  
  <br>
