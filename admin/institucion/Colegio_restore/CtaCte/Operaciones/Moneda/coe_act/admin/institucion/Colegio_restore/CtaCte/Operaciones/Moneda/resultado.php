...
<form name="form1" method="post" action="">
  <table width="60%" border="0" align="center" cellspacing="1" cellpadding="0">
    <tr> 
    ...
    <tr> 
      <td class="linea_datos_05" width="21%"> 
	...
	{
	?>
    <tr width="12%" onMouseOver="this.style.backgroundColor='yellow'" onMouseOut="this.style.backgroundColor='#FFFFFF';">
      ...
      <td class="membrete_datos"> 
        <div align="center"> 
          ...
          <input type="button" name="cb_update" value="M" class="cb_submit_9_20x17" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' onClick="MM_goToURL('parent.frames[\'main\']','update.php?ai_id='+hf_id_<?=($j)?>.value);return document.MM_returnValue" >
          <input type="button" name="cb_delete" value="E" class="cb_submit_9_20x17" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' onClick="if (confirm('¿Esta seguro que desea eliminar ?')){MM_delete.value = hf_id_<?=($j)?>.value;this.form.submit()}">
        </div>
      </td>
    </tr>
    <?
