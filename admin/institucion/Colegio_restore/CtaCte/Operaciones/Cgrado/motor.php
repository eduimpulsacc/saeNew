  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td   width="21%"> <font size="1"> 
        ...
        <input type="button" name="cb_buscar" value="Buscar &gt;&gt;" class="cb_none_9_x_70" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' onClick="MM_goToURL('parent.frames[\'main\']','resultado.php?ai_mostrar=1&ai_colegio='+dblb_colegio.options[dblb_colegio.selectedIndex].value);return document.MM_returnValue">

        <!--input type="button" name="cb_new" value="Nuevo" class="cb_none_9_x_70" onClick="MM_goToURL('parent.frames[\'main\']','nuevo.php?ai_colegio='+dblb_colegio.options[dblb_colegio.selectedIndex].value);return document.MM_returnValue"-->
