  ...
  <table width="700" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td width="44%"> <font size="1"> 
        <input type="button" name="cb_buscar" value="Buscar &gt;&gt;" class="cb_none_9_x_70" onClick="MM_goToURL('parent.frames[\'main\']','resultado.php?ai_mostrar=1&ai_criterio='+dblb_criterio.options[dblb_criterio.selectedIndex].value+'&as_input='+tf_input.value+'&ai_colegio='+ddlb_colegio.value);return document.MM_returnValue">
        <input type="button" name="cb_new" value="Nuevo" class="cb_none_9_x_70" onClick="MM_goToURL('parent.frames[\'main\']','nuevo.php?ai_colegio='+ddlb_colegio.value+'&ai_nivel='+hf_nivel.value+'&ai_perfil='+hf_perfil.value);return document.MM_returnValue">
