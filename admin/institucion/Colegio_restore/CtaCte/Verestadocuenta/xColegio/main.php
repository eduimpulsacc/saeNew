...
<?	
	...
	$sql_datos_cuentas= "SELECT a.rdb, a.id_cuenta, b.rut_apoderado, c.id_ctacte, c.cuenta_nombre, c.monto, c.rut_alumno, c.monto_saldo, 
(c.monto + c.monto_saldo) as Total_apagarconsaldo FROM con_categoria_cuenta a, con_apoderado_ctacte b, con_estado_pago_detalle c where a.rdb = $li_id_colegio and a.rdb = b.rdb and b.rut_apoderado = '$ls_rut_apoderado' and c.periodo = '$ldt_periodo' and b.id_ctacte = c.id_ctacte and a.id_cuenta = c.cuenta_id ";
...
<form name="form1" method="post" action="procesar.php?ai_colegio=<?=($li_id_colegio)?>">
  ...
  <?
...

	{
			...
			<div align="center">
			  ...
			  <input type="button" name="cb_back" value="&lt;&lt; Volver a Consultar" class="cb_none_9_x_200" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' onClick="MM_goToURL('parent.frames[\'Cuerpo\']','main.php?ai_mostrar=1&as_rut_apo='+hf_rut_apo.value+'&ai_colegio_selec='+hf_id_colegio.value);return document.MM_returnValue">
  ...
  <table width="80%" border="1" align="center" cellspacing="0" cellpadding="0">
    ...
    <tr> 
	  ...
	  ?>
        ...
        <select name="ddlb_mi" class="ddlb_9_x_100" OnChange="parent.Cuerpo.location.href='main.php?ai_mostrar=1&ai_colegio_selec='+hf_id_colegio.value+'&as_rut_apo='+ddlb_apoderado.options[ddlb_apoderado.selectedIndex].value+'&ai_mes='+ddlb_mi.options[ddlb_mi.selectedIndex].value">
  ...
  <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      ...
      <td class="linea_datos_02">ESTADO DE LA CUENTA </td>
    ...
    <tr> 
      ...
      <td class="membrete_datos">
        ...
        <select name="ddlb_apoderado" class="ddlb_9_x_250" OnChange="parent.Cuerpo.location.href='main.php?ai_mostrar=1&as_rut_apo='+ddlb_apoderado.options[ddlb_apoderado.selectedIndex].value+'&ai_colegio_selec='+hf_id_colegio.value+'&ai_mes='+ddlb_mi.options[ddlb_mi.selectedIndex].value">
	...
	?>
		...
		<!-- CAMBIE EL ORDEN DE PRESENTACION DEL NOMBRE DE NOMBRE, APE_PAT, APE_MAT A APE_PAT,APE_MAT,NOMBRE -->
		  ...
		  <?=Trim(pg_result($resultado_query, $j, 4));?> <?=Trim(pg_result($resultado_query, $j, 5));?> <?=Trim(pg_result($resultado_query, $j, 3));?>
  ...
  <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td class="linea_datos_02" colspan="2"> 
        ...
        <div align="center"><b> DETALLE TRANSACCIONES.</b></div>
    ...
    <tr class="<?=($ls_name_class)?>"> 
      ...
      <td> 
        <div align="right">&nbsp; 
          ...
          <?print number_format(pg_result($resultado_query_datos_cuentas, $x, 8),2);?>
    ...
    <tr> 
      ...
      <td class="linea_datos_02"> 
        ...
        <div align="right"><b>TOTAL TRANSACCIONES $ </b></div>
  ...
  <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td class="linea_datos_02"> 
        <div align="right"><?=number_format($li_total_pagar,2)?></div>
      </td>
    </tr>
    <tr> 
		<?
