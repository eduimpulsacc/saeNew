...
//	session_cache_limiter ('nocache'); // SETEA SIN CACHE DE PAGINA
	...
	//////////////////////////////
	//$conexion=@pg_connect("dbname=sae port=1550 user=postgres password=coleint@2005jz");
	$conexion=@pg_connect("dbname=coe_traspaso port=1550 user=postgres password=cole#newaccess");
	if (!$conexion) {
