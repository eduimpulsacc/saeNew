...
<table width="60%" border="1" align="center" cellpadding="1" cellspacing="0">
  <tr> 
    ...
    <td width="79%" class="titulosMotores">Busqueda Avanzada</td>
  ...
  <tr> 
    ...
    <td><select name="ddlb_curso" class="ddlb_9_x">
      ...
      </select> <select name="ddlb_tipo_ense" class="ddlb_9_x_250">
