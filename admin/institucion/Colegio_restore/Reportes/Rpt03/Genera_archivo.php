...
For ($j=0; $j < $total_filas; $j++)
{
 ...
 $li_cod_comuna = substr("00",1,2-strlen(pg_result($resultado_query, $j, 14))).pg_result($resultado_query, $j, 14); 
 $li_cod_comuna = $li_cod_comuna . substr("00",1,2-strlen(pg_result($resultado_query, $j, 15))).pg_result($resultado_query, $j, 15);
