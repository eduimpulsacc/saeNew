...
<table width="53%" height="5" border="1" align="center" cellpadding="1" cellspacing="0">
  <tr> 

    <td width="25%" rowspan="2" valign="center"> <div align="center"> 
        ...
        <input name="cb_ok" type="button" class="cb_submit_9_x_125" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'result\']','Rpt03.php?as_institucion=<?=($li_institucion)?>&ai_ano='+ddlb_ano.options[ddlb_ano.selectedIndex].value);return document.MM_returnValue" value="DESPLEGAR DATOS">
  ...
  <tr> 
	...
	?>
      </select> <select name="ddlb_curso" class="ddlb_9_x">
        <?
	  ...
	  ?>
      </select> <select name="ddlb_criterio" class="ddlb_9_x_100">
        <option value="alumno.rut_alumno">Rut Alumno</option>
        <option value="alumno.nombre_alu">Nombre Alumno</option>
        <option value="alumno.ape_pat">Ape. Paterno Alu.</option>
        <option value="alumno.ape_mat">Ape. Materno Alu.</option>
      </select> <input name="tf_input" type="text" class="text_9_x_150"> <input name="cb_ok" type="button" class="cb_submit_9_x_75" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'result\']','Rpt03.php?as_institucion=<?=($li_institucion)?>&as_criterio='+ddlb_criterio.options[ddlb_criterio.selectedIndex].value+'&ai_curso='+ddlb_curso.options[ddlb_curso.selectedIndex].value+'&as_letra='+ddlb_letra.options[ddlb_letra.selectedIndex].value+'&ai_tipo_ense='+ddlb_tipo_ense.options[ddlb_tipo_ense.selectedIndex].value+'&ai_ano='+ddlb_ano.options[ddlb_ano.selectedIndex].value+'&as_input='+tf_input.value);return document.MM_returnValue" value="Buscar">
    </td>
