...
<FORM NAME="Listas" METHOD="POST" ACTION="">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	?>
              ...
              <select name="ddlb_alumno" class="ddlb_9_x">
                <!--?
...
-->
              ...
              <input name="cb_ok" type="button" class="cb_submit_9_x_75" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'result\']','Rpt09.php?as_institucion=<?=($li_institucion)?>&as_alumno='+ddlb_alumno.options[ddlb_alumno.selectedIndex].value+'&ai_ano='+ddlb_ano.options[ddlb_ano.selectedIndex].value);return document.MM_returnValue" value="Buscar"> 
            </td>
          </tr>
        </table>
  </td>
