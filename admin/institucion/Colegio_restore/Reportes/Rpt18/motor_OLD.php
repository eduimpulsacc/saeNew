...
</SCRIPT> <select name="ddlb_ano" class="ddlb_9_x" OnChange="ComponerLista(document.forms.Listas.ddlb_ano[selectedIndex].value);ComponerLista_alu(document.forms.Listas.ddlb_ano[selectedIndex].value)">
...
-->
              ...
              <!--input name="cb_ok" type="button" class="cb_submit_9_x_75" id="cb_ok" onClick="MM_goToURL('parent.frames[\'result\']','rpt18.php?as_institucion=<?=($li_institucion)?>&as_alumno='+ddlb_alumno.options[ddlb_alumno.selectedIndex].value+'&ai_ano='+ddlb_ano.options[ddlb_ano.selectedIndex].value+'&ai_periodo='+ddlb_periodo.options[ddlb_periodo.selectedIndex].value);return document.MM_returnValue" value="Buscar"--> 
			  <input name="cb_ok" type="button" class="cb_submit_9_x_75" id="cb_ok" onClick="MM_goToURL('parent.frames[\'result\']','rpt18.php?as_institucion=<?=($li_institucion)?>&as_alumno='+ddlb_alumno.options[ddlb_alumno.selectedIndex].value+'&ai_ano='+ddlb_ano.options[ddlb_ano.selectedIndex].value);return document.MM_returnValue" value="Buscar"> 
