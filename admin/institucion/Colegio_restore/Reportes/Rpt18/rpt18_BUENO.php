	...
	<input 
	  ...
	  <div id="capa1">
        <table width="100%" border="0" align="center">
          <tr>
            <td align="center" bgcolor="#003b85"><font color="#FFFFFF" size="1" face="Arial, Helvetica, sans-serif"><strong>INFORME 
              EDUCACIONAL 
              <?php $sqlPer="select * from periodo where id_periodo=".$id_periodo;
							...
							for($countSubarea=0 ; $countSubarea<@pg_numrows($resultTraeSubarea) ; $countSubarea++){
								...
								echo "<td valign=bottom><font face=Arial, Helvetica, sans-serif>&nbsp;</font></td></tr>";
									...
									$countI++;
										...
										echo "<font size=1 face=Arial, Helvetica, sans-serif>".$filaTraeItem['glosa']."</font><hr size=\"1\"></td>";
												...
												if($filaTraeItem['tipo']==0){
													...
													echo "<hr size=\"1\"></td>";
													if ($countI==14) echo"</table><table width=\"100%\">";
													...
													echo "<td valign=bottom>";
													if ($countI==14) echo"</table><table width=\"100%\">";
													echo "<font size=1 face=Arial, Helvetica, sans-serif>&nbsp;&nbsp;".$filaEval['text']."</font><hr size=\"1\"></td>";
													...
													$filaEval=@pg_fetch_array($resultEval,0);
														if(($filaEval['radio']==0) and ($filaEval['radio']!="")){
															...
															if ($countI==14) echo "<div style=\"page-break-after:always\"></div>";
															if ($countI==14) echo"</table><table width=\"100%\">";
															echo "<font size=1 face=Arial, Helvetica, sans-serif>&nbsp;&nbsp;No</font><hr size=\"1\"></td>";	
														
														}else if($filaEval['radio']==1){
															echo "<td valign=bottom>";
															if ($countI==14) echo "<div style=\"page-break-after:always\"></div>";
															if ($countI==14) echo"</table><table width=\"100%\">";
															echo "<font size=1 face=Arial, Helvetica, sans-serif>&nbsp;&nbsp;Si</font><hr size=\"1\"></td>";
