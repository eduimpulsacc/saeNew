	...
	<input 
	  ...
	  <div id="capa1">
        <table width="100%" border="0" align="center">
          <tr>
              <td align="center" bgcolor="#003b85"><font color="#FFFFFF" size="2" face="Arial, Helvetica, sans-serif"><strong>INFORME 
                EDUCACIONAL </strong></font><font size="2">&nbsp;</font></td>
          </tr>
        </table>
	  ...
	  <?php } ?>
        ...
        <tr> 
          <td width="10%"><font size="1" face="Arial, Helvetica, sans-serif">Profesor 
            Jefe</font></td>
          <td width="90%"><font size="1" face="Arial, Helvetica, sans-serif">: <?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat']?></font></td>
        </tr>
      </table>
      <table width="100%" border="0">
        <tr> 
