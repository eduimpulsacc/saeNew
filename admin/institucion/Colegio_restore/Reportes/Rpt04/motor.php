...
<table width="53%" border="1" align="center" cellpadding="1" cellspacing="0">
  ...
  <tr> 
	...
	?>
      ...
      <select name="ddlb_curso" class="ddlb_x">
        <?
      ...
      <select name="ddlb_letra" class="ddlb_x">
