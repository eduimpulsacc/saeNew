			...
			<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
			  <tr>
				  <td>
				    ...
				    <?
					if ($_INSTIT==2278){  ?>  
					     <input 		name="cmdimprimiroriginal" 		type="button" 		class="botonXX" 		id="cmdimprimiroriginal" 		onclick="MM_openBrWindow('print_rpt19_formato_rapido_2278.php?c_curso=<?=$c_curso ?>&cmb_alumno=<?=$alumno ?>&cb_ok=1&periodo=<? echo $periodo;?>','','scrollbars=yes,resizable=yes,width=770,height=500')" 		value="Imprimir">
				<? }else{  ?>
				
				         <input 		name="cmdimprimiroriginal" 		type="button" 		class="botonXX" 		id="cmdimprimiroriginal" 		onclick="MM_openBrWindow('print_rpt19_formato_rapido.php?c_curso=<?=$c_curso ?>&cmb_alumno=<?=$alumno ?>&cb_ok=1&periodo=<? echo $periodo;?>','','scrollbars=yes,resizable=yes,width=770,height=500')" 		value="Imprimir">
				<? } ?>	
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td>
		<td><? if ($_INSTIT!=2278){ ?><img src='linea_v.jpg'><? } ?></td>
		<td>
			<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr><td colspan="3" class="tableindex">&nbsp;<center><strong><? echo $titulo2;?></strong></center></td></tr>
						...
						while (!feof($archivo)) {
							...
							if($cont_car == 4){
								...
								if($temp[3] == ""){
									...
									if(count($arr) == 1){
										echo "<td nowrap='nowrap' width='5%'>&nbsp;</td>";
									}
										...
										if(count($arr) == 2){
											...
											if($arr[1]!= " "){
												echo "<td nowrap='nowrap' width='5%'>".$arr[0]."</td>";
											}
											else{
												echo "<td nowrap='nowrap' width='5%'>".$arr[1]."</td>";
											}
								...
								<? if($institucion==14860){?>
									<table width="630" border="0">
										...
										<td width="210" align="center">&nbsp;</td>
											<td width="210" align="center"><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><strong>Berta Diaz Mena </strong></font></td>
										</tr>
										<tr align="center">
				...
				<?				}	?>
						  ...
						  <?		if($institucion!=25218 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380){	?>
							...
							<?		}	?>
								 ...
								 /*
								 if($institucion!=25218 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380 && $institucion!=9071  && $institucion!=9179&&$institucion!=1678&&$institucion!=25269&&$institucion!=1677&&$institucion!=1966&&$institucion!=1989){
								   */	?>
									<table width="100%" border="0">
										<tr align="center">
									...
									<table width="100%" border="0">
									<? if($institucion!=1959 && $institucion!=9827 && $institucion!=1962){ ?>
										<tr>
											<td>&nbsp;</td>
									...
									<?		if($institucion == 24511){
										...
										<tr>
											<td height="22">&nbsp;</td>
											<td height="22" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if ($institucion==9239){ ?> DIRECTORA SUBROGANTE <? } else{ ?> DIRECTOR(A) ESTABLECIMIENTO oo<? } ?></font></td>
											<td height="22">&nbsp;</td>
										</tr>
									<? } ?>
										<tr>
                           ...
                           <?		} // if institucion
										...
										<table width="630" border="0">
											...
											<tr align="center">
												<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR(A) JEFE 21 </font></td>
												<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">ORIENTADOR(A)</font></td>
								...
								<?	}
									if($institucion==22380 || $institucion==9071 || $institucion==9179 || $institucion==1678|| $institucion==25269|| $institucion==1966 || $institucion==1989){?>
										<table width="630" border="0">
											<tr>
												<td width="210" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat'];?>&nbsp;</font></strong></td>
												<td width="210" align="center">&nbsp;</td>
											...
											<tr align="center">
												<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR(A) JEFE 22</font></td>
												<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
												<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">DIRECTOR(A)ESTABLECIMIENTO</font></td>
											</tr>
											<tr>
...
<?										if($institucion!=25269 &&$institucion!=25218 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380 && $institucion!=12086 && $institucion!=1989 ){?>
										<table width="100%" border="0">
											<tr align="center">
												<td width="45%"><font size="1" face="Arial, Helvetica, sans-serif">________________________</font></td>
												<td width="55%"><font size="1" face="Arial, Helvetica, sans-serif">_________________________</font></td>
										...
										<table width="100%" border="0">
											<tr align="center">
												<td width="45%"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR (A) JEFE 8</font></td>
									...
									<?			if($institucion == 24511){
											...
											<tr>
												<td height="22">&nbsp;</td>
												<td height="22" align="center"><font size="1" face="Arial, Helvetica, sans-serif"><? if ($institucion==9239){ ?> DIRECTORA ESTABLECIMIENTO <? }else{ ?> DIRECTOR(A)ESTABLECIMIENTO <? } ?></font></td>
												<td height="22">&nbsp;</td>
											</tr>
											<tr>
												<td colspan="3" align="center">&nbsp;</td>
...
<?									}
									...
									<table width="630" border="0">
										...
										<tr align="center">
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR(A) JEFE 9</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">ORIENTADOR(A)</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">DIRECTOR(A)ESTABLECIMIENTO</font></td>
										</tr>
										<tr>
...
<?									}
									if($institucion==22380 || $institucion==25218 || $institucion==12086 || $institucion==1989 || $institucion==11209){?>
									<table width="630" border="0">
										<tr>
											<td width="210" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat'];?>&nbsp;</font></strong></td>
											<td width="210" align="center">&nbsp;</td>
										...
										<tr align="center">
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR(A) JEFE 10</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp;</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">DIRECTOR(A) ESTABLECIMIENTO</font></td>
										</tr>
										<tr>
...
<? ///////////////////////////      DESDE AQUI ES LO UTIL DESDE AHORA  ///////////////////////////////////////////////?>
	...
	<form action="print_rpt19_formato_rapido.php" name="form" target="_blank">
	<? 
    	...
    	<?
				...
				if (!$result) {
					...
					<select name="cmb_ano" class="ddlb_x" id="cmb_ano"  onChange="window.location='rpt19_formato_rapido.php?cmb_ano='+this.value;">
...
<? if($_PERFIL == 17){ ?>
			 					<select name="cmb_curso"  class="textosimple" id="cmb_curso" onChange="window.location='rpt19_formato_rapido.php?cmb_curso='+this.value;">
            ...
            <?  		    }
			  ...
			  <tr>
				...
				<? if($_PERFIL==0){?>	
				<br> <a href="../../../ano/reportes/InformePersonalidadPeriodo_C.php">informe nuevo</a>	  
