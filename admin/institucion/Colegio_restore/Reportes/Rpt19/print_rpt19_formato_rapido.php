...
<?					if ($nuevo_sis==1){  ?>
				...
				<? 						}else{	?>
									...
									$query_item="select * from informe_area_item where id_plantilla='$plantilla' and id_padre<>0 and id_padre=$row_sub[id]   $orden_elementos ";
...
<?									}			?>
						  ...
						  <?		if($institucion!=25218 && $institucion!=14629 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380){	?>
							...
							<?		}	?>
                                 ...
                                 <?	if($institucion!=25218 && $institucion!=14629 &&  $institucion!=25478 && $institucion!=24977 && $institucion!=22380 && $institucion!=11209  ){	?>
									<table width="100%" border="0">
										<tr align="center">
										...
										<tr>
											...
											<td width="55%" align="center"><font size="1" face="Arial, Helvetica, sans-serif" ><strong>&nbsp;<?php 
											if ($institucion!=1593){ 
											echo $filaORI['nombre_emp']." ".$filaORI['ape_pat']." ".$filaORI['ape_mat'];
											 }else{
									...
									<table width="100%" border="0">
										<tr align="center">
											...
											<td width="55%"><font size="1" face="Arial, Helvetica, sans-serif"><? if ($institucion!=1593 ){ ?>
											ORIENTADOR (A)
											<? }else{?>
									...
									<?		if($institucion == 24511){
										...
										<tr>
											<td colspan="3" align="left"><font size="1" face="Arial, Helvetica, sans-serif"><?php @setlocale ("LC_TIME", "es_ES"); echo (strftime("%d de %B de %Y")); ?></font></td> 
										</tr>
									</table>
									<? if($institucion==9179 && $institucion !=1685 || $institucion==1707){ ?>
										<H1 class=SaltoDePagina></H1>
									<? } ?>
									
                           <?		} // if institucion
									else if($institucion==25478 || $institucion==24977 || $institucion==1756){	?>
								...
								<?	}
									if($institucion==22380 || $institucion==25218 || $institucion==11209){?>
										<table width="630" border="0">
											<tr>
												<td width="210" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat'];?>&nbsp;</font></strong></td>
...
<?										if($institucion!=25218  && $institucion!=14629 && $institucion!=24977 && $institucion!=25478 && $institucion!=12086 && $institucion!=24464 && $institucion!=22380 && $institucion!=25768  && $institucion!=9035 && $institucion!=1707 && $institucion!=9276 && $institucion!=8905 ){ 	?>
											<H1 class=SaltoDePagina></H1>
                                            <p></p>
                                              <?										} ?>
                                           <!-- <p>&nbsp;</p>-->
...
<?										if($institucion!=25218 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380 && $institucion!=9276){?>
										<table width="100%" border="0">
											<tr align="center">
									...
									<?			if($institucion == 24511){
											...
											<tr>
												<td height="22">&nbsp;</td>
												<td height="22" align="center"><font size="1" face="Arial, Helvetica, sans-serif">DIRECTOR(A)</font></td>
												<td height="22">&nbsp;</td>
											</tr>
											<tr>
...
<?									}
									...
									<table width="630" border="0">
										...
										<tr align="center">
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">PROFESOR(A) JEFE</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">ORIENTADOR(A)</font></td>
											<td width="210"><font size="1" face="Arial, Helvetica, sans-serif">NOMBRE RECTOR(A)</font></td>
										</tr>
										<tr>
											<td></td>
										</tr>
...
<?									}
									if($institucion==22380 || $institucion==25218 || $institucion==9276){?>
									<table width="630" border="0">
										<tr>
											<td width="210" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat'];?></font></strong></td>
											<td width="210" align="center"></td>
										...
										<tr>
												<td colspan="3" align="left"><br><font size="1" face="Arial, Helvetica, sans-serif"><? echo ucwords(strtolower($fila_com['nom_com'])).", ".fecha_espanol($fecha);?></font></td> 
											</tr>
									</table>
