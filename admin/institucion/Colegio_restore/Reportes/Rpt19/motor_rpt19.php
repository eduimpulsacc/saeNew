...
<SCRIPT language="JavaScript">
			...
			if (form.cmb_curso.value!=0){
				...
				form.action = 'motor_rpt19.php?institucion=$institucion';
				form.submit(true);
  ...
  <tr>
	...
	<table width="701" border="0" cellspacing="0" cellpadding="0">
                  <tr> 
                    ...
                    <td><select name="periodo" class="ddlb_9_x">
		  ...
		  if ($fila["id_curso"]==$cmb_curso){
				...
				echo "<option value=".$fila['id_curso'].">".$Curso_pal."</option>";
                    ...
                    <td width="61" class="textosmediano">&nbsp;</td>
                    <td width="219">&nbsp;</td>
                    <td width="80"><div align="right"> 
                        <input name="cb_ok" type="button" class="botonX" onmouseover=this.style.background='FFFFD7';this.style.color='003b85' onmouseout=this.style.background='#5c6fa9';this.style.color='ffffff' id="cb_ok" onClick="MM_goToURL('parent.frames[\'mainFrame\']','rpt19.php?periodo='+periodo.options[periodo.selectedIndex].value+'&c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value);return document.MM_returnValue" value="Buscar">
                      </div></td>
                  </tr>
                  <tr>
                    <td class="textosmediano">Alumno</td>
                    <td><select name="cmb_alumno" class="ddlb_9_x">
