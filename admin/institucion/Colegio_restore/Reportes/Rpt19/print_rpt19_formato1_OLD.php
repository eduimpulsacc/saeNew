...
<?									}else{	?>
				...
				<? 						}else{	?>
									...
									<?		$query_respuesta="select * from informe_evaluacion2 where id_ano='$_ANO' and id_periodo='$periodo' and id_plantilla='$plantilla' and id_informe_area_item='$row_sub[id]' and rut_alumno='$alumno' ";
										...
										<!--	&nbsp; -->
									<? 		if($i==0){	?>
												  <font size="1" face="Arial, Helvetica, sans-serif">EVALUACI&Oacute;N</font>
										<?	}else{	?> 
												&nbsp;
										<?	} 	?>								
											</td>
...
<? 										}	// fin if modificar?>
								...
								<tr>
									<td><?
									if  ($institucion !=25218  && $institucion!=24977 && $institucion!=14629 && $institucion!=1756 && $institucion!=25478 && $institucion!=12086 && $institucion!=24464 && $institucion!=22380 && $institucion!=25768 && $institucion !=9179){ 	?>
...
<?									}			?>
						  ...
						  <?		if($institucion!=25218 && $institucion!=14629 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380){	?>
                           ...
                           <?		} // if institucion
								...
								<?	}
									if($institucion==22380 || $institucion==25218){?>
										<table width="630" border="0">
											<tr>
												<td width="210" align="center"><strong><font size="1" face="Arial, Helvetica, sans-serif" style="text-decoration:underline"><?php echo $filaProfe['nombre_emp']." ".$filaProfe['ape_pat']." ".$filaProfe['ape_mat'];?>&nbsp;</font></strong></td>
...
<?										if($institucion!=25218  && $institucion!=14629 && $institucion!=24977 && $institucion!=25478 && $institucion!=12086 && $institucion!=24464 && $institucion!=22380 && $institucion!=25768){ 	?>
											<H1 class=SaltoDePagina></H1>
                                            <p></p>
                                              <?										} ?>
                                           <!-- <p>&nbsp;</p>-->
...
<?									if($institucion!=25218 && $institucion!=14629 && $institucion!=25478 && $institucion!=24977 && $institucion!=22380){	?>
							...
							<? if (($institucion==25478) || ($institucion==24977) || ($institucion==25218) || ($institucion==14629)) {  ?>
									<H1 class=SaltoDePagina></H1>
									<? } ?>
