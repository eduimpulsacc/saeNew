...
<table width="650" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr class="texto8px">
    <td colspan="22" width="250">Subsector</td>
    <td>1</td>
    <td>2</td>
    <td>3</td>
    <td>4</td>
  ...
  <tr class="texto8px"> 
    <td width="250" colspan="22"><? Print pg_result($resultado_query, $j, 2); ?></td>
    <?
  ...
  ?>
  <tr class="texto8px"> 
    <td colspan="43"><div align="right">Promedio Periodo:</div></td>
  </tr>
  <tr class="texto8px"> 
    <td colspan="43"><div align="right">aSISTENCIA pERIODO: </div></td>
  </tr>
</table>
<br>
