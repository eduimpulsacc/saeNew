...
<table width="615" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<?php if($frmModo=="ingresar"){ ?>
									...
									<INPUT class="boton01" TYPE="submit" value="GUARDAR"   name=btnGuardar onclick="return valida(this.form);">
									&nbsp;
									<?php if($_PERFIL==0) {?>
									<INPUT class="boton01" TYPE="button" value="CANCELAR" name=btnCancelar onClick=document.location="listarInstituciones.php3?modo=ini">
									<? }?>
									&nbsp;
								<?php };?>
								<?php if($frmModo=="mostrar"){ ?>
									...
									<?php if(($_PERFIL==0) || ($_PERFIL==14)){ 	?>
										<?php // if(($_PERFIL!=3)&&($_PERFIL!=5)){ //FINANCIERO Y  CONTADOR?>
											<INPUT class="boton01" TYPE="button" value="MODIFICAR" name=btnModificar  onClick=document.location="seteaInstitucion.php3?institucion=<?php echo $institucion?>&caso=3">
											&nbsp; 
                             ...
                             <?php if($frmModo=="modificar"){ ?>
                                    <INPUT class="boton01"  TYPE="submit" value="GUARDAR"   name=btnGuardar onclick="return valida(this.form);">
                                    &nbsp;
									<INPUT class="boton01" TYPE="button" value="CANCELAR" name=btnCancelar onclick=document.location="seteaInstitucion.php3?institucion=<?php echo $institucion?>&caso=1">
									&nbsp;
								<?php };?>
        ...
        <tr>
          <td height="20" align="left" valign="middle"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="datos">
              <tr class="datosB">
		...
		<tr><td align="left">
		<table width="100%" cellpadding="0" cellspacing="0" class="datosB">
		  <tr><td><TABLE width="179" BORDER=0 CELLPADDING=0 CELLSPACING=0>
          <TR>
            <TD width="182" class="Estilo2"><FONT face="arial, geneva, helvetica"><STRONG>TIPO INSTITUCION</STRONG></FONT> </TD>
          </TR>
          <TR>
        ...
        </TABLE></td><td><TABLE width="274" BORDER=0 CELLPADDING=0 CELLSPACING=0>
          <TR>
            <TD width="274"><span class="Estilo2"> <FONT face="arial, geneva, helvetica"><STRONG>TIPO EDUCACION</STRONG> </FONT></span> </TD>
          </TR>
          <TR>
            <TD><?php if($frmModo=="ingresar"){ ?>
                <Select name="cmbEDUC" >
          ...
          <TR>
            <TD width="324" class="Estilo1"><div align="left" class="Estilo2"> <FONT face="arial, geneva, helvetica"><STRONG>IDIOMA</STRONG></FONT> </div></TD>
          </TR>
          <TR>
            <TD><?php if($frmModo=="ingresar"){ ?>
		...
		<tr><td align="left"><TABLE width=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 bgcolor=White class="datosB">
            ...
            <TR> 
              <TD> 
                  <TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0>
                    <TR> 
                      <TD class="Estilo2"> 
                        <FONT face="arial, geneva, helvetica"><STRONG>SEXO</STRONG></FONT>  </TD>
                    </TR>
                    <TR> 
                      <TD height="41"> 
                        <?php if($frmModo=="ingresar"){ ?>
		  ...
		  <tr><td></td></tr>
		  <tr><td></td></tr>
		  <tr><td align="left"><table><tr><td><TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0>
            <TR>
          ...
          </TABLE></td><td><TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 class="datosB">
            <TR>
