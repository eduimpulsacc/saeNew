...
require('../../../../util/header.inc');
	...
	for($cantidad=0 ; $cantidad<$cant ; $cantidad++){
		...
		$sqlArea="INSERT INTO informe_area (nombre, id_plantilla, con_concepto, fecha_creacion) VALUES('".$txtNombreAr[$cantidad]."', ".$plantilla.", ".$concepto[$cantidad].", to_date('" .$fechaCreacion. "','DD MM YYYY'))";
