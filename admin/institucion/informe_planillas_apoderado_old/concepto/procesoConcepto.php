...
require('../../../../util/header.inc');
	...
	for($cantidadC=0 ; $cantidadC<$canti ; $cantidadC++){
		$sqlConcepto="INSERT INTO informe_concepto_eval (id_plantilla, nombre, sigla, glosa, fecha_creacion) VALUES(".$plantilla.", '".$txtNombreConc[$cantidadC]."', '".$txtSigla[$cantidadC]."', '".$txtGlosaConc[$cantidadC]."', to_date('" .$fechaCreacion. "','DD MM YYYY'))";
	  ...
	  //echo "<script>window.location='creaConcepto.php?creada=1&id_concepto=".$_CONCEPTO."'</--!script-->";      
		...
		echo "<script>parent.location='../plantilla/plantillaPaso2.php?subareaCreada=1'</script>";
?>