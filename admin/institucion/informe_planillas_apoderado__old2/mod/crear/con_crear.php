...
if($funcion==1){
	...
	$rs_registro=$obj_informe->nuevoInforme($conn,$institucion,$activa,$nombre_informe,$tipo_ense,$descripcion,$titulo,$grado1,$grado2,$grado3,$grado4,$grado5,$grado6,$grado7,$grado8,$grado9,$grado10,$grado11,$grado12,$grado13,$grado14,$grado15,$fecha);
