...
$rs_listado = $ob_reporte->listaReservaTituloTodos($conn,$_INSTIT,$_ANO,$idLBR);
...
<table width="100%" border="0">
  <tr>
    <td colspan="3" class="textonegrita" align="center">REPORTE RESERVAS T&Iacute;TULO</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <?php }else{?>
  <tr class="detalleoff">
    <td colspan="9" align="center">SIN INFORMACI&Oacute;N DE RESERVAS</td>
    </tr>
    <?php }?>
    </table>
