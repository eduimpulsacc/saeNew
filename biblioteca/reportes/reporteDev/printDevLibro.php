...
$rs_listado = $ob_reporte->devolucionTitulo($conn,$idLBR,$_ANO,CambioFE($txtFECHADEV));
...
<table width="100%" border="0">
  <tr>
    <td colspan="3" class="textonegrita" align="center">REPORTE DEVOLUCIONES DE LIBROS</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr class="cuadro01">
    ...
    <td width="4%" align="center">CURSO</td>
   
    <?php if($cmb_usuario==0){?>
    <td width="28%" align="center">USUARIO</td>
   <?php  }?>
    <td width="42%" align="center">T&Iacute;TULO</td>
  ...
  <?php }else{?>
  <tr class="detalleoff">
    <td colspan="7" align="center">SIN INFORMACI&Oacute;N DE DEVOLUCIONES</td>
    </tr>
    <?php }?>
    </table>
