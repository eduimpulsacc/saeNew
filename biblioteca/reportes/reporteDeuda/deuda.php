...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
   	...
   	<td colspan="2" width="85%" align="center" valign="top" height="70"><? include("../../../cabecera_new/head_biblio.php");?></td>
  ...
  <tr>
    ...
    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
      <tr>
        ...
        <form method="post"  name="form" target="_blank" id="form" action="printdeuda.php">
         <table width="75%" border="0" cellpadding="3" align="center">
              <tr>
                <td  class="titulos-respaldo">REPORTE CERTIFICADO MOROSIDAD PRESTAMO LIBROS</td>
            </tr>
            <tr>
  ...
  <tr>
    ...
    <td>
    <?php $rs_cur = $ob_repo->traeCurso($conn,$_ANO); ?>
...
<?php }?>
  ...
  <tr>
    <td colspan="2" align="center"><? include("../../../cabecera_new/footer2.html");?></td>
  </tr>
  <tr>
    <td colspan="2"></td>
  </tr>
