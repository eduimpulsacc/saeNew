...
function Agregar(categoria,menu){
 var perfil =$("#cmbPERFIL").val();
 var rdb = <? echo $_INSTIT;?>;
 var parametros="funcion=2&perfil="+perfil+"&rdb="+rdb+"&categoria="+categoria+"&menu="+menu;
...
function Eliminar(categoria,menu){
 var perfil =$("#cmbPERFIL").val();
 var rdb = <? echo $_INSTIT;?>;
 var parametros="funcion=3&perfil="+perfil+"&rdb="+rdb+"&categoria="+categoria+"&menu="+menu;
