...
function abre_dialog()
{
	//alert('x');
	$('#dialog_r').html(
	'<table align="center"><tr><td><textarea cols="40" rows="3"></textarea></td></tr></table>')
	$('#dialog_r').dialog({
		effect: "blind",
        height: 210,
        width: 450,
...
<div id="tabla_2">
      ...
      <tr>
      <td class="cuadro02">SELECCIONAR</td>
      <td>
      ...
      <tr>
      <td class="cuadro02">ESTREATEGIA PRINCIPAL</td>
      <td>
      <select name="SE2" id="SE2">
      <option selected="selected">Seleccione</option>
      <option value="1">Primera Estrategia</option>
      <option value="2">segunda Estrategia</option>
      <option value="3">Tercera Estrategia</option>
      </select>&nbsp;<img align="middle" src="img/PNG-48/Add.png" id="btn_ventana" width="30" height="30" onclick='abre_dialog()' onmouseover=this.style.cursor='pointer' title="GUARDAR DATOS">
      </td>
      </tr>
      
      <tr>
      <td class="cuadro02">ESTREATEGIA SECUNDARIA</td>
      <td class="cuadro01"><textarea name="text_obj" id="text_obj" cols="40" rows="2" ></textarea></td>
      </tr>
      
      <tr>
      <td class="cuadro02">META ESTREATEGIA SECUNDARIA</td>
      <td class="cuadro01"><textarea name="text_obj" id="text_obj" cols="40" rows="2" ></textarea></td>
      </tr>
