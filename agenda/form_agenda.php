...
<script language="JavaScript" src="includes/widgets/calendar.js"></script>
<script language="JavaScript" src="includes/widgets/calendar-setup.js"></script>
<script language="JavaScript" src="includes/widgets/lang/calendar-es.js"></script>
...
<link rel="stylesheet" type="text/css" media="all" href="includes/widgets/calendar-brown.css" title="green"/>
</head>
                              ...
                              <form action="ing_agenda.php" method="post" enctype="multipart/form-data" name="form1">
                                <table width="80%" border="0" align="center" cellpadding="0" cellspacing="5">
                                  <tr>
                                    ...
                                    <td class="cuadro01"><select name="cmb_curso" id="cmb_curso">
