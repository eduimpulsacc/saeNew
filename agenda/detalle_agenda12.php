			   ...
			   <tr align="left" valign="top"> 
                <td height="75" valign="top">
			        ...
			        ?>
					 ...
					 <? if (($_PERFIL==17 OR $_PERFIL==19 )){ 
			                                         // no muestro
			                                     }else{ ?>	
					<div align="right" ><INPUT class="botonXX"  TYPE="button" value="ELIMINAR" name="btnEliminar" onClick=document.location="elimina_agenda.php?id_agenda=<? echo $id_agenda?>">
                            ...
                            <td align="left" valign="top"><table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#999999">
                                <tr align="center" valign="top"> 
                                  <td height="162" align="center">
								       <table width="100%">
						            <tr><td class="tableindex"><div align="center">AGENDA <?=$fecha;?>
															      ...
															      if ($id_curso == $curso){
                                                                      ...
                                                                      <td>
																	   ...
																	   if ($fagenda['file']!=NULL){
																	    ...
																	    if ($perfil == 17 OR $perfil == 2 OR $perfil == 19 OR $perfil ==0){
																		    // muestro
																		    ?>
														                    <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                                            <tr>
