...
<body topmargin="0">
<table width="650" border="0" align="center" height="900">
  <tr>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" align="center">
      <tr>
        <td align="justify" class="textosimple"><p><? echo $estimado."&nbsp;".$director;?>,<br /><br />
       ...
       <p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Enviamos a usted estad&iacute;stica de conexiones por perfiles que ha tenido su instituci&oacute;n en la plataforma SAE<sup>&reg;</sup>, Sistema de Gesti&oacute;n Escolar que tiene contratado.<br />
		...
		?>
          ...
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Considerando los dos utlimos meses, la tendencia de uso ha sido de un <? echo substr($variacion,0,5);?>% <?=$mensaje;?></p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sin otro particular, me despido atentamente</p>
      ...
      <tr>
        <td align="center" class="textonegrita"><img src="firma dzj (2).png" width="178" height="73" /><br />
