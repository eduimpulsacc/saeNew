						  ...
						  <span class="submenu2" id="sub_conf">
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
							  ...
							  <? } ?>		
								...
								<tr>
								  <td width="90%" class="cajamenu2"><a href="<? echo $c; ?>mensajeria/configuracion.php" >&nbsp;&nbsp;&nbsp;&nbsp;Mapa Mensajería</a></td>
								</tr>
								<tr>
								   <td colspan="2" height="1"><img  src="" width="100" height="1" /></td>
								</tr>
					    ...
					    <div onclick="SwitchMenu('sub_comunica')">
						  ...
						  <span class="submenu5" id="sub_comunica">
							<table cellspacing="0" cellpadding="0" width="100%" border="0">
							  <tbody>
								<tr>
								  <td width="90%" class="cajamenu2"><a href="<? echo $c; ?>mensajeria/mira.php" >&nbsp;&nbsp;Mensajería</a></td>
								</tr>
								<tr>
								  <td colspan="2" height="1"><img  src="" width="100" height="1" /></td>
								</tr>
  ...
  // fin ALUMNO ?>
	...
	?>
		...
		$filaM=@pg_fetch_array($resultM,0);
  		...
  		if (($filaM['mostrar_notas']==1) OR ($filaM['mostrar_notas']=="") and ($filaM['mostrar_notas']!=0)){ ?>
                  <tr>
                    <td align="left" valign="top" class="cajamenu"><div align="left"><a href="<? echo $c ?>fichas/fichaAlumno.php3">Ficha Acad&eacute;mica</a> </div></td>
                  </tr>
				...
				?>
				 ...
				 <table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tbody>
					  ...
					  <tr>
						<td  bgcolor="#f5f5f5" class="cajamenu"><a href="<? echo $c ?>admin/corporacion/reportesCorporativos.php">Reportes Corporativos</a></td>
					  </tr>
					  <? if ($menudinamico == 0)
					  	{	?>
						   <tr>
	 ...
	 ?>
		    ...
		    <? } ?>			
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <!-- primer boton  -->
                    <td align="left" valign="top" class="cajamenu"><div align="left"><a href="<? echo $c ?>admin/institucion/institucion.php3?caso=1" target="_self">Datos Institución </a></div></td>
                  </tr>
