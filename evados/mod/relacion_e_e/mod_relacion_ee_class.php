...
/*       echo "<pre>";
	...
	/*	  echo "<pre>";
		  ...
		  $select = "SELECT * FROM evados.eva_relacion_evaluacion WHERE id_ano=".$_ANO." AND rut_evaluado=".$rut_evaluado." AND rut_evaluador=".$array[0]." AND id_cargo = ".$array[1]." AND cargo_evaluado = ".$cargo_evaluado." AND id_periodo=".$periodo.";";
		...
		VALUES(".$_ANO.",".$rut_evaluado.",".$array[0].",".$array[1].",".$cargo_evaluado.",".$periodo.");";
...
$regis = pg_Exec( $this->Conec->conectar(),$sql ) or die( "Error bd Select 2".$sql);
	...
	if($regis){
	  ...
	  echo  $sql_insert = "INSERT INTO evados.eva_relacion_evaluacion(id_ano,rut_evaluado,rut_evaluador,id_cargo,cargo_evaluado,id_periodo)
