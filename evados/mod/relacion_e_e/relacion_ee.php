...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	function cargarselectbloque(ano) {
		...
		$.ajax({
			url : 'mod/relacion_e_e/contr_relacion_ee.php',
	...
	function buscar_relacion(rut, cargo) {
		...
		var parametros = "funcion=8&rut_evaluado=" + rut + "&id_cargo_evaluado=" + cargo;
	...
	<body>
		...
		<div id="bloques" align="center"  >
			...
			<input type="hidden" id="Arreglo_RutevaluadoresCargos" value="0"  />
			<fieldset>
				<legend>
