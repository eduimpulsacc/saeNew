...
function Accion(){
	...
	if(opcion==1){
		...
		document.form.action="mod/reportes/reporte_respuestas/printReporteRespuestas.php"
	}
...
<body><br />
<br />
<form name="form" action="mod/reportes/cuadroevaluaciones/printCuadroEvaluaciones.php" method="post" target="_blank">
...
Cuadro Estadistico  <input type="radio" name="rdTIPO" id="rdTIPO3" value="2"/>
Respuestas evaluaci&oacute;n</td>
			  </tr>
			  <tr>
