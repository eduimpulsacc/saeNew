...
<body><br />
<br />
<form name="form" action="mod/reportes/reporte_indicadores/printReporteIndicadores.php" method="post" target="_blank">
			...
			<td height="27"><table width="550" border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr>
				...
				<td width="409" colspan="2"><div align="left"><span class="textosmediano">
				  <select name="cmbCARGO" class="ddlb_x" onchange="carga_empleado(this.value)">
					<option value="0">seleccione</option>
			  ...
			  <tr>
				...
				<td colspan="2" class="textosimple"><input name="tipo_dato" type="radio" value="2" />
				  Sin Ponderar </td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			    <td colspan="2" class="textosimple"><strong>NOTA:</strong> Por disposición de la Unión Central, los reportes serán emitidos solamente si se cumple con más del 70% de las evaluaciones</td>
			    </tr>
			</table></td>
		  </tr>
		</table>
