...
function carga_pauta(bloque){
	...
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/itemgrupohomogenio/cont_motor.php',
		data:parametros,
		type:'POST',
...
function cargar_funcion(area,nacional){
	var parametros ='funcion=funciones&nacional='+nacional+'&area='+area;
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/itemgrupohomogenio/cont_motor.php',
		data:parametros,
...
function cargar_indicador(subarea,nacional){
	var area = $("#cmbDIMENSION").val();
	var parametros ='funcion=indicador&nacional='+nacional+'&area='+area+'&subarea='+subarea;
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/itemgrupohomogenio/cont_motor.php',
		data:parametros,
...
<body><br />
<br />
<form name="form" action="mod/reportes/itemgrupohomogenio/printItemGrupo.php" method="post" target="_blank">
