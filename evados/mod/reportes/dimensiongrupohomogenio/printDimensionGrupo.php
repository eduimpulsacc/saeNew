...
$rs_count = $ob_reporte->CuentaFuncionItem($pauta,$dimension);
$cuenta_funcion = pg_result($rs_count,0);
$cuenta_item = pg_result($rs_count,1);
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="361" class="textosimple"><div align="left"><? echo strtoupper(trim($fila_inst['nombre_instit'])) ?></div></td>
  ...
  <tr>
    ...
    <td class="textosimple"><div align="left"><? echo trim($fila_ano['nro_ano']) ?></div></td>
  </tr>
  <tr>
...
<table width="650" border="0" align="center">
  <tr>
    <td class="tablatit3"><div align="center">REPORTE POR GRUPO HOMOGENIO </div></td>
  </tr>
</table>
<br />
<table width="650" border="0" align="center">
  ...
  <tr>
    <td class="textonegrita">Dimensi&oacute;n</td>
    <td class="textonegrita"><div align="center">:</div></td>
    <td class="textosimple">&nbsp;<?=$nombre_dimension;?></td>
  </tr>
  <tr>
    <td class="textonegrita">Cantidad de Funciones </td>
    <td class="textonegrita"><div align="center">:</div></td>
    <td class="textosimple">&nbsp;<?=$cuenta_funcion;?></td>
  </tr>
  <tr>
    <td class="textonegrita">Cantidade Indicadores </td>
    <td class="textonegrita"><div align="center">:</div></td>
    <td class="textosimple">&nbsp;<?=$cuenta_item;?></td>
  </tr>
  <tr>
