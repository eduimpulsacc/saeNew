...
function carga_periodo(ano){
	...
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/pendiente_Evaluacion/cont_motor.php',
		data:parametros,
		type:'POST',
...
<body><br />
<br />
<form name="form" action="mod/reportes/pendiente_Evaluacion/printReportePendienteEvaluacion.php" method="post" target="_blank">
