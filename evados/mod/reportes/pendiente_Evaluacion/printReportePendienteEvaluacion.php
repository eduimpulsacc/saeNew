...
<table width="650" border="0" align="center">
  ...
  <tr>
    <td colspan="3"><table width="95%" border="0" align="center" cellpadding="0">
      <tr>
        <td align="center" class="textonegrita"><u>LISTADO EVALUACION PENDIENTES</u></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td> <? for($i=0;$i<pg_numrows($rs_evaluadores);$i++){
          ...
          <tr>
            ...
            <td class="textosimple"><?=$fila['rut_evaluado']."-".$fila['dig_rut'];?></td>
          </tr>
          ...
          <table width="100%" border="0">
              ...
              <? $result = $ob_reporte->Pendiente_Evaluacion($fila['rut_evaluado'],$ano,$periodo);
