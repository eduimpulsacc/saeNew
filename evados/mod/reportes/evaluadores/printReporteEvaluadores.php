...
<table width="650" border="0" align="center">
  ...
  <tr>
    <td colspan="3"><table width="95%" border="0" align="center" cellpadding="0">
      <tr>
        <td align="center" class="textonegrita"><u>LISTADO DE EVALUADORES</u></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><table width="100%" border="1" style="border-collapse:collapse">
          ...
          <? for($i=0;$i<pg_numrows($rs_evaluadores);$i++){
			...
			?>
          <tr>
            <td class="textosesion" align="right">&nbsp;<?=$fila['rut_evaluador']."-".$fila['dig_rut'];?></td>
            <td class="textosesion">&nbsp;<?=$fila['cargo'];?></td>
