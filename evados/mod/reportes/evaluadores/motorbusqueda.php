...
function carga_periodo(ano){
	...
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/evaluadores/cont_motor.php',
		data:parametros,
		type:'POST',
...
<body><br />
<br />
<form name="form" action="mod/reportes/evaluadores/printReporteEvaluadores.php" method="post" target="_blank">
