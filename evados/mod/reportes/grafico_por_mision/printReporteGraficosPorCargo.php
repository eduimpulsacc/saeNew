...
$rs_NomInstit = $ob_reporte->Nombre_Institucion($instirucion);
...
$rs_diemsion = $ob_reporte->Dimension($_POST['cmbDIMENSION']);
$nombre_dimension = pg_result($rs_diemsion,2);
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="361" class="textonegrita"><div align="left"><? echo strtoupper(trim($nom_instit)) ?></div></td>
