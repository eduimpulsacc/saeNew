...
function carga_pauta(bloque){
	...
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/functiongrupohomogenio/cont_motor.php',
		data:parametros,
		type:'POST',
...
function cargar_dimension(plantilla,nacional){
	var parametros ='funcion=dimension&plantilla='+plantilla+'&nacional='+nacional;
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/functiongrupohomogenio/cont_motor.php',
		data:parametros,
...
function cargar_funcion(area,plantilla){
	var parametros ='funcion=funciones&plantilla='+plantilla+'&area='+area;
	//alert(parametros);
	$.ajax({
		url:'mod/reportes/functiongrupohomogenio/cont_motor.php',
		data:parametros,
...
<body><br />
<br />
<form name="form" action="mod/reportes/functiongrupohomogenio/printFuncionGrupo.php" method="post" target="_blank">
