...
function carga_empleado(cargo){
	...
	var dato = cargo.split(',');
	var parametros ='funcion=empleado&cargo='+dato[0]+'&rdb='+rdb+"&ano="+ano+"&periodo="+periodo[0];
...
function Accion(){
	...
	document.form.action="mod/reportes/cuadroFunsiones/printCuadroFunsiones.php";
