...
$fila_nacional = $ob_membrete->Nacional($_NACIONAL);
...
$rs_NomCorp = $ob_reporte->nom_Corp($corporacion);
...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="3" class="textonegrita"><div align="left"><strong></strong><? echo strtoupper(trim($fila_nacional['nombre'])) ?></div></td>
    <td width="161" rowspan="9" align="center" valign="top" ><img src="../../../../cortes/<?=$_INSTIT?>/insignia.jpg" width="100" height="100" /></td>
  </tr>
  <tr>
    <td colspan="3" class="textonegrita"><div align="left"><? echo strtoupper(trim($fila_nacional['direccion'])) ?></div>      <div align="left"></div></td>
  </tr>
  <tr>
    <td width="114" class="textonegrita">&nbsp;</td>
    <td width="9" class="textonegrita">&nbsp;</td>
    <td width="361" class="textonegrita">&nbsp;</td>
  </tr>
  <tr>
...
<?
 ...
 /*[cmbANO][cmbCORP][cmbINST][cmbCARGO][cmbPAUTA][cmbDIMENSION]*/ 
	    ...
	    $_POST['cmbANO'],$nacional,$_POST['cmbCORP'],$_POST['cmbINST'],$_POST['cmbCARGO'],
