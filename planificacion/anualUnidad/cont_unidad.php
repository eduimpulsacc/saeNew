...
<table width="700" border="0" align="center">
 ...
 <input name="ens2<?php echo $fila['id_unidad']?>" type="hidden" id="ens2<?php echo $fila['id_unidad']?>" value="<?php echo pg_result($rs_curso,3) ?>"/>
    ...
    <td align="center" class="tablaredonda"><input name="es" type="button" value="ES" title="Cambiar Estado" onclick="cambiaEstado(<?php echo $fila['id_unidad'] ?>)" class="botonXX" /></td>
    ...
    <?php }?>
    <td align="center" class="tablaredonda"><a href="carhgafile/index.php?rr=<?php echo $_INSTIT ?>&icls=<?php echo $fila['id_unidad'] ?>" target="_blank" onClick="window.open(this.href, this.target, 'width=600,height=300'); return false;"><input type="button" name="ac" id="ac" value="A" title="Subir Archivo Evaluaci&oacute;n" class="botonXX" ></a></td>
    <?php if($_PERFIL==0 ){?>
...
echo 2;
	...
	$rs_obj = $ob_unidad->traeObjAll2($conn,$rdb,$en,$gr,$ids);
	
	$txt_nombre = "PLANIFICACION ".$gr."_".$ids."_".$lt."_$en"."_$numa";
	
	$rs_guarda = $ob_unidad->guardaUnidadT2($conn,$rdb,$ano,$curso,$id_ramo,$dicta,$txt_fechaini,$txt_fechater,utf8_decode($txt_nombre),$tipo);
