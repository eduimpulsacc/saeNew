...
function tipoUnidad(){
$("#tipou").html('<input name="tipu" type="radio" value="1" onclick="carga()" />Personalizada&nbsp;&nbsp;&nbsp;&nbsp;<input name="tipu" type="radio" value="2" onclick="carga()"/>Est&aacute;ndar');
$("#tabla").html('');
}

function carga(){
var tipo = $('input:radio[name=tipu]:checked').val();
creaUnidad(tipo);
}
...
function cancela(){
 $("#nvo").html('<input type="button" name="nuevaUnidad" id="nuevaUnidad" value="Nueva Planificaci&oacute;n" onclick="tipoUnidad()" class="botonXX" /> <input type="button" name="busca" id="busca" class="botonXX" value="Buscar" onclick="traeUnidades()" />');
  traeUnidades();
...
location.href='../unidad/unidad.php?iun='+unidad;
...
var curso = $("#sel_curso").val();
var cod_ramo = $("#cod_ramo").val().trim();
var dicta = $("#docdicta").val();
var tipo =  $('input:radio[name=tipu]:checked').val();
var parametros = "funcion="+funcion+"&rdb="+rdb+"&ano="+ano+"&id_ramo="+id_ramo+"&curso="+curso+"&tipo="+tipo+"&cod_ramo="+cod_ramo+"&dicta="+dicta;
//alert(parametros);
                          ...
                          <tr>
                            ...
                            <table width="100%" border="0">
                              <tr>
                                ...
                                <input type="button" name="nuevaUnidad" id="nuevaUnidad" class="botonXX" value="Nueva Planificaci&oacute;n" onclick="tipoUnidad()" />                                  <input type="button" name="busca" id="busca" class="botonXX" value="Buscar" onclick="traeUnidades()" border="0" /></div></td>
                              </tr>
                            </table>
