...
function cambiotipo(opt){
	...
	//grafico
	$("#tipografico").append('<td class="textonegrita">TIPO GRÁFICO</td><td class="textonegrita">:</td><td class="textosimple"><input name="tipo" type="radio" value="0" />BARRAS <input name="tipo" type="radio" value="1" />PUNTOS <input name="tipo" type="radio" value="2" />TORTA</td>');
}
}
...
var opt = $('input:radio[name=formato]:checked').val();
	...
	if(opt==1){
	var ruta ="printNotasCursoAsig.php";
	}else 
	{
...
<table width="1280" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3" class="tableindexredondo">Buscador Notas por Asignatura</td>
    </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
    </tr>
    ...
    ?>
    <div id="ano">
    <select name="cmbANO" id="cmbANO" onchange="cambia_curso();cambia_periodo()" class="select_redondo">
    ...
    <td class="textonegrita">:</td>
    <td class="textosimple"><input name="formato" type="radio" id="formato1" value="1" checked="checked" onclick="cambiotipo(this.value)" />
      Reporte
