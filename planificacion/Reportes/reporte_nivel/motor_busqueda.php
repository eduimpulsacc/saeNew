...
function cambiotipo(opt){
	...
	//grafico
	$("#tipografico").append('<td class="textonegrita">TIPO GRÁFICO</td><td class="textonegrita">:</td><td><input name="tipo" type="radio" value="0" />BARRAS <input name="tipo" type="radio" value="1" />PUNTOS <input name="tipo" type="radio" value="2" />TORTA</td>');
}
}
