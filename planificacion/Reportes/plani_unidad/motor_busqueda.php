...
function cambia_curso(){
 ...
 <?php }else{?>
	 ...
	 var rut = "";
 <?php }?>
 var parametros="funcion=1&ano="+ano+"&perfil="+perfil+"&rut="+rut;
 //alert(parametros);
 $.ajax({
	  url:'cont_motor.php',
	  data:parametros,
...
function cambia_ramo(){
 ...
 <?php }else{?>
	 ...
	 var rut = "";
 <?php }?>
 var parametros="funcion=2&ano="+ano+"&curso="+curso+"&perfil="+perfil+"&rut="+rut;
 $.ajax({
	  url:'cont_motor.php',
	  data:parametros,
	  type:'POST',
  ...
  <tr>
    ...
    <table width="890" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                          <tr>
                            ...
                            <form action="printPlani_unidad.php" method="post" target="_blank">
                            <table width="90%" border="0" align="center" class="cajaborde">
                              <tr>
                                <td colspan="3" class="tableindexredondo">Buscador Planificaci&oacute;n por Unidad</td>
                              </tr>
                              <tr>
                                <td colspan="3">&nbsp;</td>
                              </tr>
                              ...
                              <tr>
                                <td class="textonegrita">INCLUYE PLANFIC. DE CLASE</td>
                                <td class="textonegrita">:</td>
                                <td><input type="radio" name="radio" id="radio1" value="1" />
                                <label for="radio"></label>
                                <em>si 
                                <input name="radio" type="radio" id="radio0" value="0" checked="checked" />
                                no
                                </em></td>
                              </tr>
                              <tr>
