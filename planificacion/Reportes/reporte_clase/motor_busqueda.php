  ...
  <tr>
    ...
    <table width="890" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
                          <tr>
                            ...
                            <form action="../reporte_clase/printReporteCurso.php" method="post" target="_blank">
                            <table width="90%" border="0" align="center" class="cajaborde">
                              <tr>
                                <td colspan="3" class="tableindexredondo">Buscador Planificaci&oacute;n por Clase</td>
                              </tr>
                              <tr>
                                <td colspan="3">&nbsp;</td>
                              </tr>
