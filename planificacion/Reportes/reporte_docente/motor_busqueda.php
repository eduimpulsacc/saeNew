...
<table width="1280" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <form name="form" action="printDesempenoDocente.php" target="_blank" method="post">
    <table width="860" border="0" cellpadding="0" cellspacing="0" class="tablaredonda">
      <tr>
        <td width="5%" colspan="4"><br />
        <table width="90%" border="0" align="center" class="cajaborde">
          <tr>
            <td colspan="3" class="tableindexredondo">Buscador Efectividad Docente </td>
          </tr>
          <tr>
            <td colspan="3">&nbsp;</td>
          </tr>
