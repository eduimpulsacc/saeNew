...
if($_VOL==1){
	require("../unidad/mod_unidad.php");
	$uni2 = new Unidad();
	$ru = $uni2->traeUnidad($conn,$_GET['cls']);
	$iiun = pg_result($ru,14);
	
		
		
		$ruta = "../unidad/unidad.php?iun=$iiun"; 
		}else{
			$ruta = "../unidad/unidad.php";
		}
...
<script type="text/javascript" src="../../admin/clases/jquery-ui-1.11.4.custom/jquery-ui-1.11.4.custom/jquery-ui.min.js"></script>
 ...
 <script type="text/javascript" src="../../admin/clases/tinymce/js/tinymce/jquery.tinymce.min.js"></script>
<script type="text/javascript" src="../../admin/clases/tinymce/js/tinymce/tinymce.min.js"></script>
<script type="text/javascript" src="../../admin/clases/tinymce/js/tinymce/plugins/media/plugin.min.js"></script>
<script type="text/javascript" src="../../admin/clases/tinymce/js/tinymce/plugins/tiny_mce_wiris/editor_plugin.js"></script>
<script type="text/javascript" src="../../admin/clases/tinymce/js/tinymce/plugins/tiny_mce_wiris/integration/WIRISplugins.js?viewer=image"></script>
 
<script>

$(document).ready(function(){
	<?php if(!isset($orr)){?>
	traeUnidad(<?php echo $cls?>);
	<?php }else{?>
	traeUnidad(<?php echo $cls?>);
...
$('textarea').each(function (index, ta) {
            var $ta = $(ta);
            msg += '<input type="text" name=" ' + $ta.attr('name') + '" value="' + $ta.val() + '">';
        });
...
<div id="txt" title="" align="center"> </div>
<br />
