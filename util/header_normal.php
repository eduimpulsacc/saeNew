...
//		echo "ERROR DE ACCESO, LA SESION DE USUARIO HA EXPIRADO...";
		echo "<script>window.location = 'http://200.2.201.33/sae3.0/session/finSession.php3'</script></HEAD><BODY></BODY></HTML>";
...
//echo $_SERVER['HTTP_USER_AGENT'];
			...
			{
			$sql3="INSERT INTO usuarios_online(ip,isp,fecha,id_usuario,ruta,perfil) VALUES ('$ip','$isp','$time_now','$_USUARIO','$ruta','$_PERFIL')";
			}
