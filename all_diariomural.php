...
<table width="100%" height="207" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td align="left" valign="bottom" background="cortes/<?=$institucion?>/foto_top.jpg"><font color="#FFFFFF" size="4" face="Arial, Helvetica, sans-serif">SAE 
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
												  ...
												  if(@pg_numrows($rsDiario)!=0){
	                                                    for($i=0 ; $i < @pg_numrows($rsDiario); $i++)
														   ...
														   $output= "select lo_export(".$fDiario['foto'].",'tmp/".trim($fDiario['id_diario'])."Foto');";
			$retrieve_result = @pg_exec($conn,$output);
		  												
                                                           ?>
												     	  <tr> 
                                                          <td width="21%" height="54" align="center" valign="top">
														  <img src="fichas/diario/images/<?php echo $fDiario['nom_foto']; ?>" alt="Ampliar Imágen"  width=53 height="50" border="0" onClick="MM_openBrWindow('foto_diarioMural.php?dmural=<?php echo $fDiario['nom_foto']; ?>','','scrollbars=yes,resizable=yes,width=800,height=600')" onMouseOver=this.style.cursor='hand'>													  </td>
														 ...
														 <br>
														 <tr> 
                                                          <td colspan="2" align="center"><a href="#" onClick="MM_callJS('history.go(-1)')">Volver</a></td>
                                                        </tr>
														 <? 
												    }else{
													     ?>													 
