    ...
    <td valign="top" height="50%" ><br>
       ...
       <table width="95%" border="0" class="cajaborde" align="center">
          <tr>
           ...
           <tr>
            <td> <img src="../../cortes/10774/sombra.png" width="885" height="32"></td>
          </tr>
           <br>
...
<form action="../../admin/institucion/Colegio_restore/Reportes/Rpt18/proceso_informe.php" method="post">
...
//if($_PERFIL==0){ 
						...
						if($nuevo==1){
							...
							{	
								...
								<tr>
                                    <td colspan="3" class="tabla04"><? if($nuevo==1){
																		echo $row_cat['glosa'];
																		}else{
																		echo $row_cat['nombre'];
																		}?></td>                                   
...
<table width="709" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="80"><div align="right">
      <input name="cb_ok" type="button" class="botonXX" id="cb_ok" onClick="MM_goToURL('parent','../../admin/institucion/Colegio_restore/Reportes/Rpt18/rpt18.php?c_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].value+'&amp;cmb_curso='+cmb_curso.options[cmb_curso.selectedIndex].value+'&amp;c_alumno='+cmb_alumno.options[cmb_alumno.selectedIndex].valu');return document.MM_returnValue" value="Buscar">
    </div></td>
  </tr>
</table>
