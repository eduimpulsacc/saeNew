...
<table width="161" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="161" height="28" valign="top">&nbsp;</td>

  </tr>

  <tr>

    <td width="161" height="26" valign="bottom"><a href="../../menu/salida.php" target="_parent"><img src="imag/salir.gif" name="Image15" width="161" height="23" border="0" id="Image15" onMouseOver="MM_swapImage('Image15','','imag/salir2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
