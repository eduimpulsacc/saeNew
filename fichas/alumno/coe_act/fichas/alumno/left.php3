...
-->  <tr> 
  ...
  <tr> 
    <td width="161" height="22" valign="bottom"><a href="contenidos.htm" target="mainFrame"><img src="imag/cont_dig.gif" name="Image22" width="161" height="18" border="0" id="Image22" onMouseOver="MM_swapImage('Image22','','imag/cont_dig2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
  <tr>
  ...
  <?php if ($_USUARIO=="7573"){?>
  <tr>
    <td width="161" height="25" valign="bottom"><a href="../../admin/institucion/webmail/verMail.php" target="mainFrame"><font color="#FFFFFF">REVISA 
      TU CORREO</font></a></td>
  </tr>
  <tr>
