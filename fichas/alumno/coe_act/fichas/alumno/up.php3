...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('imag/inicio2.gif','imag/n_inst2.gif','imag/regl2.gif','imag/carta2.gif','imag/proceso2.gif','imag/uniforme2.gif','imag/mapa2.gif','imag/proyecto2.gif')">
        ...
        <tr> 
          <td width="619" height="27"><table width="559" height="27" border="0" cellpadding="0" cellspacing="0">
              <tr> 
                ...
                <td width="67"><a href="../../admin/institucion/mapa.php?botonera=1" target="mainFrame"><img src="imag/mapa.gif" name="Image7" width="67" height="27" border="0" id="Image7" onMouseOver="MM_swapImage('Image7','','imag/mapa2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
             		<td width="43"><a href="../../util/logout.php3" target="_parent""><img src="imag/salir3.gif" name="Image23" width="43" height="27" border="0" id="Image23" onMouseOver="MM_swapImage('Image23','','imag/salir4.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
			  </tr>
            </table></td>
        </tr>
      </table></td>
