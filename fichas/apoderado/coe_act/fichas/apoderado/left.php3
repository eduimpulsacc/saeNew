...
<table width="161" height="365" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td width="161" height="25"><a href="../../admin/institucion/ano/curso/horario/listarHorario.php" target="mainFrame"><img src="imag/horario.gif" name="Image1" width="161" height="25" border="0" id="Image1" onMouseOver="MM_swapImage('Image1','','imag/horario2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
  <tr> 
    <td width="161" height="25"><a href="../../admin/institucion/ano/curso/alumno/listarAlumnos.php3" target="mainFrame"><img src="imag/lista.gif" name="Image2" width="161" height="25" border="0" id="Image2" onMouseOver="MM_swapImage('Image2','','imag/lista2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="161" height="25"><a href="../../admin/institucion/ano/curso/comunicacion/ListaComunicacion.php" target="mainFrame" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image19','','imag/comunicaciones2.jpg',1)"><img src="imag/comunicaciones.jpg" name="Image19" width="161" height="25" border="0"></a></td>
  </tr>  
    <tr>
  ...
  <tr>
   ...
   <tr> 
    <td width="161" height="23"><a href="../../admin/institucion/ano/curso/alumno/apoderado/usuario/claveAcceso.php3" target="mainFrame"><img src="imag/clave.gif" name="Image201" width="161" height="23" border="0" id="Image20" onMouseOver="MM_swapImage('Image201','','imag/clave2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
    <tr>
