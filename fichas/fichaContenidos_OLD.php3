						...
						<TR height=20 bgcolor=#0099cc>
							<TD align=middle colspan=2>
								<FONT face="arial, geneva, helvetica" size=2 color=White>
									<strong>FICHA CONTENIDOS DISPONIBLES</strong>
								</FONT>
							</TD>
						</TR>
																					...
																					<TD>
																						<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=1 width=100%>
																							<TR>
																								...
																								<TD width=*>
																								<?php
																									$output= "select lo_export(".$filaY['archivo'].",'/var/www/html/tmp/".trim($filaY['nombre_archivo'])."');";
																									$retrieve_result = @pg_exec($conn,$output);
																								?>
