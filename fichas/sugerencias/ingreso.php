                          ...
                          <tr> 
                            <td height="0" align="left" valign="top"> 
							 ...
							 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cajaborde">
							   ...
							   <center>
<FORM method=post name="frm" action="proceso.php" enctype="multipart/form-data">

<? if ($diario>0){?>
<input name="sw" type="hidden" value="1">
<? 

	$sqlDiario = "select * from sugerencias where id = $diario";
...
<table width="650" border="0" cellspacing="1" cellpadding="3">
  <tr>
	...
	<? if ($diario != 0){ ?>
	     <INPUT class="botonXX"  TYPE="button" value="ELIMINAR" name="btnEliminar" onClick=document.location="proceso.php?sw=3&id_diario=<? echo $diario?>">
  	<? } ?>

	<INPUT class="botonXX"  TYPE="button" value="VOLVER" name=btnCancelar onClick=document.location="sugrec.php">	</td>
  </tr>
</table>
...
<table width="650" border="0" cellspacing="1" cellpadding="3">
	<TR height=20>
		<TD align=center colspan=2 class="tableindex">
			Ingreso de Sugerencias o Reclamos </TD>
	</TR>
</table>
<br>
