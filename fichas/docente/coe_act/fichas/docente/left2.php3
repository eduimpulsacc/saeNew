...
<table width="161" height="150" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="161" height="30"><a href="../../admin/institucion/ano/curso/ramo/contenido/listarContenidos.php3" target="mainFrame"><img src="imag/mat.gif" name="Image15" width="161" height="23" border="0" id="Image15" onMouseOver="MM_swapImage('Image15','','imag/mat2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td width="161" height="30"><a href="../../util/logout.php3" target="_parent"><img src="imag/salir.gif" name="Image15" width="161" height="23" border="0" id="Image15" onMouseOver="MM_swapImage('Image15','','imag/salir2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
</table>
</body>
</html>
