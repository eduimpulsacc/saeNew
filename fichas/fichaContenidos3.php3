...
$cuentaV = pg_result($rs_qryva,0);
  ...
  <tr class="tableindex">
    <td width="33%" align="center">T&iacute;tulo</td>
    <td width="24%" align="center">Fecha </td>
    <td width="24%" align="center">Fecha Entrega</td>
    <td width="19%" align="center">Acciones</td>
    </tr>
   <?php  for($j=0 ; $j < @pg_numrows($resultY) ; $j++){
																$filaY = @pg_fetch_array($resultY,$j);?>
  <tr>
    <td><FONT face="arial, geneva, helvetica" size=1 color=RED><STRONG><?php echo trim($filaY['titulo']);?></STRONG></FONT></td>
