...
<body bgcolor="003b85" background="imag/fondopag.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('imag/aacademico2.gif','imag/sweb2.gif','imag/personal2.gif','imag/colegiatura2.gif','imag/salir2.gif','imag/datosinst2.gif','file:///C|/Mis%20documentos/coe_prueba/menu/imag/soporte2.jpg')">
<table width="161" border="0" cellpadding="0" cellspacing="0">
 ...
 <?php if($_PERFIL!=0){ ?> 
  <?php if(($_PERFIL!=3)and ($_PERFIL!=5)){ ?>  
  <tr> 
    <td width="161" height="27" valign="bottom"><a href="../admin/institucion/ano/listarAno.php3" target="content"><img src="imag/aacademico.gif" name="Image4" width="161" height="25" border="0" id="Image4" onMouseOver="MM_swapImage('Image4','','imag/aacademico2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
   <?php }?>
     <?php if(($_PERFIL!=3)and ($_PERFIL!=5)){ ?>  
  <tr> 
