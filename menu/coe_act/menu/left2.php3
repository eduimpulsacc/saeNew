...
<table width="161" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="161" height="28" valign="bottom"><a href="index3.php3" target="_parent"><img src="imag/datosinst.gif" name="Image8" width="161" height="25" border="0" id="Image8" onMouseOver="MM_swapImage('Image8','','imag/datosinst2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
  <tr> 
...
<div align="center"><font color="#FFFFFF" size="2" face="arial, geneva, helvetica"> 
        <? if($_PERFIL==0){?>
        <a href="../admin/institucion/soporte/main_soporte.php" target="content" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','imag/soporte2.jpg',1)"><img src="imag/soporte.jpg" name="Image9" width="161" height="25" border="0"></a></font></div></td>
    <? }else{?>
 		<a href="../admin/institucion/soporte/Man_Soporte.php3" target="content" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','imag/soporte2.jpg',1)"><img src="imag/soporte.jpg" name="Image10" width="161" height="23" border="0"></a></td>
    <? } ?>
  </tr>
   <tr> 
    <td width="161" height="23" valign="bottom"><a href="../util/logout.php3" target="_parent"><img src="imag/salir.gif" name="Image15" width="161" height="23" border="0" id="Image15" onMouseOver="MM_swapImage('Image15','','imag/salir2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
  </tr>
 
  <?php if ($_PERFIL==0){?>
  <tr> 
    <td width="161" height="25" valign="bottom"><a href="../admin/institucion/webmail/verMail.php" target="content">REVISA 
      TU CORREO</a></td>
  </tr>
  <tr> 
    <td width="161" height="25" valign="bottom"><a href="../admin/institucion/webmail/crearMail.htm" target="content">CREAR 
      CORREO</a></td>
  </tr>
  <?php }?>
</table>
