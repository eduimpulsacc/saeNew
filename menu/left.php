 ...
 <?php if($_PERFIL!=0){ ?> 
  ...
  <?php }?>
    ...
    <? }else{?>
 		...
 		<a href="../admin/institucion/soporte/seteaSoporte.php3?caso=2" target="content" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','imag/soporte2.jpg',1)"><img src="imag/soporte.jpg" name="Image10" width="161" height="23" border="0"></a></td>
  ...
  <tr>
    ...
    <td width="161" height="28" valign="bottom"><a href="salida.php" target="_parent"><img src="imag/salir.gif" name="Image15" width="161" height="23" border="0" id="Image15" onMouseOver="MM_swapImage('Image15','','imag/salir2.gif',1)" onMouseOut="MM_swapImgRestore()"></a></td>
