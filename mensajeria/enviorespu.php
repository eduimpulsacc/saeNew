                                              ...
                                              <tr>
                                                <td height="23" colspan="2" valign="top">
                                                  <table width="100%" border="1">
                                                    <tr>
                                                      <td width="415"><a href="mira.php?menu=9&categoria=48&nw=1"><span class="Estilo1">Bandeja de entrada </span></a></td>
...
"id-->".$id = $row["id_mensaje"];												
"user1-->".$de = $row["user1men"];
"user2-->".$para = $row["user1men"];
$mensaje = $row["mensaje"];
$asunto = $row["asunto"];
...
//$archivos = $row["archivos"];
 ...
 ?>
                                              ...
                                              <tr>
                                                ...
                                                <td width="596" class="cuadro01"><? echo $de ?>
                                                <input type="hidden" name="rut_destino" value="<?=$idusuario?>" >
                                                
                                                </td>
                                              </tr>
                                              <tr>
                                                <td height="23" class="cuadro02">Para : </td>
                                                <td height="23" class="cuadro01"><? echo $_USUARIOENSESION; ?>	 
												<input name=respuesta Type= "hidden" value="<? echo $_NOMBREUSUARIO; ?>" ></td>
												</tr>
                                              <tr>
											 ...
											 <div id="masterdiv3">			
                                              ...
                                              <tr>
                                                <td colspan="2">
												   ...
												   <div class="Estilo9" onClick="SwitchMenu('escribir_respuesta')">
                                                   <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                     <tbody>
                                                        <tr>
                                                          <td  bgcolor="#f5f5f5"><a href="#">Escribir Respuesta</a></td>
                                                        </tr>
                                                     </tbody>
                                                   </table>
                                                   </div>
                                            ...
                                            <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                <td><label>
                                                  ...
                                                  <a href="mira.php"><span class="Estilo1">Bandeja de entrada</span></a></label></td>
                                              </tr>
                                            </table>
...
?>
									...
									$archi = 'archivo';
									$de = $_NOMBREUSUARIO;
									$idusuario=$_POST["rut_destino"];
									
$archivos =$_FILES['archivo']['name'];
if($institucion==24756){
echo"<br>";
echo "archivos -->".$archivos."<br>";
}
//echo "archivo recibido -->".$_FILES['archivo']['name'];		
...
?><!-- fin nombre --><?									
 ...
 $qryser="INSERT INTO mensajero (user1men,user2men,mensaje,asunto,archivos,fecha,lee,id_usuario,hora) VALUES ('".$nombre."','".$idusuario."','".$men."','"."".'Re: '.$asu."','".$archivos."','".$fecha."','0','".$paras."','".$hora."')";
...
$resus =pg_Exec($conn,$qryser);
	                                ...
	                                <center><br><a href="mira.php?menu=9&categoria=48&nw=1" target="_self">Bandeja de entrada</a></center></div></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table></td>
