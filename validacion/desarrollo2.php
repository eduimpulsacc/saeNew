...
<table width="650" border="0" align="center">
  ...
  <tr>
   ...
   <tr>
    <td class="cuadro02">REVISADO POR</td>
    <td class="cuadro01">CLAUDIO GOMEZ</td>
   
  </tr>
   <tr>
    <td class="cuadro02">OBSERVACIONES</td>
    <td class="cuadro01">SE RECHAZA DADO QUE NO POSEE LAS VALIDACIONES DE DATOS SOLICITADAS, ADEMÁS DE NO EXISTIR EL AVISO EN LA FICHA ACADEMICA EN EL PERFIL DE APODERADO</td>
  ...
  <tr>
    ...
    <td class="cuadro01"><label for="textfield2"></label>
      <textarea name="textfield2" id="textfield2" ROWS="5" COLS="50">SE CORRIGEN LAS VALIDACIONES INDICADAS Y SE AGREGA EL AVISO EN LA FICHA ADECEMICA DEL APODERADO</textarea></td>
     </tr>
