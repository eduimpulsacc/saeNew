...
require "mod_apoyos_especializados.php";
...
$funcion = $_POST['funcion'];
	...
	if($funcion==descarga){
		...
		$nombre = "documento_oficial/APOYOS_ESPECIALIZADOS.doc"; // Nombre del archivo
	...
	<td>'.$descargar =" <a href='mod/Area_Cognitiva/formulario_apoyos_especializados/descargar_archivo.php?id=".$fila['id_archivo']."'> <img src='Class/PNG-32/Save.png' width='22' height='24' /> </a>".'</td>
				</tr>';
			}// fin for
			$table .= "<tbody></table>";
			echo $table;
	...
	$id_prof=$_POST['id_archivo'];
	  ...
	  if($result){
		...
		//print($nombre);
		echo "mod/Area_Cognitiva/formulario_apoyos_especializados/$nombre";
		 }
	  }
	}
