...
<script>
 ...
 function descarga_archivo(){
	...
	var parametros= "funcion="+funcion; 	 
		...
		$.ajax({
		  url:'mod/Area_Cognitiva/formulario_apoyos_especializados/cont_apoyos_especializados.php',
		  data:parametros,
		  type:'POST',
...
<div id="cuerpo_area_cognitiva" >
  <fieldset>
<legend><strong><?=htmlentities("Apoyos Especializados",ENT_QUOTES,'UTF-8')?></strong></legend>
<div id="Area_Cognitiva" >
<form  id="frm" name="frm" method="post" enctype="multipart/form-data" action="mod/Area_Cognitiva/formulario_apoyos_especializados/controlUpload.php" target="iframeUpload">
...
<INPUT type="hidden" id="id_tipo" name="id_tipo" value="5">
</form>
</div>
</fieldset>
