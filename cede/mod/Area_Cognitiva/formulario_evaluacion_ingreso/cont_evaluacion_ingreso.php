...
$funcion = $_POST['funcion'];
	...
	if($funcion==descarga){
		...
		$nombre = "documento_oficial/FORMULARIO_EVALUACION_INGRESO.doc"; // Nombre del archivo
	...
	<td>'.$descargar =" <a href='mod/Area_Cognitiva/formulario_evaluacion_ingreso/descargar_archivo.php?id=".$fila['id_archivo']."'> <img src='Class/PNG-32/Save.png' width='22' height='24' /> </a>".'</td>
	...
	$id_prof=$_POST['id_archivo'];
	  ...
	  if($result){
		...
		header( "Content-Disposition: attachment; filename=".trim($nombre)."");
		//print($nombre);
		
		
		$dir="mod/Area_Cognitiva/formulario_evaluacion_ingreso";
		...
		//echo "mod/Area_Cognitiva/formulario_evaluacion_ingreso/$nombre";
		//echo"mod/Area_Cognitiva/formulario_evaluacion_ingreso/archivos/21898248_03292012_FORMULARIO_UNICO_SINTESIS_INGRESO_20102__espinoza.docx";
		 }
	  }
	}
