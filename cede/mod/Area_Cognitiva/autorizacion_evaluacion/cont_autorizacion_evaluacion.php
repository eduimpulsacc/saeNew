...
require "mod_autorizacion_evaluacion.php";
...
$funcion = $_POST['funcion'];
	...
	if($funcion==descarga){
		...
		$nombre = "documento_oficial/AUTORIZACION_EVALUACION_2010.doc"; // Nombre del archivo
	...
	<td>'.$descargar =" <a href='mod/Area_Cognitiva/autorizacion_evaluacion/descargar_archivo.php?id=".$fila['id_archivo']."'> <img src='Class/PNG-32/Save.png' width='22' height='24' /> </a>".'</td>
	...
	$id_prof=$_POST['id_archivo'];
	  ...
	  if($result){
		...
		//print($nombre);
		echo "mod/Area_Cognitiva/autorizacion_evaluacion/$nombre";
		 }
	  }
	}
