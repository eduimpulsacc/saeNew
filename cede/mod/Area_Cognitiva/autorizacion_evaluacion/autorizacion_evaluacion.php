...
<script>
 ...
 function descarga_archivo(){
	...
	var parametros= "funcion="+funcion; 	 
		...
		$.ajax({
		  url:'mod/Area_Cognitiva/autorizacion_evaluacion/cont_autorizacion_evaluacion.php',
		  data:parametros,
		  type:'POST',
...
<div id="cuerpo_area_cognitiva" >
  <fieldset>
<legend><strong><?=htmlentities("Autorización de Evaluación",ENT_QUOTES,'UTF-8')?></strong></legend>
<div id="Area_Cognitiva" >
<form  id="frm" name="frm" method="post" enctype="multipart/form-data" action="mod/Area_Cognitiva/autorizacion_evaluacion/controlUpload.php" target="iframeUpload">
