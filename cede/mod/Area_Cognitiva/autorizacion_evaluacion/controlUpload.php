...
require_once("mod_autorizacion_evaluacion.php");
...
if (($tipo == "doc") or ($tipo == "docx") or ($tipo== "pdf")){
   ...
   $result =  $Obj_Area_cog->InsertaAreaCognitiva($_ANO_CEDE, $id_curso, $_RUT_ALUMNO, $_POST['txtFECHA'],$_NOMBREUSUARIO,$_POST['obser'],   $nombre_archivo,$_POST['id_tipo']);
    ...
    }else{ echo"<script type=\"text/javascript\">alert(\"Solo Archivos .Word Y .Pdf\");</script>";}
