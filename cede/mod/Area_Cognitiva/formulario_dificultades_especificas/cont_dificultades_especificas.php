...
$funcion = $_POST['funcion'];
	...
	if($funcion==descarga){
		...
		$nombre = "documento_oficial/FORMULARIO_DIFICULTADES_ESPECIFICAS.doc"; // Nombre del archivo
	...
	<td>'.$descargar =" <a href='mod/Area_Cognitiva/formulario_dificultades_especificas/descargar_archivo.php?id=".$fila['id_archivo']."'> <img src='Class/PNG-32/Save.png' width='22' height='24' /> </a>".'</td>
	...
	$id_prof=$_POST['id_archivo'];
	  ...
	  if($result){
		...
		//print($nombre);
		echo "mod/Area_Cognitiva/formulario_dificultades_especificas/$nombre";
		 }
	  }
	}
