...
<script>
 ...
 function descarga_archivo(){
	...
	var parametros= "funcion="+funcion; 	 
		...
		$.ajax({
		  url:'mod/Area_Cognitiva/formulario_valoracion_salud/cont_valoracion_salud.php',
		  data:parametros,
		  type:'POST',
...
<div id="cuerpo_area_cognitiva" >
  <fieldset>
<legend><strong><?=htmlentities("Valoración de Salud",ENT_QUOTES,'UTF-8')?></strong></legend>
<div id="Area_Cognitiva" >
<form  id="frm" name="frm" method="post" enctype="multipart/form-data" action="mod/Area_Cognitiva/formulario_valoracion_salud/controlUpload.php" target="iframeUpload">
...
<INPUT type="hidden" id="id_tipo" name="id_tipo" value="7">
</form>
</div>
</fieldset>
