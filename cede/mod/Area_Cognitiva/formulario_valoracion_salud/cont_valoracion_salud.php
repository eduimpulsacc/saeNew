...
require "mod_valoracion_salud.php";
...
$funcion = $_POST['funcion'];
	...
	if($funcion==descarga){
		...
		$nombre = "documento_oficial/FORMULARIO_VALORACION_DE_SALUD.doc"; // Nombre del archivo
	...
	<td>'.$descargar =" <a href='mod/Area_Cognitiva/formulario_valoracion_salud/descargar_archivo.php?id=".$fila['id_archivo']."'> <img src='Class/PNG-32/Save.png' width='22' height='24' /> </a>".'</td>
	...
	$id_prof=$_POST['id_archivo'];
	  ...
	  if($result){
		...
		//print($nombre);
		echo "mod/Area_Cognitiva/formulario_valoracion_salud/$nombre";
		 }
	  }
	}
