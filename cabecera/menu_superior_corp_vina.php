						  ...
						  <tr>
						    <td>				   
							   ...
							   if(pg_dbname($conn)=="coi_antofagasta"){
								echo "<img src='".$d."tmp/logoCMDS.jpg". "' >";   
							   }else{
							  	   echo "<img src='".$d."tmp/66600.JPG". "' >";
							   }
							  ?>
						    </td>
...
<object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="539" height="86">
  ...
  <!--<![endif]-->
				...
				<?	}	?>
				  ...
				  if (($_PERFIL == 17) OR ($_PERFIL == 2) OR ($_PERFIL == 19)OR ($_PERFIL == 33) OR ($_PERFIL == 35) OR ($_PERFIL == 22) OR ($_PERFIL == 22)OR ($_PERFIL == 22)OR ($_PERFIL == 32)OR ($_PERFIL == 31)OR ($_PERFIL == 30)OR ($_PERFIL == 29)OR ($_PERFIL == 28)OR ($_PERFIL == 27)OR ($_PERFIL == 26)OR ($_PERFIL == 25)OR ($_PERFIL == 21)OR ($_PERFIL == 9)OR ($_PERFIL == 8)OR ($_PERFIL == 6)OR ($_PERFIL == 22)OR ($_PERFIL == 14) OR ($_PERFIL == 20) OR ($_PERFIL == 21) OR ($_PERFIL == 1) OR ($_PERFIL == 6) OR ($_PERFIL == 31) OR ($_PERFIL == 25) OR ($_PERFIL == 26) OR ($_PERFIL == 28)  OR ($_PERFIL == 27) OR ($_PERFIL == 44) OR ($_PERFIL == 41) OR ($_PERFIL == 47)  ){ 
					    ?>					
