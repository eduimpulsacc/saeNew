  ...
  <figure>    <img class="img4" alt="alt img1" src="<?=$d;?>cortes/foto_top_new66.png" /> 
              ...
              <img class="img1" alt="alt img4" src="<?=$d;?>cortes/foto_top_new11.png" />   
				...
				<?	}	?>
				  ...
				  if (($_PERFIL == 17) OR ($_PERFIL == 2) OR ($_PERFIL == 19)OR ($_PERFIL == 33) OR ($_PERFIL == 35) OR ($_PERFIL == 22) OR ($_PERFIL == 22)OR ($_PERFIL == 22)OR ($_PERFIL == 32)OR ($_PERFIL == 31)OR ($_PERFIL == 30)OR ($_PERFIL == 29)OR ($_PERFIL == 28)OR ($_PERFIL == 27)OR ($_PERFIL == 26)OR ($_PERFIL == 25)OR ($_PERFIL == 21)OR ($_PERFIL == 9)OR ($_PERFIL == 8)OR ($_PERFIL == 6)OR ($_PERFIL == 22)OR ($_PERFIL == 14) OR ($_PERFIL == 20) OR ($_PERFIL == 21) OR ($_PERFIL == 1) OR ($_PERFIL == 6) OR ($_PERFIL == 31) OR ($_PERFIL == 25) OR ($_PERFIL == 26) OR ($_PERFIL == 28)  OR ($_PERFIL == 27)OR ($_PERFIL == 53) OR ($_PERFIL == 44) OR ($_PERFIL == 41) OR ($_PERFIL == 47) OR ($_PERFIL == 49) OR ($_PERFIL == 24)OR ($_PERFIL == 54) OR ($_PERFIL == 51)){ 
					    ?>					
