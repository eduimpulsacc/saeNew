...
.cajaborde tr td table tr td table tr .cajaborde .cajaborde {
	font-size: 12px;
	text-align: center;
                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD>  <img src="/../../../manual_html/images/cursos_1.jpg" width="773" height="200">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                              
                                            <tr>
                                                <th width="26%" height="45" scope="row">&nbsp;</th>
                                                <td width="73%"><p>Ac&aacute; muestra todos los cursos del establecimiento, se pueden agregar<br>
                                                cursos pinchando el bot&oacute;n agregar y completando la informaci&oacute;n solicitada, en la opci&oacute;n Modificar todos podremos asignar a los profesores  jefes como muestra la imagen de abajo</p></td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <th height="45" colspan="2" scope="row"><img src="/../../../manual_html/images/cursos_2.jpg" width="800" height="355"></th>
                                              <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <th height="45" scope="row">&nbsp;</th>
                                              <td><p>Aqu&iacute; Podremos asignar a los profesores Jefes&nbsp; de todos los cursos</p></td>
                                              <td>&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
