                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="right"><img src="/../../../../../manual_html/images/claves.jpg" width="766" height="173"><br>
                                            <img src="/../../../../../manual_html/images/claves2.jpg" width="659" height="173"> <br>
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">Claves del sistema: Podemos generar y ver las claves de los<br>
                                                alumnos por Rut y por curso..</td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
