                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="center"><img src="/../../../../../manual_html/images/listar_ano.jpg" width="827" height="265">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">A&ntilde;os Acad&eacute;micos: La plataforma muestra el total de a&ntilde;os como hist&oacute;rico<br>
                                                  al cual se puede consultar sobre informaci&oacute;n de a&ntilde;os anteriores pinchamdo sobre un a&ntilde;o en particualr.<br>
La
                                                  empresa se encarga de traspasar la base de datos a&ntilde;o a a&ntilde;o y la creaci&oacute;n<br>
                                                  del a&ntilde;o presente. Por motivos de seguridad el sistema permite trabajar con<br>
                                                  un solo a&ntilde;o abierto, y el a&ntilde;o cerrado permite consultar y no modificar<br>
                                                datos.</td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
