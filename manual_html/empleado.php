                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="center"><img src="/../../../../manual_html/images/crear_cuenta.jpg" width="715" height="197">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%"><p><strong>Acceso  Web: </strong>Aqu&iacute; el administrador puede dar el acceso por primera  vez y una vez creada la clave&nbsp; podemos  modificar los perfiles de acceso.<br>
                                              Al pinchar por primera vez  crear cuenta nos mostrar&aacute; los pasos para la clave                                                </p></td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <th colspan="2" scope="row"><img src="/../../../../manual_html/images/crear_cuenta2.jpg" width="625" height="178"></th>
                                              <td>&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <th scope="row">&nbsp;</th>
                                              <td><p>En la pantalla que se mostraba anteriormente nos muestra el nombre de  usuario que debe ser como se muestra en pantalla sin puntos ni comas, sin gui&oacute;n  ni digito verificador y a continuaci&oacute;n ingresar la nueva clave repiti&eacute;ndola  nuevamente y eligiendo el perfil de acceso, posteriormente se guarda.</p></td>
                                              <td>&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
