                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="center"><img src="/../../../../../manual_html/images/periodo.jpg" width="879" height="189">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">Cerrar periodo, nos dala posibilidad de no modificar las notas de ese periodo y en<br>
                                                  esa ventana desaparece el bot&oacute;n que dice ingreso de notas. El bot&oacute;n no mostrar<br>
                                                notas nos permite visualizar la ficha acad&eacute;mica en el perfil de apoderado y alumno.</td>
                                              <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
