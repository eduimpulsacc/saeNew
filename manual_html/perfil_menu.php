                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD><img src="/../../../manual_html/images/perfil_menu.jpg" width="819" height="355">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="6">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">Aqu&iacute; se configura el perfil de acceso o los permisos que<br>
                                                  otorga el administrador Web del colegio para que tengan acceso y atribuciones los<br>
                                                distintos perfiles creados.</td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
