                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="right"><img src="manual_html/images/ano_escolar.jpg" width="869" height="186"><br>
                                            <img src="/manual_html/images/ano_escolar2.jpg" width="625" height="191">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">En esta Opci&oacute;n podremos cambiar la situaci&oacute;n del a&ntilde;o de ABIERTO A CERRADO</td>
                                                <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
