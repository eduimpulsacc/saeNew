                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD><img src="/../../../../../manual_html/images/informacion_periodo.jpg" width="971" height="268">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">En esta etapa  del men&uacute; ingresamos los d&iacute;as de los
                                                  periodos para que el total de la asistencia sea el correcto, por tanto estos datos
                                                son ingresados por el usuario. 
                                                Por cada inicio de a&ntilde;o nuevo estos datos mostraran la advertencia de Falta<br>
                                                Informaci&oacute;n ya que cada a&ntilde;o var&iacute;an los periodos del a&ntilde;o escolar y los d&iacute;as.<br>
                                                Al pinchar cada periodo podemos modificar los datos para establecer los d&iacute;as<br>
                                                trabajados o total de d&iacute;as que se relacionan con la asistencia de los alumnos en<br>
                                                base a los datos ingresados, esto permitir&aacute; que dicha informaci&oacute;n este en los<br>
                                              informes.Tambien Aca habilitamos la opci&oacute;n FICHA ACADEMICA para el  perfil de alumno y apoderado como lo muestra el recuadro azul</td>
                                              <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
