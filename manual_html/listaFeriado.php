                                  ...
                                  <td valign="top">
                                    ...
                                    <!-- AQUI VA TODA LA PROGRAMACIÓN  -->
                                      ...
                                      <TABLE WIDTH=100% BORDER=0 align="center" CELLPADDING=0 CELLSPACING=5 >
                                        <TR height=15>
                                          <TD align="center"><img src="/../../../../../manual_html/images/lista_feriado.jpg" width="989" height="488">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="5">
                                              
                                            <tr>
                                                <th width="26%" scope="row">&nbsp;</th>
                                                <td width="73%">Feriados: En este paso se ingresan los feriados asociados al establecimiento<br>
                                                y tambi&eacute;n los feriados de calendario.</td>
                                              <td width="1%">&nbsp;</td>
                                            </tr>
                                          </table></TD>
                                        </TR>			
